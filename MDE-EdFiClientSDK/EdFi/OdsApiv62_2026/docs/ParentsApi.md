# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Five_Twenty_Six_SISVendor_Profile.ParentsApi
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.parent.minnesota-twenty-five-twenty-six-sis-vendor-profile.readable+json
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.parent.minnesota-twenty-five-twenty-six-sis-vendor-profile.writable+json
 - **Accept**: Not defined
