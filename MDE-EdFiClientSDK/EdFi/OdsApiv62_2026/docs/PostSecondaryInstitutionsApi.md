# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Four_Twenty_Five_SISVendor_Profile.PostSecondaryInstitutionsApi
...
> List&lt;TrackedChangesEdFiPostSecondaryInstitutionReadableDelete&gt; DeletesPostSecondaryInstitutions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesPostSecondaryInstitutionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiPostSecondaryInstitutionReadableDelete> result = apiInstance.DeletesPostSecondaryInstitutions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiPostSecondaryInstitutionReadableDelete>> response = apiInstance.DeletesPostSecondaryInstitutionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesEdFiPostSecondaryInstitutionReadableDelete&gt;**](TrackedChangesEdFiPostSecondaryInstitutionReadableDelete.md)
...
> List&lt;EdFiPostSecondaryInstitutionReadable&gt; GetPostSecondaryInstitutions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, int? postSecondaryInstitutionId = null, string? snapshotIdentifier = null)
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPostSecondaryInstitutionReadable>> response = apiInstance.GetPostSecondaryInstitutionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.postsecondaryinstitution.minnesota-twenty-four-twenty-five-sis-vendor-profile.readable+json
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiPostSecondaryInstitutionReadable> response = apiInstance.GetPostSecondaryInstitutionsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a name="keychangespostsecondaryinstitutions"></a>
# **KeyChangesPostSecondaryInstitutions**
> List&lt;TrackedChangesEdFiPostSecondaryInstitutionReadableKeyChange&gt; KeyChangesPostSecondaryInstitutions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesPostSecondaryInstitutionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiPostSecondaryInstitutionReadableKeyChange> result = apiInstance.KeyChangesPostSecondaryInstitutions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiPostSecondaryInstitutionReadableKeyChange>> response = apiInstance.KeyChangesPostSecondaryInstitutionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**List&lt;TrackedChangesEdFiPostSecondaryInstitutionReadableKeyChange&gt;**](TrackedChangesEdFiPostSecondaryInstitutionReadableKeyChange.md)
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.postsecondaryinstitution.minnesota-twenty-four-twenty-five-sis-vendor-profile.writable+json
 - **Accept**: Not defined
