...
| [**KeyChangesStudentAssessmentPrecodes**](StudentAssessmentPrecodesApi.md#keychangesstudentassessmentprecodes) | **GET** /MN/studentAssessmentPrecodes/keyChanges | Retrieves resources key changes based on change version. |
...
> List&lt;TrackedChangesMnStudentAssessmentPrecodeReadableDelete&gt; DeletesStudentAssessmentPrecodes (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentAssessmentPrecodesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesMnStudentAssessmentPrecodeReadableDelete> result = apiInstance.DeletesStudentAssessmentPrecodes(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesMnStudentAssessmentPrecodeReadableDelete>> response = apiInstance.DeletesStudentAssessmentPrecodesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesMnStudentAssessmentPrecodeReadableDelete&gt;**](TrackedChangesMnStudentAssessmentPrecodeReadableDelete.md)
...
<a name="keychangesstudentassessmentprecodes"></a>
# **KeyChangesStudentAssessmentPrecodes**
> List&lt;TrackedChangesMnStudentAssessmentPrecodeReadableKeyChange&gt; KeyChangesStudentAssessmentPrecodes (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentAssessmentPrecodesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesMnStudentAssessmentPrecodeReadableKeyChange> result = apiInstance.KeyChangesStudentAssessmentPrecodes(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling StudentAssessmentPrecodesApi.KeyChangesStudentAssessmentPrecodes: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesStudentAssessmentPrecodesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesMnStudentAssessmentPrecodeReadableKeyChange>> response = apiInstance.KeyChangesStudentAssessmentPrecodesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentAssessmentPrecodesApi.KeyChangesStudentAssessmentPrecodesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesMnStudentAssessmentPrecodeReadableKeyChange&gt;**](TrackedChangesMnStudentAssessmentPrecodeReadableKeyChange.md)
