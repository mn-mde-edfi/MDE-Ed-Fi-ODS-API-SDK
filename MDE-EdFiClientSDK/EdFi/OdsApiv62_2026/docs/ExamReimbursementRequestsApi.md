...
| [**KeyChangesExamReimbursementRequests**](ExamReimbursementRequestsApi.md#keychangesexamreimbursementrequests) | **GET** /MN/examReimbursementRequests/keyChanges | Retrieves resources key changes based on change version. |
...
> List&lt;TrackedChangesMnExamReimbursementRequestReadableDelete&gt; DeletesExamReimbursementRequests (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesExamReimbursementRequestsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesMnExamReimbursementRequestReadableDelete> result = apiInstance.DeletesExamReimbursementRequests(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesMnExamReimbursementRequestReadableDelete>> response = apiInstance.DeletesExamReimbursementRequestsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesMnExamReimbursementRequestReadableDelete&gt;**](TrackedChangesMnExamReimbursementRequestReadableDelete.md)
...
<a name="keychangesexamreimbursementrequests"></a>
# **KeyChangesExamReimbursementRequests**
> List&lt;TrackedChangesMnExamReimbursementRequestReadableKeyChange&gt; KeyChangesExamReimbursementRequests (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesExamReimbursementRequestsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesMnExamReimbursementRequestReadableKeyChange> result = apiInstance.KeyChangesExamReimbursementRequests(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ExamReimbursementRequestsApi.KeyChangesExamReimbursementRequests: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesExamReimbursementRequestsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesMnExamReimbursementRequestReadableKeyChange>> response = apiInstance.KeyChangesExamReimbursementRequestsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ExamReimbursementRequestsApi.KeyChangesExamReimbursementRequestsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesMnExamReimbursementRequestReadableKeyChange&gt;**](TrackedChangesMnExamReimbursementRequestReadableKeyChange.md)
