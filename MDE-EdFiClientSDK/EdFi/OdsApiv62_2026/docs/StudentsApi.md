# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Five_Twenty_Six_SISVendor_Profile.StudentsApi
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.student.minnesota-twenty-five-twenty-six-sis-vendor-profile.readable+json
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.student.minnesota-twenty-five-twenty-six-sis-vendor-profile.writable+json
 - **Accept**: Not defined
