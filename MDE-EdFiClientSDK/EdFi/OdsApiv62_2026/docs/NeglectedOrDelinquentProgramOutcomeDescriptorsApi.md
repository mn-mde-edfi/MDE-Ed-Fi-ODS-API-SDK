# EdFi.OdsApi.Sdk.Apis.Descriptors.NeglectedOrDelinquentProgramOutcomeDescriptorsApi
...
| [**KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptors**](NeglectedOrDelinquentProgramOutcomeDescriptorsApi.md#keychangesneglectedordelinquentprogramoutcomedescriptors) | **GET** /MN/neglectedOrDelinquentProgramOutcomeDescriptors/keyChanges | Retrieves resources key changes based on change version. |
...
namespace Example
{
    public class DeleteNeglectedOrDelinquentProgramOutcomeDescriptorByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new NeglectedOrDelinquentProgramOutcomeDescriptorsApi(config);
...
#### Using the DeleteNeglectedOrDelinquentProgramOutcomeDescriptorByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteNeglectedOrDelinquentProgramOutcomeDescriptorByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.DeleteNeglectedOrDelinquentProgramOutcomeDescriptorByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> List&lt;TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorDelete&gt; DeletesNeglectedOrDelinquentProgramOutcomeDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesNeglectedOrDelinquentProgramOutcomeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorDelete> result = apiInstance.DeletesNeglectedOrDelinquentProgramOutcomeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
#### Using the DeletesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorDelete>> response = apiInstance.DeletesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.DeletesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorDelete&gt;**](TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorDelete.md)
...
> List&lt;MnNeglectedOrDelinquentProgramOutcomeDescriptor&gt; GetNeglectedOrDelinquentProgramOutcomeDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, int? neglectedOrDelinquentProgramOutcomeDescriptorId = null, string? snapshotIdentifier = null)
...
#### Using the GetNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<MnNeglectedOrDelinquentProgramOutcomeDescriptor>> response = apiInstance.GetNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, neglectedOrDelinquentProgramOutcomeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.GetNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the GetNeglectedOrDelinquentProgramOutcomeDescriptorsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<MnNeglectedOrDelinquentProgramOutcomeDescriptor> response = apiInstance.GetNeglectedOrDelinquentProgramOutcomeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.GetNeglectedOrDelinquentProgramOutcomeDescriptorsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a name="keychangesneglectedordelinquentprogramoutcomedescriptors"></a>
# **KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptors**
> List&lt;TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKeyChange&gt; KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptorsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKeyChange> result = apiInstance.KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptors: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKeyChange>> response = apiInstance.KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.KeyChangesNeglectedOrDelinquentProgramOutcomeDescriptorsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKeyChange&gt;**](TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKeyChange.md)
...
#### Using the PostNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo(neglectedOrDelinquentProgramOutcomeDescriptor);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.PostNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PutNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo(id, neglectedOrDelinquentProgramOutcomeDescriptor, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling NeglectedOrDelinquentProgramOutcomeDescriptorsApi.PutNeglectedOrDelinquentProgramOutcomeDescriptorWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
