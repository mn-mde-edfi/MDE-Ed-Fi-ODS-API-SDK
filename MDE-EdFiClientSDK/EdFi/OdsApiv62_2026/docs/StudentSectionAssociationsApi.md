# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Four_Twenty_Five_SISVendor_Profile.StudentSectionAssociationsApi
...
<a name="deletesstudentsectionassociations"></a>
# **DeletesStudentSectionAssociations**
> List&lt;TrackedChangesEdFiStudentSectionAssociationReadableDelete&gt; DeletesStudentSectionAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentSectionAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentSectionAssociationReadableDelete> result = apiInstance.DeletesStudentSectionAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSectionAssociationReadableDelete>> response = apiInstance.DeletesStudentSectionAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesEdFiStudentSectionAssociationReadableDelete&gt;**](TrackedChangesEdFiStudentSectionAssociationReadableDelete.md)
...
namespace Example
{
    public class GetStudentSectionAssociationsExample
    {
        public static void Main()
        {
            ...
            var maxChangeVersion = 789L;  // long? | Used in synchronization to set sequence maximum ChangeVersion (optional) 
            var totalCount = false;  // bool? | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. (optional)  (default to false)
            var beginDate = DateTime.Parse("2013-10-20");  // DateTime? | Month, day, and year of the student's entry or assignment to the section. (optional) 
            ...
            var endDate = DateTime.Parse("2013-10-20");  // DateTime? | Month, day, and year of the withdrawal or exit of the student from the section. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiStudentSectionAssociationReadable> result = apiInstance.GetStudentSectionAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, studentUniqueId, endDate, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiStudentSectionAssociationReadable>> response = apiInstance.GetStudentSectionAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, studentUniqueId, endDate, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**List&lt;EdFiStudentSectionAssociationReadable&gt;**](EdFiStudentSectionAssociationReadable.md)
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.studentsectionassociation.minnesota-twenty-four-twenty-five-sis-vendor-profile.readable+json
...
namespace Example
{
    public class GetStudentSectionAssociationsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiStudentSectionAssociationReadable result = apiInstance.GetStudentSectionAssociationsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiStudentSectionAssociationReadable> response = apiInstance.GetStudentSectionAssociationsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**EdFiStudentSectionAssociationReadable**](EdFiStudentSectionAssociationReadable.md)
...
<a name="keychangesstudentsectionassociations"></a>
# **KeyChangesStudentSectionAssociations**
> List&lt;TrackedChangesEdFiStudentSectionAssociationReadableKeyChange&gt; KeyChangesStudentSectionAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentSectionAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentSectionAssociationReadableKeyChange> result = apiInstance.KeyChangesStudentSectionAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSectionAssociationReadableKeyChange>> response = apiInstance.KeyChangesStudentSectionAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**List&lt;TrackedChangesEdFiStudentSectionAssociationReadableKeyChange&gt;**](TrackedChangesEdFiStudentSectionAssociationReadableKeyChange.md)
...
namespace Example
{
    public class PoststudentSectionAssociationExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StudentSectionAssociationsApi(config);
            var studentSectionAssociation = new EdFiStudentSectionAssociationWritable(); // EdFiStudentSectionAssociationWritable | The JSON representation of the \"studentSectionAssociation\" resource to be created or updated.
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **studentSectionAssociation** | [**EdFiStudentSectionAssociationWritable**](EdFiStudentSectionAssociationWritable.md) | The JSON representation of the \&quot;studentSectionAssociation\&quot; resource to be created or updated. |  |
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentsectionassociation.minnesota-twenty-four-twenty-five-sis-vendor-profile.writable+json
 - **Accept**: Not defined
