...
{
    /// <summary>
    /// MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable
    /// </summary>
    [DataContract(Name = "mn_studentDisciplineIncidentBehaviorAssociationExtension_readable")]
    public partial class MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable : IEquatable<MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable" /> class.
        /// </summary>
        ...
        public MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable(string secondaryBehaviorDescriptor = default(string), bool? wasArrestedLawEnforcement = default(bool?), bool? wasReferredLawEnforcement = default(bool?), bool? wasUnderCurrentSuspension = default(bool?), List<MnStudentDisciplineIncidentBehaviorAssociationBullyingHarassmentTypeReadable> bullyingHarassmentTypes = default(List<MnStudentDisciplineIncidentBehaviorAssociationBullyingHarassmentTypeReadable>), List<MnStudentDisciplineIncidentBehaviorAssociationDrugInformationReadable> drugInformation = default(List<MnStudentDisciplineIncidentBehaviorAssociationDrugInformationReadable>), List<MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeReadable> weaponAttributes = default(List<MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeReadable>))
        {
        ...
        public List<MnStudentDisciplineIncidentBehaviorAssociationBullyingHarassmentTypeReadable> BullyingHarassmentTypes { get; set; }
        ...
        public List<MnStudentDisciplineIncidentBehaviorAssociationDrugInformationReadable> DrugInformation { get; set; }
        ...
        public List<MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeReadable> WeaponAttributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable);
        }

        /// <summary>
        /// Returns true if MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentDisciplineIncidentBehaviorAssociationExtensionReadable input)
        {
            if (input == null)
            {
                return false;
