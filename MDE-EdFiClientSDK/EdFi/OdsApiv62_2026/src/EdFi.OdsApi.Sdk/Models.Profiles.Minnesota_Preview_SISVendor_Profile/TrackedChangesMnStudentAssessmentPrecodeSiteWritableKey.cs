...
{
    /// <summary>
    /// TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentAssessmentPrecodeSite_writableKey")]
    public partial class TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey : IEquatable<TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey(string precodeTypeDescriptor = default(string), int educationOrganizationId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentAssessmentPrecodeSiteWritableKey input)
        {
            if (input == null)
            {
                return false;
