...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentPlatformType_readable")]
    public partial class EdFiAssessmentPlatformTypeReadable : IEquatable<EdFiAssessmentPlatformTypeReadable>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentPlatformTypeReadable(string platformTypeDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("platformTypeDescriptor is a required property for EdFiAssessmentPlatformTypeReadable and cannot be null");
            }
