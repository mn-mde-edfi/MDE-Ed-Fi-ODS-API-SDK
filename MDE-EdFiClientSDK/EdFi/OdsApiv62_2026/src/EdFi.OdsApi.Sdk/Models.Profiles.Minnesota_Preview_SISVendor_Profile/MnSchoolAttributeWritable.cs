...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_schoolAttribute_writable")]
    public partial class MnSchoolAttributeWritable : IEquatable<MnSchoolAttributeWritable>, IValidatableObject
    {
        ...
        public MnSchoolAttributeWritable(string id = default(string), MnSchoolReference schoolReference = default(MnSchoolReference), List<MnSchoolAttributeEducationOrganizationIndicatorWritable> educationOrganizationIndicators = default(List<MnSchoolAttributeEducationOrganizationIndicatorWritable>), bool? hasAntiBullyingPolicy = default(bool?), bool? hasAntiViolencePolicy = default(bool?), bool? hasCrisisPlan = default(bool?), bool? hasDrugEducation = default(bool?), bool? hasSafetyPlan = default(bool?), bool? hasZeroTolerancePolicy = default(bool?), int? numberOfHabitualTruants = default(int?), string safetySpecialistEmail = default(string), string titleIPartASchoolDesignationDescriptor = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("schoolReference is a required property for MnSchoolAttributeWritable and cannot be null");
            }
        ...
        [DataMember(Name = "numberOfHabitualTruants", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "safetySpecialistEmail", EmitDefaultValue = true)]
        ...
        public bool Equals(MnSchoolAttributeWritable input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.NumberOfHabitualTruants != null &&
