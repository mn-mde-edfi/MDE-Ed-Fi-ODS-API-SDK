...
{
    /// <summary>
    /// EdFiDisciplineActionDisciplineReadable
    /// </summary>
    [DataContract(Name = "edFi_disciplineActionDiscipline_readable")]
    public partial class EdFiDisciplineActionDisciplineReadable : IEquatable<EdFiDisciplineActionDisciplineReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionDisciplineReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineActionDisciplineReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionDisciplineReadable" /> class.
        /// </summary>
        ...
        public EdFiDisciplineActionDisciplineReadable(string disciplineDescriptor = default(string))
        {
            // to ensure "disciplineDescriptor" is required (not null)
            if (disciplineDescriptor == null)
            {
                throw new ArgumentNullException("disciplineDescriptor is a required property for EdFiDisciplineActionDisciplineReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiDisciplineActionDisciplineReadable {\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineActionDisciplineReadable);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineActionDisciplineReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineActionDisciplineReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineActionDisciplineReadable input)
        {
            if (input == null)
            {
                return false;
