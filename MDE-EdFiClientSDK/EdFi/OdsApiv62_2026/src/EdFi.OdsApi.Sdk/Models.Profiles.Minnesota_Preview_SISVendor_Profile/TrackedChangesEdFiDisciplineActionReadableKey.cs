...
{
    /// <summary>
    /// TrackedChangesEdFiDisciplineActionReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineAction_readableKey")]
    public partial class TrackedChangesEdFiDisciplineActionReadableKey : IEquatable<TrackedChangesEdFiDisciplineActionReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineActionReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineActionReadableKey(string disciplineActionIdentifier = default(string), DateTime disciplineDate = default(DateTime), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineActionReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineActionReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineActionReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineActionReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineActionReadableKey input)
        {
            if (input == null)
            {
                return false;
