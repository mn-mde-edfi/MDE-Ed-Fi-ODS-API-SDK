...
{
    /// <summary>
    /// TrackedChangesEdFiDisciplineIncidentReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineIncident_readableKey")]
    public partial class TrackedChangesEdFiDisciplineIncidentReadableKey : IEquatable<TrackedChangesEdFiDisciplineIncidentReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineIncidentReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineIncidentReadableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineIncidentReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineIncidentReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineIncidentReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineIncidentReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineIncidentReadableKey input)
        {
            if (input == null)
            {
                return false;
