...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentAssessmentPrecodeSite_writable")]
    public partial class MnStudentAssessmentPrecodeSiteWritable : IEquatable<MnStudentAssessmentPrecodeSiteWritable>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeSiteWritable(string id = default(string), string precodeTypeDescriptor = default(string), MnEducationOrganizationReference educationOrganizationReference = default(MnEducationOrganizationReference), string contactElectronicMailAddress = default(string), string contactFirstName = default(string), string contactLastSurname = default(string), List<MnStudentAssessmentPrecodeSiteContactTelephoneWritable> contactTelephones = default(List<MnStudentAssessmentPrecodeSiteContactTelephoneWritable>), string contactTitle = default(string), List<MnStudentAssessmentPrecodeSiteShippingInstructionWritable> shippingInstructions = default(List<MnStudentAssessmentPrecodeSiteShippingInstructionWritable>), string etag = default(string))
        {
            // to ensure "precodeTypeDescriptor" is required (not null)
            if (precodeTypeDescriptor == null)
            {
                throw new ArgumentNullException("precodeTypeDescriptor is a required property for MnStudentAssessmentPrecodeSiteWritable and cannot be null");
            }
            this.PrecodeTypeDescriptor = precodeTypeDescriptor;
            // to ensure "educationOrganizationReference" is required (not null)
            if (educationOrganizationReference == null)
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for MnStudentAssessmentPrecodeSiteWritable and cannot be null");
            }
        ...
        [DataMember(Name = "contactElectronicMailAddress", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "contactLastSurname", EmitDefaultValue = true)]
        ...
        public List<MnStudentAssessmentPrecodeSiteContactTelephoneWritable> ContactTelephones { get; set; }

        /// <summary>
        /// Title of administrative contact
        /// </summary>
        /// <value>Title of administrative contact</value>
        [DataMember(Name = "contactTitle", EmitDefaultValue = true)]
        ...
        public List<MnStudentAssessmentPrecodeSiteShippingInstructionWritable> ShippingInstructions { get; set; }
