...
{
    /// <summary>
    /// TrackedChangesMnUnenrolledOffenderWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_unenrolledOffender_writableKey")]
    public partial class TrackedChangesMnUnenrolledOffenderWritableKey : IEquatable<TrackedChangesMnUnenrolledOffenderWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnUnenrolledOffenderWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnUnenrolledOffenderWritableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnUnenrolledOffenderWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnUnenrolledOffenderWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnUnenrolledOffenderWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnUnenrolledOffenderWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnUnenrolledOffenderWritableKey input)
        {
            if (input == null)
            {
                return false;
