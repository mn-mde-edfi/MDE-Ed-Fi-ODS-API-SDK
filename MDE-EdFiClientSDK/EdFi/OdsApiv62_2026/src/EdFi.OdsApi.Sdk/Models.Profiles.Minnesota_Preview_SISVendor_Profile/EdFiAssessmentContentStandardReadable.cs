...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentContentStandard_readable")]
    public partial class EdFiAssessmentContentStandardReadable : IEquatable<EdFiAssessmentContentStandardReadable>, IValidatableObject
    {
        ...
        protected EdFiAssessmentContentStandardReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentContentStandardReadable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentContentStandardReadable(string publicationStatusDescriptor = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? publicationDate = default(DateTime?), int? publicationYear = default(int?), string title = default(string), string uri = default(string), string version = default(string), EdFiEducationOrganizationReference mandatingEducationOrganizationReference = default(EdFiEducationOrganizationReference), List<EdFiAssessmentContentStandardAuthorReadable> authors = default(List<EdFiAssessmentContentStandardAuthorReadable>))
        {
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for EdFiAssessmentContentStandardReadable and cannot be null");
            }
            this.Title = title;
        ...
        public List<EdFiAssessmentContentStandardAuthorReadable> Authors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentContentStandardReadable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentContentStandardReadable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentContentStandardReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentContentStandardReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentContentStandardReadable input)
        {
            if (input == null)
            {
                return false;
