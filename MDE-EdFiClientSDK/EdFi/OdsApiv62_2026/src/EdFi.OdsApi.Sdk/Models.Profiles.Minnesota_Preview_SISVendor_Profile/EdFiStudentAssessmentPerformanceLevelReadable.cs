...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiStudentAssessmentPerformanceLevelReadable : IEquatable<EdFiStudentAssessmentPerformanceLevelReadable>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentPerformanceLevelReadable(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string performanceLevelIndicatorName = default(string))
        {
