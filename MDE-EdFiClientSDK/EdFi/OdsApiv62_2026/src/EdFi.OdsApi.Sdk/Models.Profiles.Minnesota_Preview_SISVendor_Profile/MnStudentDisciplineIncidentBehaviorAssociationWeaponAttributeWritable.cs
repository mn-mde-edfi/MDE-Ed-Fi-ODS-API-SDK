...
{
    /// <summary>
    /// MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable
    /// </summary>
    [DataContract(Name = "mn_studentDisciplineIncidentBehaviorAssociationWeaponAttribute_writable")]
    public partial class MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable : IEquatable<MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable" /> class.
        /// </summary>
        ...
        public MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable(string weaponIdentifier = default(string), string weaponDescriptor = default(string), bool? isGunCased = default(bool?), bool? isGunInTrunk = default(bool?), bool? isGunLoaded = default(bool?), int numberOfWeaponsInvolved = default(int))
        {
            // to ensure "weaponIdentifier" is required (not null)
            if (weaponIdentifier == null)
            {
                throw new ArgumentNullException("weaponIdentifier is a required property for MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable and cannot be null");
            }
            this.WeaponIdentifier = weaponIdentifier;
            // to ensure "weaponDescriptor" is required (not null)
            if (weaponDescriptor == null)
            {
                throw new ArgumentNullException("weaponDescriptor is a required property for MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable);
        }

        /// <summary>
        /// Returns true if MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentDisciplineIncidentBehaviorAssociationWeaponAttributeWritable input)
        {
            if (input == null)
            {
                return false;
