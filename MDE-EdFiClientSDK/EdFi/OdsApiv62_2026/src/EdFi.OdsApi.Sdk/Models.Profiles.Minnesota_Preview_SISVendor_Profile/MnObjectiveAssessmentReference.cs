...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_objectiveAssessmentReference")]
    public partial class MnObjectiveAssessmentReference : IEquatable<MnObjectiveAssessmentReference>, IValidatableObject
    {
        ...
        public MnObjectiveAssessmentReference(string assessmentIdentifier = default(string), string identificationCode = default(string), string _namespace = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("assessmentIdentifier is a required property for MnObjectiveAssessmentReference and cannot be null");
            }
            this.AssessmentIdentifier = assessmentIdentifier;
            // to ensure "identificationCode" is required (not null)
            if (identificationCode == null)
            {
                throw new ArgumentNullException("identificationCode is a required property for MnObjectiveAssessmentReference and cannot be null");
            }
            this.IdentificationCode = identificationCode;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for MnObjectiveAssessmentReference and cannot be null");
            }
