...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentAssessmentStudentObjectiveAssessmentPerformanceLevel_readable")]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable : IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string performanceLevelIndicatorName = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable and cannot be null");
            }
