...
{
    /// <summary>
    /// TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_disciplineIncidentAnonymousNonOffender_writableKey")]
    public partial class TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey : IEquatable<TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnDisciplineIncidentAnonymousNonOffenderWritableKey input)
        {
            if (input == null)
            {
                return false;
