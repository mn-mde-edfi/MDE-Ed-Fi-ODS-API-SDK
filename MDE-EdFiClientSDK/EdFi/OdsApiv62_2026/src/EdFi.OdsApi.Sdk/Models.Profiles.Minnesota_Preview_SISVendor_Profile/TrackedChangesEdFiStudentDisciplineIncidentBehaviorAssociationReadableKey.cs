...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentDisciplineIncidentBehaviorAssociation_readableKey")]
    public partial class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey : IEquatable<TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey(string behaviorDescriptor = default(string), string incidentIdentifier = default(string), int schoolId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
