...
{
    /// <summary>
    /// TrackedChangesMnUnenrolledOffenderReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_unenrolledOffender_readableKey")]
    public partial class TrackedChangesMnUnenrolledOffenderReadableKey : IEquatable<TrackedChangesMnUnenrolledOffenderReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnUnenrolledOffenderReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnUnenrolledOffenderReadableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnUnenrolledOffenderReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnUnenrolledOffenderReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnUnenrolledOffenderReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnUnenrolledOffenderReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnUnenrolledOffenderReadableKey input)
        {
            if (input == null)
            {
                return false;
