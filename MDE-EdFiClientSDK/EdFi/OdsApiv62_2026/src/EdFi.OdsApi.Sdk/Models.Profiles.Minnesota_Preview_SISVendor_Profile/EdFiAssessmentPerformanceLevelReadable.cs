...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentPerformanceLevel_readable")]
    public partial class EdFiAssessmentPerformanceLevelReadable : IEquatable<EdFiAssessmentPerformanceLevelReadable>, IValidatableObject
    {
        ...
        protected EdFiAssessmentPerformanceLevelReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentPerformanceLevelReadable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentPerformanceLevelReadable(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string), string performanceLevelIndicatorName = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiAssessmentPerformanceLevelReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiAssessmentPerformanceLevelReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentPerformanceLevelReadable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentPerformanceLevelReadable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentPerformanceLevelReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentPerformanceLevelReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentPerformanceLevelReadable input)
        {
            if (input == null)
            {
                return false;
