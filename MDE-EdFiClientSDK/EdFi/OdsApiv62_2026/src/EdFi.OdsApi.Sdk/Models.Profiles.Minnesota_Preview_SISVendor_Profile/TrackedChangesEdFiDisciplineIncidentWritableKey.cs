...
{
    /// <summary>
    /// TrackedChangesEdFiDisciplineIncidentWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineIncident_writableKey")]
    public partial class TrackedChangesEdFiDisciplineIncidentWritableKey : IEquatable<TrackedChangesEdFiDisciplineIncidentWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineIncidentWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineIncidentWritableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineIncidentWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineIncidentWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineIncidentWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineIncidentWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineIncidentWritableKey input)
        {
            if (input == null)
            {
                return false;
