...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentDisciplineIncidentBehaviorAssociation_writableKey")]
    public partial class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey : IEquatable<TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey(string behaviorDescriptor = default(string), string incidentIdentifier = default(string), int schoolId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
