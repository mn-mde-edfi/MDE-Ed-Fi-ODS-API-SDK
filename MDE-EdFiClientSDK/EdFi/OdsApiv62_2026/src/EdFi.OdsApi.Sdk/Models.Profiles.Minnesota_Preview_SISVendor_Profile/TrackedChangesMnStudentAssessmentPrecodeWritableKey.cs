...
{
    /// <summary>
    /// TrackedChangesMnStudentAssessmentPrecodeWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentAssessmentPrecode_writableKey")]
    public partial class TrackedChangesMnStudentAssessmentPrecodeWritableKey : IEquatable<TrackedChangesMnStudentAssessmentPrecodeWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentAssessmentPrecodeWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentAssessmentPrecodeWritableKey(string precodeTypeDescriptor = default(string), int educationOrganizationId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentAssessmentPrecodeWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentAssessmentPrecodeWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentAssessmentPrecodeWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentAssessmentPrecodeWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentAssessmentPrecodeWritableKey input)
        {
            if (input == null)
            {
                return false;
