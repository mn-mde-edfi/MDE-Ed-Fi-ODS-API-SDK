...
{
    /// <summary>
    /// EdFiDisciplineActionWritable
    /// </summary>
    [DataContract(Name = "edFi_disciplineAction_writable")]
    public partial class EdFiDisciplineActionWritable : IEquatable<EdFiDisciplineActionWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineActionWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionWritable" /> class.
        /// </summary>
        ...
        public EdFiDisciplineActionWritable(string id = default(string), string disciplineActionIdentifier = default(string), DateTime disciplineDate = default(DateTime), List<EdFiDisciplineActionDisciplineWritable> disciplines = default(List<EdFiDisciplineActionDisciplineWritable>), EdFiSchoolReference responsibilitySchoolReference = default(EdFiSchoolReference), EdFiStudentReference studentReference = default(EdFiStudentReference), double? actualDisciplineActionLength = default(double?), double? disciplineActionLength = default(double?), List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociationWritable> studentDisciplineIncidentBehaviorAssociations = default(List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociationWritable>), string etag = default(string), DisciplineActionExtensionsWritable ext = default(DisciplineActionExtensionsWritable))
        {
            // to ensure "disciplineActionIdentifier" is required (not null)
            if (disciplineActionIdentifier == null)
            {
                throw new ArgumentNullException("disciplineActionIdentifier is a required property for EdFiDisciplineActionWritable and cannot be null");
            }
            ...
            if (disciplines == null)
            {
                throw new ArgumentNullException("disciplines is a required property for EdFiDisciplineActionWritable and cannot be null");
            }
            this.Disciplines = disciplines;
            // to ensure "responsibilitySchoolReference" is required (not null)
            if (responsibilitySchoolReference == null)
            {
                throw new ArgumentNullException("responsibilitySchoolReference is a required property for EdFiDisciplineActionWritable and cannot be null");
            }
            this.ResponsibilitySchoolReference = responsibilitySchoolReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiDisciplineActionWritable and cannot be null");
            }
        ...
        public List<EdFiDisciplineActionDisciplineWritable> Disciplines { get; set; }
        ...
        public List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociationWritable> StudentDisciplineIncidentBehaviorAssociations { get; set; }
        ...
        public DisciplineActionExtensionsWritable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiDisciplineActionWritable {\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineActionWritable);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineActionWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineActionWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineActionWritable input)
        {
            if (input == null)
            {
                return false;
