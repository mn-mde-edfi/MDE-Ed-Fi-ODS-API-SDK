...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentAssessmentPeriod_readable")]
    public partial class EdFiStudentAssessmentPeriodReadable : IEquatable<EdFiStudentAssessmentPeriodReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPeriodReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentPeriodReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPeriodReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentPeriodReadable(string assessmentPeriodDescriptor = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?))
        {
            // to ensure "assessmentPeriodDescriptor" is required (not null)
            if (assessmentPeriodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentPeriodDescriptor is a required property for EdFiStudentAssessmentPeriodReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentPeriodReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentPeriodReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentPeriodReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentPeriodReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentPeriodReadable input)
        {
            if (input == null)
            {
                return false;
