...
{
    /// <summary>
    /// TrackedChangesMnExamReimbursementRequestWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_examReimbursementRequest_writableKey")]
    public partial class TrackedChangesMnExamReimbursementRequestWritableKey : IEquatable<TrackedChangesMnExamReimbursementRequestWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnExamReimbursementRequestWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnExamReimbursementRequestWritableKey(DateTime testedDate = default(DateTime), int educationOrganizationId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnExamReimbursementRequestWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnExamReimbursementRequestWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnExamReimbursementRequestWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnExamReimbursementRequestWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnExamReimbursementRequestWritableKey input)
        {
            if (input == null)
            {
                return false;
