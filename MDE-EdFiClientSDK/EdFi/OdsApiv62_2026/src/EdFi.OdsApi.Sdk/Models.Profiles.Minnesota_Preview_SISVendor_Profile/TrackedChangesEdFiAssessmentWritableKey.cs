...
{
    /// <summary>
    /// TrackedChangesEdFiAssessmentWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessment_writableKey")]
    public partial class TrackedChangesEdFiAssessmentWritableKey : IEquatable<TrackedChangesEdFiAssessmentWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentWritableKey(string assessmentIdentifier = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentWritableKey input)
        {
            if (input == null)
            {
                return false;
