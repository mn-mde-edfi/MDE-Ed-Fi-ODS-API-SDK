...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentDisciplineIncidentBehaviorAssociation_writable")]
    public partial class EdFiStudentDisciplineIncidentBehaviorAssociationWritable : IEquatable<EdFiStudentDisciplineIncidentBehaviorAssociationWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentDisciplineIncidentBehaviorAssociationWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentDisciplineIncidentBehaviorAssociationWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentDisciplineIncidentBehaviorAssociationWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentDisciplineIncidentBehaviorAssociationWritable(string id = default(string), string behaviorDescriptor = default(string), EdFiDisciplineIncidentReference disciplineIncidentReference = default(EdFiDisciplineIncidentReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string etag = default(string), StudentDisciplineIncidentBehaviorAssociationExtensionsWritable ext = default(StudentDisciplineIncidentBehaviorAssociationExtensionsWritable))
        {
            // to ensure "behaviorDescriptor" is required (not null)
            if (behaviorDescriptor == null)
            {
                throw new ArgumentNullException("behaviorDescriptor is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationWritable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("disciplineIncidentReference is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationWritable and cannot be null");
            }
            this.DisciplineIncidentReference = disciplineIncidentReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationWritable and cannot be null");
            }
        ...
        public StudentDisciplineIncidentBehaviorAssociationExtensionsWritable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentDisciplineIncidentBehaviorAssociationWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentDisciplineIncidentBehaviorAssociationWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentDisciplineIncidentBehaviorAssociationWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentDisciplineIncidentBehaviorAssociationWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentDisciplineIncidentBehaviorAssociationWritable input)
        {
            if (input == null)
            {
                return false;
