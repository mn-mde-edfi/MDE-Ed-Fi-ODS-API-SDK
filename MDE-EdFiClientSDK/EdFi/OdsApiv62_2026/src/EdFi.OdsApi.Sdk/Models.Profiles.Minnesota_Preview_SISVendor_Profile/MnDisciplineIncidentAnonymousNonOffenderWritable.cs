...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_disciplineIncidentAnonymousNonOffender_writable")]
    public partial class MnDisciplineIncidentAnonymousNonOffenderWritable : IEquatable<MnDisciplineIncidentAnonymousNonOffenderWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDisciplineIncidentAnonymousNonOffenderWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnDisciplineIncidentAnonymousNonOffenderWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDisciplineIncidentAnonymousNonOffenderWritable" /> class.
        /// </summary>
        ...
        public MnDisciplineIncidentAnonymousNonOffenderWritable(string id = default(string), MnDisciplineIncidentReference disciplineIncidentReference = default(MnDisciplineIncidentReference), string costToVictimDescriptor = default(string), bool didInjuryOccur = default(bool), bool? didSeriousBodilyInjuryOccur = default(bool?), int? estimatedStudentsEnrolled = default(int?), int? estimatedStudentsNotEnrolled = default(int?), int? nonOffenderCount = default(int?), string nonOffenderTypeDescriptor = default(string), bool? physicalAssaultState = default(bool?), string etag = default(string))
        {
            // to ensure "disciplineIncidentReference" is required (not null)
            if (disciplineIncidentReference == null)
            {
                throw new ArgumentNullException("disciplineIncidentReference is a required property for MnDisciplineIncidentAnonymousNonOffenderWritable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("costToVictimDescriptor is a required property for MnDisciplineIncidentAnonymousNonOffenderWritable and cannot be null");
            }
        ...
        [DataMember(Name = "estimatedStudentsEnrolled", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "estimatedStudentsNotEnrolled", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "nonOffenderCount", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "nonOffenderTypeDescriptor", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnDisciplineIncidentAnonymousNonOffenderWritable {\n");
        ...
        {
            return this.Equals(input as MnDisciplineIncidentAnonymousNonOffenderWritable);
        }

        /// <summary>
        /// Returns true if MnDisciplineIncidentAnonymousNonOffenderWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnDisciplineIncidentAnonymousNonOffenderWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnDisciplineIncidentAnonymousNonOffenderWritable input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.EstimatedStudentsEnrolled != null &&
                ...
                (
                    ...
                    (this.PhysicalAssaultState != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PhysicalAssaultState != null)
                {
