...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationReference")]
    public partial class EdFiStudentEducationOrganizationAssociationReference : IEquatable<EdFiStudentEducationOrganizationAssociationReference>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationReference(int educationOrganizationId = default(int), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentEducationOrganizationAssociationReference and cannot be null");
            }
