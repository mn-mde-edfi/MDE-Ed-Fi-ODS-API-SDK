...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentAssessment_readable")]
    public partial class EdFiStudentAssessmentReadable : IEquatable<EdFiStudentAssessmentReadable>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentReadable(string id = default(string), string studentAssessmentIdentifier = default(string), EdFiAssessmentReference assessmentReference = default(EdFiAssessmentReference), EdFiSchoolReference reportedSchoolReference = default(EdFiSchoolReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), EdFiStudentReference studentReference = default(EdFiStudentReference), List<EdFiStudentAssessmentAccommodationReadable> accommodations = default(List<EdFiStudentAssessmentAccommodationReadable>), DateTime? administrationDate = default(DateTime?), DateTime? administrationEndDate = default(DateTime?), string administrationEnvironmentDescriptor = default(string), string administrationLanguageDescriptor = default(string), int? assessedMinutes = default(int?), string eventCircumstanceDescriptor = default(string), string eventDescription = default(string), List<EdFiStudentAssessmentItemReadable> items = default(List<EdFiStudentAssessmentItemReadable>), List<EdFiStudentAssessmentPerformanceLevelReadable> performanceLevels = default(List<EdFiStudentAssessmentPerformanceLevelReadable>), EdFiStudentAssessmentPeriodReadable period = default(EdFiStudentAssessmentPeriodReadable), string platformTypeDescriptor = default(string), string reasonNotTestedDescriptor = default(string), string reportedSchoolIdentifier = default(string), string retestIndicatorDescriptor = default(string), List<EdFiStudentAssessmentScoreResultReadable> scoreResults = default(List<EdFiStudentAssessmentScoreResultReadable>), string serialNumber = default(string), List<EdFiStudentAssessmentStudentObjectiveAssessmentReadable> studentObjectiveAssessments = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentReadable>), string whenAssessedGradeLevelDescriptor = default(string), string etag = default(string), StudentAssessmentExtensionsReadable ext = default(StudentAssessmentExtensionsReadable))
        {
            ...
            {
                throw new ArgumentNullException("assessmentReference is a required property for EdFiStudentAssessmentReadable and cannot be null");
            }
            this.AssessmentReference = assessmentReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentAssessmentReadable and cannot be null");
            }
        ...
        public EdFiStudentAssessmentPeriodReadable Period { get; set; }
