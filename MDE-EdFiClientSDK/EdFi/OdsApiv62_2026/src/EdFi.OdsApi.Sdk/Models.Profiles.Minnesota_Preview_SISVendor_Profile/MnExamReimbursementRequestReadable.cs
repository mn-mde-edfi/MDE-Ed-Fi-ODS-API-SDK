...
{
    /// <summary>
    /// MnExamReimbursementRequestReadable
    /// </summary>
    [DataContract(Name = "mn_examReimbursementRequest_readable")]
    public partial class MnExamReimbursementRequestReadable : IEquatable<MnExamReimbursementRequestReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnExamReimbursementRequestReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnExamReimbursementRequestReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnExamReimbursementRequestReadable" /> class.
        /// </summary>
        ...
        public MnExamReimbursementRequestReadable(string id = default(string), DateTime testedDate = default(DateTime), MnStudentEducationOrganizationAssociationReference studentEducationOrganizationAssociationReference = default(MnStudentEducationOrganizationAssociationReference), string assessmentCategoryDescriptor = default(string), bool reimbursementRequested = default(bool), bool? unableToPay = default(bool?), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("studentEducationOrganizationAssociationReference is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("assessmentCategoryDescriptor is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnExamReimbursementRequestReadable {\n");
        ...
        {
            return this.Equals(input as MnExamReimbursementRequestReadable);
        }

        /// <summary>
        /// Returns true if MnExamReimbursementRequestReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnExamReimbursementRequestReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnExamReimbursementRequestReadable input)
        {
            if (input == null)
            {
                return false;
