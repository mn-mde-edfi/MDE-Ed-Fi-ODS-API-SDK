...
{
    /// <summary>
    /// TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_disciplineIncidentAnonymousNonOffender_readableKey")]
    public partial class TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey : IEquatable<TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey(string incidentIdentifier = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnDisciplineIncidentAnonymousNonOffenderReadableKey input)
        {
            if (input == null)
            {
                return false;
