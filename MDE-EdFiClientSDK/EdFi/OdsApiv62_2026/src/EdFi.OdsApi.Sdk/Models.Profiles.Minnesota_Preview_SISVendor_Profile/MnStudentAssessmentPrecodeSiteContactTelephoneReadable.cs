...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentAssessmentPrecodeSiteContactTelephone_readable")]
    public partial class MnStudentAssessmentPrecodeSiteContactTelephoneReadable : IEquatable<MnStudentAssessmentPrecodeSiteContactTelephoneReadable>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeSiteContactTelephoneReadable(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for MnStudentAssessmentPrecodeSiteContactTelephoneReadable and cannot be null");
            }
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor;
            // to ensure "telephoneNumber" is required (not null)
            if (telephoneNumber == null)
            {
                throw new ArgumentNullException("telephoneNumber is a required property for MnStudentAssessmentPrecodeSiteContactTelephoneReadable and cannot be null");
            }
