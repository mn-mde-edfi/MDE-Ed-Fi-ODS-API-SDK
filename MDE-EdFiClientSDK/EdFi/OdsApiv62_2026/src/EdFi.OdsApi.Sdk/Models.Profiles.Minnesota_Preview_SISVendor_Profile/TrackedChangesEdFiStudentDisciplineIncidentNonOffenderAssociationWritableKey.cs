...
{
    /// <summary>
    /// TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentDisciplineIncidentNonOffenderAssociation_writableKey")]
    public partial class TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey : IEquatable<TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey(string incidentIdentifier = default(string), int schoolId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
