...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentAssessmentPrecodeSiteReference")]
    public partial class MnStudentAssessmentPrecodeSiteReference : IEquatable<MnStudentAssessmentPrecodeSiteReference>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeSiteReference(int educationOrganizationId = default(int), string precodeTypeDescriptor = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("precodeTypeDescriptor is a required property for MnStudentAssessmentPrecodeSiteReference and cannot be null");
            }
