...
namespace EdFi.OdsApi.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://test.api.education.mn.gov:443/edfiapi/data/v3";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://test.api.education.mn.gov:443/edfiapi/data/v3"},
        ...
        public Configuration(
            ...
            string basePath = "https://test.api.education.mn.gov:443/edfiapi/data/v3") : this()
        {
