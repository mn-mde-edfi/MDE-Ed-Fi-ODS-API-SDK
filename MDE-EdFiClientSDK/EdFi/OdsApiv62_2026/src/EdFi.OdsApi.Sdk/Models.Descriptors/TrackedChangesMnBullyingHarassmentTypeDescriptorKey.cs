...
{
    /// <summary>
    /// TrackedChangesMnBullyingHarassmentTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_bullyingHarassmentTypeDescriptorKey")]
    public partial class TrackedChangesMnBullyingHarassmentTypeDescriptorKey : IEquatable<TrackedChangesMnBullyingHarassmentTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnBullyingHarassmentTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnBullyingHarassmentTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnBullyingHarassmentTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnBullyingHarassmentTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnBullyingHarassmentTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnBullyingHarassmentTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnBullyingHarassmentTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
