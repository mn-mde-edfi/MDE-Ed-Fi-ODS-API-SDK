...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_aesTypeDescriptorKeyChange")]
    public partial class TrackedChangesMnAesTypeDescriptorKeyChange : IEquatable<TrackedChangesMnAesTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAesTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAesTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesMnAesTypeDescriptorKey oldKeyValues = default(TrackedChangesMnAesTypeDescriptorKey), TrackedChangesMnAesTypeDescriptorKey newKeyValues = default(TrackedChangesMnAesTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesMnAesTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesMnAesTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAesTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAesTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAesTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAesTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAesTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
