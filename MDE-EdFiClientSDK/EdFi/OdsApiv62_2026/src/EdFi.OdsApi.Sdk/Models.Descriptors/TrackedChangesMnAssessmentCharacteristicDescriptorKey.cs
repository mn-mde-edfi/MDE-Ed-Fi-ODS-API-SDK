...
{
    /// <summary>
    /// TrackedChangesMnAssessmentCharacteristicDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_assessmentCharacteristicDescriptorKey")]
    public partial class TrackedChangesMnAssessmentCharacteristicDescriptorKey : IEquatable<TrackedChangesMnAssessmentCharacteristicDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAssessmentCharacteristicDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAssessmentCharacteristicDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAssessmentCharacteristicDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAssessmentCharacteristicDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAssessmentCharacteristicDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAssessmentCharacteristicDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAssessmentCharacteristicDescriptorKey input)
        {
            if (input == null)
            {
                return false;
