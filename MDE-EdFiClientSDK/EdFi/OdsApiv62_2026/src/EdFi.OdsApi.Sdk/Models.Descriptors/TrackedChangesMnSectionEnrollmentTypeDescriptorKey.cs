...
{
    /// <summary>
    /// TrackedChangesMnSectionEnrollmentTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_sectionEnrollmentTypeDescriptorKey")]
    public partial class TrackedChangesMnSectionEnrollmentTypeDescriptorKey : IEquatable<TrackedChangesMnSectionEnrollmentTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnSectionEnrollmentTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnSectionEnrollmentTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnSectionEnrollmentTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnSectionEnrollmentTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnSectionEnrollmentTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnSectionEnrollmentTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnSectionEnrollmentTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
