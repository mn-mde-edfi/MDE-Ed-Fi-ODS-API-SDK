...
{
    /// <summary>
    /// TrackedChangesMnClassroomVolunteerDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_classroomVolunteerDescriptorKey")]
    public partial class TrackedChangesMnClassroomVolunteerDescriptorKey : IEquatable<TrackedChangesMnClassroomVolunteerDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnClassroomVolunteerDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnClassroomVolunteerDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnClassroomVolunteerDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnClassroomVolunteerDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnClassroomVolunteerDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnClassroomVolunteerDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnClassroomVolunteerDescriptorKey input)
        {
            if (input == null)
            {
                return false;
