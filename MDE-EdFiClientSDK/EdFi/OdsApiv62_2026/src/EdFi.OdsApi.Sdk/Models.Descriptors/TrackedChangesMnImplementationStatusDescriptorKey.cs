...
{
    /// <summary>
    /// TrackedChangesMnImplementationStatusDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_implementationStatusDescriptorKey")]
    public partial class TrackedChangesMnImplementationStatusDescriptorKey : IEquatable<TrackedChangesMnImplementationStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnImplementationStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnImplementationStatusDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnImplementationStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnImplementationStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnImplementationStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnImplementationStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnImplementationStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
