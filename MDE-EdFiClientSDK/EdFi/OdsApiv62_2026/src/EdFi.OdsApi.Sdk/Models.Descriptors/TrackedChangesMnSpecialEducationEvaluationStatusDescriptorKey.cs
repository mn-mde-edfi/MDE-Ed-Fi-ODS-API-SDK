...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_specialEducationEvaluationStatusDescriptorKey")]
    public partial class TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey : IEquatable<TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnSpecialEducationEvaluationStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
