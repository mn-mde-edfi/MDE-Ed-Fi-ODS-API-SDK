...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_costToVictimDescriptorKey")]
    public partial class TrackedChangesMnCostToVictimDescriptorKey : IEquatable<TrackedChangesMnCostToVictimDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnCostToVictimDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnCostToVictimDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnCostToVictimDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnCostToVictimDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnCostToVictimDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnCostToVictimDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnCostToVictimDescriptorKey input)
        {
            if (input == null)
            {
                return false;
