...
{
    /// <summary>
    /// TrackedChangesMnAesTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_aesTypeDescriptorKey")]
    public partial class TrackedChangesMnAesTypeDescriptorKey : IEquatable<TrackedChangesMnAesTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAesTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAesTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAesTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAesTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAesTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAesTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAesTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
