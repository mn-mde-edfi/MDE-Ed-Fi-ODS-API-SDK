...
{
    /// <summary>
    /// TrackedChangesMnDrugTypeDescriptorKeyChange
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_drugTypeDescriptorKeyChange")]
    public partial class TrackedChangesMnDrugTypeDescriptorKeyChange : IEquatable<TrackedChangesMnDrugTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnDrugTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesMnDrugTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesMnDrugTypeDescriptorKey oldKeyValues = default(TrackedChangesMnDrugTypeDescriptorKey), TrackedChangesMnDrugTypeDescriptorKey newKeyValues = default(TrackedChangesMnDrugTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesMnDrugTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesMnDrugTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnDrugTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnDrugTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnDrugTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnDrugTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnDrugTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
