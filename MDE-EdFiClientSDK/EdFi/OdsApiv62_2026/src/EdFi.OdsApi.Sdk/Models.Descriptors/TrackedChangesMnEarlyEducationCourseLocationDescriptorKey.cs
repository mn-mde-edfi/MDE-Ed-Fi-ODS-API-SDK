...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_earlyEducationCourseLocationDescriptorKey")]
    public partial class TrackedChangesMnEarlyEducationCourseLocationDescriptorKey : IEquatable<TrackedChangesMnEarlyEducationCourseLocationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnEarlyEducationCourseLocationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnEarlyEducationCourseLocationDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnEarlyEducationCourseLocationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnEarlyEducationCourseLocationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnEarlyEducationCourseLocationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnEarlyEducationCourseLocationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnEarlyEducationCourseLocationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
