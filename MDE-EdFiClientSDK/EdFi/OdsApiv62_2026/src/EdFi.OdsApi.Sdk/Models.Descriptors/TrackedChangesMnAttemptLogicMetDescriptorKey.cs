...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_attemptLogicMetDescriptorKey")]
    public partial class TrackedChangesMnAttemptLogicMetDescriptorKey : IEquatable<TrackedChangesMnAttemptLogicMetDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAttemptLogicMetDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAttemptLogicMetDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAttemptLogicMetDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAttemptLogicMetDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAttemptLogicMetDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAttemptLogicMetDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAttemptLogicMetDescriptorKey input)
        {
            if (input == null)
            {
                return false;
