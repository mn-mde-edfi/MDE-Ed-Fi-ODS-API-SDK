...
{
    /// <summary>
    /// TrackedChangesMnEdFiSubmissionAccessDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_edFiSubmissionAccessDescriptorKey")]
    public partial class TrackedChangesMnEdFiSubmissionAccessDescriptorKey : IEquatable<TrackedChangesMnEdFiSubmissionAccessDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnEdFiSubmissionAccessDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnEdFiSubmissionAccessDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnEdFiSubmissionAccessDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnEdFiSubmissionAccessDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnEdFiSubmissionAccessDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnEdFiSubmissionAccessDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnEdFiSubmissionAccessDescriptorKey input)
        {
            if (input == null)
            {
                return false;
