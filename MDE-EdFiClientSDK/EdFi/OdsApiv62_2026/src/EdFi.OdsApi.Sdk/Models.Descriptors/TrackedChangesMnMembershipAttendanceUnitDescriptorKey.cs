...
{
    /// <summary>
    /// TrackedChangesMnMembershipAttendanceUnitDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_membershipAttendanceUnitDescriptorKey")]
    public partial class TrackedChangesMnMembershipAttendanceUnitDescriptorKey : IEquatable<TrackedChangesMnMembershipAttendanceUnitDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnMembershipAttendanceUnitDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnMembershipAttendanceUnitDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnMembershipAttendanceUnitDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnMembershipAttendanceUnitDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnMembershipAttendanceUnitDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnMembershipAttendanceUnitDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnMembershipAttendanceUnitDescriptorKey input)
        {
            if (input == null)
            {
                return false;
