...
{
    /// <summary>
    /// TrackedChangesMnFundingSourceDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_fundingSourceDescriptorKey")]
    public partial class TrackedChangesMnFundingSourceDescriptorKey : IEquatable<TrackedChangesMnFundingSourceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnFundingSourceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnFundingSourceDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnFundingSourceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnFundingSourceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnFundingSourceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnFundingSourceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnFundingSourceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
