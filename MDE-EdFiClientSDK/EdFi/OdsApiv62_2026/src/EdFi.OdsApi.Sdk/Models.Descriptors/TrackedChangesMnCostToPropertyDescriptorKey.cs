...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_costToPropertyDescriptorKey")]
    public partial class TrackedChangesMnCostToPropertyDescriptorKey : IEquatable<TrackedChangesMnCostToPropertyDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnCostToPropertyDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnCostToPropertyDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnCostToPropertyDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnCostToPropertyDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnCostToPropertyDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnCostToPropertyDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnCostToPropertyDescriptorKey input)
        {
            if (input == null)
            {
                return false;
