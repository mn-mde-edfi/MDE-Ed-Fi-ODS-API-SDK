...
{
    /// <summary>
    /// TrackedChangesMnDistrictTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_districtTypeDescriptorKey")]
    public partial class TrackedChangesMnDistrictTypeDescriptorKey : IEquatable<TrackedChangesMnDistrictTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnDistrictTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnDistrictTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnDistrictTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnDistrictTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnDistrictTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnDistrictTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnDistrictTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
