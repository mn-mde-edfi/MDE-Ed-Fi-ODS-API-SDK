...
{
    /// <summary>
    /// TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_neglectedOrDelinquentProgramOutcomeDescriptorKey")]
    public partial class TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey : IEquatable<TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnNeglectedOrDelinquentProgramOutcomeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
