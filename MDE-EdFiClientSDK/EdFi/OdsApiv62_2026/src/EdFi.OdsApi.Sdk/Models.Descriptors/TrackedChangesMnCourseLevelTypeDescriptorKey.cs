...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_courseLevelTypeDescriptorKey")]
    public partial class TrackedChangesMnCourseLevelTypeDescriptorKey : IEquatable<TrackedChangesMnCourseLevelTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnCourseLevelTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnCourseLevelTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnCourseLevelTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnCourseLevelTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnCourseLevelTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnCourseLevelTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnCourseLevelTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
