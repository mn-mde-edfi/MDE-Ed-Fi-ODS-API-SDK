...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_instructionalApproachDescriptorKey")]
    public partial class TrackedChangesMnInstructionalApproachDescriptorKey : IEquatable<TrackedChangesMnInstructionalApproachDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnInstructionalApproachDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnInstructionalApproachDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnInstructionalApproachDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnInstructionalApproachDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnInstructionalApproachDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnInstructionalApproachDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnInstructionalApproachDescriptorKey input)
        {
            if (input == null)
            {
                return false;
