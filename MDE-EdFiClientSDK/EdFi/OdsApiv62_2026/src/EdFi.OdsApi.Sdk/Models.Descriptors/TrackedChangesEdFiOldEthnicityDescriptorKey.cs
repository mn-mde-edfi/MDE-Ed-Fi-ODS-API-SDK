...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    public partial class TrackedChangesEdFiOldEthnicityDescriptorKey : IEquatable<TrackedChangesEdFiOldEthnicityDescriptorKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiOldEthnicityDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiOldEthnicityDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiOldEthnicityDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiOldEthnicityDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiOldEthnicityDescriptorKey input)
        {
            if (input == null)
            {
                return false;
