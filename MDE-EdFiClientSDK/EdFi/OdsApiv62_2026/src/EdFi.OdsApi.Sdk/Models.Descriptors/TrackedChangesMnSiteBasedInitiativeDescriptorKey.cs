...
{
    /// <summary>
    /// TrackedChangesMnSiteBasedInitiativeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_siteBasedInitiativeDescriptorKey")]
    public partial class TrackedChangesMnSiteBasedInitiativeDescriptorKey : IEquatable<TrackedChangesMnSiteBasedInitiativeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnSiteBasedInitiativeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnSiteBasedInitiativeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnSiteBasedInitiativeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnSiteBasedInitiativeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnSiteBasedInitiativeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnSiteBasedInitiativeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnSiteBasedInitiativeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
