...
{
    /// <summary>
    /// TrackedChangesMnKindergartenScheduleDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_kindergartenScheduleDescriptorKey")]
    public partial class TrackedChangesMnKindergartenScheduleDescriptorKey : IEquatable<TrackedChangesMnKindergartenScheduleDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnKindergartenScheduleDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnKindergartenScheduleDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnKindergartenScheduleDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnKindergartenScheduleDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnKindergartenScheduleDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnKindergartenScheduleDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnKindergartenScheduleDescriptorKey input)
        {
            if (input == null)
            {
                return false;
