...
{
    /// <summary>
    /// TrackedChangesMnGiftedTalentedParticipationDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_giftedTalentedParticipationDescriptorKey")]
    public partial class TrackedChangesMnGiftedTalentedParticipationDescriptorKey : IEquatable<TrackedChangesMnGiftedTalentedParticipationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnGiftedTalentedParticipationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnGiftedTalentedParticipationDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnGiftedTalentedParticipationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnGiftedTalentedParticipationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnGiftedTalentedParticipationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnGiftedTalentedParticipationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnGiftedTalentedParticipationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
