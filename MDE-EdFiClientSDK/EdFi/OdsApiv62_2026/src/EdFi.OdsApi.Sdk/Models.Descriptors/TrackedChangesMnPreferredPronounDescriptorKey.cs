...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_preferredPronounDescriptorKey")]
    public partial class TrackedChangesMnPreferredPronounDescriptorKey : IEquatable<TrackedChangesMnPreferredPronounDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnPreferredPronounDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnPreferredPronounDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnPreferredPronounDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnPreferredPronounDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnPreferredPronounDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnPreferredPronounDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnPreferredPronounDescriptorKey input)
        {
            if (input == null)
            {
                return false;
