...
{
    /// <summary>
    /// TrackedChangesMnClassPeriodTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_classPeriodTypeDescriptorKey")]
    public partial class TrackedChangesMnClassPeriodTypeDescriptorKey : IEquatable<TrackedChangesMnClassPeriodTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnClassPeriodTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnClassPeriodTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnClassPeriodTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnClassPeriodTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnClassPeriodTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnClassPeriodTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnClassPeriodTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
