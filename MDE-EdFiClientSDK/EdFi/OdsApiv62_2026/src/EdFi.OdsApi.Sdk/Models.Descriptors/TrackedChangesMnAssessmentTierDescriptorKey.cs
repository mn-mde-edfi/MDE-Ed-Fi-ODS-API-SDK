...
{
    /// <summary>
    /// TrackedChangesMnAssessmentTierDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_assessmentTierDescriptorKey")]
    public partial class TrackedChangesMnAssessmentTierDescriptorKey : IEquatable<TrackedChangesMnAssessmentTierDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAssessmentTierDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAssessmentTierDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAssessmentTierDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAssessmentTierDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAssessmentTierDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAssessmentTierDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAssessmentTierDescriptorKey input)
        {
            if (input == null)
            {
                return false;
