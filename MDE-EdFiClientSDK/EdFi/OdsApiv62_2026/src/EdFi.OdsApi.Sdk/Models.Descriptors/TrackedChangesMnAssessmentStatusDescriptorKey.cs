...
{
    /// <summary>
    /// TrackedChangesMnAssessmentStatusDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_assessmentStatusDescriptorKey")]
    public partial class TrackedChangesMnAssessmentStatusDescriptorKey : IEquatable<TrackedChangesMnAssessmentStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAssessmentStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAssessmentStatusDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAssessmentStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAssessmentStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAssessmentStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAssessmentStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAssessmentStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
