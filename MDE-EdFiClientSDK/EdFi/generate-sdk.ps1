...
$swaggerCodeGenJar = "swagger-codegen-cli-2.4.15.jar"
$metaDataUrl = "https://test.edfi5.education.mn.gov/api/metadata/"
$outputDir = "generated-sdk"

if (-not (Test-Path $swaggerCodeGenJar)) {
    Invoke-WebRequest -OutFile $swaggerCodeGenJar "https://oss.sonatype.org/content/repositories/releases/io/swagger/swagger-codegen-cli/2.4.15/$swaggerCodeGenJar"
}
