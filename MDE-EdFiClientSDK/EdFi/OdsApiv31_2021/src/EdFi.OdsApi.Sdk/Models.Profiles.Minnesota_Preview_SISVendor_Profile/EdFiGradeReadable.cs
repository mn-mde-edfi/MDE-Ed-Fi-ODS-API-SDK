...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiGradeReadable :  IEquatable<EdFiGradeReadable>, IValidatableObject
    {
        ...
        public EdFiGradeReadable(string Id = default(string), string GradeTypeDescriptor = default(string), EdFiGradingPeriodReference GradingPeriodReference = default(EdFiGradingPeriodReference), EdFiStudentSectionAssociationReference StudentSectionAssociationReference = default(EdFiStudentSectionAssociationReference), string LetterGradeEarned = default(string), double? NumericGradeEarned = default(double?), string Etag = default(string), GradeExtensionsReadable Ext = default(GradeExtensionsReadable))
        {
