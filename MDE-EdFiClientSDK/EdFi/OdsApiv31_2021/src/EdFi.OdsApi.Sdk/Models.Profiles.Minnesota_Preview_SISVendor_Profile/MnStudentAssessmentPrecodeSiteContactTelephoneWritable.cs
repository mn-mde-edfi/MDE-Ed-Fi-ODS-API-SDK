...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    public partial class MnStudentAssessmentPrecodeSiteContactTelephoneWritable :  IEquatable<MnStudentAssessmentPrecodeSiteContactTelephoneWritable>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeSiteContactTelephoneWritable(string TelephoneNumberTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string), bool? TextMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "TelephoneNumberTypeDescriptor" is required (not null)
            if (TelephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("TelephoneNumberTypeDescriptor is a required property for MnStudentAssessmentPrecodeSiteContactTelephoneWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TelephoneNumber is a required property for MnStudentAssessmentPrecodeSiteContactTelephoneWritable and cannot be null");
            }
            else
            {
