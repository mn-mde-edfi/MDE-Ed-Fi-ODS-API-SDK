...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Migrant_Update_Profile
{
    ...
    public partial class MnStudentEducationOrganizationAssociationExtensionReadable :  IEquatable<MnStudentEducationOrganizationAssociationExtensionReadable>, IValidatableObject
    {
        ...
        public MnStudentEducationOrganizationAssociationExtensionReadable(DateTime? BirthDate = default(DateTime?), string FirstName = default(string), string GenerationCodeSuffix = default(string), string LastSurname = default(string), string MiddleName = default(string))
        {
