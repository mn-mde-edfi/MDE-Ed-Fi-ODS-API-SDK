...
{
    /// <summary>
    /// MnSectionEnrollmentTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnSectionEnrollmentTypeDescriptor :  IEquatable<MnSectionEnrollmentTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSectionEnrollmentTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSectionEnrollmentTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSectionEnrollmentTypeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="SectionEnrollmentTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnSectionEnrollmentTypeDescriptor(string Id = default(string), int? SectionEnrollmentTypeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnSectionEnrollmentTypeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnSectionEnrollmentTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnSectionEnrollmentTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnSectionEnrollmentTypeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.SectionEnrollmentTypeDescriptorId = SectionEnrollmentTypeDescriptorId;
        ...
        [DataMember(Name="sectionEnrollmentTypeDescriptorId", EmitDefaultValue=false)]
        public int? SectionEnrollmentTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSectionEnrollmentTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SectionEnrollmentTypeDescriptorId: ").Append(SectionEnrollmentTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnSectionEnrollmentTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnSectionEnrollmentTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSectionEnrollmentTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSectionEnrollmentTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SectionEnrollmentTypeDescriptorId == input.SectionEnrollmentTypeDescriptorId ||
                    (this.SectionEnrollmentTypeDescriptorId != null &&
                    this.SectionEnrollmentTypeDescriptorId.Equals(input.SectionEnrollmentTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SectionEnrollmentTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.SectionEnrollmentTypeDescriptorId.GetHashCode();
