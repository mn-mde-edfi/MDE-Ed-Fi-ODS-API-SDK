...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnSiteBasedInitiativeDescriptor :  IEquatable<MnSiteBasedInitiativeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSiteBasedInitiativeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSiteBasedInitiativeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSiteBasedInitiativeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="SiteBasedInitiativeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnSiteBasedInitiativeDescriptor(string Id = default(string), int? SiteBasedInitiativeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnSiteBasedInitiativeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnSiteBasedInitiativeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnSiteBasedInitiativeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnSiteBasedInitiativeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.SiteBasedInitiativeDescriptorId = SiteBasedInitiativeDescriptorId;
        ...
        [DataMember(Name="siteBasedInitiativeDescriptorId", EmitDefaultValue=false)]
        public int? SiteBasedInitiativeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSiteBasedInitiativeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SiteBasedInitiativeDescriptorId: ").Append(SiteBasedInitiativeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnSiteBasedInitiativeDescriptor);
        }

        /// <summary>
        /// Returns true if MnSiteBasedInitiativeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSiteBasedInitiativeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSiteBasedInitiativeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SiteBasedInitiativeDescriptorId == input.SiteBasedInitiativeDescriptorId ||
                    (this.SiteBasedInitiativeDescriptorId != null &&
                    this.SiteBasedInitiativeDescriptorId.Equals(input.SiteBasedInitiativeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SiteBasedInitiativeDescriptorId != null)
                    hashCode = hashCode * 59 + this.SiteBasedInitiativeDescriptorId.GetHashCode();
