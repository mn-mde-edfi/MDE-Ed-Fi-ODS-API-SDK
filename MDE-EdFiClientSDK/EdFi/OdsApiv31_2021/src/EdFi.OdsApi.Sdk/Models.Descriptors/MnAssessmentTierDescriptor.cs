...
{
    /// <summary>
    /// MnAssessmentTierDescriptor
    /// </summary>
    [DataContract]
    public partial class MnAssessmentTierDescriptor :  IEquatable<MnAssessmentTierDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentTierDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentTierDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentTierDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="AssessmentTierDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAssessmentTierDescriptor(string Id = default(string), int? AssessmentTierDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnAssessmentTierDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentTierDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnAssessmentTierDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.AssessmentTierDescriptorId = AssessmentTierDescriptorId;
        ...
        [DataMember(Name="assessmentTierDescriptorId", EmitDefaultValue=false)]
        public int? AssessmentTierDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentTierDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssessmentTierDescriptorId: ").Append(AssessmentTierDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAssessmentTierDescriptor);
        }

        /// <summary>
        /// Returns true if MnAssessmentTierDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentTierDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentTierDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentTierDescriptorId == input.AssessmentTierDescriptorId ||
                    (this.AssessmentTierDescriptorId != null &&
                    this.AssessmentTierDescriptorId.Equals(input.AssessmentTierDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssessmentTierDescriptorId != null)
                    hashCode = hashCode * 59 + this.AssessmentTierDescriptorId.GetHashCode();
