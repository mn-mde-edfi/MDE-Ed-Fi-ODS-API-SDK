...
{
    /// <summary>
    /// MnStandardAddressedDescriptor
    /// </summary>
    [DataContract]
    public partial class MnStandardAddressedDescriptor :  IEquatable<MnStandardAddressedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStandardAddressedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStandardAddressedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStandardAddressedDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="StandardAddressedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnStandardAddressedDescriptor(string Id = default(string), int? StandardAddressedDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStandardAddressedDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnStandardAddressedDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnStandardAddressedDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnStandardAddressedDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.StandardAddressedDescriptorId = StandardAddressedDescriptorId;
        ...
        [DataMember(Name="standardAddressedDescriptorId", EmitDefaultValue=false)]
        public int? StandardAddressedDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStandardAddressedDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  StandardAddressedDescriptorId: ").Append(StandardAddressedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnStandardAddressedDescriptor);
        }

        /// <summary>
        /// Returns true if MnStandardAddressedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStandardAddressedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStandardAddressedDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StandardAddressedDescriptorId == input.StandardAddressedDescriptorId ||
                    (this.StandardAddressedDescriptorId != null &&
                    this.StandardAddressedDescriptorId.Equals(input.StandardAddressedDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StandardAddressedDescriptorId != null)
                    hashCode = hashCode * 59 + this.StandardAddressedDescriptorId.GetHashCode();
