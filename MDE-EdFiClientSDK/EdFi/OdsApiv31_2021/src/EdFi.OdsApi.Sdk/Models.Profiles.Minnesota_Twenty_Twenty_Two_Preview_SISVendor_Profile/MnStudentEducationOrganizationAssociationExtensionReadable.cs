...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationExtensionReadable
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationExtensionReadable :  IEquatable<MnStudentEducationOrganizationAssociationExtensionReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationExtensionReadable" /> class.
        /// </summary>
        ...
        /// <param name="AncestryEthnicOrigins">An unordered collection of studentEducationOrganizationAssociationAncestryEthnicOrigins. The ancestry ethnic origins that pertain to the general racial categories with which the individual identifies..</param>
        ...
        public MnStudentEducationOrganizationAssociationExtensionReadable(DateTime? BirthDate = default(DateTime?), string FirstName = default(string), string GenerationCodeSuffix = default(string), string LastSurname = default(string), string MiddleName = default(string), List<MnStudentEducationOrganizationAssociationAncestryEthnicOriginReadable> AncestryEthnicOrigins = default(List<MnStudentEducationOrganizationAssociationAncestryEthnicOriginReadable>), List<MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable> OptOutIndicators = default(List<MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable>))
        {
        ...
        /// </summary>
        /// <value>An unordered collection of studentEducationOrganizationAssociationAncestryEthnicOrigins. The ancestry ethnic origins that pertain to the general racial categories with which the individual identifies.</value>
        [DataMember(Name="ancestryEthnicOrigins", EmitDefaultValue=false)]
        public List<MnStudentEducationOrganizationAssociationAncestryEthnicOriginReadable> AncestryEthnicOrigins { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationExtensionReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationExtensionReadable);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationExtensionReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationExtensionReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationExtensionReadable input)
        {
            if (input == null)
                return false;
