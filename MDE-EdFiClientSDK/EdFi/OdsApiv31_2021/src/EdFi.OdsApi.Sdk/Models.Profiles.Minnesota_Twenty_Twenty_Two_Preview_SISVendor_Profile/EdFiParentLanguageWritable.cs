...
{
    /// <summary>
    /// EdFiParentLanguageWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentLanguageWritable :  IEquatable<EdFiParentLanguageWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentLanguageWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageWritable" /> class.
        /// </summary>
        ...
        public EdFiParentLanguageWritable(string LanguageDescriptor = default(string), List<EdFiParentLanguageUseWritable> Uses = default(List<EdFiParentLanguageUseWritable>))
        {
            // to ensure "LanguageDescriptor" is required (not null)
            if (LanguageDescriptor == null)
            {
                throw new InvalidDataException("LanguageDescriptor is a required property for EdFiParentLanguageWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiParentLanguageUseWritable> Uses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentLanguageWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentLanguageWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentLanguageWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentLanguageWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentLanguageWritable input)
        {
            if (input == null)
                return false;
