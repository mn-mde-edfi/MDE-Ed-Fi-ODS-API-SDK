...
{
    /// <summary>
    /// EdFiParentAddressWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentAddressWritable :  IEquatable<EdFiParentAddressWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddressWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentAddressWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddressWritable" /> class.
        /// </summary>
        ...
        public EdFiParentAddressWritable(string AddressTypeDescriptor = default(string), string LocaleDescriptor = default(string), string StateAbbreviationDescriptor = default(string), string ApartmentRoomSuiteNumber = default(string), string BuildingSiteNumber = default(string), string City = default(string), string CongressionalDistrict = default(string), string CountyFIPSCode = default(string), bool? DoNotPublishIndicator = default(bool?), string Latitude = default(string), string Longitude = default(string), string NameOfCounty = default(string), string PostalCode = default(string), string StreetNumberName = default(string), List<EdFiParentAddressPeriodWritable> Periods = default(List<EdFiParentAddressPeriodWritable>))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for EdFiParentAddressWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StateAbbreviationDescriptor is a required property for EdFiParentAddressWritable and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for EdFiParentAddressWritable and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for EdFiParentAddressWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StreetNumberName is a required property for EdFiParentAddressWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiParentAddressPeriodWritable> Periods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentAddressWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentAddressWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentAddressWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentAddressWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentAddressWritable input)
        {
            if (input == null)
                return false;
