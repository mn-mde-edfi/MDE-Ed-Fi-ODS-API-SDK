...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiEducationOrganizationAddressSchoolReadable :  IEquatable<EdFiEducationOrganizationAddressSchoolReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationAddressSchoolReadable(string AddressTypeDescriptor = default(string), string StateAbbreviationDescriptor = default(string), string ApartmentRoomSuiteNumber = default(string), string BuildingSiteNumber = default(string), string City = default(string), string PostalCode = default(string), string StreetNumberName = default(string))
        {
            ...
            {
                throw new InvalidDataException("StateAbbreviationDescriptor is a required property for EdFiEducationOrganizationAddressSchoolReadable and cannot be null");
            }
            else
            {
