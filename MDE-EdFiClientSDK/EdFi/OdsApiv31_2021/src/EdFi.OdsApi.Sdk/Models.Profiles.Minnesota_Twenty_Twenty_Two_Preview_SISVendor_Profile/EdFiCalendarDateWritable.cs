...
{
    /// <summary>
    /// EdFiCalendarDateWritable
    /// </summary>
    [DataContract]
    public partial class EdFiCalendarDateWritable :  IEquatable<EdFiCalendarDateWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarDateWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCalendarDateWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarDateWritable" /> class.
        /// </summary>
        ...
        public EdFiCalendarDateWritable(string Id = default(string), List<EdFiCalendarDateCalendarEventWritable> CalendarEvents = default(List<EdFiCalendarDateCalendarEventWritable>), DateTime? Date = default(DateTime?), EdFiCalendarReference CalendarReference = default(EdFiCalendarReference), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiCalendarDateWritable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("CalendarEvents is a required property for EdFiCalendarDateWritable and cannot be null");
            }
            else
            {
            ...
            if (Date == null)
            {
                throw new InvalidDataException("Date is a required property for EdFiCalendarDateWritable and cannot be null");
            }
            else
            {
                this.Date = Date;
            ...
            {
                throw new InvalidDataException("CalendarReference is a required property for EdFiCalendarDateWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiCalendarDateCalendarEventWritable> CalendarEvents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiCalendarDateWritable {\n");
        ...
        {
            return this.Equals(input as EdFiCalendarDateWritable);
        }

        /// <summary>
        /// Returns true if EdFiCalendarDateWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCalendarDateWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCalendarDateWritable input)
        {
            if (input == null)
                return false;
