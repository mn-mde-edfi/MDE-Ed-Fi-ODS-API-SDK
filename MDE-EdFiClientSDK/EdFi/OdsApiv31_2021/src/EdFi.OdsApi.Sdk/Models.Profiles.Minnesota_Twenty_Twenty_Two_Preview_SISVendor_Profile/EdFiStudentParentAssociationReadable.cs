...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiStudentParentAssociationReadable :  IEquatable<EdFiStudentParentAssociationReadable>, IValidatableObject
    {
        ...
        public EdFiStudentParentAssociationReadable(string Id = default(string), EdFiParentReference ParentReference = default(EdFiParentReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), int? ContactPriority = default(int?), string ContactRestrictions = default(string), bool? EmergencyContactStatus = default(bool?), bool? LivesWith = default(bool?), bool? PrimaryContactStatus = default(bool?), string RelationDescriptor = default(string), string Etag = default(string))
        {
