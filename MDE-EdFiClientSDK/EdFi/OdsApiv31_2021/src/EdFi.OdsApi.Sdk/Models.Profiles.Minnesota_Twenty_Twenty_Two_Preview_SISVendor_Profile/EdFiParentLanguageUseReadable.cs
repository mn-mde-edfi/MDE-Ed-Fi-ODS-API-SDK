...
{
    /// <summary>
    /// EdFiParentLanguageUseReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentLanguageUseReadable :  IEquatable<EdFiParentLanguageUseReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageUseReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentLanguageUseReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageUseReadable" /> class.
        /// </summary>
        ...
        public EdFiParentLanguageUseReadable(string LanguageUseDescriptor = default(string))
        {
            // to ensure "LanguageUseDescriptor" is required (not null)
            if (LanguageUseDescriptor == null)
            {
                throw new InvalidDataException("LanguageUseDescriptor is a required property for EdFiParentLanguageUseReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentLanguageUseReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentLanguageUseReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentLanguageUseReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentLanguageUseReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentLanguageUseReadable input)
        {
            if (input == null)
                return false;
