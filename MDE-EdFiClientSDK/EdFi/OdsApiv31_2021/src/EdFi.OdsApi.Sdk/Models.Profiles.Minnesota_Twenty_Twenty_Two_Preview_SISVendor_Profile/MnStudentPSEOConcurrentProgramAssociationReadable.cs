...
{
    /// <summary>
    /// MnStudentPSEOConcurrentProgramAssociationReadable
    /// </summary>
    [DataContract]
    public partial class MnStudentPSEOConcurrentProgramAssociationReadable :  IEquatable<MnStudentPSEOConcurrentProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOConcurrentProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentPSEOConcurrentProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOConcurrentProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudentPSEOConcurrentProgramAssociationReadable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentPSEOConcurrentProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentPSEOConcurrentProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentPSEOConcurrentProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentPSEOConcurrentProgramAssociationReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentPSEOConcurrentProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentPSEOConcurrentProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudentPSEOConcurrentProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentPSEOConcurrentProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentPSEOConcurrentProgramAssociationReadable input)
        {
            if (input == null)
                return false;
