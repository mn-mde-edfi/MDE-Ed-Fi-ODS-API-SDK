...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class MnAssessmentItemReference :  IEquatable<MnAssessmentItemReference>, IValidatableObject
    {
        ...
        public MnAssessmentItemReference(string AssessmentIdentifier = default(string), string IdentificationCode = default(string), string _Namespace = default(string), Link Link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("AssessmentIdentifier is a required property for MnAssessmentItemReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdentificationCode is a required property for MnAssessmentItemReference and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentItemReference and cannot be null");
            }
            else
            {
