...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiParentReadable :  IEquatable<EdFiParentReadable>, IValidatableObject
    {
        ...
        public EdFiParentReadable(string Id = default(string), string ParentUniqueId = default(string), List<EdFiParentAddressReadable> Addresses = default(List<EdFiParentAddressReadable>), List<EdFiParentElectronicMailReadable> ElectronicMails = default(List<EdFiParentElectronicMailReadable>), string FirstName = default(string), string GenerationCodeSuffix = default(string), List<EdFiParentInternationalAddressReadable> InternationalAddresses = default(List<EdFiParentInternationalAddressReadable>), List<EdFiParentLanguageReadable> Languages = default(List<EdFiParentLanguageReadable>), string LastSurname = default(string), string LoginId = default(string), string MaidenName = default(string), string MiddleName = default(string), List<EdFiParentOtherNameReadable> OtherNames = default(List<EdFiParentOtherNameReadable>), List<EdFiParentPersonalIdentificationDocumentReadable> PersonalIdentificationDocuments = default(List<EdFiParentPersonalIdentificationDocumentReadable>), string PersonalTitlePrefix = default(string), string SexDescriptor = default(string), List<EdFiParentTelephoneReadable> Telephones = default(List<EdFiParentTelephoneReadable>), string Etag = default(string), ParentExtensionsReadable Ext = default(ParentExtensionsReadable))
        {
        ...
        public List<EdFiParentAddressReadable> Addresses { get; set; }
        ...
        public List<EdFiParentElectronicMailReadable> ElectronicMails { get; set; }
        ...
        public List<EdFiParentInternationalAddressReadable> InternationalAddresses { get; set; }
        ...
        public List<EdFiParentLanguageReadable> Languages { get; set; }
        ...
        public List<EdFiParentOtherNameReadable> OtherNames { get; set; }
        ...
        public List<EdFiParentPersonalIdentificationDocumentReadable> PersonalIdentificationDocuments { get; set; }
        ...
        public List<EdFiParentTelephoneReadable> Telephones { get; set; }
