...
{
    /// <summary>
    /// EdFiParentPersonalIdentificationDocumentWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentPersonalIdentificationDocumentWritable :  IEquatable<EdFiParentPersonalIdentificationDocumentWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentPersonalIdentificationDocumentWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentPersonalIdentificationDocumentWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentPersonalIdentificationDocumentWritable" /> class.
        /// </summary>
        ...
        public EdFiParentPersonalIdentificationDocumentWritable(string IdentificationDocumentUseDescriptor = default(string), string PersonalInformationVerificationDescriptor = default(string), string IssuerCountryDescriptor = default(string), DateTime? DocumentExpirationDate = default(DateTime?), string DocumentTitle = default(string), string IssuerDocumentIdentificationCode = default(string), string IssuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("PersonalInformationVerificationDescriptor is a required property for EdFiParentPersonalIdentificationDocumentWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentPersonalIdentificationDocumentWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentPersonalIdentificationDocumentWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentPersonalIdentificationDocumentWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentPersonalIdentificationDocumentWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentPersonalIdentificationDocumentWritable input)
        {
            if (input == null)
                return false;
