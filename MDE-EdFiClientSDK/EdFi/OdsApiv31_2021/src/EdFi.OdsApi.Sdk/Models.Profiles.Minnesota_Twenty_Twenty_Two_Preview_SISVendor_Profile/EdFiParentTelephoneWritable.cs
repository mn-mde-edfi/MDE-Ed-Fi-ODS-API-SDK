...
{
    /// <summary>
    /// EdFiParentTelephoneWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentTelephoneWritable :  IEquatable<EdFiParentTelephoneWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentTelephoneWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentTelephoneWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentTelephoneWritable" /> class.
        /// </summary>
        ...
        public EdFiParentTelephoneWritable(string TelephoneNumberTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string), bool? TextMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "TelephoneNumberTypeDescriptor" is required (not null)
            if (TelephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("TelephoneNumberTypeDescriptor is a required property for EdFiParentTelephoneWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TelephoneNumber is a required property for EdFiParentTelephoneWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentTelephoneWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentTelephoneWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentTelephoneWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentTelephoneWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentTelephoneWritable input)
        {
            if (input == null)
                return false;
