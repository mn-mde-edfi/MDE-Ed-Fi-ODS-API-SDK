...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiStudentAssessmentScoreResultReadable :  IEquatable<EdFiStudentAssessmentScoreResultReadable>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentScoreResultReadable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string Result = default(string))
        {
            ...
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentScoreResultReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ResultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentScoreResultReadable and cannot be null");
            }
            else
            {
            ...
            if (Result == null)
            {
                throw new InvalidDataException("Result is a required property for EdFiStudentAssessmentScoreResultReadable and cannot be null");
            }
            else
            {
                this.Result = Result;
