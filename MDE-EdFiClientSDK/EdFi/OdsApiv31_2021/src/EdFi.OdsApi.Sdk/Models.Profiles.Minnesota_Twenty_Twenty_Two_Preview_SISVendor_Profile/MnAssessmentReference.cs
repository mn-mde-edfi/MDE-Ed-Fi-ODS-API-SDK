...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile
{
    ...
    public partial class MnAssessmentReference :  IEquatable<MnAssessmentReference>, IValidatableObject
    {
        ...
        public MnAssessmentReference(string AssessmentIdentifier = default(string), string _Namespace = default(string), Link Link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("AssessmentIdentifier is a required property for MnAssessmentReference and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentReference and cannot be null");
            }
            else
            {
