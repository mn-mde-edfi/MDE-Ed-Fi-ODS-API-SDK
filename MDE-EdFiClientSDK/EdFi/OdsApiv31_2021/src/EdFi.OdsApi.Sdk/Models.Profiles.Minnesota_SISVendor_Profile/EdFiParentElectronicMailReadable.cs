...
{
    /// <summary>
    /// EdFiParentElectronicMailReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentElectronicMailReadable :  IEquatable<EdFiParentElectronicMailReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentElectronicMailReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentElectronicMailReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentElectronicMailReadable" /> class.
        /// </summary>
        ...
        public EdFiParentElectronicMailReadable(string ElectronicMailTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), string ElectronicMailAddress = default(string), bool? PrimaryEmailAddressIndicator = default(bool?))
        {
            // to ensure "ElectronicMailTypeDescriptor" is required (not null)
            if (ElectronicMailTypeDescriptor == null)
            {
                throw new InvalidDataException("ElectronicMailTypeDescriptor is a required property for EdFiParentElectronicMailReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ElectronicMailAddress is a required property for EdFiParentElectronicMailReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentElectronicMailReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentElectronicMailReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentElectronicMailReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentElectronicMailReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentElectronicMailReadable input)
        {
            if (input == null)
                return false;
