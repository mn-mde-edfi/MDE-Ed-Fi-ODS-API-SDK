...
{
    /// <summary>
    /// EdFiParentPersonalIdentificationDocumentReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentPersonalIdentificationDocumentReadable :  IEquatable<EdFiParentPersonalIdentificationDocumentReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentPersonalIdentificationDocumentReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentPersonalIdentificationDocumentReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentPersonalIdentificationDocumentReadable" /> class.
        /// </summary>
        ...
        public EdFiParentPersonalIdentificationDocumentReadable(string IdentificationDocumentUseDescriptor = default(string), string PersonalInformationVerificationDescriptor = default(string), string IssuerCountryDescriptor = default(string), DateTime? DocumentExpirationDate = default(DateTime?), string DocumentTitle = default(string), string IssuerDocumentIdentificationCode = default(string), string IssuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("PersonalInformationVerificationDescriptor is a required property for EdFiParentPersonalIdentificationDocumentReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentPersonalIdentificationDocumentReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentPersonalIdentificationDocumentReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentPersonalIdentificationDocumentReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentPersonalIdentificationDocumentReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentPersonalIdentificationDocumentReadable input)
        {
            if (input == null)
                return false;
