...
{
    /// <summary>
    /// EdFiParentOtherNameWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentOtherNameWritable :  IEquatable<EdFiParentOtherNameWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentOtherNameWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentOtherNameWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentOtherNameWritable" /> class.
        /// </summary>
        ...
        public EdFiParentOtherNameWritable(string OtherNameTypeDescriptor = default(string), string FirstName = default(string), string GenerationCodeSuffix = default(string), string LastSurname = default(string), string MiddleName = default(string), string PersonalTitlePrefix = default(string))
        {
            // to ensure "OtherNameTypeDescriptor" is required (not null)
            if (OtherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("OtherNameTypeDescriptor is a required property for EdFiParentOtherNameWritable and cannot be null");
            }
            else
            {
            ...
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for EdFiParentOtherNameWritable and cannot be null");
            }
            else
            {
            ...
            if (LastSurname == null)
            {
                throw new InvalidDataException("LastSurname is a required property for EdFiParentOtherNameWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentOtherNameWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentOtherNameWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentOtherNameWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentOtherNameWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentOtherNameWritable input)
        {
            if (input == null)
                return false;
