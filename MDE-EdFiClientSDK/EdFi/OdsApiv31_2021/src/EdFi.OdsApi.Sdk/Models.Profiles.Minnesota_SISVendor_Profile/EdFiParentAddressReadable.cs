...
{
    /// <summary>
    /// EdFiParentAddressReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentAddressReadable :  IEquatable<EdFiParentAddressReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddressReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentAddressReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddressReadable" /> class.
        /// </summary>
        ...
        public EdFiParentAddressReadable(string AddressTypeDescriptor = default(string), string LocaleDescriptor = default(string), string StateAbbreviationDescriptor = default(string), string ApartmentRoomSuiteNumber = default(string), string BuildingSiteNumber = default(string), string City = default(string), string CongressionalDistrict = default(string), string CountyFIPSCode = default(string), bool? DoNotPublishIndicator = default(bool?), string Latitude = default(string), string Longitude = default(string), string NameOfCounty = default(string), string PostalCode = default(string), string StreetNumberName = default(string), List<EdFiParentAddressPeriodReadable> Periods = default(List<EdFiParentAddressPeriodReadable>))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for EdFiParentAddressReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StateAbbreviationDescriptor is a required property for EdFiParentAddressReadable and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for EdFiParentAddressReadable and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for EdFiParentAddressReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StreetNumberName is a required property for EdFiParentAddressReadable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiParentAddressPeriodReadable> Periods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentAddressReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentAddressReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentAddressReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentAddressReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentAddressReadable input)
        {
            if (input == null)
                return false;
