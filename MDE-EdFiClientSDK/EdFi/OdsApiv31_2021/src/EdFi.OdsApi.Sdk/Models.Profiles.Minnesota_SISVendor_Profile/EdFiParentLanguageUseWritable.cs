...
{
    /// <summary>
    /// EdFiParentLanguageUseWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentLanguageUseWritable :  IEquatable<EdFiParentLanguageUseWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageUseWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentLanguageUseWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentLanguageUseWritable" /> class.
        /// </summary>
        ...
        public EdFiParentLanguageUseWritable(string LanguageUseDescriptor = default(string))
        {
            // to ensure "LanguageUseDescriptor" is required (not null)
            if (LanguageUseDescriptor == null)
            {
                throw new InvalidDataException("LanguageUseDescriptor is a required property for EdFiParentLanguageUseWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentLanguageUseWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentLanguageUseWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentLanguageUseWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentLanguageUseWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentLanguageUseWritable input)
        {
            if (input == null)
                return false;
