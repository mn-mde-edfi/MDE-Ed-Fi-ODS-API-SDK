...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_SISVendor_Profile
{
    ...
    public partial class EdFiCourseReference :  IEquatable<EdFiCourseReference>, IValidatableObject
    {
        ...
        public EdFiCourseReference(string Code = default(string), int? EducationOrganizationId = default(int?), Link Link = default(Link))
        {
            // to ensure "Code" is required (not null)
            if (Code == null)
            {
                throw new InvalidDataException("Code is a required property for EdFiCourseReference and cannot be null");
            }
            else
            {
                this.Code = Code;
