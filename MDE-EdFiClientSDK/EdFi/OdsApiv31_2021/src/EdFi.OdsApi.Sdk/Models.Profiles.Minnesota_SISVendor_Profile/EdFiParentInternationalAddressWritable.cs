...
{
    /// <summary>
    /// EdFiParentInternationalAddressWritable
    /// </summary>
    [DataContract]
    public partial class EdFiParentInternationalAddressWritable :  IEquatable<EdFiParentInternationalAddressWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentInternationalAddressWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentInternationalAddressWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentInternationalAddressWritable" /> class.
        /// </summary>
        ...
        public EdFiParentInternationalAddressWritable(string AddressTypeDescriptor = default(string), string CountryDescriptor = default(string), string AddressLine1 = default(string), string AddressLine2 = default(string), string AddressLine3 = default(string), string AddressLine4 = default(string), DateTime? BeginDate = default(DateTime?), DateTime? EndDate = default(DateTime?), string Latitude = default(string), string Longitude = default(string))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for EdFiParentInternationalAddressWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CountryDescriptor is a required property for EdFiParentInternationalAddressWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AddressLine1 is a required property for EdFiParentInternationalAddressWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentInternationalAddressWritable {\n");
        ...
        {
            return this.Equals(input as EdFiParentInternationalAddressWritable);
        }

        /// <summary>
        /// Returns true if EdFiParentInternationalAddressWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentInternationalAddressWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentInternationalAddressWritable input)
        {
            if (input == null)
                return false;
