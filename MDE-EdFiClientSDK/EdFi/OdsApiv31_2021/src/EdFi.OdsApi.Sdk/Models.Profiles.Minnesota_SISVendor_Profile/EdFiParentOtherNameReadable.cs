...
{
    /// <summary>
    /// EdFiParentOtherNameReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentOtherNameReadable :  IEquatable<EdFiParentOtherNameReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentOtherNameReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentOtherNameReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentOtherNameReadable" /> class.
        /// </summary>
        ...
        public EdFiParentOtherNameReadable(string OtherNameTypeDescriptor = default(string), string FirstName = default(string), string GenerationCodeSuffix = default(string), string LastSurname = default(string), string MiddleName = default(string), string PersonalTitlePrefix = default(string))
        {
            // to ensure "OtherNameTypeDescriptor" is required (not null)
            if (OtherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("OtherNameTypeDescriptor is a required property for EdFiParentOtherNameReadable and cannot be null");
            }
            else
            {
            ...
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for EdFiParentOtherNameReadable and cannot be null");
            }
            else
            {
            ...
            if (LastSurname == null)
            {
                throw new InvalidDataException("LastSurname is a required property for EdFiParentOtherNameReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentOtherNameReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentOtherNameReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentOtherNameReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentOtherNameReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentOtherNameReadable input)
        {
            if (input == null)
                return false;
