...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_SISVendor_Profile
{
    ...
    public partial class EdFiEducationOrganizationAddressSchoolReadable :  IEquatable<EdFiEducationOrganizationAddressSchoolReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationAddressSchoolReadable(string AddressTypeDescriptor = default(string), string City = default(string), string PostalCode = default(string), string StreetNumberName = default(string))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for EdFiEducationOrganizationAddressSchoolReadable and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for EdFiEducationOrganizationAddressSchoolReadable and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for EdFiEducationOrganizationAddressSchoolReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StreetNumberName is a required property for EdFiEducationOrganizationAddressSchoolReadable and cannot be null");
            }
            else
            {
