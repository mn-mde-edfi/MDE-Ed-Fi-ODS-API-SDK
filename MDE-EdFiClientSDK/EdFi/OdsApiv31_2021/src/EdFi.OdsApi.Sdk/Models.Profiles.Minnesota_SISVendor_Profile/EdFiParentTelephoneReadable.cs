...
{
    /// <summary>
    /// EdFiParentTelephoneReadable
    /// </summary>
    [DataContract]
    public partial class EdFiParentTelephoneReadable :  IEquatable<EdFiParentTelephoneReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentTelephoneReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentTelephoneReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentTelephoneReadable" /> class.
        /// </summary>
        ...
        public EdFiParentTelephoneReadable(string TelephoneNumberTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string), bool? TextMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "TelephoneNumberTypeDescriptor" is required (not null)
            if (TelephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("TelephoneNumberTypeDescriptor is a required property for EdFiParentTelephoneReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TelephoneNumber is a required property for EdFiParentTelephoneReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParentTelephoneReadable {\n");
        ...
        {
            return this.Equals(input as EdFiParentTelephoneReadable);
        }

        /// <summary>
        /// Returns true if EdFiParentTelephoneReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentTelephoneReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentTelephoneReadable input)
        {
            if (input == null)
                return false;
