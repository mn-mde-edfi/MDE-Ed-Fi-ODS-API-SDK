...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_AssessmentVendor_Profile
{
    ...
    public partial class EdFiStudentAssessmentWritable :  IEquatable<EdFiStudentAssessmentWritable>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentWritable(string Id = default(string), string StudentAssessmentIdentifier = default(string), EdFiAssessmentReference AssessmentReference = default(EdFiAssessmentReference), EdFiSchoolYearTypeReference SchoolYearTypeReference = default(EdFiSchoolYearTypeReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), List<EdFiStudentAssessmentAccommodationWritable> Accommodations = default(List<EdFiStudentAssessmentAccommodationWritable>), DateTime? AdministrationDate = default(DateTime?), DateTime? AdministrationEndDate = default(DateTime?), string AdministrationEnvironmentDescriptor = default(string), string AdministrationLanguageDescriptor = default(string), string EventCircumstanceDescriptor = default(string), string EventDescription = default(string), List<EdFiStudentAssessmentItemWritable> Items = default(List<EdFiStudentAssessmentItemWritable>), List<EdFiStudentAssessmentPerformanceLevelWritable> PerformanceLevels = default(List<EdFiStudentAssessmentPerformanceLevelWritable>), string ReasonNotTestedDescriptor = default(string), string RetestIndicatorDescriptor = default(string), List<EdFiStudentAssessmentScoreResultWritable> ScoreResults = default(List<EdFiStudentAssessmentScoreResultWritable>), string SerialNumber = default(string), List<EdFiStudentAssessmentStudentObjectiveAssessmentWritable> StudentObjectiveAssessments = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentWritable>), string WhenAssessedGradeLevelDescriptor = default(string), string Etag = default(string), StudentAssessmentExtensionsWritable Ext = default(StudentAssessmentExtensionsWritable))
        {
            ...
            {
                throw new InvalidDataException("AdministrationDate is a required property for EdFiStudentAssessmentWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiStudentAssessmentAccommodationWritable> Accommodations { get; set; }
        ...
        public List<EdFiStudentAssessmentItemWritable> Items { get; set; }
        ...
        public List<EdFiStudentAssessmentPerformanceLevelWritable> PerformanceLevels { get; set; }
        ...
        public List<EdFiStudentAssessmentScoreResultWritable> ScoreResults { get; set; }
        ...
        public List<EdFiStudentAssessmentStudentObjectiveAssessmentWritable> StudentObjectiveAssessments { get; set; }
        ...
        public StudentAssessmentExtensionsWritable Ext { get; set; }
