...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_AssessmentVendor_Profile
{
    ...
    public partial class EdFiObjectiveAssessmentReference :  IEquatable<EdFiObjectiveAssessmentReference>, IValidatableObject
    {
        ...
        public EdFiObjectiveAssessmentReference(string AssessmentIdentifier = default(string), string IdentificationCode = default(string), string _Namespace = default(string), Link Link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("AssessmentIdentifier is a required property for EdFiObjectiveAssessmentReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdentificationCode is a required property for EdFiObjectiveAssessmentReference and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for EdFiObjectiveAssessmentReference and cannot be null");
            }
            else
            {
