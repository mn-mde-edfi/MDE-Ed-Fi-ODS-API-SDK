...
{
    /// <summary>
    /// EdFiObjectiveAssessmentPerformanceLevelWritable
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentPerformanceLevelWritable :  IEquatable<EdFiObjectiveAssessmentPerformanceLevelWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectiveAssessmentPerformanceLevelWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        ...
        public EdFiObjectiveAssessmentPerformanceLevelWritable(string AssessmentReportingMethodDescriptor = default(string), string PerformanceLevelDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string MaximumScore = default(string), string MinimumScore = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectiveAssessmentPerformanceLevelWritable {\n");
        ...
        {
            return this.Equals(input as EdFiObjectiveAssessmentPerformanceLevelWritable);
        }

        /// <summary>
        /// Returns true if EdFiObjectiveAssessmentPerformanceLevelWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectiveAssessmentPerformanceLevelWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectiveAssessmentPerformanceLevelWritable input)
        {
            if (input == null)
                return false;
