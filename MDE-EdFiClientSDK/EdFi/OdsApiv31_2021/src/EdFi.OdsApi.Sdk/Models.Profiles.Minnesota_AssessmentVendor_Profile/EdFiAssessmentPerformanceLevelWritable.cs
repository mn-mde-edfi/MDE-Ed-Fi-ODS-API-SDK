...
{
    /// <summary>
    /// EdFiAssessmentPerformanceLevelWritable
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentPerformanceLevelWritable :  IEquatable<EdFiAssessmentPerformanceLevelWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentPerformanceLevelWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentPerformanceLevelWritable(string AssessmentReportingMethodDescriptor = default(string), string PerformanceLevelDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string MaximumScore = default(string), string MinimumScore = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelDescriptor is a required property for EdFiAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentPerformanceLevelWritable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentPerformanceLevelWritable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentPerformanceLevelWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentPerformanceLevelWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentPerformanceLevelWritable input)
        {
            if (input == null)
                return false;
