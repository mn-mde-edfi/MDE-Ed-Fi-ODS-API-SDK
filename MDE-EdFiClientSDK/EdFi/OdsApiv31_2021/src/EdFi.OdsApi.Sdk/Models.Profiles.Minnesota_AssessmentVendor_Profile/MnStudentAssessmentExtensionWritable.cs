...
{
    /// <summary>
    /// MnStudentAssessmentExtensionWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentAssessmentExtensionWritable :  IEquatable<MnStudentAssessmentExtensionWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentExtensionWritable" /> class.
        /// </summary>
        ...
        public MnStudentAssessmentExtensionWritable(string AssessmentFormatDescriptor = default(string), string AssessmentTierDescriptor = default(string), string GeneralEnrollmentDescriptor = default(string), string CatStudentTestId = default(string), string LearningLocatorCode = default(string), int? TimeOnTest = default(int?), EdFiEducationOrganizationReference SiteEducationOrganizationReference = default(EdFiEducationOrganizationReference), List<MnStudentAssessmentCharacteristicWritable> Characteristics = default(List<MnStudentAssessmentCharacteristicWritable>))
        {
        ...
        public List<MnStudentAssessmentCharacteristicWritable> Characteristics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentAssessmentExtensionWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentAssessmentExtensionWritable);
        }

        /// <summary>
        /// Returns true if MnStudentAssessmentExtensionWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentAssessmentExtensionWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentAssessmentExtensionWritable input)
        {
            if (input == null)
                return false;
