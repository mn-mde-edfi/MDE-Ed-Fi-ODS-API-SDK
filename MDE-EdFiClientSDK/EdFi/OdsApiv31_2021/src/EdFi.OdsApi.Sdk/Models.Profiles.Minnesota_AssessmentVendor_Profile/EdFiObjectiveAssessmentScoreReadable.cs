...
{
    /// <summary>
    /// EdFiObjectiveAssessmentScoreReadable
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentScoreReadable :  IEquatable<EdFiObjectiveAssessmentScoreReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentScoreReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectiveAssessmentScoreReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentScoreReadable" /> class.
        /// </summary>
        ...
        public EdFiObjectiveAssessmentScoreReadable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string MaximumScore = default(string), string MinimumScore = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentScoreReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectiveAssessmentScoreReadable {\n");
        ...
        {
            return this.Equals(input as EdFiObjectiveAssessmentScoreReadable);
        }

        /// <summary>
        /// Returns true if EdFiObjectiveAssessmentScoreReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectiveAssessmentScoreReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectiveAssessmentScoreReadable input)
        {
            if (input == null)
                return false;
