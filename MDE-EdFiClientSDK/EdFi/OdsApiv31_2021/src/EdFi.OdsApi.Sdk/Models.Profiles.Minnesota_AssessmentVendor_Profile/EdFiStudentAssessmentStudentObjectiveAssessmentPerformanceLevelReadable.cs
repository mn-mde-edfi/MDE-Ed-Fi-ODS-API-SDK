...
{
    /// <summary>
    /// EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable :  IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable(string AssessmentReportingMethodDescriptor = default(string), string PerformanceLevelDescriptor = default(string), bool? PerformanceLevelMet = default(bool?))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelMet is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelReadable input)
        {
            if (input == null)
                return false;
