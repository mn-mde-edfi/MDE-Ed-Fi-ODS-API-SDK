...
{
    /// <summary>
    /// EdFiObjectiveAssessmentScoreWritable
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentScoreWritable :  IEquatable<EdFiObjectiveAssessmentScoreWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentScoreWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectiveAssessmentScoreWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentScoreWritable" /> class.
        /// </summary>
        ...
        public EdFiObjectiveAssessmentScoreWritable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string MaximumScore = default(string), string MinimumScore = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentScoreWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectiveAssessmentScoreWritable {\n");
        ...
        {
            return this.Equals(input as EdFiObjectiveAssessmentScoreWritable);
        }

        /// <summary>
        /// Returns true if EdFiObjectiveAssessmentScoreWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectiveAssessmentScoreWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectiveAssessmentScoreWritable input)
        {
            if (input == null)
                return false;
