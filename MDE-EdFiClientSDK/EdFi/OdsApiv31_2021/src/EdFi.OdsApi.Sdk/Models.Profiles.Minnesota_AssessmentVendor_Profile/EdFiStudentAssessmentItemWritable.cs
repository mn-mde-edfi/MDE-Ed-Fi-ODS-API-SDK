...
{
    /// <summary>
    /// EdFiStudentAssessmentItemWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentItemWritable :  IEquatable<EdFiStudentAssessmentItemWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentItemWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentItemWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentItemWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentItemWritable(string AssessmentItemResultDescriptor = default(string), string ResponseIndicatorDescriptor = default(string), string AssessmentResponse = default(string), string DescriptiveFeedback = default(string), int? RawScoreResult = default(int?), string TimeAssessed = default(string), EdFiAssessmentItemReference AssessmentItemReference = default(EdFiAssessmentItemReference))
        {
            ...
            {
                throw new InvalidDataException("AssessmentItemReference is a required property for EdFiStudentAssessmentItemWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentItemWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentItemWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentItemWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentItemWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentItemWritable input)
        {
            if (input == null)
                return false;
