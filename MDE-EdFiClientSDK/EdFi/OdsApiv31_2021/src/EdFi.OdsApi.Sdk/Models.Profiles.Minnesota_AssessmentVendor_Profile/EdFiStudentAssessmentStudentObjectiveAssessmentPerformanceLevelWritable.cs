...
{
    /// <summary>
    /// EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable :  IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable(string AssessmentReportingMethodDescriptor = default(string), string PerformanceLevelDescriptor = default(string), bool? PerformanceLevelMet = default(bool?))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelMet is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable input)
        {
            if (input == null)
                return false;
