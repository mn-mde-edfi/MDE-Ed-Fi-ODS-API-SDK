    ...
    public partial class ParentsApi : IParentsApi
    {
        ...
        public ApiResponse<Object> DeleteparentByIdWithHttpInfo (string id, string ifMatch = null)
        {
            ...
            String[] localVarHttpContentTypes = new String[] {
                "application/vnd.ed-fi.parent.minnesota-sisvendor-profile.writable+json"
            };
        ...
        {
             ApiResponse<List<EdFiParentReadable>> localVarResponse = GetParentsWithHttpInfo(offset, limit, totalCount, parentUniqueId, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
        ...
        public ApiResponse< List<EdFiParentReadable> > GetParentsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string parentUniqueId = null, string sexDescriptor = null, string firstName = null, string generationCodeSuffix = null, string id = null, string lastSurname = null, string loginId = null, string maidenName = null, string middleName = null, string personalTitlePrefix = null)
        {
            ...
            // to determine the Accept header
            String[] localVarHttpHeaderAccepts = new String[] {
                "application/vnd.ed-fi.parent.minnesota-sisvendor-profile.readable+json"
            };
            String localVarHttpHeaderAccept = Configuration.ApiClient.SelectHeaderAccept(localVarHttpHeaderAccepts);
            if (localVarHttpHeaderAccept != null)
                localVarHeaderParams.Add("Accept", localVarHttpHeaderAccept);
        ...
        {
             ApiResponse<List<EdFiParentReadable>> localVarResponse = await GetParentsAsyncWithHttpInfo(offset, limit, totalCount, parentUniqueId, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
             return localVarResponse.Data;
