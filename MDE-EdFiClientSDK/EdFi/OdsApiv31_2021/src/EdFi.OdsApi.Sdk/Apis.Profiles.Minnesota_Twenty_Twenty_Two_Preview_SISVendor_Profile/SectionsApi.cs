    ...
    public partial class SectionsApi : ISectionsApi
    {
        ...
        public ApiResponse<Object> DeletesectionByIdWithHttpInfo (string id, string ifMatch = null)
        {
            ...
            String[] localVarHttpContentTypes = new String[] {
                "application/vnd.ed-fi.section.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json"
            };
        ...
        public ApiResponse< List<EdFiSectionReadable> > GetSectionsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string sectionIdentifier = null, string localCourseCode = null, int? schoolId = null, int? schoolYear = null, string sessionName = null, string instructionLanguageDescriptor = null, string mediumOfInstructionDescriptor = null, string id = null, int? sequenceOfCourse = null)
        {
            ...
            // to determine the Accept header
            String[] localVarHttpHeaderAccepts = new String[] {
                "application/vnd.ed-fi.section.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json"
            };
            String localVarHttpHeaderAccept = Configuration.ApiClient.SelectHeaderAccept(localVarHttpHeaderAccepts);
            if (localVarHttpHeaderAccept != null)
                localVarHeaderParams.Add("Accept", localVarHttpHeaderAccept);
