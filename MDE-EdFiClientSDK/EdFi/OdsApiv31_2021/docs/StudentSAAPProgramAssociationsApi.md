# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.StudentSAAPProgramAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentsaapprogramassociation.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json
...
namespace Example
{
    public class GetStudentSAAPProgramAssociationsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;MnStudentSAAPProgramAssociationReadable&gt; result = apiInstance.GetStudentSAAPProgramAssociations(offset, limit, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, independentStudyIndicator, saapConcurrentIndicator, saapCredits);
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.studentsaapprogramassociation.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json
...
namespace Example
{
    public class GetStudentSAAPProgramAssociationsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                MnStudentSAAPProgramAssociationReadable result = apiInstance.GetStudentSAAPProgramAssociationsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
