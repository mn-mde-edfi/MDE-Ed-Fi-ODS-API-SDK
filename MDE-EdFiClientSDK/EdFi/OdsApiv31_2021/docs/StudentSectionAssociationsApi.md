# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.StudentSectionAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentsectionassociation.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json
...
namespace Example
{
    public class GetStudentSectionAssociationsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiStudentSectionAssociationReadable&gt; result = apiInstance.GetStudentSectionAssociations(offset, limit, totalCount, beginDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, studentUniqueId, id);
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.studentsectionassociation.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json
...
namespace Example
{
    public class GetStudentSectionAssociationsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiStudentSectionAssociationReadable result = apiInstance.GetStudentSectionAssociationsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
