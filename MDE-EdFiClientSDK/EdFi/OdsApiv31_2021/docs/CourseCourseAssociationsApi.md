# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.CourseCourseAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.coursecourseassociation.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.coursecourseassociation.minnesota-sisvendor-profile.readable+json
