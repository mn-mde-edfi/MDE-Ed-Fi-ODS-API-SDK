# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.StudentPSEOProgramAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentpseoprogramassociation.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.studentpseoprogramassociation.minnesota-sisvendor-profile.readable+json
