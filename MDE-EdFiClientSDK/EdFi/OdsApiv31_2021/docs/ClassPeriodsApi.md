# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.ClassPeriodsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.classperiod.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.classperiod.minnesota-sisvendor-profile.readable+json
