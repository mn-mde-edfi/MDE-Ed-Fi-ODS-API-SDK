# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.ClassPeriodsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.classperiod.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json
...
namespace Example
{
    public class GetClassPeriodsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiClassPeriodReadable&gt; result = apiInstance.GetClassPeriods(offset, limit, totalCount, classPeriodName, schoolId, id);
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.classperiod.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json
...
namespace Example
{
    public class GetClassPeriodsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiClassPeriodReadable result = apiInstance.GetClassPeriodsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
