...
[**PutClassPeriodTypeDescriptor**](ClassPeriodTypeDescriptorsApi.md#putclassperiodtypedescriptor) | **PUT** /MN/classPeriodTypeDescriptors/{id} | Updates or creates a resource based on the resource identifier.
...
> List<MnClassPeriodTypeDescriptor> GetClassPeriodTypeDescriptors (int? offset = null, int? limit = null, bool? totalCount = null, int? classPeriodTypeDescriptorId = null)
...
namespace Example
{
    public class GetClassPeriodTypeDescriptorsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;MnClassPeriodTypeDescriptor&gt; result = apiInstance.GetClassPeriodTypeDescriptors(offset, limit, totalCount, classPeriodTypeDescriptorId);
...
> MnClassPeriodTypeDescriptor GetClassPeriodTypeDescriptorsById (string id, string ifNoneMatch = null)
...
namespace Example
{
    public class GetClassPeriodTypeDescriptorsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                MnClassPeriodTypeDescriptor result = apiInstance.GetClassPeriodTypeDescriptorsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
