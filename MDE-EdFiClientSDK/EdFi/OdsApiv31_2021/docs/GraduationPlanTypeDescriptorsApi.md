...
[**PutGraduationPlanTypeDescriptor**](GraduationPlanTypeDescriptorsApi.md#putgraduationplantypedescriptor) | **PUT** /ed-fi/graduationPlanTypeDescriptors/{id} | Updates or creates a resource based on the resource identifier.
...
namespace Example
{
    public class GetGraduationPlanTypeDescriptorsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiGraduationPlanTypeDescriptor&gt; result = apiInstance.GetGraduationPlanTypeDescriptors(offset, limit, totalCount, graduationPlanTypeDescriptorId);
...
namespace Example
{
    public class GetGraduationPlanTypeDescriptorsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiGraduationPlanTypeDescriptor result = apiInstance.GetGraduationPlanTypeDescriptorsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
