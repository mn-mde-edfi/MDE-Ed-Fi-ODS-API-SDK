...
[**PutEventCircumstanceDescriptor**](EventCircumstanceDescriptorsApi.md#puteventcircumstancedescriptor) | **PUT** /ed-fi/eventCircumstanceDescriptors/{id} | Updates or creates a resource based on the resource identifier.
...
namespace Example
{
    public class GetEventCircumstanceDescriptorsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiEventCircumstanceDescriptor&gt; result = apiInstance.GetEventCircumstanceDescriptors(offset, limit, totalCount, eventCircumstanceDescriptorId);
...
namespace Example
{
    public class GetEventCircumstanceDescriptorsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiEventCircumstanceDescriptor result = apiInstance.GetEventCircumstanceDescriptorsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
