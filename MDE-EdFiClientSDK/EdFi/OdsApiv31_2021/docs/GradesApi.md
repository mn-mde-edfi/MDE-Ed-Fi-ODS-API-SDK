# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.GradesApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.grade.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.grade.minnesota-sisvendor-profile.readable+json
