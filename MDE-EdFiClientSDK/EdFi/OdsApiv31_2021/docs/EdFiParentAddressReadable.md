# EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.EdFiParentAddressReadable
## Properties
...
**Periods** | [**List&lt;EdFiParentAddressPeriodReadable&gt;**](EdFiParentAddressPeriodReadable.md) | An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address. | [optional] 
