# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.GradingPeriodsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.gradingperiod.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.gradingperiod.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json
