# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.SessionsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.session.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.session.minnesota-sisvendor-profile.readable+json
