# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_Two_Preview_SISVendor_Profile.SchoolsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.school.minnesota-twentytwentytwopreview-sisvendorprofile.writable+json
...
namespace Example
{
    public class GetSchoolsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiSchoolReadable&gt; result = apiInstance.GetSchools(offset, limit, totalCount, schoolId, localEducationAgencyId, titleIPartASchoolDesignationDescriptor);
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.school.minnesota-twentytwentytwopreview-sisvendorprofile.readable+json
...
namespace Example
{
    public class GetSchoolsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSchoolReadable result = apiInstance.GetSchoolsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
