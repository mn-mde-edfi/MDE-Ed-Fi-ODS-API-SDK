# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.AssessmentsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.assessment.minnesota-sisvendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.assessment.minnesota-sisvendor-profile.readable+json
