# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_SISVendor_Profile.StudentsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.student.minnesota-sisvendor-profile.writable+json
...
namespace Example
{
    public class GetStudentsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiStudentReadable&gt; result = apiInstance.GetStudents(offset, limit, totalCount, studentUniqueId, birthDate, firstName, generationCodeSuffix, id, lastSurname, middleName);
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.student.minnesota-sisvendor-profile.readable+json
