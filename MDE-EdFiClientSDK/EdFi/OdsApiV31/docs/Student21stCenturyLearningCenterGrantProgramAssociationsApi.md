# EdFi.OdsApi.Sdk.Apis.All.Student21stCenturyLearningCenterGrantProgramAssociationsApi
...
namespace Example
{
    public class GetStudent21stCenturyLearningCenterGrantProgramAssociationsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;MnStudent21stCenturyLearningCenterGrantProgramAssociation&gt; result = apiInstance.GetStudent21stCenturyLearningCenterGrantProgramAssociations(offset, limit, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId);
...
[**List<MnStudent21stCenturyLearningCenterGrantProgramAssociation>**](MnStudent21stCenturyLearningCenterGrantProgramAssociation.md)
...
# **GetStudent21stCenturyLearningCenterGrantProgramAssociationsById**
> MnStudent21stCenturyLearningCenterGrantProgramAssociation GetStudent21stCenturyLearningCenterGrantProgramAssociationsById (string id, string ifNoneMatch = null)
...
namespace Example
{
    public class GetStudent21stCenturyLearningCenterGrantProgramAssociationsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                MnStudent21stCenturyLearningCenterGrantProgramAssociation result = apiInstance.GetStudent21stCenturyLearningCenterGrantProgramAssociationsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
[**MnStudent21stCenturyLearningCenterGrantProgramAssociation**](MnStudent21stCenturyLearningCenterGrantProgramAssociation.md)
...
# **PostStudent21stCenturyLearningCenterGrantProgramAssociation**
> void PostStudent21stCenturyLearningCenterGrantProgramAssociation (MnStudent21stCenturyLearningCenterGrantProgramAssociation student21stCenturyLearningCenterGrantProgramAssociation)
...
namespace Example
{
    public class PostStudent21stCenturyLearningCenterGrantProgramAssociationExample
    {
        public void main()
        {
            ...
            var apiInstance = new Student21stCenturyLearningCenterGrantProgramAssociationsApi();
            var student21stCenturyLearningCenterGrantProgramAssociation = new MnStudent21stCenturyLearningCenterGrantProgramAssociation(); // MnStudent21stCenturyLearningCenterGrantProgramAssociation | The JSON representation of the \"student21stCenturyLearningCenterGrantProgramAssociation\" resource to be created or updated.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **student21stCenturyLearningCenterGrantProgramAssociation** | [**MnStudent21stCenturyLearningCenterGrantProgramAssociation**](MnStudent21stCenturyLearningCenterGrantProgramAssociation.md)| The JSON representation of the \&quot;student21stCenturyLearningCenterGrantProgramAssociation\&quot; resource to be created or updated. | 
...
> void PutStudent21stCenturyLearningCenterGrantProgramAssociation (string id, MnStudent21stCenturyLearningCenterGrantProgramAssociation student21stCenturyLearningCenterGrantProgramAssociation, string ifMatch = null)
