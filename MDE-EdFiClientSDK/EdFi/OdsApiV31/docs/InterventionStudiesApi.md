# EdFi.OdsApi.Sdk.Apis.All.InterventionStudiesApi
...
[**PutInterventionStudy**](InterventionStudiesApi.md#putinterventionstudy) | **PUT** /ed-fi/interventionStudies/{id} | Updates or creates a resource based on the resource identifier.
...
namespace Example
{
    public class GetInterventionStudiesExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiInterventionStudy&gt; result = apiInstance.GetInterventionStudies(offset, limit, totalCount, interventionStudyIdentificationCode, educationOrganizationId, interventionPrescriptionEducationOrganizationId, interventionPrescriptionIdentificationCode, deliveryMethodDescriptor, interventionClassDescriptor, id, participants);
...
namespace Example
{
    public class GetInterventionStudiesByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiInterventionStudy result = apiInstance.GetInterventionStudiesById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
