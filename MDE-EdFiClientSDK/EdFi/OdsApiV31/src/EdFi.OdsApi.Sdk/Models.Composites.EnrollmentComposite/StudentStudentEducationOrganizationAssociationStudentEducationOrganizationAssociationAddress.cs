...
{
    /// <summary>
    /// StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress
    /// </summary>
    [DataContract]
    public partial class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress :  IEquatable<StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress" /> class.
        /// </summary>
        ...
        public StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress(string AddressTypeDescriptor = default(string), string StreetNumberName = default(string), string City = default(string), string StateAbbreviationDescriptor = default(string), string PostalCode = default(string), string NameOfCounty = default(string))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StreetNumberName is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            {
                throw new InvalidDataException("StateAbbreviationDescriptor is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress and cannot be null");
            }
            else
            {
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress {\n");
        ...
        {
            return this.Equals(input as StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress);
        }

        /// <summary>
        /// Returns true if StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationAddress input)
        {
            if (input == null)
                return false;
