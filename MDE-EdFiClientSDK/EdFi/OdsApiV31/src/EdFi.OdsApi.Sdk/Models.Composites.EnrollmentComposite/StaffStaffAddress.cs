...
namespace EdFi.OdsApi.Sdk.Models.Composites.EnrollmentComposite
{
    ...
    /// </summary>
    [DataContract]
    public partial class StaffStaffAddress :  IEquatable<StaffStaffAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StaffStaffAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffAddress" /> class.
        /// </summary>
        ...
        public StaffStaffAddress(string AddressTypeDescriptor = default(string), string StreetNumberName = default(string), string City = default(string), string StateAbbreviationDescriptor = default(string), string PostalCode = default(string), string NameOfCounty = default(string))
        {
            // to ensure "AddressTypeDescriptor" is required (not null)
            if (AddressTypeDescriptor == null)
            {
                throw new InvalidDataException("AddressTypeDescriptor is a required property for StaffStaffAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StreetNumberName is a required property for StaffStaffAddress and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for StaffStaffAddress and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            {
                throw new InvalidDataException("StateAbbreviationDescriptor is a required property for StaffStaffAddress and cannot be null");
            }
            else
            {
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for StaffStaffAddress and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffStaffAddress {\n");
        ...
        {
            return this.Equals(input as StaffStaffAddress);
        }

        /// <summary>
        /// Returns true if StaffStaffAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffStaffAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffStaffAddress input)
        {
            if (input == null)
                return false;
