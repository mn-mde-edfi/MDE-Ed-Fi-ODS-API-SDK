...
{
    /// <summary>
    /// StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone
    /// </summary>
    [DataContract]
    public partial class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone :  IEquatable<StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone" /> class.
        /// </summary>
        ...
        public StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone(string TelephoneNumberTypeDescriptor = default(string), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string))
        {
            // to ensure "TelephoneNumberTypeDescriptor" is required (not null)
            if (TelephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("TelephoneNumberTypeDescriptor is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TelephoneNumber is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone {\n");
        ...
        {
            return this.Equals(input as StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone);
        }

        /// <summary>
        /// Returns true if StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationTelephone input)
        {
            if (input == null)
                return false;
