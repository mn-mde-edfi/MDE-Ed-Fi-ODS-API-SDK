...
namespace EdFi.OdsApi.Sdk.Models.Composites.EnrollmentComposite
{
    ...
    /// </summary>
    [DataContract]
    public partial class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode :  IEquatable<StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode" /> class.
        /// </summary>
        ...
        public StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode(string AssigningOrganizationIdentificationCode = default(string), string StudentIdentificationSystemDescriptor = default(string), string IdentificationCode = default(string))
        {
            // to ensure "AssigningOrganizationIdentificationCode" is required (not null)
            if (AssigningOrganizationIdentificationCode == null)
            {
                throw new InvalidDataException("AssigningOrganizationIdentificationCode is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentIdentificationSystemDescriptor is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdentificationCode is a required property for StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode {\n");
        ...
        {
            return this.Equals(input as StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode);
        }

        /// <summary>
        /// Returns true if StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode instances are equal
        /// </summary>
        /// <param name="input">Instance of StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StudentStudentEducationOrganizationAssociationStudentEducationOrganizationAssociationStudentIdentificationCode input)
        {
            if (input == null)
                return false;
