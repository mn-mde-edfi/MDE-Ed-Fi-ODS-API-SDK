...
namespace EdFi.OdsApi.Sdk.Models.MN
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnGiftedTalentedParticipationDescriptor :  IEquatable<MnGiftedTalentedParticipationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGiftedTalentedParticipationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnGiftedTalentedParticipationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGiftedTalentedParticipationDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="GiftedTalentedParticipationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnGiftedTalentedParticipationDescriptor(string Id = default(string), int? GiftedTalentedParticipationDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnGiftedTalentedParticipationDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnGiftedTalentedParticipationDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnGiftedTalentedParticipationDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnGiftedTalentedParticipationDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.GiftedTalentedParticipationDescriptorId = GiftedTalentedParticipationDescriptorId;
        ...
        [DataMember(Name="giftedTalentedParticipationDescriptorId", EmitDefaultValue=false)]
        public int? GiftedTalentedParticipationDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnGiftedTalentedParticipationDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GiftedTalentedParticipationDescriptorId: ").Append(GiftedTalentedParticipationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnGiftedTalentedParticipationDescriptor);
        }

        /// <summary>
        /// Returns true if MnGiftedTalentedParticipationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnGiftedTalentedParticipationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnGiftedTalentedParticipationDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GiftedTalentedParticipationDescriptorId == input.GiftedTalentedParticipationDescriptorId ||
                    (this.GiftedTalentedParticipationDescriptorId != null &&
                    this.GiftedTalentedParticipationDescriptorId.Equals(input.GiftedTalentedParticipationDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GiftedTalentedParticipationDescriptorId != null)
                    hashCode = hashCode * 59 + this.GiftedTalentedParticipationDescriptorId.GetHashCode();
