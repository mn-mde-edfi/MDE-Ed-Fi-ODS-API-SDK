...
{
    /// <summary>
    /// MnStudentSchoolAssociationExtension
    /// </summary>
    [DataContract]
    public partial class MnStudentSchoolAssociationExtension :  IEquatable<MnStudentSchoolAssociationExtension>, IValidatableObject
    {
        /// <summary>
        ...
        public MnStudentSchoolAssociationMembership Membership { get; set; }

        /// <summary>
        /// Gets or Sets Transportation
        /// </summary>
        [DataMember(Name="transportation", EmitDefaultValue=false)]
        public MnStudentSchoolAssociationTransportation Transportation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSchoolAssociationExtension {\n");
        ...
        {
            return this.Equals(input as MnStudentSchoolAssociationExtension);
        }

        /// <summary>
        /// Returns true if MnStudentSchoolAssociationExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSchoolAssociationExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSchoolAssociationExtension input)
        {
            if (input == null)
                return false;
