...
namespace EdFi.OdsApi.Sdk.Models.MN
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnTransportationCategoryDescriptor :  IEquatable<MnTransportationCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnTransportationCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnTransportationCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnTransportationCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="TransportationCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnTransportationCategoryDescriptor(string Id = default(string), int? TransportationCategoryDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnTransportationCategoryDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnTransportationCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnTransportationCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnTransportationCategoryDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.TransportationCategoryDescriptorId = TransportationCategoryDescriptorId;
        ...
        [DataMember(Name="transportationCategoryDescriptorId", EmitDefaultValue=false)]
        public int? TransportationCategoryDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnTransportationCategoryDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  TransportationCategoryDescriptorId: ").Append(TransportationCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnTransportationCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if MnTransportationCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnTransportationCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnTransportationCategoryDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TransportationCategoryDescriptorId == input.TransportationCategoryDescriptorId ||
                    (this.TransportationCategoryDescriptorId != null &&
                    this.TransportationCategoryDescriptorId.Equals(input.TransportationCategoryDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TransportationCategoryDescriptorId != null)
                    hashCode = hashCode * 59 + this.TransportationCategoryDescriptorId.GetHashCode();
