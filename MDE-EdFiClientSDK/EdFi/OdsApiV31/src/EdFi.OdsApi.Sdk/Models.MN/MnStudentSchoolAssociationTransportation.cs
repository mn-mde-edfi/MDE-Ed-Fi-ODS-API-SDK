...
{
    /// <summary>
    /// MnStudentSchoolAssociationTransportation
    /// </summary>
    [DataContract]
    public partial class MnStudentSchoolAssociationTransportation :  IEquatable<MnStudentSchoolAssociationTransportation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSchoolAssociationTransportation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSchoolAssociationTransportation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSchoolAssociationTransportation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSchoolAssociationTransportation {\n");
        ...
        {
            return this.Equals(input as MnStudentSchoolAssociationTransportation);
        }

        /// <summary>
        /// Returns true if MnStudentSchoolAssociationTransportation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSchoolAssociationTransportation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSchoolAssociationTransportation input)
        {
            if (input == null)
                return false;
