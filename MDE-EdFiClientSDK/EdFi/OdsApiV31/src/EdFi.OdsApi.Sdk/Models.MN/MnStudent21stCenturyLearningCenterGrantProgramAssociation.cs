...
namespace EdFi.OdsApi.Sdk.Models.MN
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudent21stCenturyLearningCenterGrantProgramAssociation :  IEquatable<MnStudent21stCenturyLearningCenterGrantProgramAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public MnStudent21stCenturyLearningCenterGrantProgramAssociation(string Id = default(string), DateTime? BeginDate = default(DateTime?), EdFiEducationOrganizationReference EducationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference ProgramReference = default(EdFiProgramReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), DateTime? EndDate = default(DateTime?), string ReasonExitedDescriptor = default(string), bool? ServedOutsideOfRegularSession = default(bool?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStudent21stCenturyLearningCenterGrantProgramAssociation and cannot be null");
            }
            else
            {
                this.Id = Id;
