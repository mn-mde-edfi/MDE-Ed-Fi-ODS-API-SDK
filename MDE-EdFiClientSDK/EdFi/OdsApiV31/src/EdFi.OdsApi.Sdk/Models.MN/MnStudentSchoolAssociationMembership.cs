...
namespace EdFi.OdsApi.Sdk.Models.MN
{
    ...
    public partial class MnStudentSchoolAssociationMembership :  IEquatable<MnStudentSchoolAssociationMembership>, IValidatableObject
    {
        ...
        public MnStudentSchoolAssociationMembership(string MembershipAttendanceUnitDescriptor = default(string), int? Attendance = default(int?), int? Membership = default(int?), double? PercentEnrolled = default(double?))
        {
