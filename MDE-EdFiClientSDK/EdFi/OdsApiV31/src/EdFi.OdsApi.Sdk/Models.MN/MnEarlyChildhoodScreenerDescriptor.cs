...
{
    /// <summary>
    /// MnEarlyChildhoodScreenerDescriptor
    /// </summary>
    [DataContract]
    public partial class MnEarlyChildhoodScreenerDescriptor :  IEquatable<MnEarlyChildhoodScreenerDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyChildhoodScreenerDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnEarlyChildhoodScreenerDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyChildhoodScreenerDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="EarlyChildhoodScreenerDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnEarlyChildhoodScreenerDescriptor(string Id = default(string), int? EarlyChildhoodScreenerDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnEarlyChildhoodScreenerDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnEarlyChildhoodScreenerDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnEarlyChildhoodScreenerDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnEarlyChildhoodScreenerDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.EarlyChildhoodScreenerDescriptorId = EarlyChildhoodScreenerDescriptorId;
        ...
        [DataMember(Name="earlyChildhoodScreenerDescriptorId", EmitDefaultValue=false)]
        public int? EarlyChildhoodScreenerDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnEarlyChildhoodScreenerDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EarlyChildhoodScreenerDescriptorId: ").Append(EarlyChildhoodScreenerDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnEarlyChildhoodScreenerDescriptor);
        }

        /// <summary>
        /// Returns true if MnEarlyChildhoodScreenerDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnEarlyChildhoodScreenerDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnEarlyChildhoodScreenerDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EarlyChildhoodScreenerDescriptorId == input.EarlyChildhoodScreenerDescriptorId ||
                    (this.EarlyChildhoodScreenerDescriptorId != null &&
                    this.EarlyChildhoodScreenerDescriptorId.Equals(input.EarlyChildhoodScreenerDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EarlyChildhoodScreenerDescriptorId != null)
                    hashCode = hashCode * 59 + this.EarlyChildhoodScreenerDescriptorId.GetHashCode();
