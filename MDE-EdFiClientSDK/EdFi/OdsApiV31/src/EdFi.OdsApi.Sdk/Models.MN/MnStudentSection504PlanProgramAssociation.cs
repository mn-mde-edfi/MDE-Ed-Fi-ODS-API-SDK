...
namespace EdFi.OdsApi.Sdk.Models.MN
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentSection504PlanProgramAssociation :  IEquatable<MnStudentSection504PlanProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSection504PlanProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSection504PlanProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSection504PlanProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentSection504PlanProgramAssociation(string Id = default(string), DateTime? BeginDate = default(DateTime?), EdFiEducationOrganizationReference EducationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference ProgramReference = default(EdFiProgramReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), DateTime? EndDate = default(DateTime?), string ReasonExitedDescriptor = default(string), bool? ServedOutsideOfRegularSession = default(bool?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentSection504PlanProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentSection504PlanProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentSection504PlanProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentSection504PlanProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSection504PlanProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentSection504PlanProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentSection504PlanProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSection504PlanProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSection504PlanProgramAssociation input)
        {
            if (input == null)
                return false;
