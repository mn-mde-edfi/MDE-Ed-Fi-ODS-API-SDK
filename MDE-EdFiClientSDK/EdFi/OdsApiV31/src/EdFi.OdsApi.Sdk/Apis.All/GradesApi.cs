...
namespace EdFi.OdsApi.Sdk.Apis.All
{
    ...
    public partial class GradesApi : IGradesApi
    {
        ...
        public ApiResponse< List<EdFiGrade> > GetGradesWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string gradeTypeDescriptor = null, string gradingPeriodDescriptor = null, int? gradingPeriodSequence = null, int? schoolId = null, int? gradingPeriodSchoolYear = null, DateTime? beginDate = null, string localCourseCode = null, int? schoolYear = null, string sectionIdentifier = null, string sessionName = null, string studentUniqueId = null, string performanceBaseConversionDescriptor = null, string diagnosticStatement = null, string id = null, string letterGradeEarned = null, double? numericGradeEarned = null)
        {
            ...
            if (performanceBaseConversionDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "performanceBaseConversionDescriptor", performanceBaseConversionDescriptor)); // query parameter
            ...
            return new ApiResponse<List<EdFiGrade>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiGrade>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiGrade>)));
        }
        ...
        public ApiResponse< EdFiGrade > GetGradesByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiGrade>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiGrade) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiGrade)));
        }
