...
namespace EdFi.OdsApi.Sdk.Apis.All
{
    ...
    public partial class LearningStandardsApi : ILearningStandardsApi
    {
        ...
        {
             ApiResponse<List<EdFiLearningStandard>> localVarResponse = GetLearningStandardsWithHttpInfo(offset, limit, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, courseTitle, description, id, learningStandardItemCode, _namespace, successCriteria, uri);
        ...
        public ApiResponse< List<EdFiLearningStandard> > GetLearningStandardsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string learningStandardId = null, string parentLearningStandardId = null, string learningStandardCategoryDescriptor = null, string courseTitle = null, string description = null, string id = null, string learningStandardItemCode = null, string _namespace = null, string successCriteria = null, string uri = null)
        {
            ...
            if (parentLearningStandardId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "parentLearningStandardId", parentLearningStandardId)); // query parameter
            if (learningStandardCategoryDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "learningStandardCategoryDescriptor", learningStandardCategoryDescriptor)); // query parameter
            ...
            if (learningStandardItemCode != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "learningStandardItemCode", learningStandardItemCode)); // query parameter
            ...
            return new ApiResponse<List<EdFiLearningStandard>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiLearningStandard>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiLearningStandard>)));
        }
        ...
        {
             ApiResponse<List<EdFiLearningStandard>> localVarResponse = await GetLearningStandardsAsyncWithHttpInfo(offset, limit, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, courseTitle, description, id, learningStandardItemCode, _namespace, successCriteria, uri);
             return localVarResponse.Data;
        ...
        public ApiResponse< EdFiLearningStandard > GetLearningStandardsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiLearningStandard>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiLearningStandard) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiLearningStandard)));
        }
