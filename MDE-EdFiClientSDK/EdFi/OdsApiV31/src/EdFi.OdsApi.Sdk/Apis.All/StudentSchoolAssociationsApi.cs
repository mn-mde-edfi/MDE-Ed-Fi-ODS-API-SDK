...
namespace EdFi.OdsApi.Sdk.Apis.All
{
    ...
    public partial class StudentSchoolAssociationsApi : IStudentSchoolAssociationsApi
    {
        ...
        public ApiResponse< List<EdFiStudentSchoolAssociation> > GetStudentSchoolAssociationsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, DateTime? entryDate = null, int? schoolId = null, string studentUniqueId = null, string calendarCode = null, int? schoolYear = null, int? educationOrganizationId = null, string graduationPlanTypeDescriptor = null, int? graduationSchoolYear = null, int? classOfSchoolYear = null, string entryGradeLevelReasonDescriptor = null, string entryTypeDescriptor = null, string exitWithdrawTypeDescriptor = null, string entryGradeLevelDescriptor = null, string residencyStatusDescriptor = null, bool? employedWhileEnrolled = null, DateTime? exitWithdrawDate = null, string id = null, bool? primarySchool = null, bool? repeatGradeIndicator = null, bool? schoolChoiceTransfer = null)
        {
            ...
            if (classOfSchoolYear != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "classOfSchoolYear", classOfSchoolYear)); // query parameter
            if (entryGradeLevelReasonDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "entryGradeLevelReasonDescriptor", entryGradeLevelReasonDescriptor)); // query parameter
            ...
            if (residencyStatusDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "residencyStatusDescriptor", residencyStatusDescriptor)); // query parameter
            if (employedWhileEnrolled != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "employedWhileEnrolled", employedWhileEnrolled)); // query parameter
            ...
            if (primarySchool != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "primarySchool", primarySchool)); // query parameter
            if (repeatGradeIndicator != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "repeatGradeIndicator", repeatGradeIndicator)); // query parameter
            if (schoolChoiceTransfer != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "schoolChoiceTransfer", schoolChoiceTransfer)); // query parameter
            ...
            return new ApiResponse<List<EdFiStudentSchoolAssociation>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiStudentSchoolAssociation>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiStudentSchoolAssociation>)));
        }
        ...
        public ApiResponse< EdFiStudentSchoolAssociation > GetStudentSchoolAssociationsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiStudentSchoolAssociation>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiStudentSchoolAssociation) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiStudentSchoolAssociation)));
        }
