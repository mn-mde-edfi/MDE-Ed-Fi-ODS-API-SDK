...
namespace EdFi.OdsApi.Sdk.Apis.All
{
    ...
    public partial class ParentsApi : IParentsApi
    {
        ...
        {
             ApiResponse<List<EdFiParent>> localVarResponse = GetParentsWithHttpInfo(offset, limit, totalCount, parentUniqueId, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
        ...
        public ApiResponse< List<EdFiParent> > GetParentsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string parentUniqueId = null, string sexDescriptor = null, string firstName = null, string generationCodeSuffix = null, string id = null, string lastSurname = null, string loginId = null, string maidenName = null, string middleName = null, string personalTitlePrefix = null)
        {
            ...
            return new ApiResponse<List<EdFiParent>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiParent>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiParent>)));
        }
        ...
        {
             ApiResponse<List<EdFiParent>> localVarResponse = await GetParentsAsyncWithHttpInfo(offset, limit, totalCount, parentUniqueId, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
             return localVarResponse.Data;
        ...
        public ApiResponse< EdFiParent > GetParentsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiParent>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiParent) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiParent)));
        }
