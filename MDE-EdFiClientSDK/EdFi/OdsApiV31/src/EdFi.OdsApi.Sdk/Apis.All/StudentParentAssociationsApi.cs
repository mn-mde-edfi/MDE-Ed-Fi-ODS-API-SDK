    ...
    public partial class StudentParentAssociationsApi : IStudentParentAssociationsApi
    {
        ...
        public ApiResponse< List<EdFiStudentParentAssociation> > GetStudentParentAssociationsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string parentUniqueId = null, string studentUniqueId = null, string relationDescriptor = null, int? contactPriority = null, string contactRestrictions = null, bool? emergencyContactStatus = null, string id = null, bool? livesWith = null, bool? primaryContactStatus = null)
        {
            ...
            return new ApiResponse<List<EdFiStudentParentAssociation>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiStudentParentAssociation>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiStudentParentAssociation>)));
        }
        ...
        public ApiResponse< EdFiStudentParentAssociation > GetStudentParentAssociationsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiStudentParentAssociation>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiStudentParentAssociation) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiStudentParentAssociation)));
        }
