...
namespace EdFi.OdsApi.Sdk.Apis.All
{
    ...
    public partial class SectionsApi : ISectionsApi
    {
        ...
        public ApiResponse< List<EdFiSection> > GetSectionsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string sectionIdentifier = null, string localCourseCode = null, int? schoolId = null, int? schoolYear = null, string sessionName = null, string locationClassroomIdentificationCode = null, int? locationSchoolId = null, string availableCreditTypeDescriptor = null, string educationalEnvironmentDescriptor = null, string instructionLanguageDescriptor = null, string mediumOfInstructionDescriptor = null, string populationServedDescriptor = null, double? availableCreditConversion = null, double? availableCredits = null, string id = null, int? sequenceOfCourse = null)
        {
            ...
            if (locationClassroomIdentificationCode != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "locationClassroomIdentificationCode", locationClassroomIdentificationCode)); // query parameter
            if (locationSchoolId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "locationSchoolId", locationSchoolId)); // query parameter
            if (availableCreditTypeDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "availableCreditTypeDescriptor", availableCreditTypeDescriptor)); // query parameter
            ...
            if (populationServedDescriptor != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "populationServedDescriptor", populationServedDescriptor)); // query parameter
            if (availableCreditConversion != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "availableCreditConversion", availableCreditConversion)); // query parameter
            if (availableCredits != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "availableCredits", availableCredits)); // query parameter
            ...
            return new ApiResponse<List<EdFiSection>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiSection>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiSection>)));
        }
        ...
        public ApiResponse< EdFiSection > GetSectionsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            ...
            return new ApiResponse<EdFiSection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiSection) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiSection)));
        }
