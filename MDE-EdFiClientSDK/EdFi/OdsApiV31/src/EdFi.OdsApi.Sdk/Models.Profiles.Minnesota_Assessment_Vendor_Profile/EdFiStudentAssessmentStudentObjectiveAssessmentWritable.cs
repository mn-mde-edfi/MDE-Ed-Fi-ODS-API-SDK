...
{
    /// <summary>
    /// EdFiStudentAssessmentStudentObjectiveAssessmentWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentWritable :  IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentStudentObjectiveAssessmentWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentWritable(EdFiObjectiveAssessmentReference ObjectiveAssessmentReference = default(EdFiObjectiveAssessmentReference), List<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable> PerformanceLevels = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable>), List<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable> ScoreResults = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable>), StudentAssessmentStudentObjectiveAssessmentExtensionsWritable Ext = default(StudentAssessmentStudentObjectiveAssessmentExtensionsWritable))
        {
            // to ensure "ObjectiveAssessmentReference" is required (not null)
            if (ObjectiveAssessmentReference == null)
            {
                throw new InvalidDataException("ObjectiveAssessmentReference is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ScoreResults is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelWritable> PerformanceLevels { get; set; }
        ...
        public List<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable> ScoreResults { get; set; }

        /// <summary>
        /// Gets or Sets Ext
        /// </summary>
        [DataMember(Name="_ext", EmitDefaultValue=false)]
        public StudentAssessmentStudentObjectiveAssessmentExtensionsWritable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentStudentObjectiveAssessmentWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessmentWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessmentWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessmentWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessmentWritable input)
        {
            if (input == null)
                return false;
