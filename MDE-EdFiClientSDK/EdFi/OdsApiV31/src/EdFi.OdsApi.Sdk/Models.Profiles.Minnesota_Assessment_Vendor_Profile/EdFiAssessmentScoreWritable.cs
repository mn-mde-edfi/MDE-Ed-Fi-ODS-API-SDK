...
{
    /// <summary>
    /// EdFiAssessmentScoreWritable
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentScoreWritable :  IEquatable<EdFiAssessmentScoreWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentScoreWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentScoreWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentScoreWritable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentScoreWritable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string MaximumScore = default(string), string MinimumScore = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiAssessmentScoreWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentScoreWritable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentScoreWritable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentScoreWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentScoreWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentScoreWritable input)
        {
            if (input == null)
                return false;
