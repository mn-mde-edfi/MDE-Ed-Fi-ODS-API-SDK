...
{
    /// <summary>
    /// EdFiObjectiveAssessmentWritable
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentWritable :  IEquatable<EdFiObjectiveAssessmentWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectiveAssessmentWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectiveAssessmentWritable" /> class.
        /// </summary>
        ...
        public EdFiObjectiveAssessmentWritable(string Id = default(string), string IdentificationCode = default(string), EdFiAssessmentReference AssessmentReference = default(EdFiAssessmentReference), EdFiObjectiveAssessmentReference ParentObjectiveAssessmentReference = default(EdFiObjectiveAssessmentReference), List<EdFiObjectiveAssessmentAssessmentItemWritable> AssessmentItems = default(List<EdFiObjectiveAssessmentAssessmentItemWritable>), string Description = default(string), List<EdFiObjectiveAssessmentLearningObjectiveWritable> LearningObjectives = default(List<EdFiObjectiveAssessmentLearningObjectiveWritable>), List<EdFiObjectiveAssessmentLearningStandardWritable> LearningStandards = default(List<EdFiObjectiveAssessmentLearningStandardWritable>), int? MaxRawScore = default(int?), string Nomenclature = default(string), double? PercentOfAssessment = default(double?), List<EdFiObjectiveAssessmentPerformanceLevelWritable> PerformanceLevels = default(List<EdFiObjectiveAssessmentPerformanceLevelWritable>), List<EdFiObjectiveAssessmentScoreWritable> Scores = default(List<EdFiObjectiveAssessmentScoreWritable>), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiObjectiveAssessmentWritable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("IdentificationCode is a required property for EdFiObjectiveAssessmentWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AssessmentReference is a required property for EdFiObjectiveAssessmentWritable and cannot be null");
            }
            else
            {
        ...
        public List<EdFiObjectiveAssessmentAssessmentItemWritable> AssessmentItems { get; set; }
        ...
        public List<EdFiObjectiveAssessmentLearningObjectiveWritable> LearningObjectives { get; set; }
        ...
        public List<EdFiObjectiveAssessmentLearningStandardWritable> LearningStandards { get; set; }
        ...
        public List<EdFiObjectiveAssessmentPerformanceLevelWritable> PerformanceLevels { get; set; }
        ...
        public List<EdFiObjectiveAssessmentScoreWritable> Scores { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectiveAssessmentWritable {\n");
        ...
        {
            return this.Equals(input as EdFiObjectiveAssessmentWritable);
        }

        /// <summary>
        /// Returns true if EdFiObjectiveAssessmentWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectiveAssessmentWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectiveAssessmentWritable input)
        {
            if (input == null)
                return false;
