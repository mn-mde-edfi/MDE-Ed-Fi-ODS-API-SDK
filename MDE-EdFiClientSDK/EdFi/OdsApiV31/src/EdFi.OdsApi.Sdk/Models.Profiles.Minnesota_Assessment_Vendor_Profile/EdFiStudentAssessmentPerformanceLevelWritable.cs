...
{
    /// <summary>
    /// EdFiStudentAssessmentPerformanceLevelWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentPerformanceLevelWritable :  IEquatable<EdFiStudentAssessmentPerformanceLevelWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentPerformanceLevelWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPerformanceLevelWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentPerformanceLevelWritable(string AssessmentReportingMethodDescriptor = default(string), string PerformanceLevelDescriptor = default(string), bool? PerformanceLevelMet = default(bool?))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelDescriptor is a required property for EdFiStudentAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("PerformanceLevelMet is a required property for EdFiStudentAssessmentPerformanceLevelWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentPerformanceLevelWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentPerformanceLevelWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentPerformanceLevelWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentPerformanceLevelWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentPerformanceLevelWritable input)
        {
            if (input == null)
                return false;
