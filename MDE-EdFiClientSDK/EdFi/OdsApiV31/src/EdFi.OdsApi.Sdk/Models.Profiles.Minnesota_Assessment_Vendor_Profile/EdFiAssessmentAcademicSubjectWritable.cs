...
{
    /// <summary>
    /// EdFiAssessmentAcademicSubjectWritable
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentAcademicSubjectWritable :  IEquatable<EdFiAssessmentAcademicSubjectWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentAcademicSubjectWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentAcademicSubjectWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentAcademicSubjectWritable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentAcademicSubjectWritable(string AcademicSubjectDescriptor = default(string))
        {
            // to ensure "AcademicSubjectDescriptor" is required (not null)
            if (AcademicSubjectDescriptor == null)
            {
                throw new InvalidDataException("AcademicSubjectDescriptor is a required property for EdFiAssessmentAcademicSubjectWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentAcademicSubjectWritable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentAcademicSubjectWritable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentAcademicSubjectWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentAcademicSubjectWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentAcademicSubjectWritable input)
        {
            if (input == null)
                return false;
