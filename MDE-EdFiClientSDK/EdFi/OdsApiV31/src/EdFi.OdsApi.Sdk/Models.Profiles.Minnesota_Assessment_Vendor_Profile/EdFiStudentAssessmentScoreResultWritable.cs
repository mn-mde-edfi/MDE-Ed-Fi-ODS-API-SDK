...
{
    /// <summary>
    /// EdFiStudentAssessmentScoreResultWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentScoreResultWritable :  IEquatable<EdFiStudentAssessmentScoreResultWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentScoreResultWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentScoreResultWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentScoreResultWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentScoreResultWritable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string Result = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ResultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
            ...
            if (Result == null)
            {
                throw new InvalidDataException("Result is a required property for EdFiStudentAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
                this.Result = Result;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentScoreResultWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentScoreResultWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentScoreResultWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentScoreResultWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentScoreResultWritable input)
        {
            if (input == null)
                return false;
