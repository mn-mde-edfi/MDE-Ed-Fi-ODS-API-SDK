...
{
    /// <summary>
    /// EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable :  IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable(string AssessmentReportingMethodDescriptor = default(string), string ResultDatatypeTypeDescriptor = default(string), string Result = default(string))
        {
            // to ensure "AssessmentReportingMethodDescriptor" is required (not null)
            if (AssessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("AssessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ResultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
            ...
            if (Result == null)
            {
                throw new InvalidDataException("Result is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable and cannot be null");
            }
            else
            {
                this.Result = Result;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessmentScoreResultWritable input)
        {
            if (input == null)
                return false;
