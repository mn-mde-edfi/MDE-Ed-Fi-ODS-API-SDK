...
{
    /// <summary>
    /// MnGraduationPlanReference
    /// </summary>
    [DataContract]
    public partial class MnGraduationPlanReference :  IEquatable<MnGraduationPlanReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGraduationPlanReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnGraduationPlanReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGraduationPlanReference" /> class.
        /// </summary>
        ...
        public MnGraduationPlanReference(int? EducationOrganizationId = default(int?), string GraduationPlanTypeDescriptor = default(string), int? GraduationSchoolYear = default(int?), Link Link = default(Link))
        {
            // to ensure "EducationOrganizationId" is required (not null)
            if (EducationOrganizationId == null)
            {
                throw new InvalidDataException("EducationOrganizationId is a required property for MnGraduationPlanReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("GraduationPlanTypeDescriptor is a required property for MnGraduationPlanReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("GraduationSchoolYear is a required property for MnGraduationPlanReference and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnGraduationPlanReference {\n");
        ...
        {
            return this.Equals(input as MnGraduationPlanReference);
        }

        /// <summary>
        /// Returns true if MnGraduationPlanReference instances are equal
        /// </summary>
        /// <param name="input">Instance of MnGraduationPlanReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnGraduationPlanReference input)
        {
            if (input == null)
                return false;
