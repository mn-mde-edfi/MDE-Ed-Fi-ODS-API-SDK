...
{
    /// <summary>
    /// EdFiEducationOrganizationReadable
    /// </summary>
    [DataContract]
    public partial class EdFiEducationOrganizationReadable :  IEquatable<EdFiEducationOrganizationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationOrganizationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationReadable" /> class.
        /// </summary>
        ...
        public EdFiEducationOrganizationReadable(string Id = default(string), int? EducationOrganizationId = default(int?), string NameOfInstitution = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiEducationOrganizationReadable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("EducationOrganizationId is a required property for EdFiEducationOrganizationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NameOfInstitution is a required property for EdFiEducationOrganizationReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEducationOrganizationReadable {\n");
        ...
        {
            return this.Equals(input as EdFiEducationOrganizationReadable);
        }

        /// <summary>
        /// Returns true if EdFiEducationOrganizationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationOrganizationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationOrganizationReadable input)
        {
            if (input == null)
                return false;
