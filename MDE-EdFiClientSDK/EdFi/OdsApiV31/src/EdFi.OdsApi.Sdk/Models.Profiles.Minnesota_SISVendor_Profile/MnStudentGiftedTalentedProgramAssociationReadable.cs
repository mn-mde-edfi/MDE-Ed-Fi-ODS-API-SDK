...
{
    /// <summary>
    /// MnStudentGiftedTalentedProgramAssociationReadable
    /// </summary>
    [DataContract]
    public partial class MnStudentGiftedTalentedProgramAssociationReadable :  IEquatable<MnStudentGiftedTalentedProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentGiftedTalentedProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentGiftedTalentedProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentGiftedTalentedProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudentGiftedTalentedProgramAssociationReadable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string GiftedTalentedParticipationDescriptor = default(string), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("GiftedTalentedParticipationDescriptor is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentGiftedTalentedProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentGiftedTalentedProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudentGiftedTalentedProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentGiftedTalentedProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentGiftedTalentedProgramAssociationReadable input)
        {
            if (input == null)
                return false;
