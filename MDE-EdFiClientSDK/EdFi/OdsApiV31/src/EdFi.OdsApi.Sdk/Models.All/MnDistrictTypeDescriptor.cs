...
{
    /// <summary>
    /// MnDistrictTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnDistrictTypeDescriptor :  IEquatable<MnDistrictTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDistrictTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnDistrictTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDistrictTypeDescriptor" /> class.
        /// </summary>
        ...
        public MnDistrictTypeDescriptor(string Id = default(string), int? DistrictTypeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnDistrictTypeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnDistrictTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnDistrictTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnDistrictTypeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.DistrictTypeDescriptorId = DistrictTypeDescriptorId;
        ...
        [DataMember(Name="districtTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnDistrictTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  DistrictTypeDescriptorId: ").Append(DistrictTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnDistrictTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnDistrictTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnDistrictTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnDistrictTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DistrictTypeDescriptorId == input.DistrictTypeDescriptorId ||
                    (this.DistrictTypeDescriptorId != null &&
                    this.DistrictTypeDescriptorId.Equals(input.DistrictTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DistrictTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.DistrictTypeDescriptorId.GetHashCode();
