...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseIdentificationCode :  IEquatable<EdFiCourseIdentificationCode>, IValidatableObject
    {
        ...
        public EdFiCourseIdentificationCode(string CourseIdentificationSystemDescriptor = default(string), string AssigningOrganizationIdentificationCode = default(string), string IdentificationCode = default(string))
        {
