...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationElectronicMail :  IEquatable<EdFiStudentEducationOrganizationAssociationElectronicMail>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationElectronicMail(string ElectronicMailTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), string ElectronicMailAddress = default(string), bool? PrimaryEmailAddressIndicator = default(bool?))
        {
            // to ensure "ElectronicMailTypeDescriptor" is required (not null)
            if (ElectronicMailTypeDescriptor == null)
            {
                throw new InvalidDataException("ElectronicMailTypeDescriptor is a required property for EdFiStudentEducationOrganizationAssociationElectronicMail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ElectronicMailAddress is a required property for EdFiStudentEducationOrganizationAssociationElectronicMail and cannot be null");
            }
            else
            {
