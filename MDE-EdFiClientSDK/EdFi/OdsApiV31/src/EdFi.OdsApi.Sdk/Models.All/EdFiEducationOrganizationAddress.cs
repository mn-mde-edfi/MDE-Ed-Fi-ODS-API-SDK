...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiEducationOrganizationAddress :  IEquatable<EdFiEducationOrganizationAddress>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationAddress(string AddressTypeDescriptor = default(string), string LocaleDescriptor = default(string), string StateAbbreviationDescriptor = default(string), string ApartmentRoomSuiteNumber = default(string), string BuildingSiteNumber = default(string), string City = default(string), string CongressionalDistrict = default(string), string CountyFIPSCode = default(string), bool? DoNotPublishIndicator = default(bool?), string Latitude = default(string), string Longitude = default(string), string NameOfCounty = default(string), string PostalCode = default(string), string StreetNumberName = default(string), List<EdFiEducationOrganizationAddressPeriod> Periods = default(List<EdFiEducationOrganizationAddressPeriod>))
        {
