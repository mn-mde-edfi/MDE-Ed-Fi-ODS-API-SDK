...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiParentElectronicMail :  IEquatable<EdFiParentElectronicMail>, IValidatableObject
    {
        ...
        public EdFiParentElectronicMail(string ElectronicMailTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), string ElectronicMailAddress = default(string), bool? PrimaryEmailAddressIndicator = default(bool?))
        {
