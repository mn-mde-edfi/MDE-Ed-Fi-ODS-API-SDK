...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCommunityProvider :  IEquatable<EdFiCommunityProvider>, IValidatableObject
    {
        ...
        public EdFiCommunityProvider(string Id = default(string), List<EdFiEducationOrganizationAddress> Addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiEducationOrganizationCategory> Categories = default(List<EdFiEducationOrganizationCategory>), int? CommunityProviderId = default(int?), EdFiCommunityOrganizationReference CommunityOrganizationReference = default(EdFiCommunityOrganizationReference), List<EdFiEducationOrganizationIdentificationCode> IdentificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationInstitutionTelephone> InstitutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> InternationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), bool? LicenseExemptIndicator = default(bool?), string NameOfInstitution = default(string), string OperationalStatusDescriptor = default(string), string ProviderCategoryDescriptor = default(string), string ProviderProfitabilityDescriptor = default(string), string ProviderStatusDescriptor = default(string), bool? SchoolIndicator = default(bool?), string ShortNameOfInstitution = default(string), string WebSite = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiCommunityProvider and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Addresses == null)
            {
                throw new InvalidDataException("Addresses is a required property for EdFiCommunityProvider and cannot be null");
            }
            else
            {
