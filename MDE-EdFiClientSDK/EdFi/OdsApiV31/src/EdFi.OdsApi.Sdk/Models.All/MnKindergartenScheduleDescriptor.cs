...
{
    /// <summary>
    /// MnKindergartenScheduleDescriptor
    /// </summary>
    [DataContract]
    public partial class MnKindergartenScheduleDescriptor :  IEquatable<MnKindergartenScheduleDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnKindergartenScheduleDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnKindergartenScheduleDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnKindergartenScheduleDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="KindergartenScheduleDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnKindergartenScheduleDescriptor(string Id = default(string), int? KindergartenScheduleDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnKindergartenScheduleDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnKindergartenScheduleDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnKindergartenScheduleDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnKindergartenScheduleDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.KindergartenScheduleDescriptorId = KindergartenScheduleDescriptorId;
        ...
        [DataMember(Name="kindergartenScheduleDescriptorId", EmitDefaultValue=false)]
        public int? KindergartenScheduleDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnKindergartenScheduleDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  KindergartenScheduleDescriptorId: ").Append(KindergartenScheduleDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnKindergartenScheduleDescriptor);
        }

        /// <summary>
        /// Returns true if MnKindergartenScheduleDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnKindergartenScheduleDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnKindergartenScheduleDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.KindergartenScheduleDescriptorId == input.KindergartenScheduleDescriptorId ||
                    (this.KindergartenScheduleDescriptorId != null &&
                    this.KindergartenScheduleDescriptorId.Equals(input.KindergartenScheduleDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KindergartenScheduleDescriptorId != null)
                    hashCode = hashCode * 59 + this.KindergartenScheduleDescriptorId.GetHashCode();
