...
{
    /// <summary>
    /// MnStudentSection504PlacementProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentSection504PlacementProgramAssociation :  IEquatable<MnStudentSection504PlacementProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSection504PlacementProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSection504PlacementProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSection504PlacementProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentSection504PlacementProgramAssociation(string Id = default(string), DateTime? BeginDate = default(DateTime?), EdFiEducationOrganizationReference EducationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference ProgramReference = default(EdFiProgramReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), DateTime? EndDate = default(DateTime?), string ReasonExitedDescriptor = default(string), bool? ServedOutsideOfRegularSession = default(bool?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentSection504PlacementProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentSection504PlacementProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentSection504PlacementProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentSection504PlacementProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSection504PlacementProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentSection504PlacementProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentSection504PlacementProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSection504PlacementProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSection504PlacementProgramAssociation input)
        {
            if (input == null)
                return false;
