...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiPostSecondaryInstitution :  IEquatable<EdFiPostSecondaryInstitution>, IValidatableObject
    {
        ...
        public EdFiPostSecondaryInstitution(string Id = default(string), List<EdFiEducationOrganizationAddress> Addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiEducationOrganizationCategory> Categories = default(List<EdFiEducationOrganizationCategory>), int? PostSecondaryInstitutionId = default(int?), string AdministrativeFundingControlDescriptor = default(string), List<EdFiEducationOrganizationIdentificationCode> IdentificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationInstitutionTelephone> InstitutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> InternationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), List<EdFiPostSecondaryInstitutionMediumOfInstruction> MediumOfInstructions = default(List<EdFiPostSecondaryInstitutionMediumOfInstruction>), string NameOfInstitution = default(string), string OperationalStatusDescriptor = default(string), string PostSecondaryInstitutionLevelDescriptor = default(string), string ShortNameOfInstitution = default(string), string WebSite = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiPostSecondaryInstitution and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Addresses == null)
            {
                throw new InvalidDataException("Addresses is a required property for EdFiPostSecondaryInstitution and cannot be null");
            }
            else
            {
