...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationTelephone :  IEquatable<EdFiStudentEducationOrganizationAssociationTelephone>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationTelephone(string TelephoneNumberTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string), bool? TextMessageCapabilityIndicator = default(bool?))
        {
