...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCalendarExtension :  IEquatable<MnCalendarExtension>, IValidatableObject
    {
        /// <summary>
        ...
        public MnCalendarExtension(string KindergartenScheduleDescriptor = default(string), int? InstructionalDays = default(int?), int? LengthOfDay = default(int?))
        {
