...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnSchoolClassificationDescriptor :  IEquatable<MnSchoolClassificationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolClassificationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSchoolClassificationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolClassificationDescriptor" /> class.
        /// </summary>
        ...
        public MnSchoolClassificationDescriptor(string Id = default(string), int? SchoolClassificationDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnSchoolClassificationDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnSchoolClassificationDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnSchoolClassificationDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.SchoolClassificationDescriptorId = SchoolClassificationDescriptorId;
        ...
        [DataMember(Name="schoolClassificationDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSchoolClassificationDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SchoolClassificationDescriptorId: ").Append(SchoolClassificationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnSchoolClassificationDescriptor);
        }

        /// <summary>
        /// Returns true if MnSchoolClassificationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSchoolClassificationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSchoolClassificationDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SchoolClassificationDescriptorId == input.SchoolClassificationDescriptorId ||
                    (this.SchoolClassificationDescriptorId != null &&
                    this.SchoolClassificationDescriptorId.Equals(input.SchoolClassificationDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SchoolClassificationDescriptorId != null)
                    hashCode = hashCode * 59 + this.SchoolClassificationDescriptorId.GetHashCode();
