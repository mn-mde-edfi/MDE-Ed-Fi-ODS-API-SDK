...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiActual :  IEquatable<EdFiActual>, IValidatableObject
    {
        ...
        public EdFiActual(string Id = default(string), DateTime? AsOfDate = default(DateTime?), EdFiAccountReference AccountReference = default(EdFiAccountReference), double? AmountToDate = default(double?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiActual and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (AsOfDate == null)
            {
                throw new InvalidDataException("AsOfDate is a required property for EdFiActual and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountReference is a required property for EdFiActual and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AmountToDate is a required property for EdFiActual and cannot be null");
            }
            else
            {
