...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiParent :  IEquatable<EdFiParent>, IValidatableObject
    {
        ...
        public EdFiParent(string Id = default(string), string ParentUniqueId = default(string), List<EdFiParentAddress> Addresses = default(List<EdFiParentAddress>), List<EdFiParentElectronicMail> ElectronicMails = default(List<EdFiParentElectronicMail>), string FirstName = default(string), string GenerationCodeSuffix = default(string), List<EdFiParentInternationalAddress> InternationalAddresses = default(List<EdFiParentInternationalAddress>), List<EdFiParentLanguage> Languages = default(List<EdFiParentLanguage>), string LastSurname = default(string), string LoginId = default(string), string MaidenName = default(string), string MiddleName = default(string), List<EdFiParentOtherName> OtherNames = default(List<EdFiParentOtherName>), List<EdFiParentPersonalIdentificationDocument> PersonalIdentificationDocuments = default(List<EdFiParentPersonalIdentificationDocument>), string PersonalTitlePrefix = default(string), string SexDescriptor = default(string), List<EdFiParentTelephone> Telephones = default(List<EdFiParentTelephone>), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiParent and cannot be null");
            }
            else
            {
                this.Id = Id;
