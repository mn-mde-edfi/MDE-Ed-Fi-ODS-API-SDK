...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiAccountClassificationDescriptor :  IEquatable<EdFiAccountClassificationDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAccountClassificationDescriptor(string Id = default(string), int? AccountClassificationDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EdFiAccountClassificationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAccountClassificationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAccountClassificationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAccountClassificationDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccountClassificationDescriptorId == input.AccountClassificationDescriptorId ||
                    (this.AccountClassificationDescriptorId != null &&
                    this.AccountClassificationDescriptorId.Equals(input.AccountClassificationDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccountClassificationDescriptorId != null)
                    hashCode = hashCode * 59 + this.AccountClassificationDescriptorId.GetHashCode();
