...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffTelephone :  IEquatable<EdFiStaffTelephone>, IValidatableObject
    {
        ...
        public EdFiStaffTelephone(string TelephoneNumberTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), int? OrderOfPriority = default(int?), string TelephoneNumber = default(string), bool? TextMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "TelephoneNumberTypeDescriptor" is required (not null)
            if (TelephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("TelephoneNumberTypeDescriptor is a required property for EdFiStaffTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TelephoneNumber is a required property for EdFiStaffTelephone and cannot be null");
            }
            else
            {
