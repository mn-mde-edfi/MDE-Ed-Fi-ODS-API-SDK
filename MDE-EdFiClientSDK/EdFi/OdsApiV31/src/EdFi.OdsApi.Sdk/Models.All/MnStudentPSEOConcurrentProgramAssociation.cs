...
{
    /// <summary>
    /// MnStudentPSEOConcurrentProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentPSEOConcurrentProgramAssociation :  IEquatable<MnStudentPSEOConcurrentProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOConcurrentProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentPSEOConcurrentProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOConcurrentProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentPSEOConcurrentProgramAssociation(string Id = default(string), DateTime? BeginDate = default(DateTime?), EdFiEducationOrganizationReference EducationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference ProgramReference = default(EdFiProgramReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), DateTime? EndDate = default(DateTime?), int? PseoHighSchoolHours = default(int?), string ReasonExitedDescriptor = default(string), bool? ServedOutsideOfRegularSession = default(bool?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStudentPSEOConcurrentProgramAssociation and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentPSEOConcurrentProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentPSEOConcurrentProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentPSEOConcurrentProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentPSEOConcurrentProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentPSEOConcurrentProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentPSEOConcurrentProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentPSEOConcurrentProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentPSEOConcurrentProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentPSEOConcurrentProgramAssociation input)
        {
            if (input == null)
                return false;
