...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffElectronicMail :  IEquatable<EdFiStaffElectronicMail>, IValidatableObject
    {
        ...
        public EdFiStaffElectronicMail(string ElectronicMailTypeDescriptor = default(string), bool? DoNotPublishIndicator = default(bool?), string ElectronicMailAddress = default(string), bool? PrimaryEmailAddressIndicator = default(bool?))
        {
