...
{
    /// <summary>
    /// MnStudentIndependentStudyProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentIndependentStudyProgramAssociation :  IEquatable<MnStudentIndependentStudyProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentIndependentStudyProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentIndependentStudyProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentIndependentStudyProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentIndependentStudyProgramAssociation(string Id = default(string), DateTime? BeginDate = default(DateTime?), EdFiEducationOrganizationReference EducationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference ProgramReference = default(EdFiProgramReference), EdFiStudentReference StudentReference = default(EdFiStudentReference), DateTime? EndDate = default(DateTime?), string ReasonExitedDescriptor = default(string), bool? ServedOutsideOfRegularSession = default(bool?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentIndependentStudyProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentIndependentStudyProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentIndependentStudyProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentIndependentStudyProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentIndependentStudyProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentIndependentStudyProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentIndependentStudyProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentIndependentStudyProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentIndependentStudyProgramAssociation input)
        {
            if (input == null)
                return false;
