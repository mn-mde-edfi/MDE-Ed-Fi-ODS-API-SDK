...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService :  IEquatable<EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService>, IValidatableObject
    {
        ...
        public EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService(string SpecialEducationProgramServiceDescriptor = default(string), bool? PrimaryIndicator = default(bool?), DateTime? ServiceBeginDate = default(DateTime?), DateTime? ServiceEndDate = default(DateTime?))
        {
