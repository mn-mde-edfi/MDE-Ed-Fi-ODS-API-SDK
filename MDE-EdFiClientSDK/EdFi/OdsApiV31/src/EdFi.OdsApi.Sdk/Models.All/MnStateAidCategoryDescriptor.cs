...
{
    /// <summary>
    /// MnStateAidCategoryDescriptor
    /// </summary>
    [DataContract]
    public partial class MnStateAidCategoryDescriptor :  IEquatable<MnStateAidCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStateAidCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStateAidCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStateAidCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="StateAidCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnStateAidCategoryDescriptor(string Id = default(string), int? StateAidCategoryDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStateAidCategoryDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnStateAidCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnStateAidCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnStateAidCategoryDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.StateAidCategoryDescriptorId = StateAidCategoryDescriptorId;
        ...
        [DataMember(Name="stateAidCategoryDescriptorId", EmitDefaultValue=false)]
        public int? StateAidCategoryDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStateAidCategoryDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  StateAidCategoryDescriptorId: ").Append(StateAidCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnStateAidCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if MnStateAidCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStateAidCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStateAidCategoryDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StateAidCategoryDescriptorId == input.StateAidCategoryDescriptorId ||
                    (this.StateAidCategoryDescriptorId != null &&
                    this.StateAidCategoryDescriptorId.Equals(input.StateAidCategoryDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StateAidCategoryDescriptorId != null)
                    hashCode = hashCode * 59 + this.StateAidCategoryDescriptorId.GetHashCode();
