...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnOptOutIndicatorsDescriptor :  IEquatable<MnOptOutIndicatorsDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnOptOutIndicatorsDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnOptOutIndicatorsDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnOptOutIndicatorsDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="OptOutIndicatorsDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnOptOutIndicatorsDescriptor(string Id = default(string), int? OptOutIndicatorsDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnOptOutIndicatorsDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnOptOutIndicatorsDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnOptOutIndicatorsDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnOptOutIndicatorsDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.OptOutIndicatorsDescriptorId = OptOutIndicatorsDescriptorId;
        ...
        [DataMember(Name="optOutIndicatorsDescriptorId", EmitDefaultValue=false)]
        public int? OptOutIndicatorsDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnOptOutIndicatorsDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  OptOutIndicatorsDescriptorId: ").Append(OptOutIndicatorsDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnOptOutIndicatorsDescriptor);
        }

        /// <summary>
        /// Returns true if MnOptOutIndicatorsDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnOptOutIndicatorsDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnOptOutIndicatorsDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OptOutIndicatorsDescriptorId == input.OptOutIndicatorsDescriptorId ||
                    (this.OptOutIndicatorsDescriptorId != null &&
                    this.OptOutIndicatorsDescriptorId.Equals(input.OptOutIndicatorsDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OptOutIndicatorsDescriptorId != null)
                    hashCode = hashCode * 59 + this.OptOutIndicatorsDescriptorId.GetHashCode();
