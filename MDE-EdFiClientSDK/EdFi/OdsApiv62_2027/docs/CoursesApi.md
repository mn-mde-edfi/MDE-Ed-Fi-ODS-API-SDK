# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile.CoursesApi
...
# **DeletesCourses**
> List&lt;TrackedChangesEdFiCourseReadableDelete&gt; DeletesCourses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesCoursesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCourseReadableDelete> result = apiInstance.DeletesCourses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCourseReadableDelete>> response = apiInstance.DeletesCoursesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesEdFiCourseReadableDelete&gt;**](TrackedChangesEdFiCourseReadableDelete.md)
...
<a name="getcourses"></a>
# **GetCourses**
> List&lt;EdFiCourseReadable&gt; GetCourses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? courseCode = null, int? educationOrganizationId = null, string? careerPathwayDescriptor = null, string? courseDefinedByDescriptor = null, string? courseDescription = null, string? courseTitle = null, DateTime? dateCourseAdopted = null, bool? highSchoolCourseRequirement = null, string? id = null, double? maximumAvailableCredits = null, int? numberOfParts = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class GetCoursesExample
    {
        public static void Main()
        {
            ...
            var dateCourseAdopted = DateTime.Parse("2013-10-20");  // DateTime? | Date the course was adopted by the education agency. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiCourseReadable> result = apiInstance.GetCourses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, careerPathwayDescriptor, courseDefinedByDescriptor, courseDescription, courseTitle, dateCourseAdopted, highSchoolCourseRequirement, id, maximumAvailableCredits, numberOfParts, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCourseReadable>> response = apiInstance.GetCoursesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, careerPathwayDescriptor, courseDefinedByDescriptor, courseDescription, courseTitle, dateCourseAdopted, highSchoolCourseRequirement, id, maximumAvailableCredits, numberOfParts, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.course.minnesota-twenty-six-twenty-seven-sis-vendor-profile.readable+json
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCourseReadable> response = apiInstance.GetCoursesByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a name="keychangescourses"></a>
# **KeyChangesCourses**
> List&lt;TrackedChangesEdFiCourseReadableKeyChange&gt; KeyChangesCourses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesCoursesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCourseReadableKeyChange> result = apiInstance.KeyChangesCourses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCourseReadableKeyChange>> response = apiInstance.KeyChangesCoursesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**List&lt;TrackedChangesEdFiCourseReadableKeyChange&gt;**](TrackedChangesEdFiCourseReadableKeyChange.md)
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.course.minnesota-twenty-six-twenty-seven-sis-vendor-profile.writable+json
 - **Accept**: Not defined
