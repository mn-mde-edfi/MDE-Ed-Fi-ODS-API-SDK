# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile.StudentSchoolFoodServiceProgramAssociationsApi
...
> List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableDelete&gt; DeletesStudentSchoolFoodServiceProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentSchoolFoodServiceProgramAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableDelete> result = apiInstance.DeletesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableDelete>> response = apiInstance.DeletesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableDelete&gt;**](TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableDelete.md)
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.studentschoolfoodserviceprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.readable+json
...
<a name="keychangesstudentschoolfoodserviceprogramassociations"></a>
# **KeyChangesStudentSchoolFoodServiceProgramAssociations**
> List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableKeyChange&gt; KeyChangesStudentSchoolFoodServiceProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentSchoolFoodServiceProgramAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableKeyChange> result = apiInstance.KeyChangesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableKeyChange>> response = apiInstance.KeyChangesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableKeyChange&gt;**](TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationReadableKeyChange.md)
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentschoolfoodserviceprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.writable+json
 - **Accept**: Not defined
