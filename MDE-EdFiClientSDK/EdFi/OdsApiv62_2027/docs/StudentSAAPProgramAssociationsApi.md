# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile.StudentSAAPProgramAssociationsApi
...
| [**KeyChangesStudentSAAPProgramAssociations**](StudentSAAPProgramAssociationsApi.md#keychangesstudentsaapprogramassociations) | **GET** /MN/studentSAAPProgramAssociations/keyChanges | Retrieves resources key changes based on change version. |
...
> List&lt;TrackedChangesMnStudentSAAPProgramAssociationReadableDelete&gt; DeletesStudentSAAPProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentSAAPProgramAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesMnStudentSAAPProgramAssociationReadableDelete> result = apiInstance.DeletesStudentSAAPProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesMnStudentSAAPProgramAssociationReadableDelete>> response = apiInstance.DeletesStudentSAAPProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesMnStudentSAAPProgramAssociationReadableDelete&gt;**](TrackedChangesMnStudentSAAPProgramAssociationReadableDelete.md)
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.studentsaapprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.readable+json
...
<a name="keychangesstudentsaapprogramassociations"></a>
# **KeyChangesStudentSAAPProgramAssociations**
> List&lt;TrackedChangesMnStudentSAAPProgramAssociationReadableKeyChange&gt; KeyChangesStudentSAAPProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentSAAPProgramAssociationsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesMnStudentSAAPProgramAssociationReadableKeyChange> result = apiInstance.KeyChangesStudentSAAPProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling StudentSAAPProgramAssociationsApi.KeyChangesStudentSAAPProgramAssociations: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesStudentSAAPProgramAssociationsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesMnStudentSAAPProgramAssociationReadableKeyChange>> response = apiInstance.KeyChangesStudentSAAPProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentSAAPProgramAssociationsApi.KeyChangesStudentSAAPProgramAssociationsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesMnStudentSAAPProgramAssociationReadableKeyChange&gt;**](TrackedChangesMnStudentSAAPProgramAssociationReadableKeyChange.md)
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentsaapprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.writable+json
 - **Accept**: Not defined
