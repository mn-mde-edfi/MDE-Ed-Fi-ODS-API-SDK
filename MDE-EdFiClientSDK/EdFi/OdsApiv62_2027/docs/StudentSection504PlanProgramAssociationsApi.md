# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile.StudentSection504PlanProgramAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.studentsection504planprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.readable+json
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentsection504planprogramassociation.minnesota-twenty-six-twenty-seven-sis-vendor-profile.writable+json
 - **Accept**: Not defined
