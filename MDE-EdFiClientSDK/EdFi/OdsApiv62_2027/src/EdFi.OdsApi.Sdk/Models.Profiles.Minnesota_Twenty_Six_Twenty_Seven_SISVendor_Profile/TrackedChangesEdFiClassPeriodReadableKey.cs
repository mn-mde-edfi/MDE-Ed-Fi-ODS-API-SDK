...
{
    /// <summary>
    /// TrackedChangesEdFiClassPeriodReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_classPeriod_readableKey")]
    public partial class TrackedChangesEdFiClassPeriodReadableKey : IEquatable<TrackedChangesEdFiClassPeriodReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiClassPeriodReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiClassPeriodReadableKey(string classPeriodName = default(string), int schoolId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiClassPeriodReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiClassPeriodReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiClassPeriodReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiClassPeriodReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiClassPeriodReadableKey input)
        {
            if (input == null)
            {
                return false;
