...
{
    /// <summary>
    /// TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentLanguageInstructionProgramAssociation_readableKey")]
    public partial class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey : IEquatable<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentLanguageInstructionProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
