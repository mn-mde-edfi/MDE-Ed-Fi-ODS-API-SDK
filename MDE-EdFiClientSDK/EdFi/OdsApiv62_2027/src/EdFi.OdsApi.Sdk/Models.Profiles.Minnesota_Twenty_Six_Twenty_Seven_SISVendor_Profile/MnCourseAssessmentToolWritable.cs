...
{
    /// <summary>
    /// MnCourseAssessmentToolWritable
    /// </summary>
    [DataContract(Name = "mn_courseAssessmentTool_writable")]
    public partial class MnCourseAssessmentToolWritable : IEquatable<MnCourseAssessmentToolWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseAssessmentToolWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCourseAssessmentToolWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseAssessmentToolWritable" /> class.
        /// </summary>
        ...
        public MnCourseAssessmentToolWritable(string assessmentToolDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "assessmentToolDescriptor" is required (not null)
            if (assessmentToolDescriptor == null)
            {
                throw new ArgumentNullException("assessmentToolDescriptor is a required property for MnCourseAssessmentToolWritable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCourseAssessmentToolWritable {\n");
        ...
        {
            return this.Equals(input as MnCourseAssessmentToolWritable);
        }

        /// <summary>
        /// Returns true if MnCourseAssessmentToolWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCourseAssessmentToolWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCourseAssessmentToolWritable input)
        {
            if (input == null)
            {
                return false;
