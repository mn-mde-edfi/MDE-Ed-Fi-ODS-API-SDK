...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentGiftedTalentedProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentGiftedTalentedProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
