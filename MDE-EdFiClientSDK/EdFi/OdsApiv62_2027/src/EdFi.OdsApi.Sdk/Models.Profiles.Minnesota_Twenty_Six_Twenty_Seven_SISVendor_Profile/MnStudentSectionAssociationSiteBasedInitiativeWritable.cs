...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentSectionAssociationSiteBasedInitiative_writable")]
    public partial class MnStudentSectionAssociationSiteBasedInitiativeWritable : IEquatable<MnStudentSectionAssociationSiteBasedInitiativeWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiativeWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSectionAssociationSiteBasedInitiativeWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiativeWritable" /> class.
        /// </summary>
        ...
        public MnStudentSectionAssociationSiteBasedInitiativeWritable(string siteBasedInitiativeDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "siteBasedInitiativeDescriptor" is required (not null)
            if (siteBasedInitiativeDescriptor == null)
            {
                throw new ArgumentNullException("siteBasedInitiativeDescriptor is a required property for MnStudentSectionAssociationSiteBasedInitiativeWritable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSectionAssociationSiteBasedInitiativeWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentSectionAssociationSiteBasedInitiativeWritable);
        }

        /// <summary>
        /// Returns true if MnStudentSectionAssociationSiteBasedInitiativeWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSectionAssociationSiteBasedInitiativeWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSectionAssociationSiteBasedInitiativeWritable input)
        {
            if (input == null)
            {
                return false;
