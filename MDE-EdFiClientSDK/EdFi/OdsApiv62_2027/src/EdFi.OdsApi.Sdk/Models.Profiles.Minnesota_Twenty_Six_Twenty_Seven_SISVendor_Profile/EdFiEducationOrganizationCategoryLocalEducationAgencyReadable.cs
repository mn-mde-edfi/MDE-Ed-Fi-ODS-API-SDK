...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationCategory_localEducationAgency_readable")]
    public partial class EdFiEducationOrganizationCategoryLocalEducationAgencyReadable : IEquatable<EdFiEducationOrganizationCategoryLocalEducationAgencyReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationCategoryLocalEducationAgencyReadable(string educationOrganizationCategoryDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationCategoryDescriptor is a required property for EdFiEducationOrganizationCategoryLocalEducationAgencyReadable and cannot be null");
            }
