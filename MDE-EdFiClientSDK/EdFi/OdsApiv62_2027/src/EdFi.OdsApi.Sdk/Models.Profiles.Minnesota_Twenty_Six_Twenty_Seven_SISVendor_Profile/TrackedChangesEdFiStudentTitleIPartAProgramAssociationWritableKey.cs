...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentTitleIPartAProgramAssociation_writableKey")]
    public partial class TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey : IEquatable<TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentTitleIPartAProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
