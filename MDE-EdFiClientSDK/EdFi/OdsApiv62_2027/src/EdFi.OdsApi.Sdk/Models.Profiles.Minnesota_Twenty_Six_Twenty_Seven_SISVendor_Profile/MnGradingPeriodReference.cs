...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_gradingPeriodReference")]
    public partial class MnGradingPeriodReference : IEquatable<MnGradingPeriodReference>, IValidatableObject
    {
        ...
        public MnGradingPeriodReference(string gradingPeriodDescriptor = default(string), int periodSequence = default(int), int schoolId = default(int), int schoolYear = default(int), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("gradingPeriodDescriptor is a required property for MnGradingPeriodReference and cannot be null");
            }
