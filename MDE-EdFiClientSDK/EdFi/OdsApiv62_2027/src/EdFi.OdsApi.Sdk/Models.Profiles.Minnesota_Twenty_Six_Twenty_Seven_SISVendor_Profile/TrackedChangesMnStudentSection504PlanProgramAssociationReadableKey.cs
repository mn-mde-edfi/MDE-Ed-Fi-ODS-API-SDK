...
{
    /// <summary>
    /// TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentSection504PlanProgramAssociation_readableKey")]
    public partial class TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey : IEquatable<TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentSection504PlanProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
