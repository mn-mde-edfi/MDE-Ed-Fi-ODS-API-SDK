...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentSchoolFoodServiceProgramAssociation_writable")]
    public partial class EdFiStudentSchoolFoodServiceProgramAssociationWritable : IEquatable<EdFiStudentSchoolFoodServiceProgramAssociationWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentSchoolFoodServiceProgramAssociationWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentSchoolFoodServiceProgramAssociationWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentSchoolFoodServiceProgramAssociationWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentSchoolFoodServiceProgramAssociationWritable(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), bool? directCertification = default(bool?), DateTime? endDate = default(DateTime?), List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable> schoolFoodServiceProgramServices = default(List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable>), string etag = default(string))
        {
            this.BeginDate = beginDate;
            // to ensure "educationOrganizationReference" is required (not null)
            if (educationOrganizationReference == null)
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentSchoolFoodServiceProgramAssociationWritable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for EdFiStudentSchoolFoodServiceProgramAssociationWritable and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentSchoolFoodServiceProgramAssociationWritable and cannot be null");
            }
        ...
        public List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable> SchoolFoodServiceProgramServices { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentSchoolFoodServiceProgramAssociationWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentSchoolFoodServiceProgramAssociationWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentSchoolFoodServiceProgramAssociationWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentSchoolFoodServiceProgramAssociationWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentSchoolFoodServiceProgramAssociationWritable input)
        {
            if (input == null)
            {
                return false;
