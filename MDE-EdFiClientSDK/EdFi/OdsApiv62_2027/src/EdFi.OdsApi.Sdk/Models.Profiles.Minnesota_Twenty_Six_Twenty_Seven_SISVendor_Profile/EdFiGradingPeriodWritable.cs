...
{
    /// <summary>
    /// EdFiGradingPeriodWritable
    /// </summary>
    [DataContract(Name = "edFi_gradingPeriod_writable")]
    public partial class EdFiGradingPeriodWritable : IEquatable<EdFiGradingPeriodWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradingPeriodWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradingPeriodWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradingPeriodWritable" /> class.
        /// </summary>
        ...
        public EdFiGradingPeriodWritable(string id = default(string), string gradingPeriodDescriptor = default(string), int periodSequence = default(int), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), int totalInstructionalDays = default(int), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("gradingPeriodDescriptor is a required property for EdFiGradingPeriodWritable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("schoolReference is a required property for EdFiGradingPeriodWritable and cannot be null");
            }
            this.SchoolReference = schoolReference;
            // to ensure "schoolYearTypeReference" is required (not null)
            if (schoolYearTypeReference == null)
            {
                throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiGradingPeriodWritable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiGradingPeriodWritable {\n");
        ...
        {
            return this.Equals(input as EdFiGradingPeriodWritable);
        }

        /// <summary>
        /// Returns true if EdFiGradingPeriodWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradingPeriodWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradingPeriodWritable input)
        {
            if (input == null)
            {
                return false;
