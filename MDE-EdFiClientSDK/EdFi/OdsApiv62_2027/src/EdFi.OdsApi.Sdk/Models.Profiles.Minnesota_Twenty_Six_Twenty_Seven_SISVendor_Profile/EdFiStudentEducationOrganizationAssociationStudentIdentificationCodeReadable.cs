...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationStudentIdentificationCode_readable")]
    public partial class EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable : IEquatable<EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable(string studentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            // to ensure "studentIdentificationSystemDescriptor" is required (not null)
            if (studentIdentificationSystemDescriptor == null)
            {
                throw new ArgumentNullException("studentIdentificationSystemDescriptor is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("assigningOrganizationIdentificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("identificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable input)
        {
            if (input == null)
            {
                return false;
