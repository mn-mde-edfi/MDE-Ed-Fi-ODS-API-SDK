...
{
    /// <summary>
    /// TrackedChangesMnStudentADSISProgramAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentADSISProgramAssociation_readableKey")]
    public partial class TrackedChangesMnStudentADSISProgramAssociationReadableKey : IEquatable<TrackedChangesMnStudentADSISProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentADSISProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentADSISProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentADSISProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentADSISProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentADSISProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentADSISProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
