...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_section_writableKey")]
    public partial class TrackedChangesEdFiSectionWritableKey : IEquatable<TrackedChangesEdFiSectionWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSectionWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSectionWritableKey(string sectionIdentifier = default(string), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sessionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSectionWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSectionWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSectionWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSectionWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSectionWritableKey input)
        {
            if (input == null)
            {
                return false;
