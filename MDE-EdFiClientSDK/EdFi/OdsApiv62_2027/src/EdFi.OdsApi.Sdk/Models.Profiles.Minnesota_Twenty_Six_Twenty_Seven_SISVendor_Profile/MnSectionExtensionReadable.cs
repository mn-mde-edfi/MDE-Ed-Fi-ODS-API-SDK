...
{
    /// <summary>
    /// MnSectionExtensionReadable
    /// </summary>
    [DataContract(Name = "mn_sectionExtension_readable")]
    public partial class MnSectionExtensionReadable : IEquatable<MnSectionExtensionReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSectionExtensionReadable" /> class.
        /// </summary>
        ...
        public MnSectionExtensionReadable(string instructionalDeliveryModeDescriptor = default(string), int? instructionMinutesPerTerm = default(int?))
        {
        ...
        [DataMember(Name = "instructionalDeliveryModeDescriptor", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "instructionMinutesPerTerm", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSectionExtensionReadable {\n");
        ...
        {
            return this.Equals(input as MnSectionExtensionReadable);
        }

        /// <summary>
        /// Returns true if MnSectionExtensionReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSectionExtensionReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSectionExtensionReadable input)
        {
            if (input == null)
            {
                return false;
