...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_staffSectionAssociation_writable")]
    public partial class EdFiStaffSectionAssociationWritable : IEquatable<EdFiStaffSectionAssociationWritable>, IValidatableObject
    {
        ...
        public EdFiStaffSectionAssociationWritable(string id = default(string), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiStaffReference staffReference = default(EdFiStaffReference), string classroomPositionDescriptor = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sectionReference is a required property for EdFiStaffSectionAssociationWritable and cannot be null");
            }
            this.SectionReference = sectionReference;
            // to ensure "staffReference" is required (not null)
            if (staffReference == null)
            {
                throw new ArgumentNullException("staffReference is a required property for EdFiStaffSectionAssociationWritable and cannot be null");
            }
            this.StaffReference = staffReference;
            // to ensure "classroomPositionDescriptor" is required (not null)
            if (classroomPositionDescriptor == null)
            {
                throw new ArgumentNullException("classroomPositionDescriptor is a required property for EdFiStaffSectionAssociationWritable and cannot be null");
            }
