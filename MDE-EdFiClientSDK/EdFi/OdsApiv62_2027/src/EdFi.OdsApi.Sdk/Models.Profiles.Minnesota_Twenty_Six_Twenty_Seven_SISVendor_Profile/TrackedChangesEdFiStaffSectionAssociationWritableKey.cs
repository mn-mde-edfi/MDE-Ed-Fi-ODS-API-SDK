...
{
    /// <summary>
    /// TrackedChangesEdFiStaffSectionAssociationWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffSectionAssociation_writableKey")]
    public partial class TrackedChangesEdFiStaffSectionAssociationWritableKey : IEquatable<TrackedChangesEdFiStaffSectionAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffSectionAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffSectionAssociationWritableKey(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string staffUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffSectionAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffSectionAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffSectionAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffSectionAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffSectionAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
