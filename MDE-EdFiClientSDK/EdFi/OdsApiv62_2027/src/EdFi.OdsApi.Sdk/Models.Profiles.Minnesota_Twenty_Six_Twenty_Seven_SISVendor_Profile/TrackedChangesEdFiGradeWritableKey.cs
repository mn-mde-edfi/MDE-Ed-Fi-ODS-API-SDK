...
{
    /// <summary>
    /// TrackedChangesEdFiGradeWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_grade_writableKey")]
    public partial class TrackedChangesEdFiGradeWritableKey : IEquatable<TrackedChangesEdFiGradeWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeWritableKey input)
        {
            if (input == null)
            {
                return false;
