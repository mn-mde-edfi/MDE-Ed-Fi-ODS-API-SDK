...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiGradeReadable
    /// </summary>
    [DataContract(Name = "edFi_grade_readable")]
    public partial class EdFiGradeReadable : IEquatable<EdFiGradeReadable>, IValidatableObject
    {
        ...
        public EdFiGradeReadable(string id = default(string), string gradeTypeDescriptor = default(string), EdFiGradingPeriodReference gradingPeriodReference = default(EdFiGradingPeriodReference), EdFiStudentSectionAssociationReference studentSectionAssociationReference = default(EdFiStudentSectionAssociationReference), string letterGradeEarned = default(string), string etag = default(string), GradeExtensionsReadable ext = default(GradeExtensionsReadable))
        {
            ...
            {
                throw new ArgumentNullException("gradeTypeDescriptor is a required property for EdFiGradeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("gradingPeriodReference is a required property for EdFiGradeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("studentSectionAssociationReference is a required property for EdFiGradeReadable and cannot be null");
            }
