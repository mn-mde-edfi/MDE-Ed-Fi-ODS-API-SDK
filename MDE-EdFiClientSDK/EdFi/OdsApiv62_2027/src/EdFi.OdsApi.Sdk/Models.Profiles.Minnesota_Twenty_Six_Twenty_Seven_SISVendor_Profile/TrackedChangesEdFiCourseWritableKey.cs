...
{
    /// <summary>
    /// TrackedChangesEdFiCourseWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_course_writableKey")]
    public partial class TrackedChangesEdFiCourseWritableKey : IEquatable<TrackedChangesEdFiCourseWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseWritableKey(string courseCode = default(string), int educationOrganizationId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseWritableKey input)
        {
            if (input == null)
            {
                return false;
