...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_program_readableKey")]
    public partial class TrackedChangesEdFiProgramReadableKey : IEquatable<TrackedChangesEdFiProgramReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramReadableKey(string programTypeDescriptor = default(string), string programName = default(string), int educationOrganizationId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramReadableKey input)
        {
            if (input == null)
            {
                return false;
