...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningStandard_readableKey")]
    public partial class TrackedChangesEdFiLearningStandardReadableKey : IEquatable<TrackedChangesEdFiLearningStandardReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLearningStandardReadableKey" /> class.
        /// </summary>
        /// <param name="learningStandardId">The identifier for the specific learning standard (e.g., 111.15.3.1.A)..</param>
        public TrackedChangesEdFiLearningStandardReadableKey(string learningStandardId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLearningStandardReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLearningStandardReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLearningStandardReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLearningStandardReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLearningStandardReadableKey input)
        {
            if (input == null)
            {
                return false;
