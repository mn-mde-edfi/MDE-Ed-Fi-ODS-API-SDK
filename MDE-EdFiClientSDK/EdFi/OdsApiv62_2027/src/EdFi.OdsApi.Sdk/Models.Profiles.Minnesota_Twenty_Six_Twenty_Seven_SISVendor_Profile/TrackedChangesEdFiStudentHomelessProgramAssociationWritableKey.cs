...
{
    /// <summary>
    /// TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentHomelessProgramAssociation_writableKey")]
    public partial class TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey : IEquatable<TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentHomelessProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
