...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiSectionWritable
    /// </summary>
    [DataContract(Name = "edFi_section_writable")]
    public partial class EdFiSectionWritable : IEquatable<EdFiSectionWritable>, IValidatableObject
    {
        ...
        public EdFiSectionWritable(string id = default(string), string sectionIdentifier = default(string), EdFiCourseOfferingReference courseOfferingReference = default(EdFiCourseOfferingReference), List<EdFiSectionCharacteristicWritable> characteristics = default(List<EdFiSectionCharacteristicWritable>), List<EdFiSectionClassPeriodWritable> classPeriods = default(List<EdFiSectionClassPeriodWritable>), string instructionLanguageDescriptor = default(string), string mediumOfInstructionDescriptor = default(string), int? sequenceOfCourse = default(int?), string etag = default(string), SectionExtensionsWritable ext = default(SectionExtensionsWritable))
        {
            ...
            {
                throw new ArgumentNullException("sectionIdentifier is a required property for EdFiSectionWritable and cannot be null");
            }
            this.SectionIdentifier = sectionIdentifier;
            // to ensure "courseOfferingReference" is required (not null)
            if (courseOfferingReference == null)
            {
                throw new ArgumentNullException("courseOfferingReference is a required property for EdFiSectionWritable and cannot be null");
            }
