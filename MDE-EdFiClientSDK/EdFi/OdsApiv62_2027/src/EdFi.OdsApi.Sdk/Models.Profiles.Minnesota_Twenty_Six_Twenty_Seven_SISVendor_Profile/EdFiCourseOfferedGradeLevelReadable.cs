...
{
    /// <summary>
    /// EdFiCourseOfferedGradeLevelReadable
    /// </summary>
    [DataContract(Name = "edFi_courseOfferedGradeLevel_readable")]
    public partial class EdFiCourseOfferedGradeLevelReadable : IEquatable<EdFiCourseOfferedGradeLevelReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseOfferedGradeLevelReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseOfferedGradeLevelReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseOfferedGradeLevelReadable" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels in which the course is offered. (required).</param>
        public EdFiCourseOfferedGradeLevelReadable(string gradeLevelDescriptor = default(string))
        {
            // to ensure "gradeLevelDescriptor" is required (not null)
            if (gradeLevelDescriptor == null)
            {
                throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiCourseOfferedGradeLevelReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiCourseOfferedGradeLevelReadable {\n");
        ...
        {
            return this.Equals(input as EdFiCourseOfferedGradeLevelReadable);
        }

        /// <summary>
        /// Returns true if EdFiCourseOfferedGradeLevelReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseOfferedGradeLevelReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseOfferedGradeLevelReadable input)
        {
            if (input == null)
            {
                return false;
