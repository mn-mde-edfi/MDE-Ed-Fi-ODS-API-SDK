...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationAddress_localEducationAgency_readable")]
    public partial class EdFiEducationOrganizationAddressLocalEducationAgencyReadable : IEquatable<EdFiEducationOrganizationAddressLocalEducationAgencyReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationAddressLocalEducationAgencyReadable(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string))
        {
            ...
            {
                throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiEducationOrganizationAddressLocalEducationAgencyReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiEducationOrganizationAddressLocalEducationAgencyReadable and cannot be null");
            }
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for EdFiEducationOrganizationAddressLocalEducationAgencyReadable and cannot be null");
            }
            this.City = city;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for EdFiEducationOrganizationAddressLocalEducationAgencyReadable and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "streetNumberName" is required (not null)
            if (streetNumberName == null)
            {
                throw new ArgumentNullException("streetNumberName is a required property for EdFiEducationOrganizationAddressLocalEducationAgencyReadable and cannot be null");
            }
