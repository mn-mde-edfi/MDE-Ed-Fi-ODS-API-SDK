...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiParentWritable
    /// </summary>
    [DataContract(Name = "edFi_parent_writable")]
    public partial class EdFiParentWritable : IEquatable<EdFiParentWritable>, IValidatableObject
    {
        ...
        public EdFiParentWritable(string id = default(string), string parentUniqueId = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string highestCompletedLevelOfEducationDescriptor = default(string), string lastSurname = default(string), string middleName = default(string), string sexDescriptor = default(string), string etag = default(string), ParentExtensionsWritable ext = default(ParentExtensionsWritable))
        {
            ...
            {
                throw new ArgumentNullException("parentUniqueId is a required property for EdFiParentWritable and cannot be null");
            }
            this.ParentUniqueId = parentUniqueId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for EdFiParentWritable and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastSurname" is required (not null)
            if (lastSurname == null)
            {
                throw new ArgumentNullException("lastSurname is a required property for EdFiParentWritable and cannot be null");
            }
