...
{
    /// <summary>
    /// EdFiStudentSpecialEducationProgramAssociationReadable
    /// </summary>
    [DataContract(Name = "edFi_studentSpecialEducationProgramAssociation_readable")]
    public partial class EdFiStudentSpecialEducationProgramAssociationReadable : IEquatable<EdFiStudentSpecialEducationProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentSpecialEducationProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentSpecialEducationProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentSpecialEducationProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentSpecialEducationProgramAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), List<EdFiStudentSpecialEducationProgramAssociationDisabilityReadable> disabilities = default(List<EdFiStudentSpecialEducationProgramAssociationDisabilityReadable>), DateTime? endDate = default(DateTime?), string specialEducationSettingDescriptor = default(string), string etag = default(string), StudentSpecialEducationProgramAssociationExtensionsReadable ext = default(StudentSpecialEducationProgramAssociationExtensionsReadable))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentSpecialEducationProgramAssociationReadable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for EdFiStudentSpecialEducationProgramAssociationReadable and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentSpecialEducationProgramAssociationReadable and cannot be null");
            }
        ...
        public List<EdFiStudentSpecialEducationProgramAssociationDisabilityReadable> Disabilities { get; set; }
        ...
        public StudentSpecialEducationProgramAssociationExtensionsReadable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentSpecialEducationProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentSpecialEducationProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentSpecialEducationProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentSpecialEducationProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentSpecialEducationProgramAssociationReadable input)
        {
            if (input == null)
            {
                return false;
