...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_courseCourseAssociation_readable")]
    public partial class MnCourseCourseAssociationReadable : IEquatable<MnCourseCourseAssociationReadable>, IValidatableObject
    {
        /// <summary>
        ...
        public MnCourseCourseAssociationReadable(string id = default(string), MnCourseReference courseReference = default(MnCourseReference), MnCourseReference toCourseReference = default(MnCourseReference), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("courseReference is a required property for MnCourseCourseAssociationReadable and cannot be null");
            }
            this.CourseReference = courseReference;
            // to ensure "toCourseReference" is required (not null)
            if (toCourseReference == null)
            {
                throw new ArgumentNullException("toCourseReference is a required property for MnCourseCourseAssociationReadable and cannot be null");
            }
