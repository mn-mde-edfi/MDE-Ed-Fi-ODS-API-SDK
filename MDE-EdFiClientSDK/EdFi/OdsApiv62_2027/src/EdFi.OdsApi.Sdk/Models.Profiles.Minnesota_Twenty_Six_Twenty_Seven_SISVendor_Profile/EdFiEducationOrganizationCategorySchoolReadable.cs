...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationCategory_school_readable")]
    public partial class EdFiEducationOrganizationCategorySchoolReadable : IEquatable<EdFiEducationOrganizationCategorySchoolReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationCategorySchoolReadable(string educationOrganizationCategoryDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationCategoryDescriptor is a required property for EdFiEducationOrganizationCategorySchoolReadable and cannot be null");
            }
