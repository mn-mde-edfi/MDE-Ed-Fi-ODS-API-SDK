...
{
    /// <summary>
    /// TrackedChangesEdFiCourseOfferingReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseOffering_readableKey")]
    public partial class TrackedChangesEdFiCourseOfferingReadableKey : IEquatable<TrackedChangesEdFiCourseOfferingReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseOfferingReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseOfferingReadableKey(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sessionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseOfferingReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseOfferingReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseOfferingReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseOfferingReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseOfferingReadableKey input)
        {
            if (input == null)
            {
                return false;
