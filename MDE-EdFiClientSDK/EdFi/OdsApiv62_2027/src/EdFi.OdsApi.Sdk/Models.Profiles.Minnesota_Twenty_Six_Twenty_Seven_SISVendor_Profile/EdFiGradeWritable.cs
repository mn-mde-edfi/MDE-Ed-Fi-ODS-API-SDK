...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiGradeWritable
    /// </summary>
    [DataContract(Name = "edFi_grade_writable")]
    public partial class EdFiGradeWritable : IEquatable<EdFiGradeWritable>, IValidatableObject
    {
        ...
        public EdFiGradeWritable(string id = default(string), string gradeTypeDescriptor = default(string), EdFiGradingPeriodReference gradingPeriodReference = default(EdFiGradingPeriodReference), EdFiStudentSectionAssociationReference studentSectionAssociationReference = default(EdFiStudentSectionAssociationReference), string letterGradeEarned = default(string), string etag = default(string), GradeExtensionsWritable ext = default(GradeExtensionsWritable))
        {
            ...
            {
                throw new ArgumentNullException("gradeTypeDescriptor is a required property for EdFiGradeWritable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("gradingPeriodReference is a required property for EdFiGradeWritable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("studentSectionAssociationReference is a required property for EdFiGradeWritable and cannot be null");
            }
