...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_section_readableKey")]
    public partial class TrackedChangesEdFiSectionReadableKey : IEquatable<TrackedChangesEdFiSectionReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSectionReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSectionReadableKey(string sectionIdentifier = default(string), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sessionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSectionReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSectionReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSectionReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSectionReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSectionReadableKey input)
        {
            if (input == null)
            {
                return false;
