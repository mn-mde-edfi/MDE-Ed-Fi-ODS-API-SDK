...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentEarlyChildhoodScreeningProgramAssociation_readable")]
    public partial class MnStudentEarlyChildhoodScreeningProgramAssociationReadable : IEquatable<MnStudentEarlyChildhoodScreeningProgramAssociationReadable>, IValidatableObject
    {
        ...
        protected MnStudentEarlyChildhoodScreeningProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyChildhoodScreeningProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudentEarlyChildhoodScreeningProgramAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), MnEducationOrganizationReference educationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference programReference = default(MnProgramReference), MnStudentReference studentReference = default(MnStudentReference), string earlyChildhoodScreenerDescriptor = default(string), string earlyChildhoodScreeningExitStatusDescriptor = default(string), DateTime? endDate = default(DateTime?), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for MnStudentEarlyChildhoodScreeningProgramAssociationReadable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for MnStudentEarlyChildhoodScreeningProgramAssociationReadable and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for MnStudentEarlyChildhoodScreeningProgramAssociationReadable and cannot be null");
            }
        ...
        [DataMember(Name = "earlyChildhoodScreenerDescriptor", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "earlyChildhoodScreeningExitStatusDescriptor", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEarlyChildhoodScreeningProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentEarlyChildhoodScreeningProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudentEarlyChildhoodScreeningProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEarlyChildhoodScreeningProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEarlyChildhoodScreeningProgramAssociationReadable input)
        {
            if (input == null)
            {
                return false;
