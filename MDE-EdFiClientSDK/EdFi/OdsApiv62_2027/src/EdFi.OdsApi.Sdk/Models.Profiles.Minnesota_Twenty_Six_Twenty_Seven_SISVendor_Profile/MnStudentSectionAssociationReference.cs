...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentSectionAssociationReference")]
    public partial class MnStudentSectionAssociationReference : IEquatable<MnStudentSectionAssociationReference>, IValidatableObject
    {
        ...
        public MnStudentSectionAssociationReference(DateTime beginDate = default(DateTime), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("localCourseCode is a required property for MnStudentSectionAssociationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sectionIdentifier is a required property for MnStudentSectionAssociationReference and cannot be null");
            }
            this.SectionIdentifier = sectionIdentifier;
            // to ensure "sessionName" is required (not null)
            if (sessionName == null)
            {
                throw new ArgumentNullException("sessionName is a required property for MnStudentSectionAssociationReference and cannot be null");
            }
            this.SessionName = sessionName;
            // to ensure "studentUniqueId" is required (not null)
            if (studentUniqueId == null)
            {
                throw new ArgumentNullException("studentUniqueId is a required property for MnStudentSectionAssociationReference and cannot be null");
            }
