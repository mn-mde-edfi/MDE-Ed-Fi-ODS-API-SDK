...
{
    /// <summary>
    /// TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentEducationOrganizationResponsibilityAssociation_readableKey")]
    public partial class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey : IEquatable<TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey(string responsibilityDescriptor = default(string), DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
