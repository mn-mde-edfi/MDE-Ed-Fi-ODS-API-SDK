...
{
    /// <summary>
    /// TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentEarlyChildhoodScreeningProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentEarlyChildhoodScreeningProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
