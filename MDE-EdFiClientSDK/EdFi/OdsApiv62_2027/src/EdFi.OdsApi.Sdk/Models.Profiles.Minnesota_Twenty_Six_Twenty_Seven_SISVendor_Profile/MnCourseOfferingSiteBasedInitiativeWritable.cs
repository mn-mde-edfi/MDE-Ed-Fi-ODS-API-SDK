...
{
    /// <summary>
    /// MnCourseOfferingSiteBasedInitiativeWritable
    /// </summary>
    [DataContract(Name = "mn_courseOfferingSiteBasedInitiative_writable")]
    public partial class MnCourseOfferingSiteBasedInitiativeWritable : IEquatable<MnCourseOfferingSiteBasedInitiativeWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseOfferingSiteBasedInitiativeWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCourseOfferingSiteBasedInitiativeWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseOfferingSiteBasedInitiativeWritable" /> class.
        /// </summary>
        ...
        public MnCourseOfferingSiteBasedInitiativeWritable(string siteBasedInitiativeDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "siteBasedInitiativeDescriptor" is required (not null)
            if (siteBasedInitiativeDescriptor == null)
            {
                throw new ArgumentNullException("siteBasedInitiativeDescriptor is a required property for MnCourseOfferingSiteBasedInitiativeWritable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCourseOfferingSiteBasedInitiativeWritable {\n");
        ...
        {
            return this.Equals(input as MnCourseOfferingSiteBasedInitiativeWritable);
        }

        /// <summary>
        /// Returns true if MnCourseOfferingSiteBasedInitiativeWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCourseOfferingSiteBasedInitiativeWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCourseOfferingSiteBasedInitiativeWritable input)
        {
            if (input == null)
            {
                return false;
