...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningStandard_writable")]
    public partial class EdFiLearningStandardWritable : IEquatable<EdFiLearningStandardWritable>, IValidatableObject
    {
        ...
        public EdFiLearningStandardWritable(string id = default(string), string learningStandardId = default(string), string description = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("learningStandardId is a required property for EdFiLearningStandardWritable and cannot be null");
            }
            this.LearningStandardId = learningStandardId;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for EdFiLearningStandardWritable and cannot be null");
            }
