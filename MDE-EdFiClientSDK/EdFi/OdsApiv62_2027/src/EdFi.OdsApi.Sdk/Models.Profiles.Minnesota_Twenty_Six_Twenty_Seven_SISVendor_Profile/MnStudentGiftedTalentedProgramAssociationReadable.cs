...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentGiftedTalentedProgramAssociation_readable")]
    public partial class MnStudentGiftedTalentedProgramAssociationReadable : IEquatable<MnStudentGiftedTalentedProgramAssociationReadable>, IValidatableObject
    {
        ...
        public MnStudentGiftedTalentedProgramAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), MnEducationOrganizationReference educationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference programReference = default(MnProgramReference), MnStudentReference studentReference = default(MnStudentReference), DateTime? endDate = default(DateTime?), string giftedTalentedParticipationDescriptor = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
            this.StudentReference = studentReference;
            // to ensure "giftedTalentedParticipationDescriptor" is required (not null)
            if (giftedTalentedParticipationDescriptor == null)
            {
                throw new ArgumentNullException("giftedTalentedParticipationDescriptor is a required property for MnStudentGiftedTalentedProgramAssociationReadable and cannot be null");
            }
