...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// MnProgramReference
    /// </summary>
    [DataContract(Name = "mn_programReference")]
    public partial class MnProgramReference : IEquatable<MnProgramReference>, IValidatableObject
    {
        ...
        public MnProgramReference(int educationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), Link link = default(Link))
        {
            ...
            if (programName == null)
            {
                throw new ArgumentNullException("programName is a required property for MnProgramReference and cannot be null");
            }
            this.ProgramName = programName;
            // to ensure "programTypeDescriptor" is required (not null)
            if (programTypeDescriptor == null)
            {
                throw new ArgumentNullException("programTypeDescriptor is a required property for MnProgramReference and cannot be null");
            }
