...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentSchoolAssociationMembership_readable")]
    public partial class MnStudentSchoolAssociationMembershipReadable : IEquatable<MnStudentSchoolAssociationMembershipReadable>, IValidatableObject
    {
        ...
        public MnStudentSchoolAssociationMembershipReadable(string membershipAttendanceUnitDescriptor = default(string), double attendance = default(double), int membership = default(int), int percentEnrolled = default(int))
        {
            ...
            {
                throw new ArgumentNullException("membershipAttendanceUnitDescriptor is a required property for MnStudentSchoolAssociationMembershipReadable and cannot be null");
            }
