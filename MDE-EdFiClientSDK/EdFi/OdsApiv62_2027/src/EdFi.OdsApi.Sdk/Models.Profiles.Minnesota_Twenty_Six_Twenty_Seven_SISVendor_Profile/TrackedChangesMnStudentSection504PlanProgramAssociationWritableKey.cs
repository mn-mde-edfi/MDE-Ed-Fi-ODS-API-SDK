...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentSection504PlanProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentSection504PlanProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
