...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_courseOfferingInstructionalApproach_readable")]
    public partial class MnCourseOfferingInstructionalApproachReadable : IEquatable<MnCourseOfferingInstructionalApproachReadable>, IValidatableObject
    {
        ...
        public MnCourseOfferingInstructionalApproachReadable(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("instructionalApproachDescriptor is a required property for MnCourseOfferingInstructionalApproachReadable and cannot be null");
            }
