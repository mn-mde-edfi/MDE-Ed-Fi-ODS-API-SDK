...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseIdentificationCode_readable")]
    public partial class EdFiCourseIdentificationCodeReadable : IEquatable<EdFiCourseIdentificationCodeReadable>, IValidatableObject
    {
        ...
        public EdFiCourseIdentificationCodeReadable(string courseIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new ArgumentNullException("courseIdentificationSystemDescriptor is a required property for EdFiCourseIdentificationCodeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("identificationCode is a required property for EdFiCourseIdentificationCodeReadable and cannot be null");
            }
