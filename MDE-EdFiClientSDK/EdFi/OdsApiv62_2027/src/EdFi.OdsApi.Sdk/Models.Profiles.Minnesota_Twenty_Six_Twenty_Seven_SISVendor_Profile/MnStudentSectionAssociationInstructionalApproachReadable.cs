...
{
    /// <summary>
    /// MnStudentSectionAssociationInstructionalApproachReadable
    /// </summary>
    [DataContract(Name = "mn_studentSectionAssociationInstructionalApproach_readable")]
    public partial class MnStudentSectionAssociationInstructionalApproachReadable : IEquatable<MnStudentSectionAssociationInstructionalApproachReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationInstructionalApproachReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSectionAssociationInstructionalApproachReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationInstructionalApproachReadable" /> class.
        /// </summary>
        ...
        public MnStudentSectionAssociationInstructionalApproachReadable(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "instructionalApproachDescriptor" is required (not null)
            if (instructionalApproachDescriptor == null)
            {
                throw new ArgumentNullException("instructionalApproachDescriptor is a required property for MnStudentSectionAssociationInstructionalApproachReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSectionAssociationInstructionalApproachReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentSectionAssociationInstructionalApproachReadable);
        }

        /// <summary>
        /// Returns true if MnStudentSectionAssociationInstructionalApproachReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSectionAssociationInstructionalApproachReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSectionAssociationInstructionalApproachReadable input)
        {
            if (input == null)
            {
                return false;
