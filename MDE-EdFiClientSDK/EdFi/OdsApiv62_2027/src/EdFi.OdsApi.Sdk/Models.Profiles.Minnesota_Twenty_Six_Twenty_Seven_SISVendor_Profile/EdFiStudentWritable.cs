...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiStudentWritable
    /// </summary>
    [DataContract(Name = "edFi_student_writable")]
    public partial class EdFiStudentWritable : IEquatable<EdFiStudentWritable>, IValidatableObject
    {
        ...
        public EdFiStudentWritable(string id = default(string), string studentUniqueId = default(string), DateTime birthDate = default(DateTime), string birthSexDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentWritable and cannot be null");
            }
            ...
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for EdFiStudentWritable and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastSurname" is required (not null)
            if (lastSurname == null)
            {
                throw new ArgumentNullException("lastSurname is a required property for EdFiStudentWritable and cannot be null");
            }
