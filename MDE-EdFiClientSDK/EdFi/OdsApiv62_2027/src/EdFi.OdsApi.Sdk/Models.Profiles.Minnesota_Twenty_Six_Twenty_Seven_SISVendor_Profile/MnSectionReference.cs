...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// MnSectionReference
    /// </summary>
    [DataContract(Name = "mn_sectionReference")]
    public partial class MnSectionReference : IEquatable<MnSectionReference>, IValidatableObject
    {
        ...
        public MnSectionReference(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("localCourseCode is a required property for MnSectionReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sectionIdentifier is a required property for MnSectionReference and cannot be null");
            }
            this.SectionIdentifier = sectionIdentifier;
            // to ensure "sessionName" is required (not null)
            if (sessionName == null)
            {
                throw new ArgumentNullException("sessionName is a required property for MnSectionReference and cannot be null");
            }
