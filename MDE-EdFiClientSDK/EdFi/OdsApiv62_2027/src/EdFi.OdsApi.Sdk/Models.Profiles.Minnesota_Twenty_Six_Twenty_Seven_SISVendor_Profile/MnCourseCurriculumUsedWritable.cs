...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_courseCurriculumUsed_writable")]
    public partial class MnCourseCurriculumUsedWritable : IEquatable<MnCourseCurriculumUsedWritable>, IValidatableObject
    {
        ...
        public MnCourseCurriculumUsedWritable(string curriculumUsedDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("curriculumUsedDescriptor is a required property for MnCourseCurriculumUsedWritable and cannot be null");
            }
