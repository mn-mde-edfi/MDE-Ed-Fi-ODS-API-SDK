...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_courseProgram_readable")]
    public partial class MnCourseProgramReadable : IEquatable<MnCourseProgramReadable>, IValidatableObject
    {
        ...
        public MnCourseProgramReadable(EdFiProgramReference programReference = default(EdFiProgramReference))
        {
            ...
            {
                throw new ArgumentNullException("programReference is a required property for MnCourseProgramReadable and cannot be null");
            }
