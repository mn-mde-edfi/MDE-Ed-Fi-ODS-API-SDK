...
{
    /// <summary>
    /// MnStudentSectionAssociationSiteBasedInitiativeReadable
    /// </summary>
    [DataContract(Name = "mn_studentSectionAssociationSiteBasedInitiative_readable")]
    public partial class MnStudentSectionAssociationSiteBasedInitiativeReadable : IEquatable<MnStudentSectionAssociationSiteBasedInitiativeReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiativeReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSectionAssociationSiteBasedInitiativeReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiativeReadable" /> class.
        /// </summary>
        ...
        public MnStudentSectionAssociationSiteBasedInitiativeReadable(string siteBasedInitiativeDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "siteBasedInitiativeDescriptor" is required (not null)
            if (siteBasedInitiativeDescriptor == null)
            {
                throw new ArgumentNullException("siteBasedInitiativeDescriptor is a required property for MnStudentSectionAssociationSiteBasedInitiativeReadable and cannot be null");
            }
        ...
        [DataMember(Name = "implementationStatusDescriptor", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSectionAssociationSiteBasedInitiativeReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentSectionAssociationSiteBasedInitiativeReadable);
        }

        /// <summary>
        /// Returns true if MnStudentSectionAssociationSiteBasedInitiativeReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSectionAssociationSiteBasedInitiativeReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSectionAssociationSiteBasedInitiativeReadable input)
        {
            if (input == null)
            {
                return false;
