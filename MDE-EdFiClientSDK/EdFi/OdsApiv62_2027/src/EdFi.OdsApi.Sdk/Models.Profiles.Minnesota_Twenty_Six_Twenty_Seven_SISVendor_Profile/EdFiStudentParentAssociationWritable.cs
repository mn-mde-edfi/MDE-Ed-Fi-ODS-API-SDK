...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentParentAssociation_writable")]
    public partial class EdFiStudentParentAssociationWritable : IEquatable<EdFiStudentParentAssociationWritable>, IValidatableObject
    {
        ...
        public EdFiStudentParentAssociationWritable(string id = default(string), EdFiParentReference parentReference = default(EdFiParentReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string relationDescriptor = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("parentReference is a required property for EdFiStudentParentAssociationWritable and cannot be null");
            }
            this.ParentReference = parentReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentParentAssociationWritable and cannot be null");
            }
