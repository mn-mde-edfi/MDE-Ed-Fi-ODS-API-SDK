...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentSchoolAssociationExtension_readable")]
    public partial class MnStudentSchoolAssociationExtensionReadable : IEquatable<MnStudentSchoolAssociationExtensionReadable>, IValidatableObject
    {
        ...
        [DataMember(Name = "specialEducationEvaluationStatusDescriptor", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "stateAidCategoryDescriptor", EmitDefaultValue = true)]
