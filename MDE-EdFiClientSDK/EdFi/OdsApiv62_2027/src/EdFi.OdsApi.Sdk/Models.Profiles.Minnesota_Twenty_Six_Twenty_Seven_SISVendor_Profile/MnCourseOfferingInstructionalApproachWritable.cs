...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_courseOfferingInstructionalApproach_writable")]
    public partial class MnCourseOfferingInstructionalApproachWritable : IEquatable<MnCourseOfferingInstructionalApproachWritable>, IValidatableObject
    {
        ...
        public MnCourseOfferingInstructionalApproachWritable(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("instructionalApproachDescriptor is a required property for MnCourseOfferingInstructionalApproachWritable and cannot be null");
            }
