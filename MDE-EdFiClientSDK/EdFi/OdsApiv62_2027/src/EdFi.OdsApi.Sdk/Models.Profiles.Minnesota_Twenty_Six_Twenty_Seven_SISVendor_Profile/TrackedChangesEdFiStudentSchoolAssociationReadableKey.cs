...
{
    /// <summary>
    /// TrackedChangesEdFiStudentSchoolAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentSchoolAssociation_readableKey")]
    public partial class TrackedChangesEdFiStudentSchoolAssociationReadableKey : IEquatable<TrackedChangesEdFiStudentSchoolAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentSchoolAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentSchoolAssociationReadableKey(DateTime entryDate = default(DateTime), int schoolId = default(int), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentSchoolAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSchoolAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSchoolAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSchoolAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSchoolAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
