...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentPSEOConcurrentProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentPSEOConcurrentProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
