...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// EdFiStaffReadable
    /// </summary>
    [DataContract(Name = "edFi_staff_readable")]
    public partial class EdFiStaffReadable : IEquatable<EdFiStaffReadable>, IValidatableObject
    {
        ...
        public EdFiStaffReadable(string id = default(string), string staffUniqueId = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("staffUniqueId is a required property for EdFiStaffReadable and cannot be null");
            }
            this.StaffUniqueId = staffUniqueId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for EdFiStaffReadable and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastSurname" is required (not null)
            if (lastSurname == null)
            {
                throw new ArgumentNullException("lastSurname is a required property for EdFiStaffReadable and cannot be null");
            }
