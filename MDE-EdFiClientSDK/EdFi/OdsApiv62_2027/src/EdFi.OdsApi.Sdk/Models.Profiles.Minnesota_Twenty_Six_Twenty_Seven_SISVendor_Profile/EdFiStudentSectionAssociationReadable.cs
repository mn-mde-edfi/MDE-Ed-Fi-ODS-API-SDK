...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentSectionAssociation_readable")]
    public partial class EdFiStudentSectionAssociationReadable : IEquatable<EdFiStudentSectionAssociationReadable>, IValidatableObject
    {
        ...
        public EdFiStudentSectionAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), string etag = default(string), StudentSectionAssociationExtensionsReadable ext = default(StudentSectionAssociationExtensionsReadable))
        {
            this.BeginDate = beginDate;
            // to ensure "sectionReference" is required (not null)
            if (sectionReference == null)
            {
                throw new ArgumentNullException("sectionReference is a required property for EdFiStudentSectionAssociationReadable and cannot be null");
            }
            this.SectionReference = sectionReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentSectionAssociationReadable and cannot be null");
            }
