...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentSchoolAssociationTransportation_writable")]
    public partial class MnStudentSchoolAssociationTransportationWritable : IEquatable<MnStudentSchoolAssociationTransportationWritable>, IValidatableObject
    {
        ...
        public MnStudentSchoolAssociationTransportationWritable(string transportationCategoryDescriptor = default(string), EdFiLocalEducationAgencyReference transportingLocalEducationAgencyReference = default(EdFiLocalEducationAgencyReference))
        {
            ...
            {
                throw new ArgumentNullException("transportationCategoryDescriptor is a required property for MnStudentSchoolAssociationTransportationWritable and cannot be null");
            }
