...
{
    /// <summary>
    /// TrackedChangesEdFiGradingPeriodReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradingPeriod_readableKey")]
    public partial class TrackedChangesEdFiGradingPeriodReadableKey : IEquatable<TrackedChangesEdFiGradingPeriodReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradingPeriodReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradingPeriodReadableKey(string gradingPeriodDescriptor = default(string), int periodSequence = default(int), int schoolId = default(int), int schoolYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradingPeriodReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradingPeriodReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradingPeriodReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradingPeriodReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradingPeriodReadableKey input)
        {
            if (input == null)
            {
                return false;
