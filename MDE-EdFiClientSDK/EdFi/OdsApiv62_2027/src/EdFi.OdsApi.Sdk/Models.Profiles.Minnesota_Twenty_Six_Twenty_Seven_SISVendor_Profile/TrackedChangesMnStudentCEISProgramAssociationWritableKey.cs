...
{
    /// <summary>
    /// TrackedChangesMnStudentCEISProgramAssociationWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentCEISProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudentCEISProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudentCEISProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentCEISProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentCEISProgramAssociationWritableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentCEISProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentCEISProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentCEISProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentCEISProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentCEISProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
