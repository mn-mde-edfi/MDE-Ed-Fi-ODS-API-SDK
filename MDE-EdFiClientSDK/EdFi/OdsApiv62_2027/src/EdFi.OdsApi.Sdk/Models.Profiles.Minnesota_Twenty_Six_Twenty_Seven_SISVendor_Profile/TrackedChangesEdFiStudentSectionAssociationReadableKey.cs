...
{
    /// <summary>
    /// TrackedChangesEdFiStudentSectionAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentSectionAssociation_readableKey")]
    public partial class TrackedChangesEdFiStudentSectionAssociationReadableKey : IEquatable<TrackedChangesEdFiStudentSectionAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentSectionAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentSectionAssociationReadableKey(DateTime beginDate = default(DateTime), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentSectionAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSectionAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSectionAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSectionAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSectionAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
