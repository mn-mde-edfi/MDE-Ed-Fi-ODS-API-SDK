...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_student21stCenturyLearningCenterGrantProgramAssociation_readable")]
    public partial class MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable : IEquatable<MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), MnEducationOrganizationReference educationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference programReference = default(MnProgramReference), MnStudentReference studentReference = default(MnStudentReference), int? attendanceDays = default(int?), double? attendanceHours = default(double?), DateTime? endDate = default(DateTime?), string etag = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudent21stCenturyLearningCenterGrantProgramAssociationReadable input)
        {
            if (input == null)
            {
                return false;
