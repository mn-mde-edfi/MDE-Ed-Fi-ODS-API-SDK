...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendar_readableKey")]
    public partial class TrackedChangesEdFiCalendarReadableKey : IEquatable<TrackedChangesEdFiCalendarReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCalendarReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCalendarReadableKey(string calendarCode = default(string), int schoolId = default(int), int schoolYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCalendarReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarReadableKey input)
        {
            if (input == null)
            {
                return false;
