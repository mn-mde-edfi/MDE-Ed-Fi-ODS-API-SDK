...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_classPeriod_writable")]
    public partial class EdFiClassPeriodWritable : IEquatable<EdFiClassPeriodWritable>, IValidatableObject
    {
        ...
        public EdFiClassPeriodWritable(string id = default(string), string classPeriodName = default(string), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), List<EdFiClassPeriodMeetingTimeWritable> meetingTimes = default(List<EdFiClassPeriodMeetingTimeWritable>), string etag = default(string), ClassPeriodExtensionsWritable ext = default(ClassPeriodExtensionsWritable))
        {
            ...
            {
                throw new ArgumentNullException("classPeriodName is a required property for EdFiClassPeriodWritable and cannot be null");
            }
            this.ClassPeriodName = classPeriodName;
            // to ensure "schoolReference" is required (not null)
            if (schoolReference == null)
            {
                throw new ArgumentNullException("schoolReference is a required property for EdFiClassPeriodWritable and cannot be null");
            }
