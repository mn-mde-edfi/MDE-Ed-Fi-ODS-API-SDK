...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_session_writableKey")]
    public partial class TrackedChangesEdFiSessionWritableKey : IEquatable<TrackedChangesEdFiSessionWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSessionWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSessionWritableKey(string sessionName = default(string), int schoolId = default(int), int schoolYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSessionWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSessionWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSessionWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSessionWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSessionWritableKey input)
        {
            if (input == null)
            {
                return false;
