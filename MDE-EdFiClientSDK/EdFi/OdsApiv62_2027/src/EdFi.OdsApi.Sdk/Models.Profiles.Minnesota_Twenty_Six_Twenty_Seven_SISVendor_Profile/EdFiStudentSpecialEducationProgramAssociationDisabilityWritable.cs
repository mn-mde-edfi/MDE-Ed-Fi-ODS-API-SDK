...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentSpecialEducationProgramAssociationDisability_writable")]
    public partial class EdFiStudentSpecialEducationProgramAssociationDisabilityWritable : IEquatable<EdFiStudentSpecialEducationProgramAssociationDisabilityWritable>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentSpecialEducationProgramAssociationDisabilityWritable(string disabilityDescriptor = default(string), int? orderOfDisability = default(int?))
        {
            ...
            {
                throw new ArgumentNullException("disabilityDescriptor is a required property for EdFiStudentSpecialEducationProgramAssociationDisabilityWritable and cannot be null");
            }
