...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentSpecialEducationProgramAssociationDisability_readable")]
    public partial class EdFiStudentSpecialEducationProgramAssociationDisabilityReadable : IEquatable<EdFiStudentSpecialEducationProgramAssociationDisabilityReadable>, IValidatableObject
    {
        ...
        public EdFiStudentSpecialEducationProgramAssociationDisabilityReadable(string disabilityDescriptor = default(string), int? orderOfDisability = default(int?))
        {
            ...
            {
                throw new ArgumentNullException("disabilityDescriptor is a required property for EdFiStudentSpecialEducationProgramAssociationDisabilityReadable and cannot be null");
            }
