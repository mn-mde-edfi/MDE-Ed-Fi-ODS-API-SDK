...
{
    /// <summary>
    /// TrackedChangesEdFiCourseOfferingWritableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseOffering_writableKey")]
    public partial class TrackedChangesEdFiCourseOfferingWritableKey : IEquatable<TrackedChangesEdFiCourseOfferingWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseOfferingWritableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseOfferingWritableKey(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sessionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseOfferingWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseOfferingWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseOfferingWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseOfferingWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseOfferingWritableKey input)
        {
            if (input == null)
            {
                return false;
