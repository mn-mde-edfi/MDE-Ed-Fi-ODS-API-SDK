...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_calendarExtension_readable")]
    public partial class MnCalendarExtensionReadable : IEquatable<MnCalendarExtensionReadable>, IValidatableObject
    {
        ...
        [DataMember(Name = "kindergartenScheduleDescriptor", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "instructionalDays", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "lengthOfDay", EmitDefaultValue = true)]
