...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentSAAPProgramAssociation_readableKey")]
    public partial class TrackedChangesMnStudentSAAPProgramAssociationReadableKey : IEquatable<TrackedChangesMnStudentSAAPProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentSAAPProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStudentSAAPProgramAssociationReadableKey(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentSAAPProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentSAAPProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentSAAPProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentSAAPProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentSAAPProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
