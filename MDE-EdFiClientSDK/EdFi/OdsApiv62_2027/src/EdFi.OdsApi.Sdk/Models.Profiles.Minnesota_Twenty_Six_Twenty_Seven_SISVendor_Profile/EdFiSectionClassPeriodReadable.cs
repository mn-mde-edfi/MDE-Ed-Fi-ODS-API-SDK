...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_sectionClassPeriod_readable")]
    public partial class EdFiSectionClassPeriodReadable : IEquatable<EdFiSectionClassPeriodReadable>, IValidatableObject
    {
        ...
        public EdFiSectionClassPeriodReadable(EdFiClassPeriodReference classPeriodReference = default(EdFiClassPeriodReference))
        {
            ...
            {
                throw new ArgumentNullException("classPeriodReference is a required property for EdFiSectionClassPeriodReadable and cannot be null");
            }
