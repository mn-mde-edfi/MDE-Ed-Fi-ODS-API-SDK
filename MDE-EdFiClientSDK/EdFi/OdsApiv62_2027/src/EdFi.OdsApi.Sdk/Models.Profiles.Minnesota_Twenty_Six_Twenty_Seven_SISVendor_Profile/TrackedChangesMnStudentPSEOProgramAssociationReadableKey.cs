...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_studentPSEOProgramAssociation_readableKey")]
    public partial class TrackedChangesMnStudentPSEOProgramAssociationReadableKey : IEquatable<TrackedChangesMnStudentPSEOProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudentPSEOProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudentPSEOProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudentPSEOProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudentPSEOProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudentPSEOProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudentPSEOProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
