...
{
    /// <summary>
    /// TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_student21stCenturyLearningCenterGrantProgramAssociation_readableKey")]
    public partial class TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey : IEquatable<TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationReadableKey input)
        {
            if (input == null)
            {
                return false;
