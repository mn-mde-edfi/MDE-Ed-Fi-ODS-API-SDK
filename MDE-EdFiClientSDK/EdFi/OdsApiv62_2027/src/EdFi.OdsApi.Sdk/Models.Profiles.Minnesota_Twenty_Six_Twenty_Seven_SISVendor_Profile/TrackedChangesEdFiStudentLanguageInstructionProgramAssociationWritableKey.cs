...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentLanguageInstructionProgramAssociation_writableKey")]
    public partial class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey : IEquatable<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentLanguageInstructionProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
