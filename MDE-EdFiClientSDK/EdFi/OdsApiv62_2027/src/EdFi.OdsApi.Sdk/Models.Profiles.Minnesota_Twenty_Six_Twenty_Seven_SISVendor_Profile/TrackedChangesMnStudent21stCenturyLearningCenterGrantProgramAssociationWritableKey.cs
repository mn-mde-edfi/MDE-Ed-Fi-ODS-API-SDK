...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_student21stCenturyLearningCenterGrantProgramAssociation_writableKey")]
    public partial class TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey : IEquatable<TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStudent21stCenturyLearningCenterGrantProgramAssociationWritableKey input)
        {
            if (input == null)
            {
                return false;
