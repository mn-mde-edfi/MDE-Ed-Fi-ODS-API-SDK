...
{
    /// <summary>
    /// EdFiStudentEducationOrganizationResponsibilityAssociationReadable
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationResponsibilityAssociation_readable")]
    public partial class EdFiStudentEducationOrganizationResponsibilityAssociationReadable : IEquatable<EdFiStudentEducationOrganizationResponsibilityAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationResponsibilityAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentEducationOrganizationResponsibilityAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationResponsibilityAssociationReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentEducationOrganizationResponsibilityAssociationReadable(string id = default(string), DateTime beginDate = default(DateTime), string responsibilityDescriptor = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), string etag = default(string), StudentEducationOrganizationResponsibilityAssociationExtensionsReadable ext = default(StudentEducationOrganizationResponsibilityAssociationExtensionsReadable))
        {
            this.BeginDate = beginDate;
            // to ensure "responsibilityDescriptor" is required (not null)
            if (responsibilityDescriptor == null)
            {
                throw new ArgumentNullException("responsibilityDescriptor is a required property for EdFiStudentEducationOrganizationResponsibilityAssociationReadable and cannot be null");
            }
            this.ResponsibilityDescriptor = responsibilityDescriptor;
            // to ensure "educationOrganizationReference" is required (not null)
            if (educationOrganizationReference == null)
            {
                throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentEducationOrganizationResponsibilityAssociationReadable and cannot be null");
            }
            this.EducationOrganizationReference = educationOrganizationReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentEducationOrganizationResponsibilityAssociationReadable and cannot be null");
            }
        ...
        public StudentEducationOrganizationResponsibilityAssociationExtensionsReadable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentEducationOrganizationResponsibilityAssociationReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentEducationOrganizationResponsibilityAssociationReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentEducationOrganizationResponsibilityAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentEducationOrganizationResponsibilityAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentEducationOrganizationResponsibilityAssociationReadable input)
        {
            if (input == null)
            {
                return false;
