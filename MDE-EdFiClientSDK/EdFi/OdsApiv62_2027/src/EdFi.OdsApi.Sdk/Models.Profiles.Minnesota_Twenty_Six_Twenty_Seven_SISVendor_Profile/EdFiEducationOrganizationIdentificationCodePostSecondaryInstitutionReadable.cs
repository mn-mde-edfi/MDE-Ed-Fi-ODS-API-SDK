...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationIdentificationCode_postSecondaryInstitution_readable")]
    public partial class EdFiEducationOrganizationIdentificationCodePostSecondaryInstitutionReadable : IEquatable<EdFiEducationOrganizationIdentificationCodePostSecondaryInstitutionReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationIdentificationCodePostSecondaryInstitutionReadable(string educationOrganizationIdentificationSystemDescriptor = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new ArgumentNullException("educationOrganizationIdentificationSystemDescriptor is a required property for EdFiEducationOrganizationIdentificationCodePostSecondaryInstitutionReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("identificationCode is a required property for EdFiEducationOrganizationIdentificationCodePostSecondaryInstitutionReadable and cannot be null");
            }
