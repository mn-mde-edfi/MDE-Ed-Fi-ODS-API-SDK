...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Six_Twenty_Seven_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentEarlyEducationProgramAssociationFundingSource_writable")]
    public partial class MnStudentEarlyEducationProgramAssociationFundingSourceWritable : IEquatable<MnStudentEarlyEducationProgramAssociationFundingSourceWritable>, IValidatableObject
    {
        ...
        public MnStudentEarlyEducationProgramAssociationFundingSourceWritable(string fundingSourceDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("fundingSourceDescriptor is a required property for MnStudentEarlyEducationProgramAssociationFundingSourceWritable and cannot be null");
            }
