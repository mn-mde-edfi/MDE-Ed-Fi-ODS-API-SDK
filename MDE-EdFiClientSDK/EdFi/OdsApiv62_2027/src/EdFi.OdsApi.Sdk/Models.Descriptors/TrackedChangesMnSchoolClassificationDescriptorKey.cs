...
{
    /// <summary>
    /// TrackedChangesMnSchoolClassificationDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_schoolClassificationDescriptorKey")]
    public partial class TrackedChangesMnSchoolClassificationDescriptorKey : IEquatable<TrackedChangesMnSchoolClassificationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnSchoolClassificationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnSchoolClassificationDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnSchoolClassificationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnSchoolClassificationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnSchoolClassificationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnSchoolClassificationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnSchoolClassificationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
