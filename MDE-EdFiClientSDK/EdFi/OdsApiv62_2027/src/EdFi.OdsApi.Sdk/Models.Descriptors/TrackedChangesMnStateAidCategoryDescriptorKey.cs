...
{
    /// <summary>
    /// TrackedChangesMnStateAidCategoryDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_stateAidCategoryDescriptorKey")]
    public partial class TrackedChangesMnStateAidCategoryDescriptorKey : IEquatable<TrackedChangesMnStateAidCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStateAidCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStateAidCategoryDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStateAidCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStateAidCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStateAidCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStateAidCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStateAidCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
