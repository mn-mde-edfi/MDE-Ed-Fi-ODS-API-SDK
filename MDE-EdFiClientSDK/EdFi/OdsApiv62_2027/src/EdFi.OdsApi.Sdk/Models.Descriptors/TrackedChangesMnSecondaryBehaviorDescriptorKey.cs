...
{
    /// <summary>
    /// TrackedChangesMnSecondaryBehaviorDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_secondaryBehaviorDescriptorKey")]
    public partial class TrackedChangesMnSecondaryBehaviorDescriptorKey : IEquatable<TrackedChangesMnSecondaryBehaviorDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnSecondaryBehaviorDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnSecondaryBehaviorDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnSecondaryBehaviorDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnSecondaryBehaviorDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnSecondaryBehaviorDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnSecondaryBehaviorDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnSecondaryBehaviorDescriptorKey input)
        {
            if (input == null)
            {
                return false;
