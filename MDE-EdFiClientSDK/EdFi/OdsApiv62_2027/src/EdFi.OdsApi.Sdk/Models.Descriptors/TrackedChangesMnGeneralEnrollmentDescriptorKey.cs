...
{
    /// <summary>
    /// TrackedChangesMnGeneralEnrollmentDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_generalEnrollmentDescriptorKey")]
    public partial class TrackedChangesMnGeneralEnrollmentDescriptorKey : IEquatable<TrackedChangesMnGeneralEnrollmentDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnGeneralEnrollmentDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnGeneralEnrollmentDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnGeneralEnrollmentDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnGeneralEnrollmentDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnGeneralEnrollmentDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnGeneralEnrollmentDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnGeneralEnrollmentDescriptorKey input)
        {
            if (input == null)
            {
                return false;
