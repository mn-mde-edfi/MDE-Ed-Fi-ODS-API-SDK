...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_instructionalDeliveryModeDescriptorKey")]
    public partial class TrackedChangesMnInstructionalDeliveryModeDescriptorKey : IEquatable<TrackedChangesMnInstructionalDeliveryModeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnInstructionalDeliveryModeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnInstructionalDeliveryModeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnInstructionalDeliveryModeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnInstructionalDeliveryModeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnInstructionalDeliveryModeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnInstructionalDeliveryModeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnInstructionalDeliveryModeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
