...
{
    /// <summary>
    /// TrackedChangesMnOperationalPassageDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_operationalPassageDescriptorKey")]
    public partial class TrackedChangesMnOperationalPassageDescriptorKey : IEquatable<TrackedChangesMnOperationalPassageDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnOperationalPassageDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnOperationalPassageDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnOperationalPassageDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnOperationalPassageDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnOperationalPassageDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnOperationalPassageDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnOperationalPassageDescriptorKey input)
        {
            if (input == null)
            {
                return false;
