...
{
    /// <summary>
    /// TrackedChangesMnPrecodeTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_precodeTypeDescriptorKey")]
    public partial class TrackedChangesMnPrecodeTypeDescriptorKey : IEquatable<TrackedChangesMnPrecodeTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnPrecodeTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnPrecodeTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnPrecodeTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnPrecodeTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnPrecodeTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnPrecodeTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnPrecodeTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
