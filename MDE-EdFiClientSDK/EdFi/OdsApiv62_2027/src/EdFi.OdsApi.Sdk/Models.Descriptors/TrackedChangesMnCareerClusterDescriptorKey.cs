...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_careerClusterDescriptorKey")]
    public partial class TrackedChangesMnCareerClusterDescriptorKey : IEquatable<TrackedChangesMnCareerClusterDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnCareerClusterDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnCareerClusterDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnCareerClusterDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnCareerClusterDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnCareerClusterDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnCareerClusterDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnCareerClusterDescriptorKey input)
        {
            if (input == null)
            {
                return false;
