...
{
    /// <summary>
    /// TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_earlyChildhoodScreeningExitStatusDescriptorKey")]
    public partial class TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey : IEquatable<TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnEarlyChildhoodScreeningExitStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
