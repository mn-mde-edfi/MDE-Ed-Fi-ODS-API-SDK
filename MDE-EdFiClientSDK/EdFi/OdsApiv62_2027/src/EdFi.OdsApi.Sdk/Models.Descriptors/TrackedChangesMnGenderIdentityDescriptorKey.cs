...
{
    /// <summary>
    /// TrackedChangesMnGenderIdentityDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_genderIdentityDescriptorKey")]
    public partial class TrackedChangesMnGenderIdentityDescriptorKey : IEquatable<TrackedChangesMnGenderIdentityDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnGenderIdentityDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnGenderIdentityDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnGenderIdentityDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnGenderIdentityDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnGenderIdentityDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnGenderIdentityDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnGenderIdentityDescriptorKey input)
        {
            if (input == null)
            {
                return false;
