...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_transportationCategoryDescriptorKey")]
    public partial class TrackedChangesMnTransportationCategoryDescriptorKey : IEquatable<TrackedChangesMnTransportationCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnTransportationCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnTransportationCategoryDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnTransportationCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnTransportationCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnTransportationCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnTransportationCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnTransportationCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
