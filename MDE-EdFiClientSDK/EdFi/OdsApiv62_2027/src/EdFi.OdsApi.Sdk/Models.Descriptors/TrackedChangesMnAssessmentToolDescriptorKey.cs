...
{
    /// <summary>
    /// TrackedChangesMnAssessmentToolDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_assessmentToolDescriptorKey")]
    public partial class TrackedChangesMnAssessmentToolDescriptorKey : IEquatable<TrackedChangesMnAssessmentToolDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAssessmentToolDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAssessmentToolDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAssessmentToolDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAssessmentToolDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAssessmentToolDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAssessmentToolDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAssessmentToolDescriptorKey input)
        {
            if (input == null)
            {
                return false;
