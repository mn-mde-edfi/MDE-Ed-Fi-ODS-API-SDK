...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_optOutIndicatorsDescriptorKey")]
    public partial class TrackedChangesMnOptOutIndicatorsDescriptorKey : IEquatable<TrackedChangesMnOptOutIndicatorsDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnOptOutIndicatorsDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnOptOutIndicatorsDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnOptOutIndicatorsDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnOptOutIndicatorsDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnOptOutIndicatorsDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnOptOutIndicatorsDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnOptOutIndicatorsDescriptorKey input)
        {
            if (input == null)
            {
                return false;
