...
{
    /// <summary>
    /// TrackedChangesMnCrisisEventDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_crisisEventDescriptorKey")]
    public partial class TrackedChangesMnCrisisEventDescriptorKey : IEquatable<TrackedChangesMnCrisisEventDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnCrisisEventDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnCrisisEventDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnCrisisEventDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnCrisisEventDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnCrisisEventDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnCrisisEventDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnCrisisEventDescriptorKey input)
        {
            if (input == null)
            {
                return false;
