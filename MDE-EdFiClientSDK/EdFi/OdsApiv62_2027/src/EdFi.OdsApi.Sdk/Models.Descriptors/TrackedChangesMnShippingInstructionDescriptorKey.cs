...
{
    /// <summary>
    /// TrackedChangesMnShippingInstructionDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_shippingInstructionDescriptorKey")]
    public partial class TrackedChangesMnShippingInstructionDescriptorKey : IEquatable<TrackedChangesMnShippingInstructionDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnShippingInstructionDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnShippingInstructionDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnShippingInstructionDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnShippingInstructionDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnShippingInstructionDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnShippingInstructionDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnShippingInstructionDescriptorKey input)
        {
            if (input == null)
            {
                return false;
