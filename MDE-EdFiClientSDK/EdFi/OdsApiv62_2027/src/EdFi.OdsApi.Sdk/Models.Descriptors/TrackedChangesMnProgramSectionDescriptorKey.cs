...
{
    /// <summary>
    /// TrackedChangesMnProgramSectionDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_programSectionDescriptorKey")]
    public partial class TrackedChangesMnProgramSectionDescriptorKey : IEquatable<TrackedChangesMnProgramSectionDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnProgramSectionDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnProgramSectionDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnProgramSectionDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnProgramSectionDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnProgramSectionDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnProgramSectionDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnProgramSectionDescriptorKey input)
        {
            if (input == null)
            {
                return false;
