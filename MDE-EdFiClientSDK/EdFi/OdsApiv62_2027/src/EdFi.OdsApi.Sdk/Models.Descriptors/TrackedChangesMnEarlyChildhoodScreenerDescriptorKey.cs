...
{
    /// <summary>
    /// TrackedChangesMnEarlyChildhoodScreenerDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_earlyChildhoodScreenerDescriptorKey")]
    public partial class TrackedChangesMnEarlyChildhoodScreenerDescriptorKey : IEquatable<TrackedChangesMnEarlyChildhoodScreenerDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnEarlyChildhoodScreenerDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnEarlyChildhoodScreenerDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnEarlyChildhoodScreenerDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnEarlyChildhoodScreenerDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnEarlyChildhoodScreenerDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnEarlyChildhoodScreenerDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnEarlyChildhoodScreenerDescriptorKey input)
        {
            if (input == null)
            {
                return false;
