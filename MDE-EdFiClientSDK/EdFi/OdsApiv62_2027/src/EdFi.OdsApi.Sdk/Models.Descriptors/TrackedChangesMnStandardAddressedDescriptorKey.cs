...
{
    /// <summary>
    /// TrackedChangesMnStandardAddressedDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_standardAddressedDescriptorKey")]
    public partial class TrackedChangesMnStandardAddressedDescriptorKey : IEquatable<TrackedChangesMnStandardAddressedDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnStandardAddressedDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnStandardAddressedDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnStandardAddressedDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnStandardAddressedDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnStandardAddressedDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnStandardAddressedDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnStandardAddressedDescriptorKey input)
        {
            if (input == null)
            {
                return false;
