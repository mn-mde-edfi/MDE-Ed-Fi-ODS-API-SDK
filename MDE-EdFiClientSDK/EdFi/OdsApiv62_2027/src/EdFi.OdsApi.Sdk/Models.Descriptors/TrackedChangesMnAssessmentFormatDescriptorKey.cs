...
{
    /// <summary>
    /// TrackedChangesMnAssessmentFormatDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_assessmentFormatDescriptorKey")]
    public partial class TrackedChangesMnAssessmentFormatDescriptorKey : IEquatable<TrackedChangesMnAssessmentFormatDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnAssessmentFormatDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnAssessmentFormatDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnAssessmentFormatDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnAssessmentFormatDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnAssessmentFormatDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnAssessmentFormatDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnAssessmentFormatDescriptorKey input)
        {
            if (input == null)
            {
                return false;
