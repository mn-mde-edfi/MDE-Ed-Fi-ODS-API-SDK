...
{
    /// <summary>
    /// TrackedChangesMnTimeOfIncidentDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_timeOfIncidentDescriptorKey")]
    public partial class TrackedChangesMnTimeOfIncidentDescriptorKey : IEquatable<TrackedChangesMnTimeOfIncidentDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnTimeOfIncidentDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnTimeOfIncidentDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnTimeOfIncidentDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnTimeOfIncidentDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnTimeOfIncidentDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnTimeOfIncidentDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnTimeOfIncidentDescriptorKey input)
        {
            if (input == null)
            {
                return false;
