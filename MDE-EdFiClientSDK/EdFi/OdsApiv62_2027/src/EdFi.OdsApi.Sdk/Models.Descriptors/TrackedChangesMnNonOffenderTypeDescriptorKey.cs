...
{
    /// <summary>
    /// TrackedChangesMnNonOffenderTypeDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_mn_nonOffenderTypeDescriptorKey")]
    public partial class TrackedChangesMnNonOffenderTypeDescriptorKey : IEquatable<TrackedChangesMnNonOffenderTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesMnNonOffenderTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesMnNonOffenderTypeDescriptorKey(string codeValue = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesMnNonOffenderTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesMnNonOffenderTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesMnNonOffenderTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesMnNonOffenderTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesMnNonOffenderTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
