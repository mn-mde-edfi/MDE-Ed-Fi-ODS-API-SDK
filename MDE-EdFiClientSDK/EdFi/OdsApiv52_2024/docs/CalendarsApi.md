# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile.CalendarsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.calendar.minnesota-twenty-three-twenty-four-sis-vendor-profile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.calendar.minnesota-twenty-three-twenty-four-sis-vendor-profile.readable+json
