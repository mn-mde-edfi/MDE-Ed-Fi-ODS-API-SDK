...
{
    /// <summary>
    /// MnStudentEarlyEducationProgramAssociationMembershipWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentEarlyEducationProgramAssociationMembershipWritable :  IEquatable<MnStudentEarlyEducationProgramAssociationMembershipWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociationMembershipWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEarlyEducationProgramAssociationMembershipWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociationMembershipWritable" /> class.
        /// </summary>
        ...
        public MnStudentEarlyEducationProgramAssociationMembershipWritable(string membershipAttendanceUnitDescriptor = default(string), double? attendance = default(double?), int? membership = default(int?), int? percentEnrolled = default(int?))
        {
            // to ensure "membershipAttendanceUnitDescriptor" is required (not null)
            if (membershipAttendanceUnitDescriptor == null)
            {
                throw new InvalidDataException("membershipAttendanceUnitDescriptor is a required property for MnStudentEarlyEducationProgramAssociationMembershipWritable and cannot be null");
            }
            else
            {
            ...
            if (attendance == null)
            {
                throw new InvalidDataException("attendance is a required property for MnStudentEarlyEducationProgramAssociationMembershipWritable and cannot be null");
            }
            else
            {
            ...
            if (membership == null)
            {
                throw new InvalidDataException("membership is a required property for MnStudentEarlyEducationProgramAssociationMembershipWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("percentEnrolled is a required property for MnStudentEarlyEducationProgramAssociationMembershipWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEarlyEducationProgramAssociationMembershipWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentEarlyEducationProgramAssociationMembershipWritable);
        }

        /// <summary>
        /// Returns true if MnStudentEarlyEducationProgramAssociationMembershipWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEarlyEducationProgramAssociationMembershipWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEarlyEducationProgramAssociationMembershipWritable input)
        {
            if (input == null)
                return false;
