...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentEarlyEducationProgramAssociationMembershipReadable :  IEquatable<MnStudentEarlyEducationProgramAssociationMembershipReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociationMembershipReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEarlyEducationProgramAssociationMembershipReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociationMembershipReadable" /> class.
        /// </summary>
        ...
        public MnStudentEarlyEducationProgramAssociationMembershipReadable(string membershipAttendanceUnitDescriptor = default(string), double? attendance = default(double?), int? membership = default(int?), int? percentEnrolled = default(int?))
        {
            // to ensure "membershipAttendanceUnitDescriptor" is required (not null)
            if (membershipAttendanceUnitDescriptor == null)
            {
                throw new InvalidDataException("membershipAttendanceUnitDescriptor is a required property for MnStudentEarlyEducationProgramAssociationMembershipReadable and cannot be null");
            }
            else
            {
            ...
            if (attendance == null)
            {
                throw new InvalidDataException("attendance is a required property for MnStudentEarlyEducationProgramAssociationMembershipReadable and cannot be null");
            }
            else
            {
            ...
            if (membership == null)
            {
                throw new InvalidDataException("membership is a required property for MnStudentEarlyEducationProgramAssociationMembershipReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("percentEnrolled is a required property for MnStudentEarlyEducationProgramAssociationMembershipReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEarlyEducationProgramAssociationMembershipReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentEarlyEducationProgramAssociationMembershipReadable);
        }

        /// <summary>
        /// Returns true if MnStudentEarlyEducationProgramAssociationMembershipReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEarlyEducationProgramAssociationMembershipReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEarlyEducationProgramAssociationMembershipReadable input)
        {
            if (input == null)
                return false;
