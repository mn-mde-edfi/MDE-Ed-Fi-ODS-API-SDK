...
{
    /// <summary>
    /// MnTimeOfIncidentDescriptor
    /// </summary>
    [DataContract]
    public partial class MnTimeOfIncidentDescriptor :  IEquatable<MnTimeOfIncidentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnTimeOfIncidentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnTimeOfIncidentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnTimeOfIncidentDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="timeOfIncidentDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnTimeOfIncidentDescriptor(string id = default(string), int? timeOfIncidentDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnTimeOfIncidentDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnTimeOfIncidentDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.TimeOfIncidentDescriptorId = timeOfIncidentDescriptorId;
        ...
        [DataMember(Name="timeOfIncidentDescriptorId", EmitDefaultValue=false)]
        public int? TimeOfIncidentDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnTimeOfIncidentDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  TimeOfIncidentDescriptorId: ").Append(TimeOfIncidentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnTimeOfIncidentDescriptor);
        }

        /// <summary>
        /// Returns true if MnTimeOfIncidentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnTimeOfIncidentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnTimeOfIncidentDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TimeOfIncidentDescriptorId == input.TimeOfIncidentDescriptorId ||
                    (this.TimeOfIncidentDescriptorId != null &&
                    this.TimeOfIncidentDescriptorId.Equals(input.TimeOfIncidentDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TimeOfIncidentDescriptorId != null)
                    hashCode = hashCode * 59 + this.TimeOfIncidentDescriptorId.GetHashCode();
