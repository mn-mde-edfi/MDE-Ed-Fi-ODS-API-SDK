...
{
    /// <summary>
    /// MnCostToPropertyDescriptor
    /// </summary>
    [DataContract]
    public partial class MnCostToPropertyDescriptor :  IEquatable<MnCostToPropertyDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCostToPropertyDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCostToPropertyDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCostToPropertyDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="costToPropertyDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnCostToPropertyDescriptor(string id = default(string), int? costToPropertyDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnCostToPropertyDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnCostToPropertyDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnCostToPropertyDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CostToPropertyDescriptorId = costToPropertyDescriptorId;
        ...
        [DataMember(Name="costToPropertyDescriptorId", EmitDefaultValue=false)]
        public int? CostToPropertyDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCostToPropertyDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CostToPropertyDescriptorId: ").Append(CostToPropertyDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnCostToPropertyDescriptor);
        }

        /// <summary>
        /// Returns true if MnCostToPropertyDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCostToPropertyDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCostToPropertyDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CostToPropertyDescriptorId == input.CostToPropertyDescriptorId ||
                    (this.CostToPropertyDescriptorId != null &&
                    this.CostToPropertyDescriptorId.Equals(input.CostToPropertyDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CostToPropertyDescriptorId != null)
                    hashCode = hashCode * 59 + this.CostToPropertyDescriptorId.GetHashCode();
