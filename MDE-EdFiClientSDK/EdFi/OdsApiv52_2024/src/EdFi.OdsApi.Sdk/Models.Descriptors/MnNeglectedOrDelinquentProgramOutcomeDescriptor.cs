...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnNeglectedOrDelinquentProgramOutcomeDescriptor :  IEquatable<MnNeglectedOrDelinquentProgramOutcomeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnNeglectedOrDelinquentProgramOutcomeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnNeglectedOrDelinquentProgramOutcomeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnNeglectedOrDelinquentProgramOutcomeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="neglectedOrDelinquentProgramOutcomeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnNeglectedOrDelinquentProgramOutcomeDescriptor(string id = default(string), int? neglectedOrDelinquentProgramOutcomeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnNeglectedOrDelinquentProgramOutcomeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnNeglectedOrDelinquentProgramOutcomeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnNeglectedOrDelinquentProgramOutcomeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.NeglectedOrDelinquentProgramOutcomeDescriptorId = neglectedOrDelinquentProgramOutcomeDescriptorId;
        ...
        [DataMember(Name="neglectedOrDelinquentProgramOutcomeDescriptorId", EmitDefaultValue=false)]
        public int? NeglectedOrDelinquentProgramOutcomeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnNeglectedOrDelinquentProgramOutcomeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  NeglectedOrDelinquentProgramOutcomeDescriptorId: ").Append(NeglectedOrDelinquentProgramOutcomeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnNeglectedOrDelinquentProgramOutcomeDescriptor);
        }

        /// <summary>
        /// Returns true if MnNeglectedOrDelinquentProgramOutcomeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnNeglectedOrDelinquentProgramOutcomeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnNeglectedOrDelinquentProgramOutcomeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NeglectedOrDelinquentProgramOutcomeDescriptorId == input.NeglectedOrDelinquentProgramOutcomeDescriptorId ||
                    (this.NeglectedOrDelinquentProgramOutcomeDescriptorId != null &&
                    this.NeglectedOrDelinquentProgramOutcomeDescriptorId.Equals(input.NeglectedOrDelinquentProgramOutcomeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NeglectedOrDelinquentProgramOutcomeDescriptorId != null)
                    hashCode = hashCode * 59 + this.NeglectedOrDelinquentProgramOutcomeDescriptorId.GetHashCode();
