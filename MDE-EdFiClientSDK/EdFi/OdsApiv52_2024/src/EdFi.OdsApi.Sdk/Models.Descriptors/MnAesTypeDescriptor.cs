...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnAesTypeDescriptor :  IEquatable<MnAesTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAesTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAesTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAesTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="aesTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAesTypeDescriptor(string id = default(string), int? aesTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnAesTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnAesTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnAesTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.AesTypeDescriptorId = aesTypeDescriptorId;
        ...
        [DataMember(Name="aesTypeDescriptorId", EmitDefaultValue=false)]
        public int? AesTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAesTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AesTypeDescriptorId: ").Append(AesTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAesTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnAesTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAesTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAesTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AesTypeDescriptorId == input.AesTypeDescriptorId ||
                    (this.AesTypeDescriptorId != null &&
                    this.AesTypeDescriptorId.Equals(input.AesTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AesTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.AesTypeDescriptorId.GetHashCode();
