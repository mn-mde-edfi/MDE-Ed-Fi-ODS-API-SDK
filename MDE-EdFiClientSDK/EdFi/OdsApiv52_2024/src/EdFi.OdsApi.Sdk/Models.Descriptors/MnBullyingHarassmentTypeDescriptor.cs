...
{
    /// <summary>
    /// MnBullyingHarassmentTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnBullyingHarassmentTypeDescriptor :  IEquatable<MnBullyingHarassmentTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnBullyingHarassmentTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnBullyingHarassmentTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnBullyingHarassmentTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="bullyingHarassmentTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnBullyingHarassmentTypeDescriptor(string id = default(string), int? bullyingHarassmentTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnBullyingHarassmentTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnBullyingHarassmentTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.BullyingHarassmentTypeDescriptorId = bullyingHarassmentTypeDescriptorId;
        ...
        [DataMember(Name="bullyingHarassmentTypeDescriptorId", EmitDefaultValue=false)]
        public int? BullyingHarassmentTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnBullyingHarassmentTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  BullyingHarassmentTypeDescriptorId: ").Append(BullyingHarassmentTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnBullyingHarassmentTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnBullyingHarassmentTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnBullyingHarassmentTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnBullyingHarassmentTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BullyingHarassmentTypeDescriptorId == input.BullyingHarassmentTypeDescriptorId ||
                    (this.BullyingHarassmentTypeDescriptorId != null &&
                    this.BullyingHarassmentTypeDescriptorId.Equals(input.BullyingHarassmentTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BullyingHarassmentTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.BullyingHarassmentTypeDescriptorId.GetHashCode();
