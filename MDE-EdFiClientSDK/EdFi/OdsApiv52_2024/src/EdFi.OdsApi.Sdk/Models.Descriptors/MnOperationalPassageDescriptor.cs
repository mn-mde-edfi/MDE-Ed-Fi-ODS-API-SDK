...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnOperationalPassageDescriptor :  IEquatable<MnOperationalPassageDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnOperationalPassageDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnOperationalPassageDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnOperationalPassageDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="operationalPassageDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnOperationalPassageDescriptor(string id = default(string), int? operationalPassageDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnOperationalPassageDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnOperationalPassageDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnOperationalPassageDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.OperationalPassageDescriptorId = operationalPassageDescriptorId;
        ...
        [DataMember(Name="operationalPassageDescriptorId", EmitDefaultValue=false)]
        public int? OperationalPassageDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnOperationalPassageDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  OperationalPassageDescriptorId: ").Append(OperationalPassageDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnOperationalPassageDescriptor);
        }

        /// <summary>
        /// Returns true if MnOperationalPassageDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnOperationalPassageDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnOperationalPassageDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OperationalPassageDescriptorId == input.OperationalPassageDescriptorId ||
                    (this.OperationalPassageDescriptorId != null &&
                    this.OperationalPassageDescriptorId.Equals(input.OperationalPassageDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OperationalPassageDescriptorId != null)
                    hashCode = hashCode * 59 + this.OperationalPassageDescriptorId.GetHashCode();
