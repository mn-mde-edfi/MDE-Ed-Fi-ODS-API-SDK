...
{
    /// <summary>
    /// MnCostToVictimDescriptor
    /// </summary>
    [DataContract]
    public partial class MnCostToVictimDescriptor :  IEquatable<MnCostToVictimDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCostToVictimDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCostToVictimDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCostToVictimDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="costToVictimDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnCostToVictimDescriptor(string id = default(string), int? costToVictimDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnCostToVictimDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnCostToVictimDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnCostToVictimDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CostToVictimDescriptorId = costToVictimDescriptorId;
        ...
        [DataMember(Name="costToVictimDescriptorId", EmitDefaultValue=false)]
        public int? CostToVictimDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCostToVictimDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CostToVictimDescriptorId: ").Append(CostToVictimDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnCostToVictimDescriptor);
        }

        /// <summary>
        /// Returns true if MnCostToVictimDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCostToVictimDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCostToVictimDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CostToVictimDescriptorId == input.CostToVictimDescriptorId ||
                    (this.CostToVictimDescriptorId != null &&
                    this.CostToVictimDescriptorId.Equals(input.CostToVictimDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CostToVictimDescriptorId != null)
                    hashCode = hashCode * 59 + this.CostToVictimDescriptorId.GetHashCode();
