...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnSecondaryBehaviorDescriptor :  IEquatable<MnSecondaryBehaviorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSecondaryBehaviorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSecondaryBehaviorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSecondaryBehaviorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="secondaryBehaviorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnSecondaryBehaviorDescriptor(string id = default(string), int? secondaryBehaviorDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnSecondaryBehaviorDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnSecondaryBehaviorDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnSecondaryBehaviorDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.SecondaryBehaviorDescriptorId = secondaryBehaviorDescriptorId;
        ...
        [DataMember(Name="secondaryBehaviorDescriptorId", EmitDefaultValue=false)]
        public int? SecondaryBehaviorDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSecondaryBehaviorDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SecondaryBehaviorDescriptorId: ").Append(SecondaryBehaviorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnSecondaryBehaviorDescriptor);
        }

        /// <summary>
        /// Returns true if MnSecondaryBehaviorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSecondaryBehaviorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSecondaryBehaviorDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SecondaryBehaviorDescriptorId == input.SecondaryBehaviorDescriptorId ||
                    (this.SecondaryBehaviorDescriptorId != null &&
                    this.SecondaryBehaviorDescriptorId.Equals(input.SecondaryBehaviorDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SecondaryBehaviorDescriptorId != null)
                    hashCode = hashCode * 59 + this.SecondaryBehaviorDescriptorId.GetHashCode();
