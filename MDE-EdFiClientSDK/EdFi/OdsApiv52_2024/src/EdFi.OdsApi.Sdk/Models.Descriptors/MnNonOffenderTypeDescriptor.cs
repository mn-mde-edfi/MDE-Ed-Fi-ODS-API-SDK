...
{
    /// <summary>
    /// MnNonOffenderTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnNonOffenderTypeDescriptor :  IEquatable<MnNonOffenderTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnNonOffenderTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnNonOffenderTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnNonOffenderTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="nonOffenderTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnNonOffenderTypeDescriptor(string id = default(string), int? nonOffenderTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnNonOffenderTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnNonOffenderTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnNonOffenderTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.NonOffenderTypeDescriptorId = nonOffenderTypeDescriptorId;
        ...
        [DataMember(Name="nonOffenderTypeDescriptorId", EmitDefaultValue=false)]
        public int? NonOffenderTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnNonOffenderTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  NonOffenderTypeDescriptorId: ").Append(NonOffenderTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnNonOffenderTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnNonOffenderTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnNonOffenderTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnNonOffenderTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NonOffenderTypeDescriptorId == input.NonOffenderTypeDescriptorId ||
                    (this.NonOffenderTypeDescriptorId != null &&
                    this.NonOffenderTypeDescriptorId.Equals(input.NonOffenderTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NonOffenderTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.NonOffenderTypeDescriptorId.GetHashCode();
