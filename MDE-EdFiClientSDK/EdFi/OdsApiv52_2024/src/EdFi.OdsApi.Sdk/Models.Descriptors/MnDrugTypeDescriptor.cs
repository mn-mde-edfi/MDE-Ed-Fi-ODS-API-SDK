...
{
    /// <summary>
    /// MnDrugTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnDrugTypeDescriptor :  IEquatable<MnDrugTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDrugTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnDrugTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDrugTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="drugTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnDrugTypeDescriptor(string id = default(string), int? drugTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnDrugTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnDrugTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnDrugTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.DrugTypeDescriptorId = drugTypeDescriptorId;
        ...
        [DataMember(Name="drugTypeDescriptorId", EmitDefaultValue=false)]
        public int? DrugTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnDrugTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  DrugTypeDescriptorId: ").Append(DrugTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnDrugTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnDrugTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnDrugTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnDrugTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DrugTypeDescriptorId == input.DrugTypeDescriptorId ||
                    (this.DrugTypeDescriptorId != null &&
                    this.DrugTypeDescriptorId.Equals(input.DrugTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DrugTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.DrugTypeDescriptorId.GetHashCode();
