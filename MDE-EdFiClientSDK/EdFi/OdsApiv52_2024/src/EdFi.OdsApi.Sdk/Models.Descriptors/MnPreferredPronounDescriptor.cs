...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnPreferredPronounDescriptor :  IEquatable<MnPreferredPronounDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnPreferredPronounDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnPreferredPronounDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnPreferredPronounDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="preferredPronounDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnPreferredPronounDescriptor(string id = default(string), int? preferredPronounDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnPreferredPronounDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnPreferredPronounDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.PreferredPronounDescriptorId = preferredPronounDescriptorId;
        ...
        [DataMember(Name="preferredPronounDescriptorId", EmitDefaultValue=false)]
        public int? PreferredPronounDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnPreferredPronounDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PreferredPronounDescriptorId: ").Append(PreferredPronounDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnPreferredPronounDescriptor);
        }

        /// <summary>
        /// Returns true if MnPreferredPronounDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnPreferredPronounDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnPreferredPronounDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PreferredPronounDescriptorId == input.PreferredPronounDescriptorId ||
                    (this.PreferredPronounDescriptorId != null &&
                    this.PreferredPronounDescriptorId.Equals(input.PreferredPronounDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreferredPronounDescriptorId != null)
                    hashCode = hashCode * 59 + this.PreferredPronounDescriptorId.GetHashCode();
