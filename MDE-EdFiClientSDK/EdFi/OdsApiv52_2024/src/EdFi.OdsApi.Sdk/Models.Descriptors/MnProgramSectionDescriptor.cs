...
{
    /// <summary>
    /// MnProgramSectionDescriptor
    /// </summary>
    [DataContract]
    public partial class MnProgramSectionDescriptor :  IEquatable<MnProgramSectionDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnProgramSectionDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnProgramSectionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnProgramSectionDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="programSectionDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnProgramSectionDescriptor(string id = default(string), int? programSectionDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnProgramSectionDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnProgramSectionDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.ProgramSectionDescriptorId = programSectionDescriptorId;
        ...
        [DataMember(Name="programSectionDescriptorId", EmitDefaultValue=false)]
        public int? ProgramSectionDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnProgramSectionDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ProgramSectionDescriptorId: ").Append(ProgramSectionDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnProgramSectionDescriptor);
        }

        /// <summary>
        /// Returns true if MnProgramSectionDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnProgramSectionDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnProgramSectionDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProgramSectionDescriptorId == input.ProgramSectionDescriptorId ||
                    (this.ProgramSectionDescriptorId != null &&
                    this.ProgramSectionDescriptorId.Equals(input.ProgramSectionDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProgramSectionDescriptorId != null)
                    hashCode = hashCode * 59 + this.ProgramSectionDescriptorId.GetHashCode();
