...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentEducationOrganizationAssociationInternationalAddress :  IEquatable<EdFiStudentEducationOrganizationAssociationInternationalAddress>
    {
        /// <summary>
        ...
        public EdFiStudentEducationOrganizationAssociationInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string latitude = default(string), string longitude = default(string))
        {
            ...
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("countryDescriptor is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("addressLine1 is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
            }
            else
            {
