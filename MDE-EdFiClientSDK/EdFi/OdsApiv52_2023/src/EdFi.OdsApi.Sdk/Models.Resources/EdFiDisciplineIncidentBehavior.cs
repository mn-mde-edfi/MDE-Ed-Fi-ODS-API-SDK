...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiDisciplineIncidentBehavior :  IEquatable<EdFiDisciplineIncidentBehavior>
    {
        /// <summary>
        ...
        public EdFiDisciplineIncidentBehavior(string behaviorDescriptor = default(string), string behaviorDetailedDescription = default(string))
        {
            ...
            {
                throw new InvalidDataException("behaviorDescriptor is a required property for EdFiDisciplineIncidentBehavior and cannot be null");
            }
            else
            {
