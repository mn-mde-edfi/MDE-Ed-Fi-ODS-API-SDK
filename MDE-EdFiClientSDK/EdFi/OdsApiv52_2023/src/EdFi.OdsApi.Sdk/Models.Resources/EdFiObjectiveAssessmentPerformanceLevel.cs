...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentPerformanceLevel :  IEquatable<EdFiObjectiveAssessmentPerformanceLevel>
    {
        /// <summary>
        ...
        public EdFiObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            ...
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceLevelDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
