...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiEducationContentDerivativeSourceURI :  IEquatable<EdFiEducationContentDerivativeSourceURI>
    {
        /// <summary>
        ...
        public EdFiEducationContentDerivativeSourceURI(string derivativeSourceURI = default(string))
        {
            ...
            {
                throw new InvalidDataException("derivativeSourceURI is a required property for EdFiEducationContentDerivativeSourceURI and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="derivativeSourceURI", EmitDefaultValue=false)]
