...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentContentStandard :  IEquatable<EdFiAssessmentContentStandard>
    {
        /// <summary>
        ...
        public EdFiAssessmentContentStandard(string publicationStatusDescriptor = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? publicationDate = default(DateTime?), int? publicationYear = default(int?), string title = default(string), string uri = default(string), string version = default(string), EdFiEducationOrganizationReference mandatingEducationOrganizationReference = default(EdFiEducationOrganizationReference), List<EdFiAssessmentContentStandardAuthor> authors = default(List<EdFiAssessmentContentStandardAuthor>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for EdFiAssessmentContentStandard and cannot be null");
            }
            else
            {
                this.Title = title;
