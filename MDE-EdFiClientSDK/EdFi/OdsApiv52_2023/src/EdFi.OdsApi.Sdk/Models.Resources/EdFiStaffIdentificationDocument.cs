...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStaffIdentificationDocument :  IEquatable<EdFiStaffIdentificationDocument>
    {
        /// <summary>
        ...
        public EdFiStaffIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("identificationDocumentUseDescriptor is a required property for EdFiStaffIdentificationDocument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for EdFiStaffIdentificationDocument and cannot be null");
            }
            else
            {
