...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiGradebookEntryLearningStandard :  IEquatable<EdFiGradebookEntryLearningStandard>
    {
        /// <summary>
        ...
        public EdFiGradebookEntryLearningStandard(EdFiLearningStandardReference learningStandardReference = default(EdFiLearningStandardReference))
        {
            ...
            {
                throw new InvalidDataException("learningStandardReference is a required property for EdFiGradebookEntryLearningStandard and cannot be null");
            }
            else
            {
