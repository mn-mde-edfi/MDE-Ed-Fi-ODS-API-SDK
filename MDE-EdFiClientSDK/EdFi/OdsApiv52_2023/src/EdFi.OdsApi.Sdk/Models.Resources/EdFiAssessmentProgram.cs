...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentProgram :  IEquatable<EdFiAssessmentProgram>
    {
        /// <summary>
        ...
        public EdFiAssessmentProgram(EdFiProgramReference programReference = default(EdFiProgramReference))
        {
            ...
            {
                throw new InvalidDataException("programReference is a required property for EdFiAssessmentProgram and cannot be null");
            }
            else
            {
