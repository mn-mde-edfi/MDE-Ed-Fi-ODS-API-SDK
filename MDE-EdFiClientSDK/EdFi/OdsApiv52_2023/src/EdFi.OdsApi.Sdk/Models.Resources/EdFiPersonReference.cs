...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiPersonReference :  IEquatable<EdFiPersonReference>
    {
        /// <summary>
        ...
        public EdFiPersonReference(string personId = default(string), string sourceSystemDescriptor = default(string), Link link = default(Link))
        {
            ...
            if (personId == null)
            {
                throw new InvalidDataException("personId is a required property for EdFiPersonReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceSystemDescriptor is a required property for EdFiPersonReference and cannot be null");
            }
            else
            {
