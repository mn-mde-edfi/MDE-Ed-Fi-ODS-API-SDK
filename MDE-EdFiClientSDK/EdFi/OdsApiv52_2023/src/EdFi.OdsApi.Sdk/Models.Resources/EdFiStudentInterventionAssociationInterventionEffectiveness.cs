...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentInterventionAssociationInterventionEffectiveness :  IEquatable<EdFiStudentInterventionAssociationInterventionEffectiveness>
    {
        /// <summary>
        ...
        public EdFiStudentInterventionAssociationInterventionEffectiveness(string diagnosisDescriptor = default(string), string gradeLevelDescriptor = default(string), string populationServedDescriptor = default(string), string interventionEffectivenessRatingDescriptor = default(string), int? improvementIndex = default(int?))
        {
            ...
            {
                throw new InvalidDataException("diagnosisDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("gradeLevelDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("populationServedDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("interventionEffectivenessRatingDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            }
            else
            {
