...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiLearningObjectiveAcademicSubject :  IEquatable<EdFiLearningObjectiveAcademicSubject>
    {
        /// <summary>
        ...
        public EdFiLearningObjectiveAcademicSubject(string academicSubjectDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("academicSubjectDescriptor is a required property for EdFiLearningObjectiveAcademicSubject and cannot be null");
            }
            else
            {
