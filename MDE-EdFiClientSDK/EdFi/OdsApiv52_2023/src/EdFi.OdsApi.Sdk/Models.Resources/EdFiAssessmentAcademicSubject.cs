...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentAcademicSubject :  IEquatable<EdFiAssessmentAcademicSubject>
    {
        /// <summary>
        ...
        public EdFiAssessmentAcademicSubject(string academicSubjectDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("academicSubjectDescriptor is a required property for EdFiAssessmentAcademicSubject and cannot be null");
            }
            else
            {
