...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiSchoolGradeLevel :  IEquatable<EdFiSchoolGradeLevel>
    {
        /// <summary>
        ...
        public EdFiSchoolGradeLevel(string gradeLevelDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("gradeLevelDescriptor is a required property for EdFiSchoolGradeLevel and cannot be null");
            }
            else
            {
