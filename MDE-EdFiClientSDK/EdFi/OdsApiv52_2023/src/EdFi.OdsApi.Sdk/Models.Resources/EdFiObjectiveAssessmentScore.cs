...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiObjectiveAssessmentScore :  IEquatable<EdFiObjectiveAssessmentScore>
    {
        /// <summary>
        ...
        public EdFiObjectiveAssessmentScore(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            ...
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentScore and cannot be null");
            }
            else
            {
