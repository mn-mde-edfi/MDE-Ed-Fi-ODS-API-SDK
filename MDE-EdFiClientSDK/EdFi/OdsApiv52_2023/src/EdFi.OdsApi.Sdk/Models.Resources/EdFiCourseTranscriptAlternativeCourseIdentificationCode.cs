...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCourseTranscriptAlternativeCourseIdentificationCode :  IEquatable<EdFiCourseTranscriptAlternativeCourseIdentificationCode>
    {
        /// <summary>
        ...
        public EdFiCourseTranscriptAlternativeCourseIdentificationCode(string courseIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string courseCatalogURL = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("courseIdentificationSystemDescriptor is a required property for EdFiCourseTranscriptAlternativeCourseIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for EdFiCourseTranscriptAlternativeCourseIdentificationCode and cannot be null");
            }
            else
            {
