...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiInterventionPrescriptionAppropriateSex :  IEquatable<EdFiInterventionPrescriptionAppropriateSex>
    {
        /// <summary>
        ...
        public EdFiInterventionPrescriptionAppropriateSex(string sexDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("sexDescriptor is a required property for EdFiInterventionPrescriptionAppropriateSex and cannot be null");
            }
            else
            {
