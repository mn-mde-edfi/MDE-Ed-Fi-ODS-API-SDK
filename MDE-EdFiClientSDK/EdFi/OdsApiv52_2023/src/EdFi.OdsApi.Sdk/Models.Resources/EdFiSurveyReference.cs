...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiSurveyReference :  IEquatable<EdFiSurveyReference>
    {
        /// <summary>
        ...
        public EdFiSurveyReference(string _namespace = default(string), string surveyIdentifier = default(string), Link link = default(Link))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiSurveyReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("surveyIdentifier is a required property for EdFiSurveyReference and cannot be null");
            }
            else
            {
