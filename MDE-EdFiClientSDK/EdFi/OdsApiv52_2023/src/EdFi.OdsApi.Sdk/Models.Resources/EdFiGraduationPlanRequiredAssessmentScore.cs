...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiGraduationPlanRequiredAssessmentScore :  IEquatable<EdFiGraduationPlanRequiredAssessmentScore>
    {
        /// <summary>
        ...
        public EdFiGraduationPlanRequiredAssessmentScore(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            ...
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentScore and cannot be null");
            }
            else
            {
