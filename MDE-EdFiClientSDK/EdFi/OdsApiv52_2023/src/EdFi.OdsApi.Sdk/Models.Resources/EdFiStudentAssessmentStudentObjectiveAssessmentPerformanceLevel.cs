...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel :  IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel>
    {
        /// <summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), bool? performanceLevelMet = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceLevelDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceLevelMet is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
