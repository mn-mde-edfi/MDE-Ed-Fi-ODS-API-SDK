...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentAssessmentScoreResult :  IEquatable<EdFiStudentAssessmentScoreResult>
    {
        /// <summary>
        ...
        public EdFiStudentAssessmentScoreResult(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string result = default(string))
        {
            ...
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("resultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
            ...
            if (result == null)
            {
                throw new InvalidDataException("result is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
                this.Result = result;
