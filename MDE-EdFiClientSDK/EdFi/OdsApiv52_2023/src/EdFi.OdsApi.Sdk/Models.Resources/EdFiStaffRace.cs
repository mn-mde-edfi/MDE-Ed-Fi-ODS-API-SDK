...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStaffRace :  IEquatable<EdFiStaffRace>
    {
        /// <summary>
        ...
        public EdFiStaffRace(string raceDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("raceDescriptor is a required property for EdFiStaffRace and cannot be null");
            }
            else
            {
