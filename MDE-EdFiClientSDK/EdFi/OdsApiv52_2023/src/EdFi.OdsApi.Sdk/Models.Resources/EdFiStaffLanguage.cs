...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStaffLanguage :  IEquatable<EdFiStaffLanguage>
    {
        /// <summary>
        ...
        public EdFiStaffLanguage(string languageDescriptor = default(string), List<EdFiStaffLanguageUse> uses = default(List<EdFiStaffLanguageUse>))
        {
            ...
            {
                throw new InvalidDataException("languageDescriptor is a required property for EdFiStaffLanguage and cannot be null");
            }
            else
            {
