...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiSurveySectionReference :  IEquatable<EdFiSurveySectionReference>
    {
        /// <summary>
        ...
        public EdFiSurveySectionReference(string _namespace = default(string), string surveyIdentifier = default(string), string surveySectionTitle = default(string), Link link = default(Link))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiSurveySectionReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("surveyIdentifier is a required property for EdFiSurveySectionReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("surveySectionTitle is a required property for EdFiSurveySectionReference and cannot be null");
            }
            else
            {
