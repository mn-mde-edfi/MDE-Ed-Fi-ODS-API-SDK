...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable :  IEquatable<MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable>
    {
        /// <summary>
        ...
        public MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable(string optOutIndicatorsDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("optOutIndicatorsDescriptor is a required property for MnStudentEducationOrganizationAssociationOptOutIndicatorsReadable and cannot be null");
            }
            else
            {
