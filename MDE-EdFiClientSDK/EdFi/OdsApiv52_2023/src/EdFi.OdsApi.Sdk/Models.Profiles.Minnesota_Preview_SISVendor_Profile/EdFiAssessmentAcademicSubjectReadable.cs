...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiAssessmentAcademicSubjectReadable :  IEquatable<EdFiAssessmentAcademicSubjectReadable>
    {
        /// <summary>
        ...
        public EdFiAssessmentAcademicSubjectReadable(string academicSubjectDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("academicSubjectDescriptor is a required property for EdFiAssessmentAcademicSubjectReadable and cannot be null");
            }
            else
            {
