...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentNeglectedOrDelinquentProgramAssociationWritable :  IEquatable<EdFiStudentNeglectedOrDelinquentProgramAssociationWritable>
    {
        /// <summary>
        ...
        public EdFiStudentNeglectedOrDelinquentProgramAssociationWritable(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), string etag = default(string), StudentNeglectedOrDelinquentProgramAssociationExtensionsWritable ext = default(StudentNeglectedOrDelinquentProgramAssociationExtensionsWritable))
        {
