...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCourseLearningStandardReadable :  IEquatable<EdFiCourseLearningStandardReadable>
    {
        /// <summary>
        ...
        public EdFiCourseLearningStandardReadable(EdFiLearningStandardReference learningStandardReference = default(EdFiLearningStandardReference))
        {
            ...
            {
                throw new InvalidDataException("learningStandardReference is a required property for EdFiCourseLearningStandardReadable and cannot be null");
            }
            else
            {
