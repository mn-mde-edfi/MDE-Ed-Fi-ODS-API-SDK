...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCourseLevelCharacteristicWritable :  IEquatable<EdFiCourseLevelCharacteristicWritable>
    {
        /// <summary>
        ...
        public EdFiCourseLevelCharacteristicWritable(string courseLevelCharacteristicDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("courseLevelCharacteristicDescriptor is a required property for EdFiCourseLevelCharacteristicWritable and cannot be null");
            }
            else
            {
