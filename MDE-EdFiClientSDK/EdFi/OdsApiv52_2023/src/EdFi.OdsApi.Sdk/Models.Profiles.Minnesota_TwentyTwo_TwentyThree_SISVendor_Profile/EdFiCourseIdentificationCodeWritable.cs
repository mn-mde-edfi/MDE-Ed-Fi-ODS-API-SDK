...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCourseIdentificationCodeWritable :  IEquatable<EdFiCourseIdentificationCodeWritable>
    {
        /// <summary>
        ...
        public EdFiCourseIdentificationCodeWritable(string courseIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("courseIdentificationSystemDescriptor is a required property for EdFiCourseIdentificationCodeWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for EdFiCourseIdentificationCodeWritable and cannot be null");
            }
            else
            {
