...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCourseReference :  IEquatable<MnCourseReference>
    {
        /// <summary>
        ...
        public MnCourseReference(string courseCode = default(string), int? educationOrganizationId = default(int?), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationId is a required property for MnCourseReference and cannot be null");
            }
            else
            {
