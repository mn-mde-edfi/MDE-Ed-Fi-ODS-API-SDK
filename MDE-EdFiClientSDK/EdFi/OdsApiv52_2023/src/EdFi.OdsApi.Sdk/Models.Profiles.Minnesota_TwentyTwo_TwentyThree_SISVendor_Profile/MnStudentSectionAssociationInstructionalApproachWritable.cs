...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentSectionAssociationInstructionalApproachWritable :  IEquatable<MnStudentSectionAssociationInstructionalApproachWritable>
    {
        /// <summary>
        ...
        public MnStudentSectionAssociationInstructionalApproachWritable(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("instructionalApproachDescriptor is a required property for MnStudentSectionAssociationInstructionalApproachWritable and cannot be null");
            }
            else
            {
