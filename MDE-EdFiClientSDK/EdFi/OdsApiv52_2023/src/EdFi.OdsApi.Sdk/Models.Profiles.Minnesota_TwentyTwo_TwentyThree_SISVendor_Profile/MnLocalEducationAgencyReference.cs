...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyTwo_TwentyThree_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnLocalEducationAgencyReference :  IEquatable<MnLocalEducationAgencyReference>
    {
        /// <summary>
        ...
        public MnLocalEducationAgencyReference(int? localEducationAgencyId = default(int?), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("localEducationAgencyId is a required property for MnLocalEducationAgencyReference and cannot be null");
            }
            else
            {
