...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable :  IEquatable<EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable(string studentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("studentIdentificationSystemDescriptor is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assigningOrganizationIdentificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeReadable and cannot be null");
            }
            else
            {
