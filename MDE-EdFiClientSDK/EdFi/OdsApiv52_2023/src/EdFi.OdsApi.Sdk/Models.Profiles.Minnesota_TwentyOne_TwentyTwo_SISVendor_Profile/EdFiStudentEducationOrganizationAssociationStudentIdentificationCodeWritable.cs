...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyOne_TwentyTwo_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable :  IEquatable<EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable>
    {
        /// <summary>
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable(string studentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("studentIdentificationSystemDescriptor is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assigningOrganizationIdentificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for EdFiStudentEducationOrganizationAssociationStudentIdentificationCodeWritable and cannot be null");
            }
            else
            {
