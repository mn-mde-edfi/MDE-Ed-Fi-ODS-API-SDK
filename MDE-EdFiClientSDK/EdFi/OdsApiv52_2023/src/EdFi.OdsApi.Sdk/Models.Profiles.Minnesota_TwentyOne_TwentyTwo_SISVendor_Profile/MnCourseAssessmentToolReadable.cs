...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyOne_TwentyTwo_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCourseAssessmentToolReadable :  IEquatable<MnCourseAssessmentToolReadable>
    {
        /// <summary>
        ...
        public MnCourseAssessmentToolReadable(string assessmentToolDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("assessmentToolDescriptor is a required property for MnCourseAssessmentToolReadable and cannot be null");
            }
            else
            {
