...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyOne_TwentyTwo_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCourseCurriculumUsedReadable :  IEquatable<MnCourseCurriculumUsedReadable>
    {
        /// <summary>
        ...
        public MnCourseCurriculumUsedReadable(string curriculumUsedDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("curriculumUsedDescriptor is a required property for MnCourseCurriculumUsedReadable and cannot be null");
            }
            else
            {
