...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyOne_TwentyTwo_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCourseOfferedGradeLevelWritable :  IEquatable<EdFiCourseOfferedGradeLevelWritable>
    {
        /// <summary>
        ...
        public EdFiCourseOfferedGradeLevelWritable(string gradeLevelDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("gradeLevelDescriptor is a required property for EdFiCourseOfferedGradeLevelWritable and cannot be null");
            }
            else
            {
