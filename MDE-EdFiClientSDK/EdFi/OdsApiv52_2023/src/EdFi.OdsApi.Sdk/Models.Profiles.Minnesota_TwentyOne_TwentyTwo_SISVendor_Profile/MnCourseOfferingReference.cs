...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_TwentyOne_TwentyTwo_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCourseOfferingReference :  IEquatable<MnCourseOfferingReference>
    {
        /// <summary>
        ...
        public MnCourseOfferingReference(string localCourseCode = default(string), int? schoolId = default(int?), int? schoolYear = default(int?), string sessionName = default(string), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("localCourseCode is a required property for MnCourseOfferingReference and cannot be null");
            }
            else
            {
            ...
            if (schoolId == null)
            {
                throw new InvalidDataException("schoolId is a required property for MnCourseOfferingReference and cannot be null");
            }
            else
            {
            ...
            if (schoolYear == null)
            {
                throw new InvalidDataException("schoolYear is a required property for MnCourseOfferingReference and cannot be null");
            }
            else
            {
            ...
            if (sessionName == null)
            {
                throw new InvalidDataException("sessionName is a required property for MnCourseOfferingReference and cannot be null");
            }
            else
            {
