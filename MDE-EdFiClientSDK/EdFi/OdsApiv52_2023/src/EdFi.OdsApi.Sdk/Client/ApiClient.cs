...
namespace EdFi.OdsApi.Sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://localhost:54746/data/v3/");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:54746/data/v3/).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:54746/data/v3/")
        {
