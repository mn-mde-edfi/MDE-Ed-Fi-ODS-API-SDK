    ...
    public partial class LearningStandardsApi : ILearningStandardsApi
    {
        ...
        public ApiResponse<Object> DeletelearningStandardByIdWithHttpInfo (string id, string ifMatch = null)
        {
            ...
            String[] localVarHttpContentTypes = new String[] {
                "application/vnd.ed-fi.learningstandard.minnesota-twentytwo-twentythree-sisvendorprofile.writable+json"
            };
        ...
        public ApiResponse< List<EdFiLearningStandardReadable> > GetLearningStandardsWithHttpInfo (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, string learningStandardId = null, string description = null, string id = null, string _namespace = null, string snapshotIdentifier = null)
        {
            ...
            // to determine the Accept header
            String[] localVarHttpHeaderAccepts = new String[] {
                "application/vnd.ed-fi.learningstandard.minnesota-twentytwo-twentythree-sisvendorprofile.readable+json"
            };
            String localVarHttpHeaderAccept = this.Configuration.ApiClient.SelectHeaderAccept(localVarHttpHeaderAccepts);
            if (localVarHttpHeaderAccept != null)
                localVarHeaderParams.Add("Accept", localVarHttpHeaderAccept);
