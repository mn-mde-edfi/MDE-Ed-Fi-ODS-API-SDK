...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiIndicatorLevelDescriptor :  IEquatable<EdFiIndicatorLevelDescriptor>
    {
        /// <summary>
        ...
        public EdFiIndicatorLevelDescriptor(string id = default(string), int? indicatorLevelDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            else
            {
        ...
        public bool Equals(EdFiIndicatorLevelDescriptor input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.IndicatorLevelDescriptorId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IndicatorLevelDescriptorId != null)
