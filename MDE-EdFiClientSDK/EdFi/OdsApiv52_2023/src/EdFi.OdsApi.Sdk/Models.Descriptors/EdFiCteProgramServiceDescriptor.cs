...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiCteProgramServiceDescriptor :  IEquatable<EdFiCteProgramServiceDescriptor>
    {
        /// <summary>
        ...
        public EdFiCteProgramServiceDescriptor(string id = default(string), int? cteProgramServiceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiCteProgramServiceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiCteProgramServiceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiCteProgramServiceDescriptor and cannot be null");
            }
            else
            {
        ...
        public bool Equals(EdFiCteProgramServiceDescriptor input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.CteProgramServiceDescriptorId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CteProgramServiceDescriptorId != null)
