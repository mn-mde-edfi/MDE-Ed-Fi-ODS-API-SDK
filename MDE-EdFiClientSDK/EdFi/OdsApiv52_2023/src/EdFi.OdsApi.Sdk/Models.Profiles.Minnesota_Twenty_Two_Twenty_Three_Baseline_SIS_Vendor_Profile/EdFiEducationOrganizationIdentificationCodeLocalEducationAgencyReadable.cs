...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_Baseline_SIS_Vendor_Profile
{
    ...
    public partial class EdFiEducationOrganizationIdentificationCodeLocalEducationAgencyReadable :  IEquatable<EdFiEducationOrganizationIdentificationCodeLocalEducationAgencyReadable>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationIdentificationCodeLocalEducationAgencyReadable(string educationOrganizationIdentificationSystemDescriptor = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationIdentificationSystemDescriptor is a required property for EdFiEducationOrganizationIdentificationCodeLocalEducationAgencyReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for EdFiEducationOrganizationIdentificationCodeLocalEducationAgencyReadable and cannot be null");
            }
            else
            {
