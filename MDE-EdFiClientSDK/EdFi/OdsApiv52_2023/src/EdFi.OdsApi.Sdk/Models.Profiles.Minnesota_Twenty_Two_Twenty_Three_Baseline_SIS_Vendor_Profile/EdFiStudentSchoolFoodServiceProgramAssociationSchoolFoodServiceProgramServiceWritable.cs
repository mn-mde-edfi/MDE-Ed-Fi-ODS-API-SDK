...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_Baseline_SIS_Vendor_Profile
{
    ...
    public partial class EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable :  IEquatable<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable>, IValidatableObject
    {
        ...
        public EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable(string schoolFoodServiceProgramServiceDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("schoolFoodServiceProgramServiceDescriptor is a required property for EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramServiceWritable and cannot be null");
            }
            else
            {
