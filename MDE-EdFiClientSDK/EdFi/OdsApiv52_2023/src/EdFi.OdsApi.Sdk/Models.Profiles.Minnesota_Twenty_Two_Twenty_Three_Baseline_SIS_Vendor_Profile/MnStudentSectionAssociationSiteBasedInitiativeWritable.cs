...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_Baseline_SIS_Vendor_Profile
{
    ...
    public partial class MnStudentSectionAssociationSiteBasedInitiativeWritable :  IEquatable<MnStudentSectionAssociationSiteBasedInitiativeWritable>, IValidatableObject
    {
        ...
        public MnStudentSectionAssociationSiteBasedInitiativeWritable(string siteBasedInitiativeDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("siteBasedInitiativeDescriptor is a required property for MnStudentSectionAssociationSiteBasedInitiativeWritable and cannot be null");
            }
            else
            {
