...
{
    /// <summary>
    /// EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable
    /// </summary>
    [DataContract]
    public partial class EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable :  IEquatable<EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable(string neglectedOrDelinquentProgramServiceDescriptor = default(string), bool? primaryIndicator = default(bool?), DateTime? serviceBeginDate = default(DateTime?), DateTime? serviceEndDate = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("neglectedOrDelinquentProgramServiceDescriptor is a required property for EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="neglectedOrDelinquentProgramServiceDescriptor", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceReadable input)
        {
            if (input == null)
                return false;
