...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationStudentCrisisEventWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationStudentCrisisEventWritable :  IEquatable<MnStudentEducationOrganizationAssociationStudentCrisisEventWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationStudentCrisisEventWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationStudentCrisisEventWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationStudentCrisisEventWritable" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationStudentCrisisEventWritable(string crisisEventDescriptor = default(string), bool? displacedStudentIndicator = default(bool?))
        {
            // to ensure "crisisEventDescriptor" is required (not null)
            if (crisisEventDescriptor == null)
            {
                throw new InvalidDataException("crisisEventDescriptor is a required property for MnStudentEducationOrganizationAssociationStudentCrisisEventWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displacedStudentIndicator is a required property for MnStudentEducationOrganizationAssociationStudentCrisisEventWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationStudentCrisisEventWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationStudentCrisisEventWritable);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationStudentCrisisEventWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationStudentCrisisEventWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationStudentCrisisEventWritable input)
        {
            if (input == null)
                return false;
