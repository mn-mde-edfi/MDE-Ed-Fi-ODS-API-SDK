...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationOtherNameWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationOtherNameWritable :  IEquatable<MnStudentEducationOrganizationAssociationOtherNameWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherNameWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationOtherNameWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherNameWritable" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationOtherNameWritable(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string))
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            if (otherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("otherNameTypeDescriptor is a required property for MnStudentEducationOrganizationAssociationOtherNameWritable and cannot be null");
            }
            else
            {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for MnStudentEducationOrganizationAssociationOtherNameWritable and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for MnStudentEducationOrganizationAssociationOtherNameWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationOtherNameWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationOtherNameWritable);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationOtherNameWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationOtherNameWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationOtherNameWritable input)
        {
            if (input == null)
                return false;
