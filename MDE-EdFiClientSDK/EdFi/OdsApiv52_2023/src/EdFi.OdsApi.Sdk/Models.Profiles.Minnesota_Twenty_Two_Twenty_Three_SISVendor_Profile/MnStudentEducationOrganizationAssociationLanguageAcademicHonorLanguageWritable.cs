...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable :  IEquatable<MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable(string languageDescriptor = default(string))
        {
            // to ensure "languageDescriptor" is required (not null)
            if (languageDescriptor == null)
            {
                throw new InvalidDataException("languageDescriptor is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguageWritable input)
        {
            if (input == null)
                return false;
