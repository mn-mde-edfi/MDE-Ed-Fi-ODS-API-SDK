...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationOtherNameReadable
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationOtherNameReadable :  IEquatable<MnStudentEducationOrganizationAssociationOtherNameReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherNameReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationOtherNameReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherNameReadable" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationOtherNameReadable(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string))
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            if (otherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("otherNameTypeDescriptor is a required property for MnStudentEducationOrganizationAssociationOtherNameReadable and cannot be null");
            }
            else
            {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for MnStudentEducationOrganizationAssociationOtherNameReadable and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for MnStudentEducationOrganizationAssociationOtherNameReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationOtherNameReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationOtherNameReadable);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationOtherNameReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationOtherNameReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationOtherNameReadable input)
        {
            if (input == null)
                return false;
