...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable :  IEquatable<EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable" /> class.
        /// </summary>
        ...
        public EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable(string neglectedOrDelinquentProgramServiceDescriptor = default(string), bool? primaryIndicator = default(bool?), DateTime? serviceBeginDate = default(DateTime?), DateTime? serviceEndDate = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("neglectedOrDelinquentProgramServiceDescriptor is a required property for EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable);
        }

        /// <summary>
        /// Returns true if EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramServiceWritable input)
        {
            if (input == null)
                return false;
