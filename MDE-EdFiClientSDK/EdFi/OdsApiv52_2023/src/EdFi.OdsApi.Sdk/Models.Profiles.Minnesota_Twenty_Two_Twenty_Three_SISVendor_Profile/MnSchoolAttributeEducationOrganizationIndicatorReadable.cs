...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile
{
    ...
    public partial class MnSchoolAttributeEducationOrganizationIndicatorReadable :  IEquatable<MnSchoolAttributeEducationOrganizationIndicatorReadable>, IValidatableObject
    {
        ...
        public MnSchoolAttributeEducationOrganizationIndicatorReadable(string indicatorDescriptor = default(string), string indicatorLevelDescriptor = default(string))
        {
            // to ensure "indicatorDescriptor" is required (not null)
            if (indicatorDescriptor == null)
            {
                throw new InvalidDataException("indicatorDescriptor is a required property for MnSchoolAttributeEducationOrganizationIndicatorReadable and cannot be null");
            }
            else
            {
