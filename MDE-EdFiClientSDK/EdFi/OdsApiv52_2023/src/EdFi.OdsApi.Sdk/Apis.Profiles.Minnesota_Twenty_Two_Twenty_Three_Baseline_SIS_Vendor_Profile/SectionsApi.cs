...
namespace EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Two_Twenty_Three_Baseline_SIS_Vendor_Profile
{
    ...
    public interface ISectionsApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiSectionReadable> GetSectionsByIdWithHttpInfo (string id, string ifNoneMatch = null, string snapshotIdentifier = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiSectionReadable> GetSectionsByIdAsync (string id, string ifNoneMatch = null, string snapshotIdentifier = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiSectionReadable>> GetSectionsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null, string snapshotIdentifier = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class SectionsApi : ISectionsApi
    {
        ...
        public ApiResponse< List<DeletedResource> > DeletesSectionsWithHttpInfo (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string snapshotIdentifier = null)
        {
            ...
            String[] localVarHttpContentTypes = new String[] {
                "application/vnd.ed-fi.section.minnesota-twenty-two-twenty-three-baseline-sis-vendor-profile.writable+json"
            };
        ...
        {
             ApiResponse<List<EdFiSectionReadable>> localVarResponse = GetSectionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionIdentifier, localCourseCode, schoolId, schoolYear, sessionName, instructionLanguageDescriptor, mediumOfInstructionDescriptor, id, sequenceOfCourse, snapshotIdentifier);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< List<EdFiSectionReadable> > GetSectionsWithHttpInfo (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, string sectionIdentifier = null, string localCourseCode = null, int? schoolId = null, int? schoolYear = null, string sessionName = null, string instructionLanguageDescriptor = null, string mediumOfInstructionDescriptor = null, string id = null, int? sequenceOfCourse = null, string snapshotIdentifier = null)
        {
            ...
            // to determine the Accept header
            String[] localVarHttpHeaderAccepts = new String[] {
                "application/vnd.ed-fi.section.minnesota-twenty-two-twenty-three-baseline-sis-vendor-profile.readable+json"
            };
            String localVarHttpHeaderAccept = this.Configuration.ApiClient.SelectHeaderAccept(localVarHttpHeaderAccepts);
            if (localVarHttpHeaderAccept != null)
                localVarHeaderParams.Add("Accept", localVarHttpHeaderAccept);
            ...
            return new ApiResponse<List<EdFiSectionReadable>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiSectionReadable>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiSectionReadable>)));
        }
        ...
        /// <param name="snapshotIdentifier">Indicates the Snapshot-Identifier that should be used. (optional)</param>
        /// <returns>EdFiSectionReadable</returns>
        public EdFiSectionReadable GetSectionsById (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
        {
             ApiResponse<EdFiSectionReadable> localVarResponse = GetSectionsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
             return localVarResponse.Data;
        }
        ...
        /// <param name="snapshotIdentifier">Indicates the Snapshot-Identifier that should be used. (optional)</param>
        /// <returns>ApiResponse of EdFiSectionReadable</returns>
        public ApiResponse< EdFiSectionReadable > GetSectionsByIdWithHttpInfo (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<EdFiSectionReadable>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiSectionReadable) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiSectionReadable)));
        }
        ...
        /// <param name="snapshotIdentifier">Indicates the Snapshot-Identifier that should be used. (optional)</param>
        /// <returns>Task of EdFiSectionReadable</returns>
        public async System.Threading.Tasks.Task<EdFiSectionReadable> GetSectionsByIdAsync (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
        {
             ApiResponse<EdFiSectionReadable> localVarResponse = await GetSectionsByIdAsyncWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
             return localVarResponse.Data;
        ...
        /// <param name="snapshotIdentifier">Indicates the Snapshot-Identifier that should be used. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiSectionReadable)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiSectionReadable>> GetSectionsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling SectionsApi->GetSectionsById");
