...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationLanguageAcademicHonor
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationLanguageAcademicHonor :  IEquatable<MnStudentEducationOrganizationAssociationLanguageAcademicHonor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationLanguageAcademicHonor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationLanguageAcademicHonor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationLanguageAcademicHonor" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationLanguageAcademicHonor(string academicHonorCategoryDescriptor = default(string), string honorDescription = default(string), string achievementCategoryDescriptor = default(string), string assessmentCategoryDescriptor = default(string), string assessedGradeLevelDescriptor = default(string), string assessmentTitle = default(string), DateTime? honorAwardDate = default(DateTime?), DateTime? honorAwardExpiresDate = default(DateTime?), EdFiSchoolYearTypeReference assessedSchoolYearTypeReference = default(EdFiSchoolYearTypeReference), List<MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguage> languages = default(List<MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguage>))
        {
            // to ensure "academicHonorCategoryDescriptor" is required (not null)
            if (academicHonorCategoryDescriptor == null)
            {
                throw new InvalidDataException("academicHonorCategoryDescriptor is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("honorDescription is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("achievementCategoryDescriptor is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assessmentCategoryDescriptor is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assessedGradeLevelDescriptor is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assessedSchoolYearTypeReference is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
            ...
            if (languages == null)
            {
                throw new InvalidDataException("languages is a required property for MnStudentEducationOrganizationAssociationLanguageAcademicHonor and cannot be null");
            }
            else
            {
        ...
        public List<MnStudentEducationOrganizationAssociationLanguageAcademicHonorLanguage> Languages { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationLanguageAcademicHonor {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationLanguageAcademicHonor);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationLanguageAcademicHonor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationLanguageAcademicHonor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationLanguageAcademicHonor input)
        {
            if (input == null)
                return false;
