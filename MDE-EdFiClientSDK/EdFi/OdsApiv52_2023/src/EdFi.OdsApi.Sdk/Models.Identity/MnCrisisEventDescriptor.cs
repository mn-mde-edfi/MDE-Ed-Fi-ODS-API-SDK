...
namespace EdFi.OdsApi.Sdk.Models.Identity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCrisisEventDescriptor :  IEquatable<MnCrisisEventDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCrisisEventDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCrisisEventDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCrisisEventDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="crisisEventDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnCrisisEventDescriptor(string id = default(string), int? crisisEventDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for MnCrisisEventDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnCrisisEventDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnCrisisEventDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CrisisEventDescriptorId = crisisEventDescriptorId;
        ...
        [DataMember(Name="crisisEventDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCrisisEventDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CrisisEventDescriptorId: ").Append(CrisisEventDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnCrisisEventDescriptor);
        }

        /// <summary>
        /// Returns true if MnCrisisEventDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCrisisEventDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCrisisEventDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CrisisEventDescriptorId == input.CrisisEventDescriptorId ||
                    (this.CrisisEventDescriptorId != null &&
                    this.CrisisEventDescriptorId.Equals(input.CrisisEventDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CrisisEventDescriptorId != null)
                    hashCode = hashCode * 59 + this.CrisisEventDescriptorId.GetHashCode();
