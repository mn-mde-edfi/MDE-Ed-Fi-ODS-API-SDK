...
{
    /// <summary>
    /// MnCourseAssessmentTool
    /// </summary>
    [DataContract]
    public partial class MnCourseAssessmentTool :  IEquatable<MnCourseAssessmentTool>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseAssessmentTool" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCourseAssessmentTool() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseAssessmentTool" /> class.
        /// </summary>
        ...
        public MnCourseAssessmentTool(string assessmentToolDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "assessmentToolDescriptor" is required (not null)
            if (assessmentToolDescriptor == null)
            {
                throw new InvalidDataException("assessmentToolDescriptor is a required property for MnCourseAssessmentTool and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCourseAssessmentTool {\n");
        ...
        {
            return this.Equals(input as MnCourseAssessmentTool);
        }

        /// <summary>
        /// Returns true if MnCourseAssessmentTool instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCourseAssessmentTool to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCourseAssessmentTool input)
        {
            if (input == null)
                return false;
