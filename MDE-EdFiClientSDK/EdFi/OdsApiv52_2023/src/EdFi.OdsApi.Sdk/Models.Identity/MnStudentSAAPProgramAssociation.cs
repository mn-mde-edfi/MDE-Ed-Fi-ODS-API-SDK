...
namespace EdFi.OdsApi.Sdk.Models.Identity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentSAAPProgramAssociation :  IEquatable<MnStudentSAAPProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSAAPProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSAAPProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSAAPProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentSAAPProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), bool? independentStudyIndicator = default(bool?), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool? saapConcurrentIndicator = default(bool?), double? saapCredits = default(double?), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSAAPProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentSAAPProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentSAAPProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSAAPProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSAAPProgramAssociation input)
        {
            if (input == null)
                return false;
