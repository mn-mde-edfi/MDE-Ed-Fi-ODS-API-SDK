...
{
    /// <summary>
    /// MnStudentPSEOProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentPSEOProgramAssociation :  IEquatable<MnStudentPSEOProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentPSEOProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentPSEOProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentPSEOProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), int? pseoHighSchoolHours = default(int?), string reasonExitedDescriptor = default(string), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string))
        {
            // to ensure "beginDate" is required (not null)
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for MnStudentPSEOProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("educationOrganizationReference is a required property for MnStudentPSEOProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("programReference is a required property for MnStudentPSEOProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentReference is a required property for MnStudentPSEOProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentPSEOProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentPSEOProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentPSEOProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentPSEOProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentPSEOProgramAssociation input)
        {
            if (input == null)
                return false;
