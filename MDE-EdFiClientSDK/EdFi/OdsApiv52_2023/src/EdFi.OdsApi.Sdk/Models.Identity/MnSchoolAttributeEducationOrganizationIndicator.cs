...
{
    /// <summary>
    /// MnSchoolAttributeEducationOrganizationIndicator
    /// </summary>
    [DataContract]
    public partial class MnSchoolAttributeEducationOrganizationIndicator :  IEquatable<MnSchoolAttributeEducationOrganizationIndicator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolAttributeEducationOrganizationIndicator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSchoolAttributeEducationOrganizationIndicator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolAttributeEducationOrganizationIndicator" /> class.
        /// </summary>
        ...
        public MnSchoolAttributeEducationOrganizationIndicator(string indicatorDescriptor = default(string), string indicatorGroupDescriptor = default(string), string indicatorLevelDescriptor = default(string), string designatedBy = default(string), string indicatorValue = default(string), List<MnSchoolAttributeEducationOrganizationIndicatorPeriod> periods = default(List<MnSchoolAttributeEducationOrganizationIndicatorPeriod>))
        {
            // to ensure "indicatorDescriptor" is required (not null)
            if (indicatorDescriptor == null)
            {
                throw new InvalidDataException("indicatorDescriptor is a required property for MnSchoolAttributeEducationOrganizationIndicator and cannot be null");
            }
            else
            {
        ...
        public List<MnSchoolAttributeEducationOrganizationIndicatorPeriod> Periods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSchoolAttributeEducationOrganizationIndicator {\n");
        ...
        {
            return this.Equals(input as MnSchoolAttributeEducationOrganizationIndicator);
        }

        /// <summary>
        /// Returns true if MnSchoolAttributeEducationOrganizationIndicator instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSchoolAttributeEducationOrganizationIndicator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSchoolAttributeEducationOrganizationIndicator input)
        {
            if (input == null)
                return false;
