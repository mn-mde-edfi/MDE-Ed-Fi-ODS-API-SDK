...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationStudentCrisisEvent
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationStudentCrisisEvent :  IEquatable<MnStudentEducationOrganizationAssociationStudentCrisisEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationStudentCrisisEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationStudentCrisisEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationStudentCrisisEvent" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationStudentCrisisEvent(string crisisEventDescriptor = default(string), bool? displacedStudentIndicator = default(bool?))
        {
            // to ensure "crisisEventDescriptor" is required (not null)
            if (crisisEventDescriptor == null)
            {
                throw new InvalidDataException("crisisEventDescriptor is a required property for MnStudentEducationOrganizationAssociationStudentCrisisEvent and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displacedStudentIndicator is a required property for MnStudentEducationOrganizationAssociationStudentCrisisEvent and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationStudentCrisisEvent {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationStudentCrisisEvent);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationStudentCrisisEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationStudentCrisisEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationStudentCrisisEvent input)
        {
            if (input == null)
                return false;
