...
{
    /// <summary>
    /// MnStudentAssessmentPrecodeAccommodation
    /// </summary>
    [DataContract]
    public partial class MnStudentAssessmentPrecodeAccommodation :  IEquatable<MnStudentAssessmentPrecodeAccommodation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecodeAccommodation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentAssessmentPrecodeAccommodation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecodeAccommodation" /> class.
        /// </summary>
        ...
        public MnStudentAssessmentPrecodeAccommodation(string accommodationDescriptor = default(string))
        {
            // to ensure "accommodationDescriptor" is required (not null)
            if (accommodationDescriptor == null)
            {
                throw new InvalidDataException("accommodationDescriptor is a required property for MnStudentAssessmentPrecodeAccommodation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentAssessmentPrecodeAccommodation {\n");
        ...
        {
            return this.Equals(input as MnStudentAssessmentPrecodeAccommodation);
        }

        /// <summary>
        /// Returns true if MnStudentAssessmentPrecodeAccommodation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentAssessmentPrecodeAccommodation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentAssessmentPrecodeAccommodation input)
        {
            if (input == null)
                return false;
