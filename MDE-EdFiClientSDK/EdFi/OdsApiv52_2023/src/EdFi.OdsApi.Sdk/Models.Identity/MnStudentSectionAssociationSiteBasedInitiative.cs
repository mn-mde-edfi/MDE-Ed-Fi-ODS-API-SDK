...
{
    /// <summary>
    /// MnStudentSectionAssociationSiteBasedInitiative
    /// </summary>
    [DataContract]
    public partial class MnStudentSectionAssociationSiteBasedInitiative :  IEquatable<MnStudentSectionAssociationSiteBasedInitiative>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiative" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSectionAssociationSiteBasedInitiative() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationSiteBasedInitiative" /> class.
        /// </summary>
        ...
        public MnStudentSectionAssociationSiteBasedInitiative(string siteBasedInitiativeDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "siteBasedInitiativeDescriptor" is required (not null)
            if (siteBasedInitiativeDescriptor == null)
            {
                throw new InvalidDataException("siteBasedInitiativeDescriptor is a required property for MnStudentSectionAssociationSiteBasedInitiative and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSectionAssociationSiteBasedInitiative {\n");
        ...
        {
            return this.Equals(input as MnStudentSectionAssociationSiteBasedInitiative);
        }

        /// <summary>
        /// Returns true if MnStudentSectionAssociationSiteBasedInitiative instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSectionAssociationSiteBasedInitiative to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSectionAssociationSiteBasedInitiative input)
        {
            if (input == null)
                return false;
