...
namespace EdFi.OdsApi.Sdk.Models.Identity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentGiftedTalentedProgramAssociation :  IEquatable<MnStudentGiftedTalentedProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentGiftedTalentedProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentGiftedTalentedProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentGiftedTalentedProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentGiftedTalentedProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), string giftedTalentedParticipationDescriptor = default(string), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string))
        {
            // to ensure "beginDate" is required (not null)
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for MnStudentGiftedTalentedProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("educationOrganizationReference is a required property for MnStudentGiftedTalentedProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("programReference is a required property for MnStudentGiftedTalentedProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentReference is a required property for MnStudentGiftedTalentedProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("giftedTalentedParticipationDescriptor is a required property for MnStudentGiftedTalentedProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentGiftedTalentedProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentGiftedTalentedProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentGiftedTalentedProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentGiftedTalentedProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentGiftedTalentedProgramAssociation input)
        {
            if (input == null)
                return false;
