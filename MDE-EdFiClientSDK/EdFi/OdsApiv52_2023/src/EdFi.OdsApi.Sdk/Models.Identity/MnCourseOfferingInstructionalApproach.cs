...
{
    /// <summary>
    /// MnCourseOfferingInstructionalApproach
    /// </summary>
    [DataContract]
    public partial class MnCourseOfferingInstructionalApproach :  IEquatable<MnCourseOfferingInstructionalApproach>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseOfferingInstructionalApproach" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCourseOfferingInstructionalApproach() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseOfferingInstructionalApproach" /> class.
        /// </summary>
        ...
        public MnCourseOfferingInstructionalApproach(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "instructionalApproachDescriptor" is required (not null)
            if (instructionalApproachDescriptor == null)
            {
                throw new InvalidDataException("instructionalApproachDescriptor is a required property for MnCourseOfferingInstructionalApproach and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCourseOfferingInstructionalApproach {\n");
        ...
        {
            return this.Equals(input as MnCourseOfferingInstructionalApproach);
        }

        /// <summary>
        /// Returns true if MnCourseOfferingInstructionalApproach instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCourseOfferingInstructionalApproach to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCourseOfferingInstructionalApproach input)
        {
            if (input == null)
                return false;
