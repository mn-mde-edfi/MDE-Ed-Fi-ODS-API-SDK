...
{
    /// <summary>
    /// MnStudentEducationOrganizationAssociationOtherName
    /// </summary>
    [DataContract]
    public partial class MnStudentEducationOrganizationAssociationOtherName :  IEquatable<MnStudentEducationOrganizationAssociationOtherName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherName" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEducationOrganizationAssociationOtherName() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEducationOrganizationAssociationOtherName" /> class.
        /// </summary>
        ...
        public MnStudentEducationOrganizationAssociationOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            if (otherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("otherNameTypeDescriptor is a required property for MnStudentEducationOrganizationAssociationOtherName and cannot be null");
            }
            else
            {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for MnStudentEducationOrganizationAssociationOtherName and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for MnStudentEducationOrganizationAssociationOtherName and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEducationOrganizationAssociationOtherName {\n");
        ...
        {
            return this.Equals(input as MnStudentEducationOrganizationAssociationOtherName);
        }

        /// <summary>
        /// Returns true if MnStudentEducationOrganizationAssociationOtherName instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEducationOrganizationAssociationOtherName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEducationOrganizationAssociationOtherName input)
        {
            if (input == null)
                return false;
