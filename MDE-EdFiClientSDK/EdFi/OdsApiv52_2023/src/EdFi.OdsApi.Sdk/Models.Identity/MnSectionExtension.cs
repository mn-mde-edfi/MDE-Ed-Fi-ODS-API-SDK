...
namespace EdFi.OdsApi.Sdk.Models.Identity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnSectionExtension :  IEquatable<MnSectionExtension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSectionExtension" /> class.
        /// </summary>
        ...
        public MnSectionExtension(string instructionalDeliveryModeDescriptor = default(string), int? instructionMinutesPerTerm = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSectionExtension {\n");
        ...
        {
            return this.Equals(input as MnSectionExtension);
        }

        /// <summary>
        /// Returns true if MnSectionExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSectionExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSectionExtension input)
        {
            if (input == null)
                return false;
