...
{
    /// <summary>
    /// MnStudentAssessmentPrecode
    /// </summary>
    [DataContract]
    public partial class MnStudentAssessmentPrecode :  IEquatable<MnStudentAssessmentPrecode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentAssessmentPrecode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecode" /> class.
        /// </summary>
        ...
        public MnStudentAssessmentPrecode(string id = default(string), string precodeTypeDescriptor = default(string), MnStudentAssessmentPrecodeSiteReference siteStudentAssessmentPrecodeSiteReference = default(MnStudentAssessmentPrecodeSiteReference), EdFiStudentEducationOrganizationAssociationReference studentEducationOrganizationAssociationReference = default(EdFiStudentEducationOrganizationAssociationReference), List<MnStudentAssessmentPrecodeAcademicSubject> academicSubjects = default(List<MnStudentAssessmentPrecodeAcademicSubject>), List<MnStudentAssessmentPrecodeAccommodation> accommodations = default(List<MnStudentAssessmentPrecodeAccommodation>), string assessedGradeLevelDescriptor = default(string), string assessmentTitle = default(string), string customGroup = default(string), string enrolledGradeLevelDescriptor = default(string), string generalEnrollmentDescriptor = default(string), string etag = default(string))
        {
            // to ensure "precodeTypeDescriptor" is required (not null)
            if (precodeTypeDescriptor == null)
            {
                throw new InvalidDataException("precodeTypeDescriptor is a required property for MnStudentAssessmentPrecode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentEducationOrganizationAssociationReference is a required property for MnStudentAssessmentPrecode and cannot be null");
            }
            else
            {
        ...
        public List<MnStudentAssessmentPrecodeAcademicSubject> AcademicSubjects { get; set; }
        ...
        public List<MnStudentAssessmentPrecodeAccommodation> Accommodations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentAssessmentPrecode {\n");
        ...
        {
            return this.Equals(input as MnStudentAssessmentPrecode);
        }

        /// <summary>
        /// Returns true if MnStudentAssessmentPrecode instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentAssessmentPrecode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentAssessmentPrecode input)
        {
            if (input == null)
                return false;
