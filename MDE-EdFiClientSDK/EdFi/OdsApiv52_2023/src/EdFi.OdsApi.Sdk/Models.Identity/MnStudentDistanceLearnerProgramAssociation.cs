...
{
    /// <summary>
    /// MnStudentDistanceLearnerProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentDistanceLearnerProgramAssociation :  IEquatable<MnStudentDistanceLearnerProgramAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDistanceLearnerProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentDistanceLearnerProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDistanceLearnerProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentDistanceLearnerProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationReference is a required property for MnStudentDistanceLearnerProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("programReference is a required property for MnStudentDistanceLearnerProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentReference is a required property for MnStudentDistanceLearnerProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentDistanceLearnerProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentDistanceLearnerProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentDistanceLearnerProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentDistanceLearnerProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentDistanceLearnerProgramAssociation input)
        {
            if (input == null)
                return false;
