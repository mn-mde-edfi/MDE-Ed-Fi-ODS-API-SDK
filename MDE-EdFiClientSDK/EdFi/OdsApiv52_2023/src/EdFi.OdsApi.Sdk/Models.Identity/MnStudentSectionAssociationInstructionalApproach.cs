...
{
    /// <summary>
    /// MnStudentSectionAssociationInstructionalApproach
    /// </summary>
    [DataContract]
    public partial class MnStudentSectionAssociationInstructionalApproach :  IEquatable<MnStudentSectionAssociationInstructionalApproach>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationInstructionalApproach" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentSectionAssociationInstructionalApproach() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentSectionAssociationInstructionalApproach" /> class.
        /// </summary>
        ...
        public MnStudentSectionAssociationInstructionalApproach(string instructionalApproachDescriptor = default(string), string implementationStatusDescriptor = default(string))
        {
            // to ensure "instructionalApproachDescriptor" is required (not null)
            if (instructionalApproachDescriptor == null)
            {
                throw new InvalidDataException("instructionalApproachDescriptor is a required property for MnStudentSectionAssociationInstructionalApproach and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentSectionAssociationInstructionalApproach {\n");
        ...
        {
            return this.Equals(input as MnStudentSectionAssociationInstructionalApproach);
        }

        /// <summary>
        /// Returns true if MnStudentSectionAssociationInstructionalApproach instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentSectionAssociationInstructionalApproach to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentSectionAssociationInstructionalApproach input)
        {
            if (input == null)
                return false;
