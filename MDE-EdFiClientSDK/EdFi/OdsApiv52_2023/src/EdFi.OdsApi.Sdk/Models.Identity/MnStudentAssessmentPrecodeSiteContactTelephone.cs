...
{
    /// <summary>
    /// MnStudentAssessmentPrecodeSiteContactTelephone
    /// </summary>
    [DataContract]
    public partial class MnStudentAssessmentPrecodeSiteContactTelephone :  IEquatable<MnStudentAssessmentPrecodeSiteContactTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecodeSiteContactTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentAssessmentPrecodeSiteContactTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentAssessmentPrecodeSiteContactTelephone" /> class.
        /// </summary>
        ...
        public MnStudentAssessmentPrecodeSiteContactTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for MnStudentAssessmentPrecodeSiteContactTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for MnStudentAssessmentPrecodeSiteContactTelephone and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentAssessmentPrecodeSiteContactTelephone {\n");
        ...
        {
            return this.Equals(input as MnStudentAssessmentPrecodeSiteContactTelephone);
        }

        /// <summary>
        /// Returns true if MnStudentAssessmentPrecodeSiteContactTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentAssessmentPrecodeSiteContactTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentAssessmentPrecodeSiteContactTelephone input)
        {
            if (input == null)
                return false;
