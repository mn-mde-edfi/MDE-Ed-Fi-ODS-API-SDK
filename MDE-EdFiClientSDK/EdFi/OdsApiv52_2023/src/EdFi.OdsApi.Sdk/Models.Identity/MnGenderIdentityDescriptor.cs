...
{
    /// <summary>
    /// MnGenderIdentityDescriptor
    /// </summary>
    [DataContract]
    public partial class MnGenderIdentityDescriptor :  IEquatable<MnGenderIdentityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGenderIdentityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnGenderIdentityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGenderIdentityDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="genderIdentityDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnGenderIdentityDescriptor(string id = default(string), int? genderIdentityDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MnGenderIdentityDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for MnGenderIdentityDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.GenderIdentityDescriptorId = genderIdentityDescriptorId;
        ...
        [DataMember(Name="genderIdentityDescriptorId", EmitDefaultValue=false)]
        public int? GenderIdentityDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnGenderIdentityDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GenderIdentityDescriptorId: ").Append(GenderIdentityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnGenderIdentityDescriptor);
        }

        /// <summary>
        /// Returns true if MnGenderIdentityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnGenderIdentityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnGenderIdentityDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GenderIdentityDescriptorId == input.GenderIdentityDescriptorId ||
                    (this.GenderIdentityDescriptorId != null &&
                    this.GenderIdentityDescriptorId.Equals(input.GenderIdentityDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GenderIdentityDescriptorId != null)
                    hashCode = hashCode * 59 + this.GenderIdentityDescriptorId.GetHashCode();
