...
namespace EdFi.OdsApi.Sdk.Models.Identity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnGradeExtension :  IEquatable<MnGradeExtension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGradeExtension" /> class.
        /// </summary>
        ...
        public MnGradeExtension(string academicSubjectDescriptor = default(string), double? collegeCreditEarned = default(double?), string collegeGradeEarned = default(string), double? localCreditEarned = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnGradeExtension {\n");
        ...
        {
            return this.Equals(input as MnGradeExtension);
        }

        /// <summary>
        /// Returns true if MnGradeExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of MnGradeExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnGradeExtension input)
        {
            if (input == null)
                return false;
