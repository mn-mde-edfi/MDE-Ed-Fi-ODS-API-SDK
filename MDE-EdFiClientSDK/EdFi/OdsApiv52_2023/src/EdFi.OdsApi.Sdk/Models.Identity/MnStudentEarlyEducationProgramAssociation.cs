...
{
    /// <summary>
    /// MnStudentEarlyEducationProgramAssociation
    /// </summary>
    [DataContract]
    public partial class MnStudentEarlyEducationProgramAssociation :  IEquatable<MnStudentEarlyEducationProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentEarlyEducationProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentEarlyEducationProgramAssociation" /> class.
        /// </summary>
        ...
        public MnStudentEarlyEducationProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), List<MnStudentEarlyEducationProgramAssociationFundingSource> fundingSources = default(List<MnStudentEarlyEducationProgramAssociationFundingSource>), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool? servedOutsideOfRegularSession = default(bool?), int? serviceAttendanceHours = default(int?), int? serviceMembershipHours = default(int?), string etag = default(string))
        {
            // to ensure "beginDate" is required (not null)
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for MnStudentEarlyEducationProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("educationOrganizationReference is a required property for MnStudentEarlyEducationProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("programReference is a required property for MnStudentEarlyEducationProgramAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentReference is a required property for MnStudentEarlyEducationProgramAssociation and cannot be null");
            }
            else
            {
        ...
        public List<MnStudentEarlyEducationProgramAssociationFundingSource> FundingSources { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentEarlyEducationProgramAssociation {\n");
        ...
        {
            return this.Equals(input as MnStudentEarlyEducationProgramAssociation);
        }

        /// <summary>
        /// Returns true if MnStudentEarlyEducationProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentEarlyEducationProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentEarlyEducationProgramAssociation input)
        {
            if (input == null)
                return false;
