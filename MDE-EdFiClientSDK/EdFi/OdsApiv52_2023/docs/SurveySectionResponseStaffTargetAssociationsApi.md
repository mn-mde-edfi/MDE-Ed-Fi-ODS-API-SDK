# EdFi.OdsApi.Sdk.Apis.Identity.SurveySectionResponseStaffTargetAssociationsApi
...
<a name="deletesurveysectionresponsestafftargetassociationbyid"></a>
...
namespace Example
{
    public class DeleteSurveySectionResponseStaffTargetAssociationByIdExample
    {
        public void main()
        {
            ...
            var apiInstance = new SurveySectionResponseStaffTargetAssociationsApi();
...
<a name="deletessurveysectionresponsestafftargetassociations"></a>
# **DeletesSurveySectionResponseStaffTargetAssociations**
> List<DeletedResource> DeletesSurveySectionResponseStaffTargetAssociations (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string snapshotIdentifier = null)
...
<a name="getsurveysectionresponsestafftargetassociations"></a>
...
namespace Example
{
    public class GetSurveySectionResponseStaffTargetAssociationsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiSurveySectionResponseStaffTargetAssociation&gt; result = apiInstance.GetSurveySectionResponseStaffTargetAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, staffUniqueId, _namespace, surveyIdentifier, surveyResponseIdentifier, surveySectionTitle, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
<a name="getsurveysectionresponsestafftargetassociationsbyid"></a>
...
<a name="postsurveysectionresponsestafftargetassociation"></a>
...
<a name="putsurveysectionresponsestafftargetassociation"></a>
