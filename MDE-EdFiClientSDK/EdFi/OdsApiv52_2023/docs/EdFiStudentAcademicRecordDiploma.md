# EdFi.OdsApi.Sdk.Models.Identity.EdFiStudentAcademicRecordDiploma
## Properties
...
**DiplomaAwardDate** | **DateTime?** | The month, day, and year on which the student met  graduation requirements and was awarded a diploma. | 
...
**DiplomaAwardExpiresDate** | **DateTime?** | Date on which the award expires. | [optional] 
