# EdFi.OdsApi.Sdk.Apis.Identity.CteProgramServiceDescriptorsApi
...
namespace Example
{
    public class DeleteCTEProgramServiceDescriptorByIdExample
    {
        public void main()
        {
            ...
            var apiInstance = new CteProgramServiceDescriptorsApi();
...
> List<DeletedResource> DeletesCTEProgramServiceDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string snapshotIdentifier = null)
...
> List<EdFiCteProgramServiceDescriptor> GetCTEProgramServiceDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, int? cteProgramServiceDescriptorId = null, string snapshotIdentifier = null)
