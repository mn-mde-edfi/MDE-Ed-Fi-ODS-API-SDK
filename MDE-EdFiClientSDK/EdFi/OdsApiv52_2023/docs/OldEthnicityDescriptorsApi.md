# EdFi.OdsApi.Sdk.Apis.Identity.OldEthnicityDescriptorsApi
...
> List<DeletedResource> DeletesOldEthnicityDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string snapshotIdentifier = null)
...
> List<EdFiOldEthnicityDescriptor> GetOldEthnicityDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, int? oldEthnicityDescriptorId = null, string snapshotIdentifier = null)
