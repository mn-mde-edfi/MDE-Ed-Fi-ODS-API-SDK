...
${nuget_cmd} install src/EdFi.OdsApi.Sdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EdFi.OdsApi.Sdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/EdFi.OdsApi.Sdk.dll \
-recurse:'src/EdFi.OdsApi.Sdk/*.cs' \
-doc:bin/EdFi.OdsApi.Sdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/EdFi.OdsApi.Sdk.dll was created successfully"
fi
