# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Preview_SISVendor_Profile.DisciplineActionsApi
...
> List&lt;EdFiDisciplineActionReadable&gt; GetDisciplineActions (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, string? disciplineActionIdentifier = null, DateTime? disciplineDate = null, string? studentUniqueId = null, int? responsibilitySchoolId = null, double? actualDisciplineActionLength = null, double? disciplineActionLength = null, string? id = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class GetDisciplineActionsExample
    {
        public static void Main()
        {
            ...
            var disciplineDate = DateTime.Parse("2013-10-20");  // DateTime? | The date of the DisciplineAction. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiDisciplineActionReadable> result = apiInstance.GetDisciplineActions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, disciplineActionIdentifier, disciplineDate, studentUniqueId, responsibilitySchoolId, actualDisciplineActionLength, disciplineActionLength, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
[**List&lt;EdFiDisciplineActionReadable&gt;**](EdFiDisciplineActionReadable.md)
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.ed-fi.disciplineaction.minnesota-preview-sisvendorprofile.readable+json
...
> EdFiDisciplineActionReadable GetDisciplineActionsById (string id, string? ifNoneMatch = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class GetDisciplineActionsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiDisciplineActionReadable result = apiInstance.GetDisciplineActionsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiDisciplineActionReadable> response = apiInstance.GetDisciplineActionsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
[**EdFiDisciplineActionReadable**](EdFiDisciplineActionReadable.md)
...
> void PostdisciplineAction (EdFiDisciplineActionWritable disciplineAction)
...
namespace Example
{
    public class PostdisciplineActionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new DisciplineActionsApi(config);
            var disciplineAction = new EdFiDisciplineActionWritable(); // EdFiDisciplineActionWritable | The JSON representation of the \"disciplineAction\" resource to be created or updated.
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **disciplineAction** | [**EdFiDisciplineActionWritable**](EdFiDisciplineActionWritable.md) | The JSON representation of the \&quot;disciplineAction\&quot; resource to be created or updated. |  |
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.disciplineaction.minnesota-preview-sisvendorprofile.writable+json
 - **Accept**: Not defined
...
# **PutdisciplineAction**
> void PutdisciplineAction (string id, EdFiDisciplineActionWritable disciplineAction, string? ifMatch = null)
