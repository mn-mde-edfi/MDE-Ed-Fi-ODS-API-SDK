...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    public partial class EdFiAssessmentPerformanceLevelReadable : IEquatable<EdFiAssessmentPerformanceLevelReadable>, IValidatableObject
    {
        ...
        public EdFiAssessmentPerformanceLevelReadable(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
