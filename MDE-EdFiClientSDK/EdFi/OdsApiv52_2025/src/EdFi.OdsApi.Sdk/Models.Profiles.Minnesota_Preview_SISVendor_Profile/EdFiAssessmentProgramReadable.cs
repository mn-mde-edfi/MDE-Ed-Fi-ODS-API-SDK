...
{
    /// <summary>
    /// EdFiAssessmentProgramReadable
    /// </summary>
    [DataContract(Name = "edFi_assessmentProgram_readable")]
    public partial class EdFiAssessmentProgramReadable : IEquatable<EdFiAssessmentProgramReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentProgramReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentProgramReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentProgramReadable" /> class.
        /// </summary>
        ...
        public EdFiAssessmentProgramReadable(EdFiProgramReference programReference = default(EdFiProgramReference))
        {
            ...
            {
                throw new ArgumentNullException("programReference is a required property for EdFiAssessmentProgramReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssessmentProgramReadable {\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentProgramReadable);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentProgramReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentProgramReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentProgramReadable input)
        {
            if (input == null)
            {
                return false;
