...
{
    /// <summary>
    /// EdFiDisciplineIncidentReadable
    /// </summary>
    [DataContract(Name = "edFi_disciplineIncident_readable")]
    public partial class EdFiDisciplineIncidentReadable : IEquatable<EdFiDisciplineIncidentReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineIncidentReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineIncidentReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineIncidentReadable" /> class.
        /// </summary>
        ...
        public EdFiDisciplineIncidentReadable(string id = default(string), string incidentIdentifier = default(string), List<EdFiDisciplineIncidentLocationReadable> locations = default(List<EdFiDisciplineIncidentLocationReadable>), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), DateTime incidentDate = default(DateTime), string etag = default(string), DisciplineIncidentExtensionsReadable ext = default(DisciplineIncidentExtensionsReadable))
        {
            // to ensure "incidentIdentifier" is required (not null)
            if (incidentIdentifier == null)
            {
                throw new ArgumentNullException("incidentIdentifier is a required property for EdFiDisciplineIncidentReadable and cannot be null");
            }
            this.IncidentIdentifier = incidentIdentifier;
            // to ensure "locations" is required (not null)
            if (locations == null)
            {
                throw new ArgumentNullException("locations is a required property for EdFiDisciplineIncidentReadable and cannot be null");
            }
            this.Locations = locations;
            // to ensure "schoolReference" is required (not null)
            if (schoolReference == null)
            {
                throw new ArgumentNullException("schoolReference is a required property for EdFiDisciplineIncidentReadable and cannot be null");
            }
        ...
        public List<EdFiDisciplineIncidentLocationReadable> Locations { get; set; }
        ...
        public DisciplineIncidentExtensionsReadable Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiDisciplineIncidentReadable {\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineIncidentReadable);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineIncidentReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineIncidentReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineIncidentReadable input)
        {
            if (input == null)
            {
                return false;
