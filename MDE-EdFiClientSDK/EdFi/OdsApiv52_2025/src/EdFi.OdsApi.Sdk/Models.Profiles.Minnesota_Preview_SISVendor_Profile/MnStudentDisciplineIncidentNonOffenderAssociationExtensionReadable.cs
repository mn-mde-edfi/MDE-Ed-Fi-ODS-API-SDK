...
{
    /// <summary>
    /// MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable
    /// </summary>
    [DataContract(Name = "mn_studentDisciplineIncidentNonOffenderAssociationExtension_readable")]
    public partial class MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable : IEquatable<MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable" /> class.
        /// </summary>
        ...
        public MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable(string costToVictimDescriptor = default(string), bool didInjuryOccur = default(bool), bool didSeriousBodilyInjuryOccur = default(bool))
        {
        ...
        [DataMember(Name = "costToVictimDescriptor", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable);
        }

        /// <summary>
        /// Returns true if MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentDisciplineIncidentNonOffenderAssociationExtensionReadable input)
        {
            if (input == null)
            {
                return false;
