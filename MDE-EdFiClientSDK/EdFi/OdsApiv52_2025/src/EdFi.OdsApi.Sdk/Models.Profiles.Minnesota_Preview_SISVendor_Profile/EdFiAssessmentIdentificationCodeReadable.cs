...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentIdentificationCode_readable")]
    public partial class EdFiAssessmentIdentificationCodeReadable : IEquatable<EdFiAssessmentIdentificationCodeReadable>, IValidatableObject
    {
        ...
        public EdFiAssessmentIdentificationCodeReadable(string assessmentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new ArgumentNullException("assessmentIdentificationSystemDescriptor is a required property for EdFiAssessmentIdentificationCodeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("identificationCode is a required property for EdFiAssessmentIdentificationCodeReadable and cannot be null");
            }
