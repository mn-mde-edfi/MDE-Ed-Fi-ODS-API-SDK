...
{
    /// <summary>
    /// MnDisciplineIncidentReference
    /// </summary>
    [DataContract(Name = "mn_disciplineIncidentReference")]
    public partial class MnDisciplineIncidentReference : IEquatable<MnDisciplineIncidentReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDisciplineIncidentReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnDisciplineIncidentReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnDisciplineIncidentReference" /> class.
        /// </summary>
        ...
        public MnDisciplineIncidentReference(string incidentIdentifier = default(string), int schoolId = default(int), Link link = default(Link))
        {
            // to ensure "incidentIdentifier" is required (not null)
            if (incidentIdentifier == null)
            {
                throw new ArgumentNullException("incidentIdentifier is a required property for MnDisciplineIncidentReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnDisciplineIncidentReference {\n");
        ...
        {
            return this.Equals(input as MnDisciplineIncidentReference);
        }

        /// <summary>
        /// Returns true if MnDisciplineIncidentReference instances are equal
        /// </summary>
        /// <param name="input">Instance of MnDisciplineIncidentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnDisciplineIncidentReference input)
        {
            if (input == null)
            {
                return false;
