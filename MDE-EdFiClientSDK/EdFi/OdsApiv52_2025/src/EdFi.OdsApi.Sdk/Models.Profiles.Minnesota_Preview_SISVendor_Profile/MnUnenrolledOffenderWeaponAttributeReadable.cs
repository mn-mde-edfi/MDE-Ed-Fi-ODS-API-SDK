...
{
    /// <summary>
    /// MnUnenrolledOffenderWeaponAttributeReadable
    /// </summary>
    [DataContract(Name = "mn_unenrolledOffenderWeaponAttribute_readable")]
    public partial class MnUnenrolledOffenderWeaponAttributeReadable : IEquatable<MnUnenrolledOffenderWeaponAttributeReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnUnenrolledOffenderWeaponAttributeReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnUnenrolledOffenderWeaponAttributeReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnUnenrolledOffenderWeaponAttributeReadable" /> class.
        /// </summary>
        ...
        public MnUnenrolledOffenderWeaponAttributeReadable(string weaponDescriptor = default(string), bool isGunCased = default(bool), bool isGunInTrunk = default(bool), bool isGunLoaded = default(bool), int numberOfWeaponsInvolved = default(int), string weaponIdentifier = default(string))
        {
            // to ensure "weaponDescriptor" is required (not null)
            if (weaponDescriptor == null)
            {
                throw new ArgumentNullException("weaponDescriptor is a required property for MnUnenrolledOffenderWeaponAttributeReadable and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("weaponIdentifier is a required property for MnUnenrolledOffenderWeaponAttributeReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnUnenrolledOffenderWeaponAttributeReadable {\n");
        ...
        {
            return this.Equals(input as MnUnenrolledOffenderWeaponAttributeReadable);
        }

        /// <summary>
        /// Returns true if MnUnenrolledOffenderWeaponAttributeReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnUnenrolledOffenderWeaponAttributeReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnUnenrolledOffenderWeaponAttributeReadable input)
        {
            if (input == null)
            {
                return false;
