...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentAssessmentPrecodeAccommodation_readable")]
    public partial class MnStudentAssessmentPrecodeAccommodationReadable : IEquatable<MnStudentAssessmentPrecodeAccommodationReadable>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeAccommodationReadable(string accommodationDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("accommodationDescriptor is a required property for MnStudentAssessmentPrecodeAccommodationReadable and cannot be null");
            }
