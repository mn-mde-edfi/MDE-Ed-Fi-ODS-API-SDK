...
namespace EdFi.OdsApi.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://test.edfi5.education.mn.gov:443/sb24/api/data/v3";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://test.edfi5.education.mn.gov:443/sb24/api/data/v3"},
        ...
        public Configuration(
            ...
            string basePath = "https://test.edfi5.education.mn.gov:443/sb24/api/data/v3") : this()
        {
