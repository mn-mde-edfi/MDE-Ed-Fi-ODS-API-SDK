...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Two_Twenty_Three_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationStudentIndicator_readable")]
    public partial class EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable : IEquatable<EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable(string indicatorName = default(string), string indicator = default(string), string indicatorGroup = default(string))
        {
            ...
            {
                throw new ArgumentNullException("indicatorName is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable and cannot be null");
            }
            this.IndicatorName = indicatorName;
            // to ensure "indicator" is required (not null)
            if (indicator == null)
            {
                throw new ArgumentNullException("indicator is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable and cannot be null");
            }
