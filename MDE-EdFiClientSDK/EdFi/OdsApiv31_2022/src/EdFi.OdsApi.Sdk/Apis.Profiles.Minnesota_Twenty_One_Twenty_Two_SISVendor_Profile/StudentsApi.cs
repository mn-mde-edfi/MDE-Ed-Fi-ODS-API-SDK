...
namespace EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    public interface IStudentsApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiStudentReadable> GetStudentsByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiStudentReadable> GetStudentsByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiStudentReadable>> GetStudentsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class StudentsApi : IStudentsApi
    {
        ...
        public ApiResponse< List<EdFiStudentReadable> > GetStudentsWithHttpInfo (int? offset = null, int? limit = null, bool? totalCount = null, string studentUniqueId = null, string birthSexDescriptor = null, DateTime? birthDate = null, string firstName = null, string generationCodeSuffix = null, string id = null, string lastSurname = null, string middleName = null)
        {
            ...
            return new ApiResponse<List<EdFiStudentReadable>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<EdFiStudentReadable>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<EdFiStudentReadable>)));
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiStudentReadable</returns>
        public EdFiStudentReadable GetStudentsById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentReadable> localVarResponse = GetStudentsByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiStudentReadable</returns>
        public ApiResponse< EdFiStudentReadable > GetStudentsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<EdFiStudentReadable>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (EdFiStudentReadable) Configuration.ApiClient.Deserialize(localVarResponse, typeof(EdFiStudentReadable)));
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiStudentReadable</returns>
        public async System.Threading.Tasks.Task<EdFiStudentReadable> GetStudentsByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentReadable> localVarResponse = await GetStudentsByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiStudentReadable)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiStudentReadable>> GetStudentsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StudentsApi->GetStudentsById");
