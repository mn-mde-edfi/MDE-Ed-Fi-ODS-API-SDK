...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_Twenty_One_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentCEISProgramAssociationReadable :  IEquatable<MnStudentCEISProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        ...
        public MnStudentCEISProgramAssociationReadable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStudentCEISProgramAssociationReadable and cannot be null");
            }
            else
            {
                this.Id = Id;
