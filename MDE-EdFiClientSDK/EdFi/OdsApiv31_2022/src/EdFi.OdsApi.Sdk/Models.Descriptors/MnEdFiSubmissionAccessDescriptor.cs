...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnEdFiSubmissionAccessDescriptor :  IEquatable<MnEdFiSubmissionAccessDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEdFiSubmissionAccessDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnEdFiSubmissionAccessDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEdFiSubmissionAccessDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="EdFiSubmissionAccessDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnEdFiSubmissionAccessDescriptor(string Id = default(string), int? EdFiSubmissionAccessDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnEdFiSubmissionAccessDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnEdFiSubmissionAccessDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnEdFiSubmissionAccessDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.EdFiSubmissionAccessDescriptorId = EdFiSubmissionAccessDescriptorId;
        ...
        [DataMember(Name="edFiSubmissionAccessDescriptorId", EmitDefaultValue=false)]
        public int? EdFiSubmissionAccessDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnEdFiSubmissionAccessDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EdFiSubmissionAccessDescriptorId: ").Append(EdFiSubmissionAccessDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnEdFiSubmissionAccessDescriptor);
        }

        /// <summary>
        /// Returns true if MnEdFiSubmissionAccessDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnEdFiSubmissionAccessDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnEdFiSubmissionAccessDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EdFiSubmissionAccessDescriptorId == input.EdFiSubmissionAccessDescriptorId ||
                    (this.EdFiSubmissionAccessDescriptorId != null &&
                    this.EdFiSubmissionAccessDescriptorId.Equals(input.EdFiSubmissionAccessDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EdFiSubmissionAccessDescriptorId != null)
                    hashCode = hashCode * 59 + this.EdFiSubmissionAccessDescriptorId.GetHashCode();
