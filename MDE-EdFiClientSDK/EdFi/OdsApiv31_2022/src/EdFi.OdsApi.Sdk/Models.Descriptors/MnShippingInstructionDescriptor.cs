...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnShippingInstructionDescriptor :  IEquatable<MnShippingInstructionDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnShippingInstructionDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnShippingInstructionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnShippingInstructionDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="ShippingInstructionDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnShippingInstructionDescriptor(string Id = default(string), int? ShippingInstructionDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnShippingInstructionDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnShippingInstructionDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnShippingInstructionDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.ShippingInstructionDescriptorId = ShippingInstructionDescriptorId;
        ...
        [DataMember(Name="shippingInstructionDescriptorId", EmitDefaultValue=false)]
        public int? ShippingInstructionDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnShippingInstructionDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ShippingInstructionDescriptorId: ").Append(ShippingInstructionDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnShippingInstructionDescriptor);
        }

        /// <summary>
        /// Returns true if MnShippingInstructionDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnShippingInstructionDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnShippingInstructionDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ShippingInstructionDescriptorId == input.ShippingInstructionDescriptorId ||
                    (this.ShippingInstructionDescriptorId != null &&
                    this.ShippingInstructionDescriptorId.Equals(input.ShippingInstructionDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShippingInstructionDescriptorId != null)
                    hashCode = hashCode * 59 + this.ShippingInstructionDescriptorId.GetHashCode();
