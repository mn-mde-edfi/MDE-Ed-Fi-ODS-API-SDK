...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnAssessmentToolDescriptor :  IEquatable<MnAssessmentToolDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentToolDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentToolDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentToolDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="AssessmentToolDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAssessmentToolDescriptor(string Id = default(string), int? AssessmentToolDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnAssessmentToolDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnAssessmentToolDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentToolDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnAssessmentToolDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.AssessmentToolDescriptorId = AssessmentToolDescriptorId;
        ...
        [DataMember(Name="assessmentToolDescriptorId", EmitDefaultValue=false)]
        public int? AssessmentToolDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentToolDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssessmentToolDescriptorId: ").Append(AssessmentToolDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAssessmentToolDescriptor);
        }

        /// <summary>
        /// Returns true if MnAssessmentToolDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentToolDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentToolDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentToolDescriptorId == input.AssessmentToolDescriptorId ||
                    (this.AssessmentToolDescriptorId != null &&
                    this.AssessmentToolDescriptorId.Equals(input.AssessmentToolDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssessmentToolDescriptorId != null)
                    hashCode = hashCode * 59 + this.AssessmentToolDescriptorId.GetHashCode();
