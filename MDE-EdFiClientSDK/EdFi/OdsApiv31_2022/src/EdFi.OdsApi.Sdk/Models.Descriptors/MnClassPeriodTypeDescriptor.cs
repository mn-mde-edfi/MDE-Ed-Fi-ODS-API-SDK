...
{
    /// <summary>
    /// MnClassPeriodTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnClassPeriodTypeDescriptor :  IEquatable<MnClassPeriodTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnClassPeriodTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnClassPeriodTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnClassPeriodTypeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="ClassPeriodTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnClassPeriodTypeDescriptor(string Id = default(string), int? ClassPeriodTypeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnClassPeriodTypeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnClassPeriodTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnClassPeriodTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnClassPeriodTypeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.ClassPeriodTypeDescriptorId = ClassPeriodTypeDescriptorId;
        ...
        [DataMember(Name="classPeriodTypeDescriptorId", EmitDefaultValue=false)]
        public int? ClassPeriodTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnClassPeriodTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ClassPeriodTypeDescriptorId: ").Append(ClassPeriodTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnClassPeriodTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnClassPeriodTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnClassPeriodTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnClassPeriodTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ClassPeriodTypeDescriptorId == input.ClassPeriodTypeDescriptorId ||
                    (this.ClassPeriodTypeDescriptorId != null &&
                    this.ClassPeriodTypeDescriptorId.Equals(input.ClassPeriodTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClassPeriodTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.ClassPeriodTypeDescriptorId.GetHashCode();
