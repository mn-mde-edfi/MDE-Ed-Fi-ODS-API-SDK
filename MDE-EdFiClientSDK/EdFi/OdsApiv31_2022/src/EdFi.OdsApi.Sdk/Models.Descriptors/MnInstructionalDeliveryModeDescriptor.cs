...
{
    /// <summary>
    /// MnInstructionalDeliveryModeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnInstructionalDeliveryModeDescriptor :  IEquatable<MnInstructionalDeliveryModeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnInstructionalDeliveryModeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnInstructionalDeliveryModeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnInstructionalDeliveryModeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="InstructionalDeliveryModeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnInstructionalDeliveryModeDescriptor(string Id = default(string), int? InstructionalDeliveryModeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnInstructionalDeliveryModeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnInstructionalDeliveryModeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnInstructionalDeliveryModeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnInstructionalDeliveryModeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.InstructionalDeliveryModeDescriptorId = InstructionalDeliveryModeDescriptorId;
        ...
        [DataMember(Name="instructionalDeliveryModeDescriptorId", EmitDefaultValue=false)]
        public int? InstructionalDeliveryModeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnInstructionalDeliveryModeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InstructionalDeliveryModeDescriptorId: ").Append(InstructionalDeliveryModeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnInstructionalDeliveryModeDescriptor);
        }

        /// <summary>
        /// Returns true if MnInstructionalDeliveryModeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnInstructionalDeliveryModeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnInstructionalDeliveryModeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InstructionalDeliveryModeDescriptorId == input.InstructionalDeliveryModeDescriptorId ||
                    (this.InstructionalDeliveryModeDescriptorId != null &&
                    this.InstructionalDeliveryModeDescriptorId.Equals(input.InstructionalDeliveryModeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InstructionalDeliveryModeDescriptorId != null)
                    hashCode = hashCode * 59 + this.InstructionalDeliveryModeDescriptorId.GetHashCode();
