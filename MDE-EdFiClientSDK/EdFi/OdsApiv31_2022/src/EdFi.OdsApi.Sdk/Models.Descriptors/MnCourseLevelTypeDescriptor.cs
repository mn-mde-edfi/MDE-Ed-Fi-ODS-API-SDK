...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnCourseLevelTypeDescriptor :  IEquatable<MnCourseLevelTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseLevelTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCourseLevelTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCourseLevelTypeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="CourseLevelTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnCourseLevelTypeDescriptor(string Id = default(string), int? CourseLevelTypeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnCourseLevelTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnCourseLevelTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnCourseLevelTypeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.CourseLevelTypeDescriptorId = CourseLevelTypeDescriptorId;
        ...
        [DataMember(Name="courseLevelTypeDescriptorId", EmitDefaultValue=false)]
        public int? CourseLevelTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCourseLevelTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CourseLevelTypeDescriptorId: ").Append(CourseLevelTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnCourseLevelTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnCourseLevelTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCourseLevelTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCourseLevelTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CourseLevelTypeDescriptorId == input.CourseLevelTypeDescriptorId ||
                    (this.CourseLevelTypeDescriptorId != null &&
                    this.CourseLevelTypeDescriptorId.Equals(input.CourseLevelTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CourseLevelTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.CourseLevelTypeDescriptorId.GetHashCode();
