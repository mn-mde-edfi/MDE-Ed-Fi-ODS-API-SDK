...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    public partial class EdFiNetworkPurposeDescriptor :  IEquatable<EdFiNetworkPurposeDescriptor>, IValidatableObject
    {
        ...
        public EdFiNetworkPurposeDescriptor(string Id = default(string), int? NetworkPurposeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            else
            {
        ...
        public bool Equals(EdFiNetworkPurposeDescriptor input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.NetworkPurposeDescriptorId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NetworkPurposeDescriptorId != null)
