...
{
    /// <summary>
    /// MnCareerClusterDescriptor
    /// </summary>
    [DataContract]
    public partial class MnCareerClusterDescriptor :  IEquatable<MnCareerClusterDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCareerClusterDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnCareerClusterDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnCareerClusterDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="CareerClusterDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnCareerClusterDescriptor(string Id = default(string), int? CareerClusterDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnCareerClusterDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnCareerClusterDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnCareerClusterDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnCareerClusterDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.CareerClusterDescriptorId = CareerClusterDescriptorId;
        ...
        [DataMember(Name="careerClusterDescriptorId", EmitDefaultValue=false)]
        public int? CareerClusterDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnCareerClusterDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CareerClusterDescriptorId: ").Append(CareerClusterDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnCareerClusterDescriptor);
        }

        /// <summary>
        /// Returns true if MnCareerClusterDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnCareerClusterDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnCareerClusterDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CareerClusterDescriptorId == input.CareerClusterDescriptorId ||
                    (this.CareerClusterDescriptorId != null &&
                    this.CareerClusterDescriptorId.Equals(input.CareerClusterDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CareerClusterDescriptorId != null)
                    hashCode = hashCode * 59 + this.CareerClusterDescriptorId.GetHashCode();
