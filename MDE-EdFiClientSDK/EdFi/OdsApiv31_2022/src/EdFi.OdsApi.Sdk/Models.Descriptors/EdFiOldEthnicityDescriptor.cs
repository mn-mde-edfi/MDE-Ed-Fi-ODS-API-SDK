...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiOldEthnicityDescriptor :  IEquatable<EdFiOldEthnicityDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiOldEthnicityDescriptor(string Id = default(string), int? OldEthnicityDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for EdFiOldEthnicityDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for EdFiOldEthnicityDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for EdFiOldEthnicityDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for EdFiOldEthnicityDescriptor and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EdFiOldEthnicityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiOldEthnicityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOldEthnicityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOldEthnicityDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OldEthnicityDescriptorId == input.OldEthnicityDescriptorId ||
                    (this.OldEthnicityDescriptorId != null &&
                    this.OldEthnicityDescriptorId.Equals(input.OldEthnicityDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OldEthnicityDescriptorId != null)
                    hashCode = hashCode * 59 + this.OldEthnicityDescriptorId.GetHashCode();
