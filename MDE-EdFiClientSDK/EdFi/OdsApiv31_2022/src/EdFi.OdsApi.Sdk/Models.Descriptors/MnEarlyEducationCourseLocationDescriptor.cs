...
{
    /// <summary>
    /// MnEarlyEducationCourseLocationDescriptor
    /// </summary>
    [DataContract]
    public partial class MnEarlyEducationCourseLocationDescriptor :  IEquatable<MnEarlyEducationCourseLocationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyEducationCourseLocationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnEarlyEducationCourseLocationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyEducationCourseLocationDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="EarlyEducationCourseLocationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnEarlyEducationCourseLocationDescriptor(string Id = default(string), int? EarlyEducationCourseLocationDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnEarlyEducationCourseLocationDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnEarlyEducationCourseLocationDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnEarlyEducationCourseLocationDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.EarlyEducationCourseLocationDescriptorId = EarlyEducationCourseLocationDescriptorId;
        ...
        [DataMember(Name="earlyEducationCourseLocationDescriptorId", EmitDefaultValue=false)]
        public int? EarlyEducationCourseLocationDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnEarlyEducationCourseLocationDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EarlyEducationCourseLocationDescriptorId: ").Append(EarlyEducationCourseLocationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnEarlyEducationCourseLocationDescriptor);
        }

        /// <summary>
        /// Returns true if MnEarlyEducationCourseLocationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnEarlyEducationCourseLocationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnEarlyEducationCourseLocationDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EarlyEducationCourseLocationDescriptorId == input.EarlyEducationCourseLocationDescriptorId ||
                    (this.EarlyEducationCourseLocationDescriptorId != null &&
                    this.EarlyEducationCourseLocationDescriptorId.Equals(input.EarlyEducationCourseLocationDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EarlyEducationCourseLocationDescriptorId != null)
                    hashCode = hashCode * 59 + this.EarlyEducationCourseLocationDescriptorId.GetHashCode();
