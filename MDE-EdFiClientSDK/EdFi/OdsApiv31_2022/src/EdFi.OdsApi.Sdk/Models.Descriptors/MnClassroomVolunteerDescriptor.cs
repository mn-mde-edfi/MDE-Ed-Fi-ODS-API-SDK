...
{
    /// <summary>
    /// MnClassroomVolunteerDescriptor
    /// </summary>
    [DataContract]
    public partial class MnClassroomVolunteerDescriptor :  IEquatable<MnClassroomVolunteerDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnClassroomVolunteerDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnClassroomVolunteerDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnClassroomVolunteerDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="ClassroomVolunteerDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnClassroomVolunteerDescriptor(string Id = default(string), int? ClassroomVolunteerDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnClassroomVolunteerDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnClassroomVolunteerDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnClassroomVolunteerDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnClassroomVolunteerDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.ClassroomVolunteerDescriptorId = ClassroomVolunteerDescriptorId;
        ...
        [DataMember(Name="classroomVolunteerDescriptorId", EmitDefaultValue=false)]
        public int? ClassroomVolunteerDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnClassroomVolunteerDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ClassroomVolunteerDescriptorId: ").Append(ClassroomVolunteerDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnClassroomVolunteerDescriptor);
        }

        /// <summary>
        /// Returns true if MnClassroomVolunteerDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnClassroomVolunteerDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnClassroomVolunteerDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ClassroomVolunteerDescriptorId == input.ClassroomVolunteerDescriptorId ||
                    (this.ClassroomVolunteerDescriptorId != null &&
                    this.ClassroomVolunteerDescriptorId.Equals(input.ClassroomVolunteerDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClassroomVolunteerDescriptorId != null)
                    hashCode = hashCode * 59 + this.ClassroomVolunteerDescriptorId.GetHashCode();
