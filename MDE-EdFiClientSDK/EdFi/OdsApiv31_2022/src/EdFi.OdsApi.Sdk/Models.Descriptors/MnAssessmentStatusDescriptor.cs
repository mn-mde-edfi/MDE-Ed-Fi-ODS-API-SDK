...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnAssessmentStatusDescriptor :  IEquatable<MnAssessmentStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentStatusDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="AssessmentStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAssessmentStatusDescriptor(string Id = default(string), int? AssessmentStatusDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnAssessmentStatusDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnAssessmentStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnAssessmentStatusDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.AssessmentStatusDescriptorId = AssessmentStatusDescriptorId;
        ...
        [DataMember(Name="assessmentStatusDescriptorId", EmitDefaultValue=false)]
        public int? AssessmentStatusDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssessmentStatusDescriptorId: ").Append(AssessmentStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAssessmentStatusDescriptor);
        }

        /// <summary>
        /// Returns true if MnAssessmentStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentStatusDescriptorId == input.AssessmentStatusDescriptorId ||
                    (this.AssessmentStatusDescriptorId != null &&
                    this.AssessmentStatusDescriptorId.Equals(input.AssessmentStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssessmentStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.AssessmentStatusDescriptorId.GetHashCode();
