...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnInstructionalApproachDescriptor :  IEquatable<MnInstructionalApproachDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnInstructionalApproachDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnInstructionalApproachDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnInstructionalApproachDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="InstructionalApproachDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnInstructionalApproachDescriptor(string Id = default(string), int? InstructionalApproachDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnInstructionalApproachDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnInstructionalApproachDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnInstructionalApproachDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.InstructionalApproachDescriptorId = InstructionalApproachDescriptorId;
        ...
        [DataMember(Name="instructionalApproachDescriptorId", EmitDefaultValue=false)]
        public int? InstructionalApproachDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnInstructionalApproachDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InstructionalApproachDescriptorId: ").Append(InstructionalApproachDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnInstructionalApproachDescriptor);
        }

        /// <summary>
        /// Returns true if MnInstructionalApproachDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnInstructionalApproachDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnInstructionalApproachDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InstructionalApproachDescriptorId == input.InstructionalApproachDescriptorId ||
                    (this.InstructionalApproachDescriptorId != null &&
                    this.InstructionalApproachDescriptorId.Equals(input.InstructionalApproachDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InstructionalApproachDescriptorId != null)
                    hashCode = hashCode * 59 + this.InstructionalApproachDescriptorId.GetHashCode();
