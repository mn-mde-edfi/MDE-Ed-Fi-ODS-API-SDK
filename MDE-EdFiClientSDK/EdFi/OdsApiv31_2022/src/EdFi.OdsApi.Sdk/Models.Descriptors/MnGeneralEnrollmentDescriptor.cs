...
{
    /// <summary>
    /// MnGeneralEnrollmentDescriptor
    /// </summary>
    [DataContract]
    public partial class MnGeneralEnrollmentDescriptor :  IEquatable<MnGeneralEnrollmentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGeneralEnrollmentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnGeneralEnrollmentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnGeneralEnrollmentDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="GeneralEnrollmentDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnGeneralEnrollmentDescriptor(string Id = default(string), int? GeneralEnrollmentDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnGeneralEnrollmentDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnGeneralEnrollmentDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnGeneralEnrollmentDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.GeneralEnrollmentDescriptorId = GeneralEnrollmentDescriptorId;
        ...
        [DataMember(Name="generalEnrollmentDescriptorId", EmitDefaultValue=false)]
        public int? GeneralEnrollmentDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnGeneralEnrollmentDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GeneralEnrollmentDescriptorId: ").Append(GeneralEnrollmentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnGeneralEnrollmentDescriptor);
        }

        /// <summary>
        /// Returns true if MnGeneralEnrollmentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnGeneralEnrollmentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnGeneralEnrollmentDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GeneralEnrollmentDescriptorId == input.GeneralEnrollmentDescriptorId ||
                    (this.GeneralEnrollmentDescriptorId != null &&
                    this.GeneralEnrollmentDescriptorId.Equals(input.GeneralEnrollmentDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GeneralEnrollmentDescriptorId != null)
                    hashCode = hashCode * 59 + this.GeneralEnrollmentDescriptorId.GetHashCode();
