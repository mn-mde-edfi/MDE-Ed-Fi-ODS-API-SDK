...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnEarlyChildhoodScreeningExitStatusDescriptor :  IEquatable<MnEarlyChildhoodScreeningExitStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyChildhoodScreeningExitStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnEarlyChildhoodScreeningExitStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnEarlyChildhoodScreeningExitStatusDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="EarlyChildhoodScreeningExitStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnEarlyChildhoodScreeningExitStatusDescriptor(string Id = default(string), int? EarlyChildhoodScreeningExitStatusDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnEarlyChildhoodScreeningExitStatusDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnEarlyChildhoodScreeningExitStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnEarlyChildhoodScreeningExitStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnEarlyChildhoodScreeningExitStatusDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.EarlyChildhoodScreeningExitStatusDescriptorId = EarlyChildhoodScreeningExitStatusDescriptorId;
        ...
        [DataMember(Name="earlyChildhoodScreeningExitStatusDescriptorId", EmitDefaultValue=false)]
        public int? EarlyChildhoodScreeningExitStatusDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnEarlyChildhoodScreeningExitStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EarlyChildhoodScreeningExitStatusDescriptorId: ").Append(EarlyChildhoodScreeningExitStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnEarlyChildhoodScreeningExitStatusDescriptor);
        }

        /// <summary>
        /// Returns true if MnEarlyChildhoodScreeningExitStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnEarlyChildhoodScreeningExitStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnEarlyChildhoodScreeningExitStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EarlyChildhoodScreeningExitStatusDescriptorId == input.EarlyChildhoodScreeningExitStatusDescriptorId ||
                    (this.EarlyChildhoodScreeningExitStatusDescriptorId != null &&
                    this.EarlyChildhoodScreeningExitStatusDescriptorId.Equals(input.EarlyChildhoodScreeningExitStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EarlyChildhoodScreeningExitStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.EarlyChildhoodScreeningExitStatusDescriptorId.GetHashCode();
