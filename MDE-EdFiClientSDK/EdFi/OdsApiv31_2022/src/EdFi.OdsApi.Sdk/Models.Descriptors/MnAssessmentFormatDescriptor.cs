...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnAssessmentFormatDescriptor :  IEquatable<MnAssessmentFormatDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentFormatDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentFormatDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentFormatDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="AssessmentFormatDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAssessmentFormatDescriptor(string Id = default(string), int? AssessmentFormatDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnAssessmentFormatDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnAssessmentFormatDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentFormatDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnAssessmentFormatDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.AssessmentFormatDescriptorId = AssessmentFormatDescriptorId;
        ...
        [DataMember(Name="assessmentFormatDescriptorId", EmitDefaultValue=false)]
        public int? AssessmentFormatDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentFormatDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssessmentFormatDescriptorId: ").Append(AssessmentFormatDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAssessmentFormatDescriptor);
        }

        /// <summary>
        /// Returns true if MnAssessmentFormatDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentFormatDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentFormatDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentFormatDescriptorId == input.AssessmentFormatDescriptorId ||
                    (this.AssessmentFormatDescriptorId != null &&
                    this.AssessmentFormatDescriptorId.Equals(input.AssessmentFormatDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssessmentFormatDescriptorId != null)
                    hashCode = hashCode * 59 + this.AssessmentFormatDescriptorId.GetHashCode();
