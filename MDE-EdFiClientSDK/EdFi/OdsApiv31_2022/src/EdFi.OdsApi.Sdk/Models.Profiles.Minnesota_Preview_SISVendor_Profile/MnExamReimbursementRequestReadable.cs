...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    public partial class MnExamReimbursementRequestReadable :  IEquatable<MnExamReimbursementRequestReadable>, IValidatableObject
    {
        ...
        public MnExamReimbursementRequestReadable(string Id = default(string), DateTime? TestedDate = default(DateTime?), MnStudentEducationOrganizationAssociationReference StudentEducationOrganizationAssociationReference = default(MnStudentEducationOrganizationAssociationReference), string AssessmentCategoryDescriptor = default(string), bool? ReimbursementRequested = default(bool?), bool? UnableToPay = default(bool?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (TestedDate == null)
            {
                throw new InvalidDataException("TestedDate is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentEducationOrganizationAssociationReference is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AssessmentCategoryDescriptor is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ReimbursementRequested is a required property for MnExamReimbursementRequestReadable and cannot be null");
            }
            else
            {
