...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    public partial class MnStudentSAAPProgramAssociationWritable :  IEquatable<MnStudentSAAPProgramAssociationWritable>, IValidatableObject
    {
        ...
        public MnStudentSAAPProgramAssociationWritable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), bool? IndependentStudyIndicator = default(bool?), bool? SaapConcurrentIndicator = default(bool?), double? SaapCredits = default(double?), string Etag = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IndependentStudyIndicator is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SaapConcurrentIndicator is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            if (SaapCredits == null)
            {
                throw new InvalidDataException("SaapCredits is a required property for MnStudentSAAPProgramAssociationWritable and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="independentStudyIndicator", EmitDefaultValue=false)]
        ...
        [DataMember(Name="saapConcurrentIndicator", EmitDefaultValue=false)]
        ...
        public bool Equals(MnStudentSAAPProgramAssociationWritable input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.IndependentStudyIndicator != null &&
