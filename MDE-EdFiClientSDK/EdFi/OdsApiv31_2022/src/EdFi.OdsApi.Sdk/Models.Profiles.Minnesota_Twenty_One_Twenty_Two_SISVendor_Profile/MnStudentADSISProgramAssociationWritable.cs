...
{
    /// <summary>
    /// MnStudentADSISProgramAssociationWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentADSISProgramAssociationWritable :  IEquatable<MnStudentADSISProgramAssociationWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentADSISProgramAssociationWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentADSISProgramAssociationWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentADSISProgramAssociationWritable" /> class.
        /// </summary>
        ...
        public MnStudentADSISProgramAssociationWritable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentADSISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentADSISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentADSISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentADSISProgramAssociationWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentADSISProgramAssociationWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentADSISProgramAssociationWritable);
        }

        /// <summary>
        /// Returns true if MnStudentADSISProgramAssociationWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentADSISProgramAssociationWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentADSISProgramAssociationWritable input)
        {
            if (input == null)
                return false;
