...
{
    /// <summary>
    /// MnStudentADSISProgramAssociationReadable
    /// </summary>
    [DataContract]
    public partial class MnStudentADSISProgramAssociationReadable :  IEquatable<MnStudentADSISProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentADSISProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentADSISProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentADSISProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudentADSISProgramAssociationReadable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentADSISProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentADSISProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentADSISProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentADSISProgramAssociationReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentADSISProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentADSISProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudentADSISProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentADSISProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentADSISProgramAssociationReadable input)
        {
            if (input == null)
                return false;
