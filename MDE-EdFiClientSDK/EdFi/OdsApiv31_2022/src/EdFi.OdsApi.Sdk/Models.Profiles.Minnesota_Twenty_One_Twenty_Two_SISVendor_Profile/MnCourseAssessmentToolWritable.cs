...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    public partial class MnCourseAssessmentToolWritable :  IEquatable<MnCourseAssessmentToolWritable>, IValidatableObject
    {
        ...
        public MnCourseAssessmentToolWritable(string AssessmentToolDescriptor = default(string), string ImplementationStatusDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("AssessmentToolDescriptor is a required property for MnCourseAssessmentToolWritable and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="assessmentToolDescriptor", EmitDefaultValue=false)]
