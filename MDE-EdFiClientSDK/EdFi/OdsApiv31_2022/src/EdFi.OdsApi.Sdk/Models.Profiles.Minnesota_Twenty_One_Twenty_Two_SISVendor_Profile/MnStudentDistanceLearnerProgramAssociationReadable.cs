...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnStudentDistanceLearnerProgramAssociationReadable :  IEquatable<MnStudentDistanceLearnerProgramAssociationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDistanceLearnerProgramAssociationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentDistanceLearnerProgramAssociationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentDistanceLearnerProgramAssociationReadable" /> class.
        /// </summary>
        ...
        public MnStudentDistanceLearnerProgramAssociationReadable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentDistanceLearnerProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentDistanceLearnerProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentDistanceLearnerProgramAssociationReadable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentDistanceLearnerProgramAssociationReadable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentDistanceLearnerProgramAssociationReadable {\n");
        ...
        {
            return this.Equals(input as MnStudentDistanceLearnerProgramAssociationReadable);
        }

        /// <summary>
        /// Returns true if MnStudentDistanceLearnerProgramAssociationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentDistanceLearnerProgramAssociationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentDistanceLearnerProgramAssociationReadable input)
        {
            if (input == null)
                return false;
