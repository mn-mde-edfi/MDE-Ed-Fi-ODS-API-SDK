# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_One_SISVendor_Profile.StudentParentAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studentparentassociation.minnesota-twentytwentyone-sisvendorprofile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.studentparentassociation.minnesota-twentytwentyone-sisvendorprofile.readable+json
