# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_Twenty_One_SISVendor_Profile.StudentTitleIPartAProgramAssociationsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.studenttitleipartaprogramassociation.minnesota-twentytwentyone-sisvendorprofile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.studenttitleipartaprogramassociation.minnesota-twentytwentyone-sisvendorprofile.readable+json
