# EdFi.OdsApi.Sdk.Apis.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile.SectionsApi
...
### HTTP request headers
 ...
 - **Content-Type**: application/vnd.ed-fi.section.minnesota-twentyone-twentytwo-sisvendorprofile.writable+json
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.ed-fi.section.minnesota-twentyone-twentytwo-sisvendorprofile.readable+json
