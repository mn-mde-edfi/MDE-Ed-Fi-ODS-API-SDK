# EdFi.OdsApi.Sdk.Apis.Descriptors.EntryGradeLevelReasonDescriptorsApi
...
[**PutEntryGradeLevelReasonDescriptor**](EntryGradeLevelReasonDescriptorsApi.md#putentrygradelevelreasondescriptor) | **PUT** /ed-fi/entryGradeLevelReasonDescriptors/{id} | Updates or creates a resource based on the resource identifier.
...
namespace Example
{
    public class GetEntryGradeLevelReasonDescriptorsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiEntryGradeLevelReasonDescriptor&gt; result = apiInstance.GetEntryGradeLevelReasonDescriptors(offset, limit, totalCount, entryGradeLevelReasonDescriptorId);
...
namespace Example
{
    public class GetEntryGradeLevelReasonDescriptorsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiEntryGradeLevelReasonDescriptor result = apiInstance.GetEntryGradeLevelReasonDescriptorsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
