...
> List&lt;DeletedResource&gt; DeletesGeneralEnrollmentDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesGeneralEnrollmentDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesGeneralEnrollmentDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesGeneralEnrollmentDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
> List&lt;MnGeneralEnrollmentDescriptor&gt; GetGeneralEnrollmentDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, int? generalEnrollmentDescriptorId = null, string? snapshotIdentifier = null)
