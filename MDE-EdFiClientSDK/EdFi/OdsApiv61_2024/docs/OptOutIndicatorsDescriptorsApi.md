...
> List&lt;DeletedResource&gt; DeletesOptOutIndicatorsDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesOptOutIndicatorsDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesOptOutIndicatorsDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesOptOutIndicatorsDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
> List&lt;MnOptOutIndicatorsDescriptor&gt; GetOptOutIndicatorsDescriptors (int? offset = null, int? limit = null, int? minChangeVersion = null, int? maxChangeVersion = null, bool? totalCount = null, int? optOutIndicatorsDescriptorId = null, string? snapshotIdentifier = null)
