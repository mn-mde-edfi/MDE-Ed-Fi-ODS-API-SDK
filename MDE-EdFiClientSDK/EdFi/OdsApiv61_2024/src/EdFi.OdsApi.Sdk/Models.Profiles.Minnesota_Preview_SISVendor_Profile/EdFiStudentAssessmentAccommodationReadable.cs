...
{
    /// <summary>
    /// EdFiStudentAssessmentAccommodationReadable
    /// </summary>
    [DataContract(Name = "edFi_studentAssessmentAccommodation_readable")]
    public partial class EdFiStudentAssessmentAccommodationReadable : IEquatable<EdFiStudentAssessmentAccommodationReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentAccommodationReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentAccommodationReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentAccommodationReadable" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentAccommodationReadable(string accommodationDescriptor = default(string))
        {
            // to ensure "accommodationDescriptor" is required (not null)
            if (accommodationDescriptor == null)
            {
                throw new ArgumentNullException("accommodationDescriptor is a required property for EdFiStudentAssessmentAccommodationReadable and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentAccommodationReadable {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentAccommodationReadable);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentAccommodationReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentAccommodationReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentAccommodationReadable input)
        {
            if (input == null)
            {
                return false;
