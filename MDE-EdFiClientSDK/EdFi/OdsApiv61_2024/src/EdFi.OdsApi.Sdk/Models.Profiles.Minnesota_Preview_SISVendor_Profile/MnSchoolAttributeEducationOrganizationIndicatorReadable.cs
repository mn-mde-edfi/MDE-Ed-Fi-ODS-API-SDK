...
{
    /// <summary>
    /// MnSchoolAttributeEducationOrganizationIndicatorReadable
    /// </summary>
    [DataContract(Name = "mn_schoolAttributeEducationOrganizationIndicator_readable")]
    public partial class MnSchoolAttributeEducationOrganizationIndicatorReadable : IEquatable<MnSchoolAttributeEducationOrganizationIndicatorReadable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolAttributeEducationOrganizationIndicatorReadable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnSchoolAttributeEducationOrganizationIndicatorReadable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnSchoolAttributeEducationOrganizationIndicatorReadable" /> class.
        /// </summary>
        ...
        public MnSchoolAttributeEducationOrganizationIndicatorReadable(string indicatorDescriptor = default(string), string indicatorGroupDescriptor = default(string), string indicatorLevelDescriptor = default(string), string designatedBy = default(string), string indicatorValue = default(string), List<MnSchoolAttributeEducationOrganizationIndicatorPeriodReadable> periods = default(List<MnSchoolAttributeEducationOrganizationIndicatorPeriodReadable>))
        {
            // to ensure "indicatorDescriptor" is required (not null)
            if (indicatorDescriptor == null)
            {
                throw new ArgumentNullException("indicatorDescriptor is a required property for MnSchoolAttributeEducationOrganizationIndicatorReadable and cannot be null");
            }
        ...
        public List<MnSchoolAttributeEducationOrganizationIndicatorPeriodReadable> Periods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnSchoolAttributeEducationOrganizationIndicatorReadable {\n");
        ...
        {
            return this.Equals(input as MnSchoolAttributeEducationOrganizationIndicatorReadable);
        }

        /// <summary>
        /// Returns true if MnSchoolAttributeEducationOrganizationIndicatorReadable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnSchoolAttributeEducationOrganizationIndicatorReadable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnSchoolAttributeEducationOrganizationIndicatorReadable input)
        {
            if (input == null)
            {
                return false;
