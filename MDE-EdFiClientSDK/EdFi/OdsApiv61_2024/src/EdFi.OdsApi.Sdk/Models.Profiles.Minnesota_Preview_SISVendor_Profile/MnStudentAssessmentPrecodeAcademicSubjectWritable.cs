...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Preview_SISVendor_Profile
{
    ...
    /// </summary>
    [DataContract(Name = "mn_studentAssessmentPrecodeAcademicSubject_writable")]
    public partial class MnStudentAssessmentPrecodeAcademicSubjectWritable : IEquatable<MnStudentAssessmentPrecodeAcademicSubjectWritable>, IValidatableObject
    {
        ...
        public MnStudentAssessmentPrecodeAcademicSubjectWritable(string academicSubjectDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("academicSubjectDescriptor is a required property for MnStudentAssessmentPrecodeAcademicSubjectWritable and cannot be null");
            }
