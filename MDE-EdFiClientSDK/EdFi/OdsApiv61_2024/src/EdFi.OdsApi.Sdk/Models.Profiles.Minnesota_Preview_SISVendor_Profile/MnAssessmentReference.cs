...
{
    /// <summary>
    /// MnAssessmentReference
    /// </summary>
    [DataContract(Name = "mn_assessmentReference")]
    public partial class MnAssessmentReference : IEquatable<MnAssessmentReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentReference" /> class.
        /// </summary>
        ...
        public MnAssessmentReference(string assessmentIdentifier = default(string), string _namespace = default(string), Link link = default(Link))
        {
            // to ensure "assessmentIdentifier" is required (not null)
            if (assessmentIdentifier == null)
            {
                throw new ArgumentNullException("assessmentIdentifier is a required property for MnAssessmentReference and cannot be null");
            }
            this.AssessmentIdentifier = assessmentIdentifier;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for MnAssessmentReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentReference {\n");
        ...
        {
            return this.Equals(input as MnAssessmentReference);
        }

        /// <summary>
        /// Returns true if MnAssessmentReference instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentReference input)
        {
            if (input == null)
            {
                return false;
