...
{
    /// <summary>
    /// MnAssessmentItemReference
    /// </summary>
    [DataContract(Name = "mn_assessmentItemReference")]
    public partial class MnAssessmentItemReference : IEquatable<MnAssessmentItemReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentItemReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentItemReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentItemReference" /> class.
        /// </summary>
        ...
        public MnAssessmentItemReference(string assessmentIdentifier = default(string), string identificationCode = default(string), string _namespace = default(string), Link link = default(Link))
        {
            // to ensure "assessmentIdentifier" is required (not null)
            if (assessmentIdentifier == null)
            {
                throw new ArgumentNullException("assessmentIdentifier is a required property for MnAssessmentItemReference and cannot be null");
            }
            this.AssessmentIdentifier = assessmentIdentifier;
            // to ensure "identificationCode" is required (not null)
            if (identificationCode == null)
            {
                throw new ArgumentNullException("identificationCode is a required property for MnAssessmentItemReference and cannot be null");
            }
            this.IdentificationCode = identificationCode;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for MnAssessmentItemReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentItemReference {\n");
        ...
        {
            return this.Equals(input as MnAssessmentItemReference);
        }

        /// <summary>
        /// Returns true if MnAssessmentItemReference instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentItemReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentItemReference input)
        {
            if (input == null)
            {
                return false;
