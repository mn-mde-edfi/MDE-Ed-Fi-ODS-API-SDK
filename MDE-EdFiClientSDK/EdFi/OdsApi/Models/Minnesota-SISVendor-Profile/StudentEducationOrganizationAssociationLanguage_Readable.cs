...
{
    public class StudentEducationOrganizationAssociationLanguage_Readable 
    {
        /// <summary>
        ...
        /// </summary>
        public List<StudentEducationOrganizationAssociationLanguageUse_Readable> uses { get; set; }
