...
namespace EdFi.OdsApi.Api.Types 
{
    public class DiagnosisTypesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<DiagnosisType>> GetDiagnosisTypesByExample(int? offset= null, int? limit= null, int? diagnosisTypeId= null, string description= null, string codeValue= null, string shortDescription= null, string id= null) 
        {
            var request = new RestRequest("/diagnosisTypes", Method.GET);
            request.RequestFormat = DataFormat.Json;
