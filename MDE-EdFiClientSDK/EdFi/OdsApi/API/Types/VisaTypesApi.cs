...
namespace EdFi.OdsApi.Api.Types 
{
    public class VisaTypesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<VisaType>> GetVisaTypesByExample(int? offset= null, int? limit= null, int? visaTypeId= null, string codeValue= null, string description= null, string shortDescription= null, string id= null) 
        {
            var request = new RestRequest("/visaTypes", Method.GET);
            request.RequestFormat = DataFormat.Json;
