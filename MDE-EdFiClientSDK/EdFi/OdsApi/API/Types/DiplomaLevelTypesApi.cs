...
namespace EdFi.OdsApi.Api.Types 
{
    public class DiplomaLevelTypesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<DiplomaLevelType>> GetDiplomaLevelTypesByExample(int? offset= null, int? limit= null, int? diplomaLevelTypeId= null, string codeValue= null, string description= null, string shortDescription= null, string id= null) 
        {
            var request = new RestRequest("/diplomaLevelTypes", Method.GET);
            request.RequestFormat = DataFormat.Json;
