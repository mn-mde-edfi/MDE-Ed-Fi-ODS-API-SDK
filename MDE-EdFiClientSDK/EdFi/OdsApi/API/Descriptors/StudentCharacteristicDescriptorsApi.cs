...
namespace EdFi.OdsApi.Api.Descriptors 
{
    public class StudentCharacteristicDescriptorsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentCharacteristicDescriptor>> GetStudentCharacteristicDescriptorsByExample(int? offset= null, int? limit= null, int? studentCharacteristicDescriptorId= null, string studentCharacteristicType= null) 
        {
            var request = new RestRequest("/studentCharacteristicDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
