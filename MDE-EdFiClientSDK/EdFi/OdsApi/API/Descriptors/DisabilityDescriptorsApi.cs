...
namespace EdFi.OdsApi.Api.Descriptors 
{
    public class DisabilityDescriptorsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<DisabilityDescriptor>> GetDisabilityDescriptorsByExample(int? offset= null, int? limit= null, int? disabilityDescriptorId= null, string disabilityCategoryType= null, string disabilityType= null) 
        {
            var request = new RestRequest("/disabilityDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
