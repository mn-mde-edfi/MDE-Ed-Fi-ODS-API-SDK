...
namespace EdFi.OdsApi.Api.Descriptors 
{
    public class EntryTypeDescriptorsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<EntryTypeDescriptor>> GetEntryTypeDescriptorsByExample(int? offset= null, int? limit= null, int? entryTypeDescriptorId= null, string entryType= null) 
        {
            var request = new RestRequest("/entryTypeDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
