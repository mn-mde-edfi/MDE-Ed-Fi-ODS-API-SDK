...
namespace EdFi.OdsApi.Api.MinnesotaSISVendorProfile 
{
    public class SchoolsApi 
    {
        ...
        public IRestResponse<List<School_Readable>> GetSchoolsAll(int? offset= null, int? limit= null) 
        {
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.school.MinnesotaSISVendorProfile.readable+json");
        ...
        public IRestResponse PostSchools(School_Writable body) 
        {
            ...
            request.Parameters.First(param => param.Type == ParameterType.RequestBody).Name = "application/vnd.ed-fi.school.MinnesotaSISVendorProfile.writable+json";
