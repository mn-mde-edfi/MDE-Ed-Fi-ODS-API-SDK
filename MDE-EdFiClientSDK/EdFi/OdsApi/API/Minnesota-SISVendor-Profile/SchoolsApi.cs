...
namespace EdFi.OdsApi.Api.Minnesota-SISVendor-Profile 
{
    public class SchoolsApi 
    {
        ...
        public IRestResponse<List<School_Readable>> GetSchoolsAll(int? offset= null, int? limit= null) 
        {
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.school.Minnesota-SISVendor-Profile.readable+json");
        ...
        /// <param name="classificationDescriptor">The numeric code representing the MARSS school classification.</param>
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<School_Readable>> GetSchoolsByExample(int? offset= null, int? limit= null, int? schoolId= null, int? localEducationAgencyId= null, int? charterApprovalSchoolYear= null, string administrativeFundingControlDescriptor= null, string charterApprovalAgencyType= null, string charterStatusType= null, string internetAccessType= null, string magnetSpecialProgramEmphasisSchoolType= null, string classificationDescriptor= null, string type= null, string titleIPartASchoolDesignationType= null) 
        {
            var request = new RestRequest("/schools", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            if (classificationDescriptor != null)
                request.AddParameter("classificationDescriptor", classificationDescriptor);
            if (type != null)
        ...
        public IRestResponse PostSchools(School_Writable body) 
        {
            ...
            request.Parameters.First(param => param.Type == ParameterType.RequestBody).Name = "application/vnd.ed-fi.school.Minnesota-SISVendor-Profile.writable+json";
        ...
        public IRestResponse<School_Readable> GetSchoolsById(string id, string IfNoneMatch= null) 
        {
            ...
            if (id == null ) 
               throw new ArgumentException("API method call is missing required parameters");
            request.AddHeader("If-None-Match", IfNoneMatch);
            request.AddHeader("Accept", "application/vnd.ed-fi.school.MinnesotaSISVendor
                              .readable+json");
            var response = client.Execute<School_Readable>(request);
