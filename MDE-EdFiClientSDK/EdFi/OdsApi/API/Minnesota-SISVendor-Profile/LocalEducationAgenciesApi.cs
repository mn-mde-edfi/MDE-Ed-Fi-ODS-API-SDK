...
namespace EdFi.OdsApi.Api.MinnesotaSISVendorProfile 
{
    public class LocalEducationAgenciesApi 
    {
        ...
        public IRestResponse<List<LocalEducationAgency_Readable>> GetLocalEducationAgenciesAll(int? offset= null, int? limit= null) 
        {
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.localeducationagency.MinnesotaSISVendorProfile.readable+json");
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<LocalEducationAgency_Readable>> GetLocalEducationAgenciesByExample(int? offset= null, int? limit= null, int? localEducationAgencyId= null, int? educationServiceCenterId= null, int? parentLocalEducationAgencyId= null, int? stateEducationAgencyId= null, string charterStatusType= null, string districtTypeDescriptor= null, string categoryType= null) 
        {
            var request = new RestRequest("/localEducationAgencies", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<LocalEducationAgency_Readable> GetLocalEducationAgencyByKey(int? localEducationAgencyId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/localEducationAgencies", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostLocalEducationAgencies(LocalEducationAgency_Writable body) 
        {
            ...
            request.Parameters.First(param => param.Type == ParameterType.RequestBody).Name = "application/vnd.ed-fi.localeducationagency.MinnesotaSISVendorProfile.writable+json";
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<LocalEducationAgency_Readable> GetLocalEducationAgenciesById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutLocalEducationAgency(string id, string IfMatch, LocalEducationAgency_Writable body) 
        {
