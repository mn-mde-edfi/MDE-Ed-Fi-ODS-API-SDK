...
namespace EdFi.OdsApi.Api.Resources 
{
    public class BellSchedulesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<BellSchedule>> GetBellSchedulesByExample(int? offset= null, int? limit= null, string gradeLevelDescriptor= null, string name= null, int? schoolId= null, DateTime? date= null, string id= null) 
        {
            var request = new RestRequest("/bellSchedules", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<BellSchedule> GetBellScheduleByKey(string name, DateTime? date, string gradeLevelDescriptor, int? schoolId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/bellSchedules", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (name == null || date == null || gradeLevelDescriptor == null || schoolId == null ) 
