...
namespace EdFi.OdsApi.Api.Resources 
{
    public class DisciplineIncidentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<DisciplineIncident>> GetDisciplineIncidentsByExample(int? offset= null, int? limit= null, string incidentIdentifier= null, int? schoolId= null, string staffUniqueId= null, string incidentLocationType= null, string reporterDescriptionDescriptor= null, DateTime? incidentDate= null, string incidentTime= null, string incidentDescription= null, string reporterName= null, bool? reportedToLawEnforcement= null, string caseNumber= null, double? incidentCost= null, string id= null) 
        {
            var request = new RestRequest("/disciplineIncidents", Method.GET);
            request.RequestFormat = DataFormat.Json;
