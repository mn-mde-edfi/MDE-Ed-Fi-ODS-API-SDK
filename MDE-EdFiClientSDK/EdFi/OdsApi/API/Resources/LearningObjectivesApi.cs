...
namespace EdFi.OdsApi.Api.Resources 
{
    public class LearningObjectivesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<LearningObjective>> GetLearningObjectivesByExample(int? offset= null, int? limit= null, string academicSubjectDescriptor= null, string objectiveGradeLevelDescriptor= null, string objective= null, string parentObjective= null, string parentAcademicSubjectDescriptor= null, string parentObjectiveGradeLevelDescriptor= null, string learningObjectiveId= null, string description= null, string nomenclature= null, string successCriteria= null, string @namespace= null, string id= null) 
        {
            var request = new RestRequest("/learningObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<LearningObjective> GetLearningObjectiveByKey(string academicSubjectDescriptor, string objective, string objectiveGradeLevelDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/learningObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (academicSubjectDescriptor == null || objective == null || objectiveGradeLevelDescriptor == null ) 
