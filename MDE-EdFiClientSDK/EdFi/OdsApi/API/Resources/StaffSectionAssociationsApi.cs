...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StaffSectionAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StaffSectionAssociation>> GetStaffSectionAssociationsByExample(int? offset= null, int? limit= null, int? schoolId= null, string classPeriodName= null, string classroomIdentificationCode= null, string localCourseCode= null, string termDescriptor= null, int? schoolYear= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, string staffUniqueId= null, string classroomPositionDescriptor= null, DateTime? beginDate= null, DateTime? endDate= null, bool? highlyQualifiedTeacher= null, bool? teacherStudentDataLinkExclusion= null, double? percentageContribution= null, string id= null) 
        {
            var request = new RestRequest("/staffSectionAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StaffSectionAssociation> GetStaffSectionAssociationByKey(string classPeriodName, string classroomIdentificationCode, string localCourseCode, int? schoolId, int? schoolYear, int? sequenceOfCourse, string staffUniqueId, string termDescriptor, string uniqueSectionCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/staffSectionAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || schoolId == null || schoolYear == null || sequenceOfCourse == null || staffUniqueId == null || termDescriptor == null || uniqueSectionCode == null ) 
