...
namespace EdFi.OdsApi.Api.Resources 
{
    public class AcademicWeeksApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<AcademicWeek>> GetAcademicWeeksByExample(int? offset= null, int? limit= null, string weekIdentifier= null, int? schoolId= null, DateTime? beginDate= null, DateTime? endDate= null, int? totalInstructionalDays= null, string id= null) 
        {
            var request = new RestRequest("/academicWeeks", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<AcademicWeek> GetAcademicWeekByKey(int? schoolId, string weekIdentifier, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/academicWeeks", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (schoolId == null || weekIdentifier == null ) 
