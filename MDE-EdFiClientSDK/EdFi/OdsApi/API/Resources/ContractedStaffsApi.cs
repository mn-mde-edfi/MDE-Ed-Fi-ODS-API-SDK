...
namespace EdFi.OdsApi.Api.Resources 
{
    public class ContractedStaffsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<ContractedStaff>> GetContractedStaffsByExample(int? offset= null, int? limit= null, DateTime? asOfDate= null, int? educationOrganizationId= null, string accountNumber= null, int? fiscalYear= null, string staffUniqueId= null, double? amountToDate= null, string id= null) 
        {
            var request = new RestRequest("/contractedStaffs", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<ContractedStaff> GetContractedStaffByKey(string accountNumber, DateTime? asOfDate, int? educationOrganizationId, int? fiscalYear, string staffUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/contractedStaffs", Method.GET);
            request.RequestFormat = DataFormat.Json;
