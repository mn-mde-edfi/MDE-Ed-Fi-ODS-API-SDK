...
namespace EdFi.OdsApi.Api.Resources 
{
    public class OpenStaffPositionsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<OpenStaffPosition>> GetOpenStaffPositionsByExample(int? offset= null, int? limit= null, string employmentStatusDescriptor= null, string staffClassificationDescriptor= null, string requisitionNumber= null, DateTime? datePosted= null, int? educationOrganizationId= null, string postingResultType= null, string programAssignmentDescriptor= null, string positionTitle= null, DateTime? datePostingRemoved= null, string id= null) 
        {
            var request = new RestRequest("/openStaffPositions", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<OpenStaffPosition> GetOpenStaffPositionByKey(DateTime? datePosted, int? educationOrganizationId, string employmentStatusDescriptor, string requisitionNumber, string staffClassificationDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/openStaffPositions", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (datePosted == null || educationOrganizationId == null || employmentStatusDescriptor == null || requisitionNumber == null || staffClassificationDescriptor == null ) 
