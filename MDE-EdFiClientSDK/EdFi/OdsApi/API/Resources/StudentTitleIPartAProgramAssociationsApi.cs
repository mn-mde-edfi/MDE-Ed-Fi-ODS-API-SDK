...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentTitleIPartAProgramAssociationsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentTitleIPartAProgramAssociation>> GetStudentTitleIPartAProgramAssociationsByExample(int? offset= null, int? limit= null, int? educationOrganizationId= null, string programType= null, string programName= null, int? programEducationOrganizationId= null, DateTime? beginDate= null, string titleIPartAParticipantType= null, string studentUniqueId= null) 
        {
            var request = new RestRequest("/studentTitleIPartAProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentTitleIPartAProgramAssociation> GetStudentTitleIPartAProgramAssociationByKey(DateTime? beginDate, int? educationOrganizationId, int? programEducationOrganizationId, string programName, string programType, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentTitleIPartAProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
