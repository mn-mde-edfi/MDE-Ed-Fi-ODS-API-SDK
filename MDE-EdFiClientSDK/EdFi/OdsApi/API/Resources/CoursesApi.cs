...
namespace EdFi.OdsApi.Api.Resources 
{
    public class CoursesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Course>> GetCoursesByExample(int? offset= null, int? limit= null, string code= null, int? educationOrganizationId= null, string academicSubjectDescriptor= null, string careerPathwayType= null, string definedByType= null, string gpaApplicabilityType= null, string maximumAvailableCreditType= null, string minimumAvailableCreditType= null, string title= null, int? numberOfParts= null, string description= null, DateTime? dateCourseAdopted= null, bool? highSchoolCourseRequirement= null, double? minimumAvailableCreditConversion= null, double? minimumAvailableCredits= null, double? maximumAvailableCreditConversion= null, double? maximumAvailableCredits= null, int? timeRequiredForCompletion= null, string id= null) 
        {
            var request = new RestRequest("/courses", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Course> GetCourseByKey(string code, int? educationOrganizationId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/courses", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (code == null || educationOrganizationId == null ) 
