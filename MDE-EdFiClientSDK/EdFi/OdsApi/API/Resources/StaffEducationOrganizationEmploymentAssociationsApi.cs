...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StaffEducationOrganizationEmploymentAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StaffEducationOrganizationEmploymentAssociation>> GetStaffEducationOrganizationEmploymentAssociationsByExample(int? offset= null, int? limit= null, string employmentStatusDescriptor= null, DateTime? hireDate= null, int? educationOrganizationId= null, string staffUniqueId= null, string separationReasonDescriptor= null, string separationType= null, DateTime? endDate= null, string department= null, double? fullTimeEquivalency= null, DateTime? offerDate= null, double? hourlyWage= null, string id= null) 
        {
            var request = new RestRequest("/staffEducationOrganizationEmploymentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StaffEducationOrganizationEmploymentAssociation> GetStaffEducationOrganizationEmploymentAssociationByKey(int? educationOrganizationId, string employmentStatusDescriptor, DateTime? hireDate, string staffUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/staffEducationOrganizationEmploymentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (educationOrganizationId == null || employmentStatusDescriptor == null || hireDate == null || staffUniqueId == null ) 
