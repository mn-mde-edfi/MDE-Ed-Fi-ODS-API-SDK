...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentSchoolAssociationsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSchoolAssociation> GetStudentSchoolAssociationByKey(DateTime? entryDate, int? schoolId, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSchoolAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
