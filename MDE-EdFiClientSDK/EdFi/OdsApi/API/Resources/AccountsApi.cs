...
namespace EdFi.OdsApi.Api.Resources 
{
    public class AccountsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Account>> GetAccountsByExample(int? offset= null, int? limit= null, string number= null, int? fiscalYear= null, int? educationOrganizationId= null, string id= null) 
        {
            var request = new RestRequest("/accounts", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Account> GetAccountByKey(string number, int? educationOrganizationId, int? fiscalYear, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/accounts", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (number == null || educationOrganizationId == null || fiscalYear == null ) 
