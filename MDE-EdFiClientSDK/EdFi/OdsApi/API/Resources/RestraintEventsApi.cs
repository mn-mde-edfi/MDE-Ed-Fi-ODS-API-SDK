...
namespace EdFi.OdsApi.Api.Resources 
{
    public class RestraintEventsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<RestraintEvent>> GetRestraintEventsByExample(int? offset= null, int? limit= null, string identifier= null, DateTime? eventDate= null, int? schoolId= null, string studentUniqueId= null, string educationalEnvironmentType= null, string id= null) 
        {
            var request = new RestRequest("/restraintEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<RestraintEvent> GetRestraintEventByKey(DateTime? eventDate, string identifier, int? schoolId, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/restraintEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (eventDate == null || identifier == null || schoolId == null || studentUniqueId == null ) 
