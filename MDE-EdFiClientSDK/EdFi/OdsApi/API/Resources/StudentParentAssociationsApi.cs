...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentParentAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentParentAssociation>> GetStudentParentAssociationsByExample(int? offset= null, int? limit= null, string parentUniqueId= null, string studentUniqueId= null, string relationType= null, bool? primaryContactStatus= null, bool? livesWith= null, bool? emergencyContactStatus= null, int? contactPriority= null, string contactRestrictions= null, string id= null) 
        {
            var request = new RestRequest("/studentParentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentParentAssociation> GetStudentParentAssociationByKey(string parentUniqueId, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentParentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (parentUniqueId == null || studentUniqueId == null ) 
