...
namespace EdFi.OdsApi.Api.Resources 
{
    public class GraduationPlansApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<GraduationPlan>> GetGraduationPlansByExample(int? offset= null, int? limit= null, string typeDescriptor= null, int? educationOrganizationId= null, int? graduationSchoolYear= null, string totalRequiredCreditType= null, bool? individualPlan= null, double? totalRequiredCredits= null, double? totalRequiredCreditConversion= null, string id= null) 
        {
            var request = new RestRequest("/graduationPlans", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<GraduationPlan> GetGraduationPlanByKey(int? educationOrganizationId, string typeDescriptor, int? graduationSchoolYear, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/graduationPlans", Method.GET);
            request.RequestFormat = DataFormat.Json;
