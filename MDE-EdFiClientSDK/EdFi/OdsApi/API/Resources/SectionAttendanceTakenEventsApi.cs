...
namespace EdFi.OdsApi.Api.Resources 
{
    public class SectionAttendanceTakenEventsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<SectionAttendanceTakenEvent>> GetSectionAttendanceTakenEventsByExample(int? offset= null, int? limit= null, int? schoolId= null, DateTime? date= null, string classPeriodName= null, string classroomIdentificationCode= null, string localCourseCode= null, string termDescriptor= null, int? schoolYear= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, string staffUniqueId= null, DateTime? eventDate= null, string id= null) 
        {
            var request = new RestRequest("/sectionAttendanceTakenEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<SectionAttendanceTakenEvent> GetSectionAttendanceTakenEventByKey(string classPeriodName, string classroomIdentificationCode, DateTime? date, string localCourseCode, int? schoolId, int? schoolYear, int? sequenceOfCourse, string termDescriptor, string uniqueSectionCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/sectionAttendanceTakenEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (classPeriodName == null || classroomIdentificationCode == null || date == null || localCourseCode == null || schoolId == null || schoolYear == null || sequenceOfCourse == null || termDescriptor == null || uniqueSectionCode == null ) 
