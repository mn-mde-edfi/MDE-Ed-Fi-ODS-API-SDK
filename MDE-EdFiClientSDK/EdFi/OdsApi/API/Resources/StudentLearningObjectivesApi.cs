...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentLearningObjectivesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentLearningObjective>> GetStudentLearningObjectivesByExample(int? offset= null, int? limit= null, string gradingPeriodDescriptor= null, int? schoolId= null, DateTime? gradingPeriodBeginDate= null, string objective= null, string academicSubjectDescriptor= null, string objectiveGradeLevelDescriptor= null, string studentUniqueId= null, int? educationOrganizationId= null, string programType= null, string programName= null, int? programEducationOrganizationId= null, DateTime? beginDate= null, string classPeriodName= null, string classroomIdentificationCode= null, string localCourseCode= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, int? schoolYear= null, string termDescriptor= null, DateTime? studentSectionAssociationBeginDate= null, string competencyLevelDescriptor= null, string diagnosticStatement= null, string id= null) 
        {
            var request = new RestRequest("/studentLearningObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentLearningObjective> GetStudentLearningObjectiveByKey(string academicSubjectDescriptor, DateTime? gradingPeriodBeginDate, string gradingPeriodDescriptor, string objective, string objectiveGradeLevelDescriptor, int? schoolId, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentLearningObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (academicSubjectDescriptor == null || gradingPeriodBeginDate == null || gradingPeriodDescriptor == null || objective == null || objectiveGradeLevelDescriptor == null || schoolId == null || studentUniqueId == null ) 
