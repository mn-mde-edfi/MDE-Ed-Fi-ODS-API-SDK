...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentInterventionAttendanceEventsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentInterventionAttendanceEvent>> GetStudentInterventionAttendanceEventsByExample(int? offset= null, int? limit= null, string attendanceEventCategoryDescriptor= null, DateTime? eventDate= null, string interventionIdentificationCode= null, int? educationOrganizationId= null, string studentUniqueId= null, string educationalEnvironmentType= null, string attendanceEventReason= null, string id= null) 
        {
            var request = new RestRequest("/studentInterventionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentInterventionAttendanceEvent> GetStudentInterventionAttendanceEventByKey(string attendanceEventCategoryDescriptor, int? educationOrganizationId, DateTime? eventDate, string interventionIdentificationCode, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentInterventionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (attendanceEventCategoryDescriptor == null || educationOrganizationId == null || eventDate == null || interventionIdentificationCode == null || studentUniqueId == null ) 
