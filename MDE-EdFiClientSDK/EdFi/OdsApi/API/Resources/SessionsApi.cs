...
namespace EdFi.OdsApi.Api.Resources 
{
    public class SessionsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Session>> GetSessionsByExample(int? offset= null, int? limit= null, string termDescriptor= null, int? schoolId= null, int? schoolYear= null, string name= null, DateTime? beginDate= null, DateTime? endDate= null, int? totalInstructionalDays= null, string id= null) 
        {
            var request = new RestRequest("/sessions", Method.GET);
            request.RequestFormat = DataFormat.Json;
