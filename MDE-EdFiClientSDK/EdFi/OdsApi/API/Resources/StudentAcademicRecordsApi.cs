...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentAcademicRecordsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentAcademicRecord>> GetStudentAcademicRecordsByExample(int? offset= null, int? limit= null, string termDescriptor= null, int? educationOrganizationId= null, int? schoolYear= null, string studentUniqueId= null, string cumulativeAttemptedCreditType= null, string cumulativeEarnedCreditType= null, string sessionAttemptedCreditType= null, string sessionEarnedCreditType= null, double? cumulativeEarnedCreditConversion= null, double? cumulativeEarnedCredits= null, double? cumulativeAttemptedCreditConversion= null, double? cumulativeAttemptedCredits= null, double? cumulativeGradePointsEarned= null, double? cumulativeGradePointAverage= null, string gradeValueQualifier= null, DateTime? projectedGraduationDate= null, double? sessionEarnedCreditConversion= null, double? sessionEarnedCredits= null, double? sessionAttemptedCreditConversion= null, double? sessionAttemptedCredits= null, double? sessionGradePointsEarned= null, double? sessionGradePointAverage= null, string id= null) 
        {
            var request = new RestRequest("/studentAcademicRecords", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentAcademicRecord> GetStudentAcademicRecordByKey(int? educationOrganizationId, int? schoolYear, string studentUniqueId, string termDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentAcademicRecords", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (educationOrganizationId == null || schoolYear == null || studentUniqueId == null || termDescriptor == null ) 
