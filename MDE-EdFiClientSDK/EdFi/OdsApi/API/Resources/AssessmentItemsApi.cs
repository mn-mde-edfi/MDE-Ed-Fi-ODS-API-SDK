...
namespace EdFi.OdsApi.Api.Resources 
{
    public class AssessmentItemsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<AssessmentItem>> GetAssessmentItemsByExample(int? offset= null, int? limit= null, string identificationCode= null, string assessmentTitle= null, string assessedGradeLevelDescriptor= null, string academicSubjectDescriptor= null, int? version= null, string categoryType= null, int? maxRawScore= null, string correctResponse= null, string expectedTimeAssessed= null, string nomenclature= null, string id= null) 
        {
            var request = new RestRequest("/assessmentItems", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<AssessmentItem> GetAssessmentItemByKey(string academicSubjectDescriptor, string assessedGradeLevelDescriptor, string assessmentTitle, string identificationCode, int? version, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/assessmentItems", Method.GET);
            request.RequestFormat = DataFormat.Json;
