...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StaffCohortAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StaffCohortAssociation>> GetStaffCohortAssociationsByExample(int? offset= null, int? limit= null, DateTime? beginDate= null, string cohortIdentifier= null, int? educationOrganizationId= null, string staffUniqueId= null, DateTime? endDate= null, bool? studentRecordAccess= null, string id= null) 
        {
            var request = new RestRequest("/staffCohortAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StaffCohortAssociation> GetStaffCohortAssociationByKey(DateTime? beginDate, string cohortIdentifier, int? educationOrganizationId, string staffUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/staffCohortAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (beginDate == null || cohortIdentifier == null || educationOrganizationId == null || staffUniqueId == null ) 
