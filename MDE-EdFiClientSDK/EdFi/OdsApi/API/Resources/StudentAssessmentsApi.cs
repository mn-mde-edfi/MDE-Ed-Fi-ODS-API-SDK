...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentAssessmentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentAssessment>> GetStudentAssessmentsByExample(int? offset= null, int? limit= null, DateTime? administrationDate= null, string assessmentTitle= null, string assessedGradeLevelDescriptor= null, string academicSubjectDescriptor= null, int? version= null, string studentUniqueId= null, string administrationEnvironmentType= null, string eventCircumstanceType= null, string whenAssessedGradeLevelDescriptor= null, string administrationLanguageDescriptor= null, string reasonNotTestedType= null, string retestIndicatorType= null, DateTime? administrationEndDate= null, string serialNumber= null, string eventDescription= null, string id= null) 
        {
            var request = new RestRequest("/studentAssessments", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentAssessment> GetStudentAssessmentByKey(string academicSubjectDescriptor, DateTime? administrationDate, string assessedGradeLevelDescriptor, string assessmentTitle, string studentUniqueId, int? version, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentAssessments", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (academicSubjectDescriptor == null || administrationDate == null || assessedGradeLevelDescriptor == null || assessmentTitle == null || studentUniqueId == null || version == null ) 
