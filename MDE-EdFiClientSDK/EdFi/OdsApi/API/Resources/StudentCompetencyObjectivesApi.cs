...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentCompetencyObjectivesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentCompetencyObjective>> GetStudentCompetencyObjectivesByExample(int? offset= null, int? limit= null, string objective= null, string objectiveGradeLevelDescriptor= null, int? objectiveEducationOrganizationId= null, string gradingPeriodDescriptor= null, int? schoolId= null, DateTime? gradingPeriodBeginDate= null, string studentUniqueId= null, int? educationOrganizationId= null, string programType= null, string programName= null, int? programEducationOrganizationId= null, DateTime? beginDate= null, string classPeriodName= null, string classroomIdentificationCode= null, string localCourseCode= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, int? schoolYear= null, string termDescriptor= null, string competencyLevelDescriptor= null, string diagnosticStatement= null, string id= null) 
        {
            var request = new RestRequest("/studentCompetencyObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentCompetencyObjective> GetStudentCompetencyObjectiveByKey(DateTime? gradingPeriodBeginDate, string gradingPeriodDescriptor, string objective, int? objectiveEducationOrganizationId, string objectiveGradeLevelDescriptor, int? schoolId, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentCompetencyObjectives", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (gradingPeriodBeginDate == null || gradingPeriodDescriptor == null || objective == null || objectiveEducationOrganizationId == null || objectiveGradeLevelDescriptor == null || schoolId == null || studentUniqueId == null ) 
