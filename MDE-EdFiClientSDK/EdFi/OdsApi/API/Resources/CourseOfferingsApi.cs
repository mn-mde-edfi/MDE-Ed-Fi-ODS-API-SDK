...
namespace EdFi.OdsApi.Api.Resources 
{
    public class CourseOfferingsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<CourseOffering>> GetCourseOfferingsByExample(int? offset= null, int? limit= null, string localCourseCode= null, int? schoolId= null, int? schoolYear= null, string termDescriptor= null, int? educationOrganizationId= null, string courseCode= null, string localCourseTitle= null, int? instructionalTimePlanned= null, string id= null) 
        {
            var request = new RestRequest("/courseOfferings", Method.GET);
            request.RequestFormat = DataFormat.Json;
