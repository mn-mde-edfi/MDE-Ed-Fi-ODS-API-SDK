...
namespace EdFi.OdsApi.Api.Resources 
{
    public class DisciplineActionsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<DisciplineAction>> GetDisciplineActionsByExample(int? offset= null, int? limit= null, string identifier= null, DateTime? disciplineDate= null, string studentUniqueId= null, int? responsibilitySchoolId= null, int? assignmentSchoolId= null, string lengthDifferenceReasonType= null, int? length= null, int? actualDisciplineActionLength= null, bool? relatedToZeroTolerancePolicy= null, string id= null) 
        {
            var request = new RestRequest("/disciplineActions", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<DisciplineAction> GetDisciplineActionByKey(string identifier, DateTime? disciplineDate, string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/disciplineActions", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (identifier == null || disciplineDate == null || studentUniqueId == null ) 
