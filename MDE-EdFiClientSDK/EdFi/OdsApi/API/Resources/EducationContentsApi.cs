...
namespace EdFi.OdsApi.Api.Resources 
{
    public class EducationContentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<EducationContent>> GetEducationContentsByExample(int? offset= null, int? limit= null, string contentIdentifier= null, string learningStandardId= null, string contentClassType= null, string costRateType= null, string interactivityStyleType= null, string learningResourceMetadataURI= null, string shortDescription= null, string description= null, bool? additionalAuthorsIndicator= null, string publisher= null, string timeRequired= null, string useRightsURL= null, DateTime? publicationDate= null, int? publicationYear= null, string version= null, double? cost= null, string @namespace= null, string id= null) 
        {
            var request = new RestRequest("/educationContents", Method.GET);
            request.RequestFormat = DataFormat.Json;
