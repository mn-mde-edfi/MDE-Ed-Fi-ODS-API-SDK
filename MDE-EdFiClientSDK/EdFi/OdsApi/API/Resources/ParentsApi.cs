...
namespace EdFi.OdsApi.Api.Resources 
{
    public class ParentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Parent>> GetParentsByExample(int? offset= null, int? limit= null, string parentUniqueId= null, string sexType= null, string personalTitlePrefix= null, string firstName= null, string middleName= null, string lastSurname= null, string generationCodeSuffix= null, string maidenName= null, string loginId= null, string id= null) 
        {
            var request = new RestRequest("/parents", Method.GET);
            request.RequestFormat = DataFormat.Json;
