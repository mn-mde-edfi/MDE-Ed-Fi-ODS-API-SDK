...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentGradebookEntriesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentGradebookEntry>> GetStudentGradebookEntriesByExample(int? offset= null, int? limit= null, string gradebookEntryTitle= null, string classroomIdentificationCode= null, int? schoolId= null, string classPeriodName= null, string localCourseCode= null, int? schoolYear= null, string termDescriptor= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, DateTime? dateAssigned= null, string studentUniqueId= null, DateTime? beginDate= null, string competencyLevelDescriptor= null, DateTime? dateFulfilled= null, string letterGradeEarned= null, double? numericGradeEarned= null, string diagnosticStatement= null, string id= null) 
        {
            var request = new RestRequest("/studentGradebookEntries", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentGradebookEntry> GetStudentGradebookEntryByKey(DateTime? beginDate, string classPeriodName, string classroomIdentificationCode, DateTime? dateAssigned, string gradebookEntryTitle, string localCourseCode, int? schoolId, int? schoolYear, int? sequenceOfCourse, string studentUniqueId, string termDescriptor, string uniqueSectionCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentGradebookEntries", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (beginDate == null || classPeriodName == null || classroomIdentificationCode == null || dateAssigned == null || gradebookEntryTitle == null || localCourseCode == null || schoolId == null || schoolYear == null || sequenceOfCourse == null || studentUniqueId == null || termDescriptor == null || uniqueSectionCode == null ) 
