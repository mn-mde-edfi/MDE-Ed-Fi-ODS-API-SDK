...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentSectionAttendanceEventsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentSectionAttendanceEvent>> GetStudentSectionAttendanceEventsByExample(int? offset= null, int? limit= null, string attendanceEventCategoryDescriptor= null, DateTime? eventDate= null, int? schoolId= null, string classPeriodName= null, string classroomIdentificationCode= null, string localCourseCode= null, string termDescriptor= null, int? schoolYear= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, string studentUniqueId= null, string educationalEnvironmentType= null, string attendanceEventReason= null, string id= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSectionAttendanceEvent> GetStudentSectionAttendanceEventByKey(string attendanceEventCategoryDescriptor, string classPeriodName, string classroomIdentificationCode, DateTime? eventDate, string localCourseCode, int? schoolId, int? schoolYear, int? sequenceOfCourse, string studentUniqueId, string termDescriptor, string uniqueSectionCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (attendanceEventCategoryDescriptor == null || classPeriodName == null || classroomIdentificationCode == null || eventDate == null || localCourseCode == null || schoolId == null || schoolYear == null || sequenceOfCourse == null || studentUniqueId == null || termDescriptor == null || uniqueSectionCode == null ) 
