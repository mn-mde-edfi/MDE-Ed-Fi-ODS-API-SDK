...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentSchoolAttendanceEventsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentSchoolAttendanceEvent>> GetStudentSchoolAttendanceEventsByExample(int? offset= null, int? limit= null, string attendanceEventCategoryDescriptor= null, DateTime? eventDate= null, int? schoolId= null, int? schoolYear= null, string termDescriptor= null, string studentUniqueId= null, string educationalEnvironmentType= null, string attendanceEventReason= null, string id= null) 
        {
            var request = new RestRequest("/studentSchoolAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSchoolAttendanceEvent> GetStudentSchoolAttendanceEventByKey(string attendanceEventCategoryDescriptor, DateTime? eventDate, int? schoolId, int? schoolYear, string studentUniqueId, string termDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSchoolAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (attendanceEventCategoryDescriptor == null || eventDate == null || schoolId == null || schoolYear == null || studentUniqueId == null || termDescriptor == null ) 
