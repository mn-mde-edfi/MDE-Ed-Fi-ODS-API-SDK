...
namespace EdFi.OdsApi.Api.Resources 
{
    public class GradingPeriodsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<GradingPeriod>> GetGradingPeriodsByExample(int? offset= null, int? limit= null, string descriptor= null, DateTime? beginDate= null, int? schoolId= null, int? totalInstructionalDays= null, DateTime? endDate= null, int? periodSequence= null, string id= null) 
        {
            var request = new RestRequest("/gradingPeriods", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<GradingPeriod> GetGradingPeriodByKey(DateTime? beginDate, string descriptor, int? schoolId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/gradingPeriods", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (beginDate == null || descriptor == null || schoolId == null ) 
