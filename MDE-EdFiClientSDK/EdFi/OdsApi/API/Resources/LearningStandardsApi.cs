...
namespace EdFi.OdsApi.Api.Resources 
{
    public class LearningStandardsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<LearningStandard>> GetLearningStandardsByExample(int? offset= null, int? limit= null, string learningStandardId= null, string parentLearningStandardId= null, string academicSubjectDescriptor= null, string description= null, string itemCode= null, string uri= null, string courseTitle= null, string successCriteria= null, string id= null, string @namespace= null) 
        {
            var request = new RestRequest("/learningStandards", Method.GET);
            request.RequestFormat = DataFormat.Json;
