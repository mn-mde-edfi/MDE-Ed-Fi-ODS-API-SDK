# EdFi.OdsApi.Sdk.Apis.Descriptors.CharterStatusDescriptorsApi
...
[**PutCharterStatusDescriptor**](CharterStatusDescriptorsApi.md#putcharterstatusdescriptor) | **PUT** /ed-fi/charterStatusDescriptors/{id} | Updates or creates a resource based on the resource identifier.


<a name="deletecharterstatusdescriptorbyid"></a>
...
namespace Example
{
    public class DeleteCharterStatusDescriptorByIdExample
    {
        public void main()
        {
            ...
            var apiInstance = new CharterStatusDescriptorsApi();
...
<a name="getcharterstatusdescriptors"></a>
...
namespace Example
{
    public class GetCharterStatusDescriptorsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List&lt;EdFiCharterStatusDescriptor&gt; result = apiInstance.GetCharterStatusDescriptors(offset, limit, totalCount, charterStatusDescriptorId);
...
<a name="getcharterstatusdescriptorsbyid"></a>
...
namespace Example
{
    public class GetCharterStatusDescriptorsByIdExample
    {
        public void main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiCharterStatusDescriptor result = apiInstance.GetCharterStatusDescriptorsById(id, ifNoneMatch);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
<a name="postcharterstatusdescriptor"></a>
...
<a name="putcharterstatusdescriptor"></a>
