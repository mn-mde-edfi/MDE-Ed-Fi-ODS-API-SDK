...
**StudentIndicators** | [**List&lt;EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable&gt;**](EdFiStudentEducationOrganizationAssociationStudentIndicatorReadable.md) | An unordered collection of studentEducationOrganizationAssociationStudentIndicators. Indicator(s) or metric(s) computed for the student (e.g., at risk) to influence more effective education or direct specific interventions. | [optional] 
