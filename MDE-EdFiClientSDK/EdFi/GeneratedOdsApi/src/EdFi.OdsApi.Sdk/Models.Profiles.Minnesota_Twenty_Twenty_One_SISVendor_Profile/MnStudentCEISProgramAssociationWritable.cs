...
{
    /// <summary>
    /// MnStudentCEISProgramAssociationWritable
    /// </summary>
    [DataContract]
    public partial class MnStudentCEISProgramAssociationWritable :  IEquatable<MnStudentCEISProgramAssociationWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentCEISProgramAssociationWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnStudentCEISProgramAssociationWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnStudentCEISProgramAssociationWritable" /> class.
        /// </summary>
        ...
        public MnStudentCEISProgramAssociationWritable(string Id = default(string), DateTime? BeginDate = default(DateTime?), MnEducationOrganizationReference EducationOrganizationReference = default(MnEducationOrganizationReference), MnProgramReference ProgramReference = default(MnProgramReference), MnStudentReference StudentReference = default(MnStudentReference), DateTime? EndDate = default(DateTime?), string Etag = default(string))
        {
            ...
            if (BeginDate == null)
            {
                throw new InvalidDataException("BeginDate is a required property for MnStudentCEISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("EducationOrganizationReference is a required property for MnStudentCEISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProgramReference is a required property for MnStudentCEISProgramAssociationWritable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StudentReference is a required property for MnStudentCEISProgramAssociationWritable and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnStudentCEISProgramAssociationWritable {\n");
        ...
        {
            return this.Equals(input as MnStudentCEISProgramAssociationWritable);
        }

        /// <summary>
        /// Returns true if MnStudentCEISProgramAssociationWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of MnStudentCEISProgramAssociationWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnStudentCEISProgramAssociationWritable input)
        {
            if (input == null)
                return false;
