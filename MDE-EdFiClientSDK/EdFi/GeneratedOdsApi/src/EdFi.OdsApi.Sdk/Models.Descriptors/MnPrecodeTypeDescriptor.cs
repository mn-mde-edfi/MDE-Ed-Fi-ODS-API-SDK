...
{
    /// <summary>
    /// MnPrecodeTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class MnPrecodeTypeDescriptor :  IEquatable<MnPrecodeTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnPrecodeTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnPrecodeTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnPrecodeTypeDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="PrecodeTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnPrecodeTypeDescriptor(string Id = default(string), int? PrecodeTypeDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnPrecodeTypeDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnPrecodeTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnPrecodeTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnPrecodeTypeDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.PrecodeTypeDescriptorId = PrecodeTypeDescriptorId;
        ...
        [DataMember(Name="precodeTypeDescriptorId", EmitDefaultValue=false)]
        public int? PrecodeTypeDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnPrecodeTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PrecodeTypeDescriptorId: ").Append(PrecodeTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnPrecodeTypeDescriptor);
        }

        /// <summary>
        /// Returns true if MnPrecodeTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnPrecodeTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnPrecodeTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrecodeTypeDescriptorId == input.PrecodeTypeDescriptorId ||
                    (this.PrecodeTypeDescriptorId != null &&
                    this.PrecodeTypeDescriptorId.Equals(input.PrecodeTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrecodeTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.PrecodeTypeDescriptorId.GetHashCode();
