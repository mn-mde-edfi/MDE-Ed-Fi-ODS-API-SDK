...
{
    /// <summary>
    /// MnMembershipAttendanceUnitDescriptor
    /// </summary>
    [DataContract]
    public partial class MnMembershipAttendanceUnitDescriptor :  IEquatable<MnMembershipAttendanceUnitDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnMembershipAttendanceUnitDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnMembershipAttendanceUnitDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnMembershipAttendanceUnitDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="MembershipAttendanceUnitDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnMembershipAttendanceUnitDescriptor(string Id = default(string), int? MembershipAttendanceUnitDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnMembershipAttendanceUnitDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnMembershipAttendanceUnitDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnMembershipAttendanceUnitDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnMembershipAttendanceUnitDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.MembershipAttendanceUnitDescriptorId = MembershipAttendanceUnitDescriptorId;
        ...
        [DataMember(Name="membershipAttendanceUnitDescriptorId", EmitDefaultValue=false)]
        public int? MembershipAttendanceUnitDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnMembershipAttendanceUnitDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  MembershipAttendanceUnitDescriptorId: ").Append(MembershipAttendanceUnitDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnMembershipAttendanceUnitDescriptor);
        }

        /// <summary>
        /// Returns true if MnMembershipAttendanceUnitDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnMembershipAttendanceUnitDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnMembershipAttendanceUnitDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MembershipAttendanceUnitDescriptorId == input.MembershipAttendanceUnitDescriptorId ||
                    (this.MembershipAttendanceUnitDescriptorId != null &&
                    this.MembershipAttendanceUnitDescriptorId.Equals(input.MembershipAttendanceUnitDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MembershipAttendanceUnitDescriptorId != null)
                    hashCode = hashCode * 59 + this.MembershipAttendanceUnitDescriptorId.GetHashCode();
