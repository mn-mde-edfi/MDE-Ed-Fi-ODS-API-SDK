...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnImplementationStatusDescriptor :  IEquatable<MnImplementationStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnImplementationStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnImplementationStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnImplementationStatusDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="ImplementationStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnImplementationStatusDescriptor(string Id = default(string), int? ImplementationStatusDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnImplementationStatusDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnImplementationStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnImplementationStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnImplementationStatusDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.ImplementationStatusDescriptorId = ImplementationStatusDescriptorId;
        ...
        [DataMember(Name="implementationStatusDescriptorId", EmitDefaultValue=false)]
        public int? ImplementationStatusDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnImplementationStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ImplementationStatusDescriptorId: ").Append(ImplementationStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnImplementationStatusDescriptor);
        }

        /// <summary>
        /// Returns true if MnImplementationStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnImplementationStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnImplementationStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ImplementationStatusDescriptorId == input.ImplementationStatusDescriptorId ||
                    (this.ImplementationStatusDescriptorId != null &&
                    this.ImplementationStatusDescriptorId.Equals(input.ImplementationStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ImplementationStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.ImplementationStatusDescriptorId.GetHashCode();
