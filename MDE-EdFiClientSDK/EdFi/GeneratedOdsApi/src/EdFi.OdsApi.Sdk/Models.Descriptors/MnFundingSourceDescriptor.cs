...
{
    /// <summary>
    /// MnFundingSourceDescriptor
    /// </summary>
    [DataContract]
    public partial class MnFundingSourceDescriptor :  IEquatable<MnFundingSourceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnFundingSourceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnFundingSourceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnFundingSourceDescriptor" /> class.
        /// </summary>
        ...
        public MnFundingSourceDescriptor(string Id = default(string), int? FundingSourceDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MnFundingSourceDescriptor and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnFundingSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnFundingSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnFundingSourceDescriptor and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnFundingSourceDescriptor {\n");
        ...
        {
            return this.Equals(input as MnFundingSourceDescriptor);
        }

        /// <summary>
        /// Returns true if MnFundingSourceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnFundingSourceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnFundingSourceDescriptor input)
        {
            if (input == null)
                return false;
