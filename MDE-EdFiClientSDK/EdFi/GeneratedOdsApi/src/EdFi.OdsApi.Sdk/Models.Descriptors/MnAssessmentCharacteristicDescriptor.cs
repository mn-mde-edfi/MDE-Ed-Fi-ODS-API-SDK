...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class MnAssessmentCharacteristicDescriptor :  IEquatable<MnAssessmentCharacteristicDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentCharacteristicDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MnAssessmentCharacteristicDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MnAssessmentCharacteristicDescriptor" /> class.
        /// </summary>
        /// <param name="Id">Id (required).</param>
        /// <param name="AssessmentCharacteristicDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public MnAssessmentCharacteristicDescriptor(string Id = default(string), int? AssessmentCharacteristicDescriptorId = default(int?), string CodeValue = default(string), string Description = default(string), DateTime? EffectiveBeginDate = default(DateTime?), DateTime? EffectiveEndDate = default(DateTime?), string _Namespace = default(string), int? PriorDescriptorId = default(int?), string ShortDescription = default(string), string Etag = default(string))
        {
            ...
            if (CodeValue == null)
            {
                throw new InvalidDataException("CodeValue is a required property for MnAssessmentCharacteristicDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_Namespace == null)
            {
                throw new InvalidDataException("_Namespace is a required property for MnAssessmentCharacteristicDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ShortDescription is a required property for MnAssessmentCharacteristicDescriptor and cannot be null");
            }
            else
            {
                this.ShortDescription = ShortDescription;
            }
            this.AssessmentCharacteristicDescriptorId = AssessmentCharacteristicDescriptorId;
        ...
        [DataMember(Name="assessmentCharacteristicDescriptorId", EmitDefaultValue=false)]
        public int? AssessmentCharacteristicDescriptorId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MnAssessmentCharacteristicDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssessmentCharacteristicDescriptorId: ").Append(AssessmentCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as MnAssessmentCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if MnAssessmentCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of MnAssessmentCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MnAssessmentCharacteristicDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentCharacteristicDescriptorId == input.AssessmentCharacteristicDescriptorId ||
                    (this.AssessmentCharacteristicDescriptorId != null &&
                    this.AssessmentCharacteristicDescriptorId.Equals(input.AssessmentCharacteristicDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssessmentCharacteristicDescriptorId != null)
                    hashCode = hashCode * 59 + this.AssessmentCharacteristicDescriptorId.GetHashCode();
