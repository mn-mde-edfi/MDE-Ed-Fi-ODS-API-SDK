...
namespace EdFi.OdsApi.Sdk.Models.Profiles.Minnesota_Twenty_One_Twenty_Two_SISVendor_Profile
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationStudentIndicatorWritable :  IEquatable<EdFiStudentEducationOrganizationAssociationStudentIndicatorWritable>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIndicatorWritable(string IndicatorName = default(string), string Indicator = default(string), string IndicatorGroup = default(string))
        {
            ...
            {
                throw new InvalidDataException("IndicatorName is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicatorWritable and cannot be null");
            }
            else
            {
            ...
            if (Indicator == null)
            {
                throw new InvalidDataException("Indicator is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicatorWritable and cannot be null");
            }
            else
            {
